...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"46512");

  script_name(english:"Ektron CMS400.NET WorkArea/ContentRatingGraph.aspx res Variable SQL Injection");
...
database." );
 script_set_attribute(attribute:"see_also", value:"http://www.digitrustgroup.com/advisories/web-application-security-ektron.html" );
