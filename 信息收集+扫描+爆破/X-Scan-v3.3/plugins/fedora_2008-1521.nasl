...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1521
#
...
script_name(english: "Fedora 8 2008-1521: duplicity");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1521 (duplicity)");
...
if ( rpm_check( reference:"duplicity-0.4.9-1.fc8", release:"FC8") )
{
