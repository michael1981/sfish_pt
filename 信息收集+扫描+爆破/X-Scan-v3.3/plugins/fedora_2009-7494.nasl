...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7494
#
...
script_name(english: "Fedora 11 2009-7494: ocaml-camlimages");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7494 (ocaml-camlimages)");
...
if ( rpm_check( reference:"ocaml-camlimages-3.0.1-7.fc11.2", release:"FC11") )
{
