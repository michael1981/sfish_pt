...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:160: kdebase");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:160 (kdebase).");
 script_set_attribute(attribute: "description", value: "Ilja van Sprundel from suresec.org notified the KDE security team about
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:160");
