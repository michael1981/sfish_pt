...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"17105");
...
of data." );
 script_set_attribute(attribute:"see_also", value:"http://www.idefense.com/application/poi/display?id=246&type=vulnerabilities" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2005-07/0474.html" );
