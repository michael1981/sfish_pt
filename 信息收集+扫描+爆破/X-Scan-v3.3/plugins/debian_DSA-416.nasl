...
'The remote host is missing the DSA-416 security update');
...
'Read http://www.debian.org/security/2004/dsa-416
...
deb_check(prefix: 'fsp', release: '3.0', reference: '2.81.b3-3.1woody1');
deb_check(prefix: 'fspd', release: '3.0', reference: '2.81.b3-3.1woody1');
