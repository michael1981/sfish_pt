...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7531
#
...
script_name(english: "Fedora 8 2008-7531: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7531 (openoffice.org)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-4575", "CVE-2007-5747", "CVE-2008-2152", "CVE-2008-3282");
...
if ( rpm_check( reference:"openoffice.org-2.3.0-6.16.fc8", release:"FC8") )
{
