...
attackers in order to avoid detection while controlling a 'botnet'." );
 script_set_attribute(attribute:"see_also", value:"http://en.wikipedia.org/wiki/Bouncer_(networking)" );
 script_set_attribute(attribute:"see_also", value:"http://en.wikipedia.org/wiki/Botnet#Formation_and_exploitation" );
