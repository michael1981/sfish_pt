...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:219: tar");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:219 (tar).");
 script_set_attribute(attribute: "description", value: "GNU tar 1.16 and 1.15.1, and possibly other versions, allows
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:219");
