...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"27490");
  script_xref(name:"OSVDB", value:"27492");
  script_xref(name:"OSVDB", value:"53478");
...
applications to provide support for handling ZIP files." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2006-07/0584.html" );
