...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:014: metamail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:014 (metamail).");
 script_set_attribute(attribute: "description", value: "Two format string and two buffer overflow vulnerabilities were
discovered in metamail by Ulf Harnhammar. The updated packages are
patched to fix these holes.
");
 script_set_attribute(attribute: "cvss_vector", value: "CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P");
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:014");
