...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5315
#
...
script_name(english: "Fedora 7 2008-5315: roundcubemail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5315 (roundcubemail)");
...
if ( rpm_check( reference:"roundcubemail-0.2-0.alpha.fc7.1", release:"FC7") )
{
