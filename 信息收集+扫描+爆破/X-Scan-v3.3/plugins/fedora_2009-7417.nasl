...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7417
#
...
script_name(english: "Fedora 11 2009-7417: libtiff");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7417 (libtiff)");
...
if ( rpm_check( reference:"libtiff-3.8.2-13.fc11", release:"FC11") )
{
