...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2601
#
...
script_name(english: "Fedora 7 2007-2601: seamonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2601 (seamonkey)");
...
if ( rpm_check( reference:"seamonkey-1.1.5-1.fc7", release:"FC7") )
{
