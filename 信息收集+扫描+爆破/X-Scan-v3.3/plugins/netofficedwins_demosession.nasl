...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"42483");
...
which the web server operates." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://netofficedwins.sourceforge.net/modules/news/article.php?storyid=47" );
