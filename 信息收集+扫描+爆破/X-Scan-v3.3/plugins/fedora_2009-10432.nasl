...
#
# This plugin text was extracted from Fedora Security Advisory 2009-10432
#
...
script_name(english: "Fedora 10 2009-10432: Django");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-10432 (Django)");
...
if ( rpm_check( reference:"Django-1.1.1-1.fc10", release:"FC10") )
{
