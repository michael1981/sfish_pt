...
'The remote host is missing the DSA-1114 security update');
...
'The Debian project recommends that you upgrade your hashcash package.');
...
deb_check(prefix: 'hashcash', release: '3.1', reference: '1.17-1sarge1');
