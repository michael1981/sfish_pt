...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:158: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:158 (samba).");
 script_set_attribute(attribute: "description", value: "Remote exploitation of an integer overflow vulnerability
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:158");
