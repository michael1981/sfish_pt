...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200903-12 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200903-12
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-0749');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200903-12.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'OptiPNG: User-assisted execution of arbitrary code');
 exit(0);
}
...
if (qpkg_check(package: "media-gfx/optipng", unaffected: make_list("ge 0.6.2-r1"), vulnerable: make_list("lt 0.6.2-r1")
