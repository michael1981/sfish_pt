...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0103
#
...
script_name(english: "Fedora 8 2008-0103: wordpress");
...
if ( rpm_check( reference:"wordpress-2.3.2-1.fc8", release:"FC8") )
{
