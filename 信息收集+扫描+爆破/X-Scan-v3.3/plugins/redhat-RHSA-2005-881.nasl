...
if(description)
{
 ...
 script_name(english: "RHSA-2005-881: perl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2005-881");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2005-881.html");
