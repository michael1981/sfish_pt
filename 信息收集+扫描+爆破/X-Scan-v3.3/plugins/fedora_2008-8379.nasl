...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8379
#
...
script_name(english: "Fedora 9 2008-8379: emacspeak");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8379 (emacspeak)");
...
if ( rpm_check( reference:"emacspeak-28.0-3.fc9", release:"FC9") )
{
