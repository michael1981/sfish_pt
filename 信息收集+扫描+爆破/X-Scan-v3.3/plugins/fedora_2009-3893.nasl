...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3893
#
...
script_name(english: "Fedora 10 2009-3893: ruby-gnome2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3893 (ruby-gnome2)");
...
if ( rpm_check( reference:"ruby-gnome2-0.18.1-5.fc10.1", release:"FC10") )
{
