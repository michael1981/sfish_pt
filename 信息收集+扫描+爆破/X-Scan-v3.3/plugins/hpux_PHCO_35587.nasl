...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHCO_35587");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHCO_35587 security update");
 script_set_attribute(attribute: "description", value:
"Software Distributor Cumulative Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_35587");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHCO_35587");
...
if ( hpux_patch_installed (patches:"PHCO_35587 PHCO_38226 ") )
{
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.GZIP", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-AGENT", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-CMDS", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-ENG-A-MAN", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-FRE-I-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-GER-I-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-HELP", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-JPN-E-HELP", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-JPN-E-MAN", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-JPN-E-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-JPN-S-HELP", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-JPN-S-MAN", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-JPN-S-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-KOR-E-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-TCH-B-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
...
if ( hpux_check_patch( app:"SW-DIST.SD-TCH-H-MSG", version:"B.11.11.0612.458") )
{
 security_hole(0);
 exit(0);
}
