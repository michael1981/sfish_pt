...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3740
#
...
script_name(english: "Fedora 10 2009-3740: argyllcms");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3740 (argyllcms)");
...
if ( rpm_check( reference:"argyllcms-1.0.3-5.fc10", release:"FC10") )
{
