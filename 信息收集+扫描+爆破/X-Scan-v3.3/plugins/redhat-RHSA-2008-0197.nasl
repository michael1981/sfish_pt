...
if(description)
{
 ...
 script_name(english: "RHSA-2008-0197: gnome");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2008-0197");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2008-0197.html");
...
if ( rpm_check( reference:"gnome-screensaver-2.16.1-5.el5_1.1", release:'RHEL5') )
{
