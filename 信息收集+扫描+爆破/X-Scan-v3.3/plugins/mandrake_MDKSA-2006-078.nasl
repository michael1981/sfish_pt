...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:078: mozilla-thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:078 (mozilla-thunderbird).");
 script_set_attribute(attribute: "description", value: "A number of vulnerabilities have been discovered in the Mozilla
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:078");
