...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  acroread: Fix various security issues (acroread-6332)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch acroread-6332");
...
script_set_attribute(attribute: "solution", value: "Install the security patch acroread-6332");
script_end_attributes();

script_cve_id("CVE-2009-1855", "CVE-2009-1856", "CVE-2009-1857", "CVE-2009-1858", "CVE-2009-1859", "CVE-2009-0198", "CVE-2009-0509", "CVE-2009-0510", "CVE-2009-0511", "CVE-2009-0512", "CVE-2009-1861");
script_summary(english: "Check for the acroread-6332 package");
...
if ( rpm_check( reference:"acroread-8.1.6-0.1", release:"SUSE10.3") )
{
