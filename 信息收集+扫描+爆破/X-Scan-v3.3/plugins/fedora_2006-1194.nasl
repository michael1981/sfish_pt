...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1194
#
...
script_name(english: "Fedora 5 2006-1194: thunderbird");
...
if ( rpm_check( reference:"thunderbird-1.5.0.8-1.fc5", release:"FC5") )
{
