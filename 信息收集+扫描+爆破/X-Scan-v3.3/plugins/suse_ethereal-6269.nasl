...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for ethereal (ethereal-6269)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch ethereal-6269");
...
script_set_attribute(attribute: "solution", value: "Install the security patch ethereal-6269");
script_end_attributes();

script_cve_id("CVE-2009-1210", "CVE-2009-1266", "CVE-2009-1267", "CVE-2009-1268", "CVE-2009-1269");
script_summary(english: "Check for the ethereal-6269 package");
...
if ( rpm_check( reference:"ethereal-0.10.14-16.35", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"ethereal-devel-0.10.14-16.35", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
