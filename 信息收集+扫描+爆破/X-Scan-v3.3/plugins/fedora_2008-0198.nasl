...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0198
#
...
script_name(english: "Fedora 7 2008-0198: asterisk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0198 (asterisk)");
...
if ( rpm_check( reference:"asterisk-1.4.17-1.fc7", release:"FC7") )
{
