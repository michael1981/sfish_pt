...
#
# This plugin text was extracted from Fedora Security Advisory 2007-751
#
...
script_name(english: "Fedora 6 2007-751: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-751 (samba)");
...
if ( rpm_check( reference:"samba-3.0.24-8.fc6", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"samba-swat-3.0.24-8.fc6", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
