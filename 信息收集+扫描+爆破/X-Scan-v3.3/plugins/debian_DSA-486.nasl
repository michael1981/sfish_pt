...
'The remote host is missing the DSA-486 security update');
...
'Read http://www.debian.org/security/2004/dsa-486
...
deb_check(prefix: 'cvs', release: '3.0', reference: '1.11.1p1debian-9woody2');
