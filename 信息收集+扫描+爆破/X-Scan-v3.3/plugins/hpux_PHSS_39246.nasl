...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_39246");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_39246 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.53 IA-64 Intermediate Patch 22");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_39246");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_39246");
...
if ( hpux_patch_installed (patches:"PHSS_39246 PHSS_39640 PHSS_39945 ") )
{
 exit(0);
}
