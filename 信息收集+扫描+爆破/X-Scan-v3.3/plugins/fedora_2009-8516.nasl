...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8516
#
...
script_name(english: "Fedora 11 2009-8516: buildbot");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8516 (buildbot)");
...
if ( rpm_check( reference:"buildbot-0.7.11p3-2.fc11", release:"FC11") )
{
