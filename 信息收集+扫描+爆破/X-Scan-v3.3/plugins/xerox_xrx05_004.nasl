...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"14658");

  script_name(english:"XEROX MicroServer Web Server Directory Navigation Crafted URL DoS (XRX05-004)");
