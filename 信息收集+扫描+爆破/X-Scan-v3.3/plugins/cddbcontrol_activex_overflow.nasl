...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"26874");
...
remote host subject to the privileges of the current user." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2006-06/0737.html" );
 script_set_attribute(attribute:"see_also", value:"http://www.gracenote.com/corporate/security/" );
...
if (file)
{
  ...
  )
  {
    ...
    set_kb_item (name:"GraceNote/CDDBControl/File", value:file);
    set_kb_item (name:"GraceNote/CDDBControl/Version", value:version);
    set_kb_item (name:"GraceNote/CDDBControl/Flags", value:flags);
