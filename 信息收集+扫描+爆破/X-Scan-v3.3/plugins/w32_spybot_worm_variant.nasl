...
that has been used for purposes such as DDoS attacks."
 ...
 script_set_attribute(
  attribute:"see_also",
  value:"http://securityresponse.symantec.com/avcenter/venc/data/w32.spybot.fcd.html"
 );
 script_set_attribute(
  attribute:"solution",
  value:
...
necessary."
 ...
 script_set_attribute(
  ...
  value:"CVSS2#AV:N/AC:L/Au:N/C:C/I:P/A:C"
 );
 ...
 script_copyright(english:"This script is Copyright (C) 2004-2009 jorge rodriguez");
