...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1699
#
...
script_name(english: "Fedora 8 2008-1699: cacti");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1699 (cacti)");
...
Generation fails if e.g. ifDescr contains some blanks  bug#0001132: TCP/UDP pin
g
...
if ( rpm_check( reference:"cacti-0.8.7b-1.fc8", release:"FC8") )
{
