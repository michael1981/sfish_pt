...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6645
#
...
script_name(english: "Fedora 8 2008-6645: wireshark");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6645 (wireshark)");
...
if ( rpm_check( reference:"wireshark-1.0.2-1.fc8", release:"FC8") )
{
