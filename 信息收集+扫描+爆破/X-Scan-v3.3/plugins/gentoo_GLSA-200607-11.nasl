...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200607-11 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200607-11
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-3600');
script_set_attribute(attribute: 'see_also', value: 'http://bugs.musicbrainz.org/ticket/1764');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200607-11.xml');
...
if (qpkg_check(package: "media-libs/tunepimp", unaffected: make_list("ge 0.5.0"), vulnerable: make_list("le 0.4.2")
