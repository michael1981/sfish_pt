...
if(description)
{
 ...
 script_name(english: "RHSA-2007-1177: autofs");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2007-1177");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2007-1177.html");
...
if ( rpm_check( reference:"autofs5-5.0.1-0.rc2.55.el4_6.2", release:'RHEL4') )
{
