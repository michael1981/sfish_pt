...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1922
#
...
script_name(english: "Fedora 7 2008-1922: sword");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1922 (sword)");
...
if ( rpm_check( reference:"sword-1.5.10-2.fc7", release:"FC7") )
{
