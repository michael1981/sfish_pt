...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1191
#
...
script_name(english: "Fedora 6 2006-1191: yelp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1191 (yelp)");
...
if ( rpm_check( reference:"yelp-2.16.0-10.fc6", release:"FC6") )
{
