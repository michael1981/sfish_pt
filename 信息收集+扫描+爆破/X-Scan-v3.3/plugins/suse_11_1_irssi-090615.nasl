...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  irssi (2009-06-15)");
...
if ( rpm_check( reference:"irssi-0.8.12-30.70.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"irssi-0.8.12-30.70.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"irssi-devel-0.8.12-30.70.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"irssi-devel-0.8.12-30.70.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
