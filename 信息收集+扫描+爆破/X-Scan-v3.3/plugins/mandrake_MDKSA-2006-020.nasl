...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:020: ipsec-tools");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:020 (ipsec-tools).");
 script_set_attribute(attribute: "description", value: "The Internet Key Exchange version 1 (IKEv1) implementation (isakmp_agg.c)
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:020");
