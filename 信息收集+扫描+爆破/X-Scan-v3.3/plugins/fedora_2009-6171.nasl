...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6171
#
...
script_name(english: "Fedora 9 2009-6171: drupal-views");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6171 (drupal-views)");
...
if ( rpm_check( reference:"drupal-views-6.x.2.6-1.fc9", release:"FC9") )
{
