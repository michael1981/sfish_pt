...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3639
#
...
script_name(english: "Fedora 10 2009-3639: bash-completion");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3639 (bash-completion)");
...
if ( rpm_check( reference:"bash-completion-1.0-2.fc10", release:"FC10") )
{
