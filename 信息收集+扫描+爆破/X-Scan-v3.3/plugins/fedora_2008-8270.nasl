...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8270
#
...
script_name(english: "Fedora 8 2008-8270: viewvc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8270 (viewvc)");
...
if ( rpm_check( reference:"viewvc-1.0.6-1.fc8", release:"FC8") )
{
