...
#
# This plugin text was extracted from Fedora Security Advisory 2006-488
#
...
script_name(english: "Fedora 4 2006-488: mozilla");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-488 (mozilla)");
...
if ( rpm_check( reference:"mozilla-1.7.13-1.1.fc4", release:"FC4") )
{
