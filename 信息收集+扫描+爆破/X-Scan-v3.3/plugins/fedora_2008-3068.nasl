...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3068
#
...
script_name(english: "Fedora 7 2008-3068: feh");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3068 (feh)");
...
if ( rpm_check( reference:"feh-1.3.4-8.fc7", release:"FC7") )
{
