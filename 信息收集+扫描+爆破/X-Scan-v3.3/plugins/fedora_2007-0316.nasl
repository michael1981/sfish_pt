...
#
# This plugin text was extracted from Fedora Security Advisory 2007-0316
#
...
script_name(english: "Fedora 7 2007-0316: mod_perl");
...
if ( rpm_check( reference:"mod_perl-2.0.3-9.1.fc7", release:"FC7") )
{
