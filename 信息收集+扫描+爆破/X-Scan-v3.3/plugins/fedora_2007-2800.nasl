...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2800
#
...
script_name(english: "Fedora 8 2007-2800: tar");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2800 (tar)");
...
if ( rpm_check( reference:"tar-1.17-4.fc8", release:"FC8") )
{
