...
#
# This plugin text was extracted from Fedora Security Advisory 2007-041
#
...
script_name(english: "Fedora 5 2007-041: fetchmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-041 (fetchmail)");
...
if ( rpm_check( reference:"fetchmail-6.3.6-1.fc5", release:"FC5") )
{
