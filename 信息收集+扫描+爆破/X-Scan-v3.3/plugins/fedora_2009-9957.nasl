...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9957
#
...
script_name(english: "Fedora 10 2009-9957: newt");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9957 (newt)");
...
if ( rpm_check( reference:"newt-0.52.10-2.fc10", release:"FC10") )
{
