...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1914
#
...
script_name(english: "Fedora 9 2009-1914: perl-Crypt-OpenSSL-DSA");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1914 (perl-Crypt-OpenSSL-DSA)");
...
if ( rpm_check( reference:"perl-Crypt-OpenSSL-DSA-0.13-9.fc9", release:"FC9") )
{
