...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8800
#
...
script_name(english: "Fedora 11 2009-8800: qt");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8800 (qt)");
...
could allow remote attackers to cause a denial of service (memory corruption an
d
...
if ( rpm_check( reference:"qt-4.5.2-2.fc11", release:"FC11") )
{
