...
if (description)
{
  ...
  script_bugtraq_id(35649);
  script_xref(name:"OSVDB", value:"55839");
...
commands on the remote system with system level privileges." );
  ...
  script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?67a244a3" );
...
if (report_paranoia < 2)
{
 ...
 res = http_send_recv3(method:"GET", item:"/hserver.dll?&V94",port:port);
 ...
 exit(1,"Wyse WDM Service was not detected.");
}
