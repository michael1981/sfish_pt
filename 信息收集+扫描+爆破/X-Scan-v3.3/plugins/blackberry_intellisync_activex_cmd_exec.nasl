...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"59748");
...
if (rc == TRUE)
{
  ...
  if (report_paranoia > 1)
    ...
    report = string(
      ...
      "  Fixed version     : ", fixed_version, "\n",
      "\n",
      "Moreover, its killbit is not set so it is accessible via Internet\n",
      "Explorer.\n"
    );
  if (report)
  {
  ...
  else exit(0, "A vulnerable version of the control is installed but its killbit is set.");
}
