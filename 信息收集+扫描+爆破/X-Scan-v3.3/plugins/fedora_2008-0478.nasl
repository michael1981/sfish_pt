...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0478
#
...
script_name(english: "Fedora 8 2008-0478: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0478 (postgresql)");
...
if ( rpm_check( reference:"postgresql-8.2.6-1.fc8", release:"FC8") )
{
