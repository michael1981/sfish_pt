...
TLS using stunnel." );
 script_set_attribute(attribute:"see_also", value:"RFC 2222 for infomation about SASL." );
 script_set_attribute(attribute:"see_also", value:"RFC 2595 for information about TLS with POP3." );
...
if (!user || !pass) {
  exit(1, "pop3/login and/or pop3/password are empty");
}
