...
"http://sunsolve.sun.com/search/document.do?assetkey=1-21-120085-02-1");
...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"120085-02", obsoleted_by:"140399-01 128000-01 126258-02 ", package:"SUNWftpu", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
