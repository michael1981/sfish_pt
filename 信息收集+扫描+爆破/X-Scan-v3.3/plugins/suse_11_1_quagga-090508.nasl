...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  quagga (2009-05-08)");
...
if ( rpm_check( reference:"quagga-0.99.10-17.30.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"quagga-0.99.10-17.30.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"quagga-devel-0.99.10-17.30.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"quagga-devel-0.99.10-17.30.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
