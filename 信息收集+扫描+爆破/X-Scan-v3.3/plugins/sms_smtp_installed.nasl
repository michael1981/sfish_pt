...
if (description)
{
  ...
  script_name(english:"Symantec Mail Security For SMTP Installed");
  script_summary(english:"Looks for SMS for SMTP");

  script_set_attribute(
    attribute:"synopsis",
    value:"An email security application is running on the remote Windows host."
  );
  script_set_attribute(
    attribute:"description",
    value:string(
      "The remote host is running Symantec Mail Security for SMTP.\n",
      "This application is used to protect mail servers against against spam,\n",
      "viruses, and other unwanted content."
    )
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.symantec.com/business/mail-security-for-smtp"
  );
  script_set_attribute(
    attribute:"solution",
    value:"n/a"
