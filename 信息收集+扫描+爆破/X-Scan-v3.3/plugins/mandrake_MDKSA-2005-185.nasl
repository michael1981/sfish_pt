...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:185: koffice");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:185 (koffice).");
 script_set_attribute(attribute: "description", value: "Chris Evans reported a heap based buffer overflow in the RTF importer
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:185");
