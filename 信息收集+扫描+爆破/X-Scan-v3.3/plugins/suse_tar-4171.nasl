...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for tar (tar-4171)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch tar-4171");
script_end_attributes();

script_summary(english: "Check for the tar-4171 package");
