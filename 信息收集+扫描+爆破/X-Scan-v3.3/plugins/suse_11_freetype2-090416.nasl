...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  freetype2 (2009-04-16)");
...
if ( rpm_check( reference:"freetype2-2.3.7-25.9.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"freetype2-2.3.7-25.9.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"freetype2-devel-2.3.7-25.9.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
