...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  java-1_5_0-sun: Security update to 1.5.0 update 16 (java-1_5_0-sun-5434)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_5_0-sun-5434");
script_end_attributes();

script_cve_id("CVE-2008-3115", "CVE-2008-3114", "CVE-2008-3113", "CVE-2008-3112", "CVE-2008-3111", "CVE-2008-3108", "CVE-2008-3107", "CVE-2008-3106", "CVE-2008-3105", "CVE-2008-3104", "CVE-2008-3103");
script_summary(english: "Check for the java-1_5_0-sun-5434 package");
...
if ( rpm_check( reference:"java-1_5_0-sun-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-alsa-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-demo-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-devel-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-jdbc-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-plugin-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-src-1.5.0_update16-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
