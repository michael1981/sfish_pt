# This script was automatically generated from the dsa-1570
...
if (description) {
 ...
 script_cve_id("CVE-2006-7227", "CVE-2006-7228", "CVE-2006-7230", "CVE-2007-1659", "CVE-2007-1660", "CVE-2007-1661", "CVE-2007-1662");

 script_set_attribute(attribute:'synopsis', value: 
'The remote host is missing the DSA-1570 security update');
...
'The Debian project recommends that you upgrade your kazehakase package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:P');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1570] DSA-1570-1 kazehakase");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1570-1 kazehakase");
 exit(0);
}
...
deb_check(prefix: 'kazehakase', release: '4.0', reference: '0.4.2-1etch1');
