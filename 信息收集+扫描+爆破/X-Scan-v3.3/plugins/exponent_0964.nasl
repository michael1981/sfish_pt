...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"21023");
  script_xref(name:"OSVDB", value:"21024");
  script_xref(name:"OSVDB", value:"21025");
  script_xref(name:"OSVDB", value:"21026");
  script_xref(name:"OSVDB", value:"21027");
