...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_33842");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_33842 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.01 Intermediate Patch 9");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_33842");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_33842");
...
if ( hpux_patch_installed (patches:"PHSS_33842 PHSS_35579 PHSS_36773 PHSS_38761 ") )
{
 exit(0);
}
