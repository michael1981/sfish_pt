# This script was automatically generated from the dsa-1352
...
'The remote host is missing the DSA-1352 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1352] DSA-1352-1 pdfkit.framework");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1352-1 pdfkit.framework");
 exit(0);
}
...
deb_check(prefix: 'pdfkit.framework', release: '3.1', reference: '0.8-2sarge4');
