...
if(description)
{
 ...
 script_name(english: "SuSE9 Security Update:  Security update for gnome-vfs (10009)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE9 system is missing the security patch 10009");
...
script_set_attribute(attribute: "solution", value: "Install the security patch 10009");
script_end_attributes();

script_summary(english: "Check for the security advisory #10009");
...
if ( rpm_check( reference:"gnome-vfs-1.0.5-806.7", release:"SUSE9", cpu: "i586") )
{
