...
if (description)
{
  ...
  script_name(english:"WordPress 2.1.1 Multiple Script Backdoor");
...
of the web server user id." );
 script_set_attribute(attribute:"see_also", value:"http://ifsec.blogspot.com/2007/03/wordpress-code-compromised-to-enable.html" );
