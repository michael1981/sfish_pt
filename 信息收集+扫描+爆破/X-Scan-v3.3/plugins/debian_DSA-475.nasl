...
'The remote host is missing the DSA-475 security update');
...
deb_check(prefix: 'kernel-headers-2.4.18-hppa', release: '3.0', reference: '62.1');
deb_check(prefix: 'kernel-image-2.4.18-32', release: '3.0', reference: '62.1');
deb_check(prefix: 'kernel-image-2.4.18-32-smp', release: '3.0', reference: '62.1');
deb_check(prefix: 'kernel-image-2.4.18-64', release: '3.0', reference: '62.1');
deb_check(prefix: 'kernel-image-2.4.18-64-smp', release: '3.0', reference: '62.1');
deb_check(prefix: 'kernel-source-2.4.18-hppa', release: '3.0', reference: '62.1');
