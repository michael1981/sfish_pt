...
#
# This plugin text was extracted from Fedora Security Advisory 2006-491
#
...
script_name(english: "Fedora 5 2006-491: epiphany");
...
if ( rpm_check( reference:"epiphany-2.14.1-1.fc5.2", release:"FC5") )
{
