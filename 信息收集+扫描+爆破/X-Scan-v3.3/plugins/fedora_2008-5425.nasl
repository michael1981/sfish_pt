...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5425
#
...
script_name(english: "Fedora 9 2008-5425: freetype");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5425 (freetype)");
...
if ( rpm_check( reference:"freetype-2.3.5-6.fc9", release:"FC9") )
{
