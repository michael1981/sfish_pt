...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3204
#
...
script_name(english: "Fedora 10 2009-3204: pam");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3204 (pam)");
...
if ( rpm_check( reference:"pam-1.0.4-4.fc10", release:"FC10") )
{
