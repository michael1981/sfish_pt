...
#
# This plugin text was extracted from Fedora Security Advisory 2009-10466
#
...
script_name(english: "Fedora 11 2009-10466: drupal-service_links");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-10466 (drupal-service_links)");
...
if ( rpm_check( reference:"drupal-service_links-6.x.1.0-5.fc11", release:"FC11") )
{
