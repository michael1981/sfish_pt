...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_32692");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_32692 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.50 Patch for Jan-05");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32692");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_32692");
...
if ( hpux_patch_installed (patches:"PHSS_32692 PHSS_32816 PHSS_33072 PHSS_33222 PHSS_33344 PHSS_33459 PHSS_33662 PHSS_34098 PHSS_34870 ") )
{
 exit(0);
}
