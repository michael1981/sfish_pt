...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  horde (2008-11-19)");
...
script_set_attribute(attribute: "see_also", value: "https://bugzilla.novell.com/show_bug.cgi?id=368593");
script_set_attribute(attribute: "see_also", value: "https://bugzilla.novell.com/show_bug.cgi?id=412566");
script_set_attribute(attribute: "see_also", value: "https://bugzilla.novell.com/show_bug.cgi?id=423520");
...
if ( rpm_check( reference:"horde-3.1.4-121.2", release:"SUSE11.0", cpu:"noarch") )
{
