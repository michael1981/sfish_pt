...
'The remote host is missing the DSA-1166 security update');
...
'The Debian project recommends that you upgrade your cheesetracker package.');
...
deb_check(prefix: 'cheesetracker', release: '3.1', reference: '0.9.9-1sarge1');
