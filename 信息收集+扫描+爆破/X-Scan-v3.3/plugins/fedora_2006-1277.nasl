...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1277
#
...
script_name(english: "Fedora 5 2006-1277: elinks");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1277 (elinks)");
...
* Tue Nov 21 2006 Karel Zak <kzak redhat com> 0.11.0-2.4
...
if ( rpm_check( reference:"elinks-0.11.0-2.4", release:"FC5") )
{
