...
'The remote host is missing the DSA-797 security update');
...
'The Debian project recommends that you upgrade your zsync package.');
...
deb_check(prefix: 'zsync', release: '3.1', reference: '0.3.3-1.sarge.1');
