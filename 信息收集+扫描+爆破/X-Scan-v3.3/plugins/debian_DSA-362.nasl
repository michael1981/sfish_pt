...
'The remote host is missing the DSA-362 security update');
...
'Read http://www.debian.org/security/2003/dsa-362
...
deb_check(prefix: 'mindi', release: '3.0', reference: '0.58.r5-1woody1');
