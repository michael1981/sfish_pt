...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0943
#
...
script_name(english: "Fedora 10 2009-0943: dia");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0943 (dia)");
...
if ( rpm_check( reference:"dia-0.96.1-9.fc10", release:"FC10") )
{
