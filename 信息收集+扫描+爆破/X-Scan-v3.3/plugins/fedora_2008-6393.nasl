...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6393
#
...
script_name(english: "Fedora 9 2008-6393: httpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6393 (httpd)");
...
This update includes the latest release of httpd 2.2.    Two security issues ar
e
...
if ( rpm_check( reference:"httpd-2.2.9-1.fc9", release:"FC9") )
{
