...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2285
#
...
script_name(english: "Fedora 10 2009-2285: psi");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2285 (psi)");
...
if ( rpm_check( reference:"psi-0.12.1-1.fc10", release:"FC10") )
{
