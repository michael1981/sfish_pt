...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1853
#
...
script_name(english: "Fedora 7 2007-1853: bugzilla");
...
if ( rpm_check( reference:"bugzilla-3.0.1-0.fc7", release:"FC7") )
{
