...
#
# This plugin text was extracted from Fedora Security Advisory 2006-806
#
...
script_name(english: "Fedora 5 2006-806: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-806 (kernel)");
...
if ( rpm_check( reference:"kernel-2.6.17-1.2157_FC5", prefix:"kernel-", release:"FC5") )
{
