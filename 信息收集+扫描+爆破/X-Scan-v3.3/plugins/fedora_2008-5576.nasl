...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5576
#
...
script_name(english: "Fedora 9 2008-5576: gallery2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5576 (gallery2)");
...
if ( rpm_check( reference:"gallery2-2.2.5-1.fc9", release:"FC9") )
{
