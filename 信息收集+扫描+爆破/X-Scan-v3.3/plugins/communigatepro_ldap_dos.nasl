...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"22787");
  script_xref(name:"OSVDB", value:"22788");
...
Remote code execution may even be possible." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://lists.grok.org.uk/pipermail/full-disclosure/2006-January/041863.html" );
