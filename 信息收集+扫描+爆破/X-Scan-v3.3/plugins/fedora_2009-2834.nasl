...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2834
#
...
script_name(english: "Fedora 9 2009-2834: krb5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2834 (krb5)");
...
if ( rpm_check( reference:"krb5-1.6.3-16.fc9", release:"FC9") )
{
