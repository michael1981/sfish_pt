...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2867
#
...
script_name(english: "Fedora 8 2008-2867: centerim");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2867 (centerim)");
...
if ( rpm_check( reference:"centerim-4.22.4-1.fc8", release:"FC8") )
{
