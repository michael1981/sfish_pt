...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  imlib2: Fixed various security problems in imlib2-loaders (imlib2-loaders-2244)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch imlib2-loaders-2244");
...
script_set_attribute(attribute: "solution", value: "Install the security patch imlib2-loaders-2244");
script_end_attributes();

script_cve_id("CVE-2006-4809", "CVE-2006-4808", "CVE-2006-4807", "CVE-2006-4806");
script_summary(english: "Check for the imlib2-loaders-2244 package");
...
if ( rpm_check( reference:"imlib2-loaders-1.2.1-17.7", release:"SUSE10.1") )
{
