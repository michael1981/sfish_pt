...
if(description)
{
 ...
 script_name(english: "MDKSA-2002:002-1: mutt");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2002:002-1 (mutt).");
 script_set_attribute(attribute: "description", value: "Joost Pol reported a remotely exploitable buffer overflow in the mutt
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2002:002-1");
