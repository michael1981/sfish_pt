...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  wine (2009-01-28)");
...
if ( rpm_check( reference:"wine-1.1.9-1.11.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"wine-devel-1.1.9-1.11.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
