...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaFirefox: Security update to version 1.5.0.10 (MozillaFirefox-2699)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-2699");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-2699");
...
script_summary(english: "Check for the MozillaFirefox-2699 package");
...
if ( rpm_check( reference:"MozillaFirefox-1.5.0.10-0.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-1.5.0.10-0.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
