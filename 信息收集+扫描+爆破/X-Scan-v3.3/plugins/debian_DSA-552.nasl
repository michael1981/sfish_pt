...
'The remote host is missing the DSA-552 security update');
...
deb_check(prefix: 'libimlib2', release: '3.0', reference: '1.0.5-2woody1');
deb_check(prefix: 'libimlib2-dev', release: '3.0', reference: '1.0.5-2woody1');
deb_check(prefix: 'imlib2', release: '3.0', reference: '1.0.5-2woody1');
