...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_34119");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_34119 security update");
 script_set_attribute(attribute: "description", value:
"Virtualvault 4.5 OWS update");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_34119");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_34119");
...
if ( hpux_patch_installed (patches:"PHSS_34119 PHSS_35107 PHSS_35461 PHSS_35556 ") )
{
 exit(0);
}
