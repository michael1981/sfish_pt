...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1189
#
...
script_name(english: "Fedora 9 2009-1189: gedit");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1189 (gedit)");
...
if ( rpm_check( reference:"gedit-2.22.3-3.fc9", release:"FC9") )
{
