...
PHP.  See http://www.ubbcentral.com/ for more information.";
...
foreach dir (cgi_dirs()) {
  ...
  # If it's UBB.threads.
  if (
    egrep(string:res, pattern:'a href="http://www.infopop.com/landing/goto.php\\?a=ubb.threads') ||
    egrep(string:res, pattern:'A HREF="http://www.ubbthreads.com')
  ) {
    if (dir == "") dir = "/";
...
if (installs && report_verbosity > 0) {
  ...
  desc = ereg_replace(
    string:desc["english"],
    pattern:"This script.+instances found\.", 
    replace:info
  );
