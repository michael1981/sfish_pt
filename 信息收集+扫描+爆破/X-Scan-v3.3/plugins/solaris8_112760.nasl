...
if(description)
{
 ...
 script_name(english: "Solaris 5.8 (sparc) : 112760-19");
...
e +=  solaris_check_patch(release:"5.8", arch:"sparc", patch:"112760-19", obsoleted_by:"", package:"SPROcc", version:"8.0,REV=2003.03.13");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
