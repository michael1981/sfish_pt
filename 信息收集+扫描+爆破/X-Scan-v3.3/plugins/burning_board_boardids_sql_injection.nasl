...
if (description)
{
  ...
  script_name(english:"WoltLab Burning Board search.php Multiple Variable SQL Injection");
...
discovery of password hashes of users of the application." );
 script_set_attribute(attribute:"see_also", value:"http://milw0rm.com/exploits/3143" );
 script_set_attribute(attribute:"see_also", value:"http://milw0rm.com/exploits/3144" );
 script_set_attribute(attribute:"see_also", value:"http://milw0rm.com/exploits/3146" );
