...
'The remote host is missing the DSA-420 security update');
...
'The Debian project recommends that you upgrade your jitterbug package.');
...
deb_check(prefix: 'jitterbug', release: '3.0', reference: '1.6.2-4.2woody2');
