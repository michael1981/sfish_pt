...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2266
#
...
script_name(english: "Fedora 10 2009-2266: opensc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2266 (opensc)");
...
if ( rpm_check( reference:"opensc-0.11.7-1.fc10", release:"FC10") )
{
