...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2237
#
...
script_name(english: "Fedora 9 2009-2237: mediawiki");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2237 (mediawiki)");
...
if ( rpm_check( reference:"mediawiki-1.14.0-45.fc9", release:"FC9") )
{
