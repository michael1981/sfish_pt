...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4163
#
...
script_name(english: "Fedora 8 2007-4163: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4163 (drupal)");
...
if ( rpm_check( reference:"drupal-5.4-1.fc8", release:"FC8") )
{
