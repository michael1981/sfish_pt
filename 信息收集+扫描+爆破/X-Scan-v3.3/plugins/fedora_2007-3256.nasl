...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3256
#
...
script_name(english: "Fedora 7 2007-3256: openvrml");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3256 (openvrml)");
...
if ( rpm_check( reference:"openvrml-0.16.6-6.fc7", release:"FC7") )
{
