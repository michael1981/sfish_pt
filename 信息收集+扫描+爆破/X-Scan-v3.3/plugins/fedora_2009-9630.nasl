...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9630
#
...
script_name(english: "Fedora 11 2009-9630: nginx");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9630 (nginx)");
...
if ( rpm_check( reference:"nginx-0.7.62-1.fc11", release:"FC11") )
{
