...
#
# This plugin text was extracted from Fedora Security Advisory 2007-220
#
...
script_name(english: "Fedora 6 2007-220: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-220 (samba)");
...
if ( rpm_check( reference:"samba-swat-3.0.24-1.fc6", release:"FC6") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"samba-3.0.24-1.fc6", release:"FC6") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
