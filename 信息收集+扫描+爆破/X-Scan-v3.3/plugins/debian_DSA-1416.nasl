# This script was automatically generated from the dsa-1416
...
'The remote host is missing the DSA-1416 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1416] DSA-1416-1 tk8.3");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1416-1 tk8.3");
 exit(0);
}
...
deb_check(prefix: 'tk8.3', release: '4.0', reference: '8.3.5-6etch1');
deb_check(prefix: 'tk8.3-dev', release: '4.0', reference: '8.3.5-6etch1');
deb_check(prefix: 'tk8.3-doc', release: '4.0', reference: '8.3.5-6etch1');
