...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1467
#
...
script_name(english: "Fedora 7 2008-1467: tomcat5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1467 (tomcat5)");
...
if ( rpm_check( reference:"tomcat5-5.5.26-1jpp.2.fc7", release:"FC7") )
{
