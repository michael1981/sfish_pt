...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2650
#
...
script_name(english: "Fedora 8 2008-2650: gallery2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2650 (gallery2)");
...
if ( rpm_check( reference:"gallery2-2.2.4-3.fc8", release:"FC8") )
{
