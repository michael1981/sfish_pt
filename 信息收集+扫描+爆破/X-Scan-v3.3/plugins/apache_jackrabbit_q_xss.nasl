...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"51467");
  script_xref(name:"OSVDB", value:"51468");
...
The version of Apache Jackrabbit installed on the remote host fails to
...
security context of the affected site." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.apache.org/dist/jackrabbit/RELEASE-NOTES-1.5.2.txt" );
