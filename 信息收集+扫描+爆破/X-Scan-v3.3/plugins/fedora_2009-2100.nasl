...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2100
#
...
script_name(english: "Fedora 10 2009-2100: optipng");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2100 (optipng)");
...
if ( rpm_check( reference:"optipng-0.6.2.1-1.fc10", release:"FC10") )
{
