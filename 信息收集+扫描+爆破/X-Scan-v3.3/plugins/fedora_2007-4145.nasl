...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4145
#
...
script_name(english: "Fedora 8 2007-4145: nagios");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4145 (nagios)");
...
if ( rpm_check( reference:"nagios-2.10-5.fc8", release:"FC8") )
{
