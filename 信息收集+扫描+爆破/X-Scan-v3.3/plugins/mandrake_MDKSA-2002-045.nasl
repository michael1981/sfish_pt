...
if(description)
{
 ...
 script_name(english: "MDKSA-2002:045: mm");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2002:045 (mm).");
 script_set_attribute(attribute: "description", value: "Marcus Meissner and Sebastian Krahmer discovered a temporary file
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2002:045");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2002-0658");
script_summary(english: "Check for the version of the mm package");
