...
if(description)
{
 ...
 desc["english"] = "
The remote web server is a version of Zope which is older than version 2.6.3
...
Solution : Upgrade to Zope 2.6.3
See also : http://mail.zope.org/pipermail/zope-announce/2004-January/001325.html
Risk factor : High";
