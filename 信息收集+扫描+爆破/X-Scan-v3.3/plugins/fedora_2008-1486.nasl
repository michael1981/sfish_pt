...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1486
#
...
script_name(english: "Fedora 8 2008-1486: moin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1486 (moin)");
...
if ( rpm_check( reference:"moin-1.5.8-3.fc8", release:"FC8") )
{
