...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  xpdf (2009-07-27)");
...
if ( rpm_check( reference:"xpdf-3.02-95.6", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"xpdf-3.02-95.6", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"xpdf-tools-3.02-95.6", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"xpdf-tools-3.02-95.6", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
