...
"Windows Live OneCare Anti-Virus, a commercial anti-virus software
package for Windows, is installed on the remote host.  However, there
is a problem with the install -  either its services are not running,
or its engine and/or virus definition are out of date." );
...
# Last Engine Version
last_engine_version="1.1.5202.0";
