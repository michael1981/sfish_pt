...
while processing very long URLs.  By tricking a user into clicking on
a specially crafted stream, it may be possible to execute arbitrary
code on the remote system subject to the user's privileges." );
 script_set_attribute(attribute:"see_also", value:"http://security.bkis.vn/?p=277" );
 script_set_attribute(attribute:"see_also", value:"http://seclists.org/fulldisclosure/2008/Nov/0540.html" );
 script_set_attribute(attribute:"solution", value:
"Upgrade to ffdshow rev2347_20081123 or later." );
