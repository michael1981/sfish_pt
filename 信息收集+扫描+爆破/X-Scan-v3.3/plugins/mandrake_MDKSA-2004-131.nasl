...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:131: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:131 (samba).");
 script_set_attribute(attribute: "description", value: "Karol Wiesek discovered a bug in the input validation routines in
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:131");
