...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2993
#
...
script_name(english: "Fedora 7 2008-2993: comix");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2993 (comix)");
...
if ( rpm_check( reference:"comix-3.6.4-6.fc7", release:"FC7") )
{
