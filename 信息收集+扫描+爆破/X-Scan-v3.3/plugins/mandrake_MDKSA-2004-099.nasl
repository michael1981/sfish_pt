...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:099: XFree86");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:099");
...
if ( rpm_check( reference:"libxfree86-static-devel-4.3-32.2.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"XFree86-cyrillic-fonts-4.3-32.2.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"libxfree86-static-devel-4.3-24.5.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
