...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:237: cpio");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:237 (cpio).");
 script_set_attribute(attribute: "description", value: "A buffer overflow in cpio 2.6 on 64-bit platforms could allow a local
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:237");
