...
'The remote host is missing the DSA-1414 security update');
...
'The Debian project recommends that you upgrade your wireshark/ethereal packages.');
...
deb_check(prefix: 'ethereal', release: '3.1', reference: '0.10.10-2sarge10');
deb_check(prefix: 'ethereal-common', release: '3.1', reference: '0.10.10-2sarge10');
deb_check(prefix: 'ethereal-dev', release: '3.1', reference: '0.10.10-2sarge10');
deb_check(prefix: 'tethereal', release: '3.1', reference: '0.10.10-2sarge10');
deb_check(prefix: 'ethereal', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'ethereal-common', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'ethereal-dev', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'tethereal', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'tshark', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'wireshark', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'wireshark-common', release: '4.0', reference: '0.99.4-5.etch.1');
deb_check(prefix: 'wireshark-dev', release: '4.0', reference: '0.99.4-5.etch.1');
