...
"The remote host is missing Sun Security Patch number 138876-01");
...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"138876-01", obsoleted_by:"", package:"SUNWdhcsu", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
