...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"30830");
...
to execute arbitrary PHP code, possibly taken from third-party hosts." );
 script_set_attribute(attribute:"see_also", value:"http://forums.postnuke.com/index.php?name=PNphpBB2&file=viewtopic&t=41948" );
 script_set_attribute(attribute:"see_also", value:"http://www.pnphpbb.com/index.php?name=PNphpBB2&file=viewtopic&t=5606" );
