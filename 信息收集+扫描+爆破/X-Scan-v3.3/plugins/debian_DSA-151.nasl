...
'The remote host is missing the DSA-151 security update');
...
'The Debian project recommends that you upgrade your xinetd packages.');
...
deb_check(prefix: 'xinetd', release: '3.0', reference: '2.3.4-1.2');
