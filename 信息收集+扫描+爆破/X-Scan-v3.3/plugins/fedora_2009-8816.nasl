...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8816
#
...
script_name(english: "Fedora 11 2009-8816: afuse");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8816 (afuse)");
...
if ( rpm_check( reference:"afuse-0.2-4.fc11", release:"FC11") )
{
