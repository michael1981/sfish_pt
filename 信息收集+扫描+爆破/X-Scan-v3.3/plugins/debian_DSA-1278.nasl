...
'The remote host is missing the DSA-1278 security update');
...
'The Debian project recommends that you upgrade your man-db package.');
...
deb_check(prefix: 'man-db', release: '3.1', reference: '2.4.2-21sarge1');
