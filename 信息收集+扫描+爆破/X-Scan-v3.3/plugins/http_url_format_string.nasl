...
"The remote web server seems to be vulnerable to 
a format string attack on the URI.
An attacker might use this flaw to make it crash 
...
"Nessus did not kill the remote server but 
the server behaves suspiciously: hexadecimal 
digits were found in the output, they might 
have been generated by %08x");
}
