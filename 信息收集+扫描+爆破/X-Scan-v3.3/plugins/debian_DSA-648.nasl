...
'The remote host is missing the DSA-648 security update');
...
deb_check(prefix: 'xpdf', release: '3.0', reference: '1.00-3.4');
deb_check(prefix: 'xpdf-common', release: '3.0', reference: '1.00-3.4');
deb_check(prefix: 'xpdf-reader', release: '3.0', reference: '1.00-3.4');
deb_check(prefix: 'xpdf-utils', release: '3.0', reference: '1.00-3.4');
