...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  rsyslog (2008-12-17)");
...
if ( rpm_check( reference:"rsyslog-3.18.3-4.2", release:"SUSE11.1", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"rsyslog-3.18.3-4.2", release:"SUSE11.1", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
