...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"14538");
 script_version ("$Revision: 1.22 $");

 script_name(english:"Achievo class.atkdateattribute.js.php config_atkroot Variable Remote File Inclusion");
...
is accessible by the web server." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2002-08/0235.html" );
