...
if(description)
{
 ...
 script_name(english: "SuSE9 Security Update:  Security update for XFree86-Xnest (12043)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE9 system is missing the security patch 12043");
...
script_set_attribute(attribute: "solution", value: "Install the security patch 12043");
script_end_attributes();

script_cve_id("CVE-2007-5760","CVE-2007-5958","CVE-2007-6427","CVE-2007-6428","CVE-2007-6429","CVE-2007-6429");
script_summary(english: "Check for the security advisory #12043");
...
if ( rpm_check( reference:"XFree86-Xnest-4.3.99.902-43.94", release:"SUSE9", cpu: "i586") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"XFree86-Xvfb-4.3.99.902-43.94", release:"SUSE9", cpu: "i586") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
