...
'The remote host is missing the DSA-575 security update');
...
'The Debian project recommends that you upgrade your catdoc package.');
...
deb_check(prefix: 'catdoc', release: '3.0', reference: '0.91.5-1.woody3');
