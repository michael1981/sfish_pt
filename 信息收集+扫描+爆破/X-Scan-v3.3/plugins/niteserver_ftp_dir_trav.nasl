...
if(description)
{
  ...
  script_xref(name:"OSVDB", value:"2126");
  script_xref(name:"OSVDB", value:"51637");
  ...
  script_summary(english:"Attempts to set the current directory to the root of the disk");
   ...
   script_set_attribute(
    attribute:'synopsis',
    value:'The remote FTP server allows arbitrary file access'
  );

  script_set_attribute(
    attribute:'description',
    value:"The remote FTP server allows anybody to switch to the
root directory and read potentialy sensitive files."
  );

  script_set_attribute(
    attribute:'solution',
    value: "If this is Thomas Krebs Nite Server, upgrade to version 1.85 or later.
Otherwise contact your vendor for the appropriate patch."
  );

  script_set_attribute(
    attribute:'see_also',
    value:'http://archives.neohapsis.com/archives/vulnwatch/2003-q1/0022.html'
  );
