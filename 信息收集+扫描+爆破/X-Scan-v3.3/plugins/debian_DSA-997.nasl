...
'The remote host is missing the DSA-997 security update');
...
deb_check(prefix: 'bomberclone', release: '3.1', reference: '0.11.5-1sarge1');
deb_check(prefix: 'bomberclone-data', release: '3.1', reference: '0.11.5-1sarge1');
