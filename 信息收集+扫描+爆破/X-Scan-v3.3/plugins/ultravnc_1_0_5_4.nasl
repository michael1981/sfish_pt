...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"55422");
...
"The installed version of UltraVNC Viewer is earlier than 1.0.5.4. 
Such versions reportedly miscalculate a buffer size on the heap.  If
an attacker can trick a user on the remote host into connecting to a
