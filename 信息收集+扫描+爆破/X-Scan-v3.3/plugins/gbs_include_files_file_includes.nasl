...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"25251");

  script_name(english:"Stadtaus Gaestebuch-Script index.php include_files Variable Remote File Inclusion");
...
to take code from third-party hosts." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.stadtaus.com/forum/t-2600.html" );
