...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3666
#
...
script_name(english: "Fedora 9 2009-3666: xorg-x11-xfs");
...
if ( rpm_check( reference:"xorg-x11-xfs-1.0.5-2.1.fc9", release:"FC9") )
{
