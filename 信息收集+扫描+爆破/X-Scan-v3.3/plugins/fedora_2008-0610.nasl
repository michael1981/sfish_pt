...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0610
#
...
script_name(english: "Fedora 8 2008-0610: moodle");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0610 (moodle)");
...
if ( rpm_check( reference:"moodle-1.8.4-1.fc8", release:"FC8") )
{
