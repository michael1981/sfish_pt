...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2143
#
...
script_name(english: "Fedora 7 2008-2143: viewvc");
...
if ( rpm_check( reference:"viewvc-1.0.5-1.fc7", release:"FC7") )
{
