...
if(description)
{
 ...
 script_cve_id("CVE-2002-0036", "CVE-2003-0059", "CVE-2003-0060", "CVE-2003-0072", "CVE-2003-0082",
               "CVE-2003-0138", "CVE-2003-0139", "CVE-2004-0642", "CVE-2004-0643", "CVE-2004-0644",
               "CVE-2004-0772");
 script_bugtraq_id(11078, 11079, 6712, 6713, 6714, 7184, 7185);
 script_xref(name:"IAVA", value:"2003-t-0007");
 script_xref(name:"OSVDB", value:"4868");
 script_xref(name:"OSVDB", value:"4869");
 script_xref(name:"OSVDB", value:"4879");
 script_xref(name:"OSVDB", value:"4887");
 script_xref(name:"OSVDB", value:"4896");
 script_xref(name:"OSVDB", value:"4901");
 script_xref(name:"OSVDB", value:"4902");
 ...
 script_xref(name:"RHSA", value:"RHSA-2003:091-01");
 ...
 script_set_attribute(
  attribute:"synopsis",
  value:"It may be possible to execute arbitrary code on the remote Kerberos server."
 );
 script_set_attribute(
...
There are multiple flaws which affect this product.  Make sure you are
...
be a false positive."
 ...
 script_set_attribute(
  attribute:"see_also", 
  value:"http://web.mit.edu/kerberos/www/advisories/MITKRB5-SA-2004-002-dblfree.txt"
 );
 script_set_attribute(
  attribute:"solution", 
  value:"Upgrade to Kerberos 5 (krb5) 1.3.5 or later."
 );
 script_set_attribute(
