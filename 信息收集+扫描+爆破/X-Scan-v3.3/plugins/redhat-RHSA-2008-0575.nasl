...
if(description)
{
 ...
 script_name(english: "RHSA-2008-0575: rdesktop");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2008-0575");
 script_set_attribute(attribute: "description", value: '
  An updated rdesktop package that fixes a security issue is now available
  for
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2008-0575.html");
...
if ( rpm_check( reference:"rdesktop-1.4.1-6", release:'RHEL5') )
{
