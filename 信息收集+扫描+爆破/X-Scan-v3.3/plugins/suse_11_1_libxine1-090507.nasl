...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  libxine1 (2009-05-07)");
...
if ( rpm_check( reference:"libxine1-1.1.15-23.4.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libxine1-1.1.15-23.4.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libxine1-32bit-1.1.15-23.4.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
