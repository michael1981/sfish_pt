...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3130
#
...
script_name(english: "Fedora 7 2007-3130: mono");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3130 (mono)");
...
if ( rpm_check( reference:"mono-1.2.3-5.fc7", release:"FC7") )
{
