...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2928
#
...
script_name(english: "Fedora 9 2009-2928: lcms");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2928 (lcms)");
...
if ( rpm_check( reference:"lcms-1.18-1.fc9", release:"FC9") )
{
