...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"2017");
...
buffer and crash the affected web server or even execute arbirtray
code on the affected host." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2002-01/0036.html" );
