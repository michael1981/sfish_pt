...
#
# This plugin text was extracted from Fedora Security Advisory 2007-351
#
...
script_name(english: "Fedora 6 2007-351: libwpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-351 (libwpd)");
...
if ( rpm_check( reference:"libwpd-0.8.9-1.fc6", release:"FC6") )
{
