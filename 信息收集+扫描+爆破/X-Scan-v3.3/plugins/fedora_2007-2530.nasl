...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2530
#
...
script_name(english: "Fedora 7 2007-2530: openssl");
...
if ( rpm_check( reference:"openssl-0.9.8b-15.fc7", release:"FC7") )
{
