...
'The remote host is missing the DSA-939 security update');
...
deb_check(prefix: 'fetchmail', release: '3.1', reference: '6.2.5-12sarge4');
deb_check(prefix: 'fetchmail-ssl', release: '3.1', reference: '6.2.5-12sarge4');
deb_check(prefix: 'fetchmailconf', release: '3.1', reference: '6.2.5-12sarge4');
