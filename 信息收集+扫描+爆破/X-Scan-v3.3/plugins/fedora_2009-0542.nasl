...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0542
#
...
script_name(english: "Fedora 9 2009-0542: xine-lib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0542 (xine-lib)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-3231", "CVE-2008-5236", "CVE-2008-5243");
...
if ( rpm_check( reference:"xine-lib-1.1.16-1.fc9.1", release:"FC9") )
{
