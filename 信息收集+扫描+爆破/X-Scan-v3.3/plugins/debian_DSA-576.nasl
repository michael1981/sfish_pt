...
'The remote host is missing the DSA-576 security update');
...
deb_check(prefix: 'squid', release: '3.0', reference: '2.4.6-2woody4');
deb_check(prefix: 'squid-cgi', release: '3.0', reference: '2.4.6-2woody4');
deb_check(prefix: 'squidclient', release: '3.0', reference: '2.4.6-2woody4');
