...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"33199");
...
This plugin provides the primary means of viewing DjVu documents,
...
functions.  An attacker may be able to leverage these issues to
execute arbitrary code on the remote host subject to the user's
privileges if he can trick the user into viewing a specially-crafted
web page." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2007-02/0349.html" );
 script_set_attribute(attribute:"see_also", value:"http://www.lizardtech.com/products/doc/djvupluginrelease.php" );
