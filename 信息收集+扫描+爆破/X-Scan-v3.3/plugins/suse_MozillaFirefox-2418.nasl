...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaFirefox: Security update to 1.5.0.9 (MozillaFirefox-2418)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-2418");
 script_set_attribute(attribute: "description", value: "This update brings MozillaFirefox to the security update
release 1.5.0.9
 (2.0.0.1 for openSUSE 10.2) and includes
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-2418");
...
script_summary(english: "Check for the MozillaFirefox-2418 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.1-0.1", release:"SUSE10.2") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.1-0.1", release:"SUSE10.2") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
