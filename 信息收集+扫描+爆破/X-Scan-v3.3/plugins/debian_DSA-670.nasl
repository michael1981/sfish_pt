...
'The remote host is missing the DSA-670 security update');
...
deb_check(prefix: 'emacs20', release: '3.0', reference: '20.7-13.3');
deb_check(prefix: 'emacs20-el', release: '3.0', reference: '20.7-13.3');
