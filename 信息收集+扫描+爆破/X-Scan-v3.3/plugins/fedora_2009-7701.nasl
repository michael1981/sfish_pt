...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7701
#
...
script_name(english: "Fedora 11 2009-7701: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7701 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.8.1-1.fc11", release:"FC11") )
{
