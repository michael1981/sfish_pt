...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:176: webmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:176 (webmin).");
 script_set_attribute(attribute: "description", value: "Miniserv.pl in Webmin 1.220, when 'full PAM conversations' is enabled,
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:176");
