...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3093
#
...
script_name(english: "Fedora 8 2007-3093: koffice");
...
if ( rpm_check( reference:"koffice-1.6.3-13.fc8", release:"FC8") )
{
