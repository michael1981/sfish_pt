...
'The remote host is missing the DSA-1067 security update');
...
deb_check(prefix: 'kernel-doc-2.4.16', release: '3.0', reference: '2.4.16-1woody3');
deb_check(prefix: 'kernel-headers-2.4.16', release: '3.0', reference: '20040419woody1');
deb_check(prefix: 'kernel-image-2.4.16-lart', release: '3.0', reference: '20040419woody1');
deb_check(prefix: 'kernel-image-2.4.16-netwinder', release: '3.0', reference: '20040419woody1');
deb_check(prefix: 'kernel-image-2.4.16-riscpc', release: '3.0', reference: '20040419woody1');
deb_check(prefix: 'kernel-source-2.4.16', release: '3.0', reference: '2.4.16-1woody3');
