...
#
# This plugin text was extracted from Fedora Security Advisory 2008-10938
#
...
script_name(english: "Fedora 8 2008-10938: awstats");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-10938 (awstats)");
...
if ( rpm_check( reference:"awstats-6.8-3.fc8", release:"FC8") )
{
