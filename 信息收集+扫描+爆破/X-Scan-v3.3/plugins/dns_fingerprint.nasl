...
if(description)
{
 ...
 script_set_attribute(
   attribute:"synopsis",
   value:"It may be possible fingerprint the remote DNS server."
 );
 script_set_attribute(
   attribute:"description", 
   value:string(
     "This script attempts to identify the remote DNS server type and\n",
     "version by sending various invalid requests to the remote DNS server\n",
     "and analyzing the error codes returned."
   )
 );
 script_set_attribute(
   attribute:"see_also",
   value:"http://cr.yp.to/surveys/dns1.html"
 );
 script_set_attribute(
   attribute:"solution", 
   value:"n/a"
...
global_var RD_BIT, TC_BIT, AA_BIT, Z0_BIT, RCODE15, Z1_BIT, Z2_BIT, OPCODE2, OPCODE3, OPCODE6;
...
function probe(message)
{
 ...
 if ( ! r ) 
 {
  ...
  if ( timeouts > 3 && !thorough_tests)
  {
	 ...
	 report = '\nThe remote name server could not be fingerprinted (too many itimeouts)\n';
