...
"The remote server seems open to remote users. Some people prefer open public
NNTP servers to be able to read or post articles anonymously.
Unwanted connections could waste your bandwith or put you into legal 
trouble if a malicious person were to use your server to post abusive 
articles.
