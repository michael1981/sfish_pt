...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for OpenSSL (openssl-6654)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch openssl-6654");
...
script_set_attribute(attribute: "solution", value: "Install the security patch openssl-6654");
script_end_attributes();

script_cve_id("CVE-2009-3555");
script_summary(english: "Check for the openssl-6654 package");
...
if ( rpm_check( reference:"openssl-0.9.8a-18.39.1", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"openssl-devel-0.9.8a-18.39.1", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"openssl-doc-0.9.8a-18.39.1", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
