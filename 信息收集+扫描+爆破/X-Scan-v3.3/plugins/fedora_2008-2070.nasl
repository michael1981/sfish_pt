...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2070
#
...
script_name(english: "Fedora 8 2008-2070: dbus");
...
if ( rpm_check( reference:"dbus-1.1.2-9.fc8", release:"FC8") )
{
