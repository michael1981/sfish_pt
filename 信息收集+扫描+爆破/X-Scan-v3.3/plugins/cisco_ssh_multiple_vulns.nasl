...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"3561");
 script_xref(name:"OSVDB", value:"3562");
 ...
 script_set_attribute(
   attribute:"see_also",
   value:"http://archives.neohapsis.com/archives/bugtraq/2001-03/0225.html"
 );
 script_set_attribute(
   attribute:"see_also",
   value:"http://www.cisco.com/warp/public/707/SSH-multiple-pub.html"
 );
 script_set_attribute(
   attribute:"solution", 
