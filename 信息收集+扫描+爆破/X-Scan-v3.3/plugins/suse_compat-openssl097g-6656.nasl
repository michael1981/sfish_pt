...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for OpenSSL (compat-openssl097g-6656)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch compat-openssl097g-6656");
...
script_set_attribute(attribute: "solution", value: "Install the security patch compat-openssl097g-6656");
script_end_attributes();

script_cve_id("CVE-2009-3555");
script_summary(english: "Check for the compat-openssl097g-6656 package");
...
if ( rpm_check( reference:"compat-openssl097g-0.9.7g-13.19.1", release:"SLES10") )
{
