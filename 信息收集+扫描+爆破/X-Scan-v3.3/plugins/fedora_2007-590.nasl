...
#
# This plugin text was extracted from Fedora Security Advisory 2007-590
#
...
script_name(english: "Fedora 6 2007-590: iscsi-initiator-utils");
...
if ( rpm_check( reference:"iscsi-initiator-utils-6.2.0.865-0.0.fc6", release:"FC6") )
{
