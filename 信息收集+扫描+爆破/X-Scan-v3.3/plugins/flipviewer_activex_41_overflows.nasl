...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"37042");
...
contains multiple stack buffer overflow vulnerabilities.  A remote
...
code on the remote host subject to the privileges of the current user." );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/449089" );
 script_set_attribute(attribute:"solution", value:
"Upgrade to version 4.1 or later of the control." );
