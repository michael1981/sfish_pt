...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9396
#
...
script_name(english: "Fedora 9 2008-9396: uw-imap");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9396 (uw-imap)");
...
if ( rpm_check( reference:"uw-imap-2007d-1.fc9", release:"FC9") )
{
