...
#
# This plugin text was extracted from Fedora Security Advisory 2007-716
#
...
script_name(english: "Fedora 6 2007-716: kdebase");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-716 (kdebase)");
...
* Tue Oct  2 2007 Than Ngo <than redhat com> - 6:3.5.7-1.fc6
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-3820", "CVE-2007-4569");
...
if ( rpm_check( reference:"kdebase-3.5.7-1.fc6", release:"FC6") )
{
