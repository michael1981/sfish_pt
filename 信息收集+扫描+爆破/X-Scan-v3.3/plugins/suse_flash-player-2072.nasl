...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  flash-player: Security update to fix various problems (flash-player-2072)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch flash-player-2072");
...
that include or reference the Flash Player. (CVE-2006-3311,
...
script_set_attribute(attribute: "solution", value: "Install the security patch flash-player-2072");
script_end_attributes();

script_cve_id("CVE-2006-3311", "CVE-2006-3587", "CVE-2006-3588", "CVE-2006-4640");
script_summary(english: "Check for the flash-player-2072 package");
...
if ( rpm_check( reference:"flash-player-7.0.68.0-1.2", release:"SUSE10.1") )
{
