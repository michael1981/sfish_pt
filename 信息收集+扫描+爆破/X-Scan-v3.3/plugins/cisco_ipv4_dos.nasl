...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"2325");
 script_xref(name:"IAVA", value:"2003-A-0010");
 ...
 script_set_attribute(
   ...
   value:string(
     "According to its version number, the remote router or switch is\n",
     "running a vulnerable version of Cisco IOS.  Sending a specific\n",
     "sequence of IPv4 packets can cause the input interface to stop\n",
     "accepting traffic.\n\n",
 ...
 script_set_attribute(
   attribute:"see_also",
   value:"http://www.cert.org/advisories/CA-2003-15.html"
 );
 script_set_attribute(
   attribute:"see_also",
   value:"http://www.cisco.com/warp/public/707/cisco-sa-20030717-blocked.shtml"
 );
 script_set_attribute(
   attribute:"solution", 
   value:"Upgrade to the version of IOS referenced in the vendor's advisory."
 );
 script_set_attribute(
