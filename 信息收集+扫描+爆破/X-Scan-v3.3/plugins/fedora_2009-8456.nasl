...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8456
#
...
script_name(english: "Fedora 10 2009-8456: xmlsec1");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8456 (xmlsec1)");
...
if ( rpm_check( reference:"xmlsec1-1.2.12-1.fc10", release:"FC10") )
{
