...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"29219");
  script_xref(name:"OSVDB", value:"29220");
  script_xref(name:"OSVDB", value:"29221");
  script_xref(name:"OSVDB", value:"29222");
  script_xref(name:"OSVDB", value:"29223");
  script_xref(name:"OSVDB", value:"29224");
  script_xref(name:"OSVDB", value:"29225");
  script_xref(name:"OSVDB", value:"29226");
...
context of the affected web site." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://sunsolve.sun.com/search/document.do?assetkey=1-26-102650-1" );
