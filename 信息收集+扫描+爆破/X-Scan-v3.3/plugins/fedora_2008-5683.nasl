...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5683
#
...
script_name(english: "Fedora 9 2008-5683: horde");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5683 (horde)");
...
Update to the New Horde Application Framework (3.2.1)  Includes security fixes
(XSS in object browser)
");
...
if ( rpm_check( reference:"horde-3.2.1-1.fc9", release:"FC9") )
{
