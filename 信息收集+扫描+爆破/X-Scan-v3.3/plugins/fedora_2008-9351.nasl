...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9351
#
...
script_name(english: "Fedora 8 2008-9351: enscript");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9351 (enscript)");
...
if ( rpm_check( reference:"enscript-1.6.4-9.fc8", release:"FC8") )
{
