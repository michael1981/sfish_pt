...
"The remote host is missing the patch for the advisory MDKA-2006:045 (coreutils).");
 script_set_attribute(attribute: "description", value: "The coreutils package lacked several features due to a build
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKA-2006:045");
