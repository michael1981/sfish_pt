...
"http://sunsolve.sun.com/search/document.do?assetkey=1-21-120982-18-1");
...
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"120982-18", obsoleted_by:"", package:"SUNWproxy", version:"4.0,REV=2005.08.18.08.09");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
