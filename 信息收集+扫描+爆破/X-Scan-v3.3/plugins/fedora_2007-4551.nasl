...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4551
#
...
script_name(english: "Fedora 8 2007-4551: exiv2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4551 (exiv2)");
...
if ( rpm_check( reference:"exiv2-0.15-5.fc8", release:"FC8") )
{
