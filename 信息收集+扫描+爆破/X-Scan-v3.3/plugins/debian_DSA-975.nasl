...
'The remote host is missing the DSA-975 security update');
...
'The Debian project recommends that you upgrade your nfs-user-server package.');
...
deb_check(prefix: 'nfs-user-server', release: '3.0', reference: '2.2beta47-12woody1');
deb_check(prefix: 'ugidd', release: '3.0', reference: '2.2beta47-12woody1');
deb_check(prefix: 'nfs-user-server', release: '3.1', reference: '2.2beta47-20sarge2');
deb_check(prefix: 'ugidd', release: '3.1', reference: '2.2beta47-20sarge2');
