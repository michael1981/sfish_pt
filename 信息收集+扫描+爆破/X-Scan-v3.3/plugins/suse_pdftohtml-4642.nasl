...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  pdftohtml security update (pdftohtml-4642)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch pdftohtml-4642");
script_end_attributes();

script_cve_id("CVE-2007-4352", "CVE-2007-5392", "CVE-2007-5393");
script_summary(english: "Check for the pdftohtml-4642 package");
