...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6038
#
...
script_name(english: "Fedora 8 2008-6038: linuxdcpp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6038 (linuxdcpp)");
...
if ( rpm_check( reference:"linuxdcpp-1.0.1-2.fc8", release:"FC8") )
{
