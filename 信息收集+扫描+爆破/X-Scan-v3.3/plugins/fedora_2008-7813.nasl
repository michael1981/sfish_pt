...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7813
#
...
script_name(english: "Fedora 9 2008-7813: fedora-ds-base");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7813 (fedora-ds-base)");
...
if ( rpm_check( reference:"fedora-ds-base-1.1.2-1.fc9", release:"FC9") )
{
