...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  kdegraphics3-pdf (2009-11-10)");
...
if ( rpm_check( reference:"kdegraphics3-pdf-3.5.10-1.64.1", release:"SUSE11.1", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"kdegraphics3-pdf-3.5.10-1.64.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
