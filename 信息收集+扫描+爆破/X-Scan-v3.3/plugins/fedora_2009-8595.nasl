...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8595
#
...
script_name(english: "Fedora 10 2009-8595: htmldoc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8595 (htmldoc)");
...
if ( rpm_check( reference:"htmldoc-1.8.27-8.fc10", release:"FC10") )
{
