...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2118
#
...
script_name(english: "Fedora 7 2008-2118: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2118 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-2.0.0.12-1.fc7", release:"FC7") )
{
