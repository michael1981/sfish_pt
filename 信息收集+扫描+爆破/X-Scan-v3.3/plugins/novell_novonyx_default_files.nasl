...
if(description)
{
  ...
  script_xref(name:"OSVDB", value:"17461");
  script_xref(name:"OSVDB", value:"17462");
  script_xref(name:"OSVDB", value:"17463");
  script_xref(name:"OSVDB", value:"17464");
  script_xref(name:"OSVDB", value:"17465");
  script_xref(name:"OSVDB", value:"17466");
  script_xref(name:"OSVDB", value:"17467");
  script_xref(name:"OSVDB", value:"17468");
