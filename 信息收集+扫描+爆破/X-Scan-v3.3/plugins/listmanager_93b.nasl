...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"42160");
  script_xref(name:"OSVDB", value:"42161");
  script_xref(name:"OSVDB", value:"42162");
...
results in overwriting data in the those accounts." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-02/0307.html" );
