...
#
# This plugin text was extracted from Fedora Security Advisory 2006-598
#
...
script_name(english: "Fedora 5 2006-598: spamassassin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-598 (spamassassin)");
...
if ( rpm_check( reference:"spamassassin-3.1.3-1.fc5", release:"FC5") )
{
