...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_32781");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_32781 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM6.4x/ET2.0x Patch for Feb-05");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32781");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_32781");
...
if ( hpux_patch_installed (patches:"PHSS_32781 PHSS_33585 PHSS_34202 PHSS_34949 PHSS_35830 PHSS_37141 PHSS_37757 ") )
{
 exit(0);
}
