...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  acroread_ja (2009-08-06)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing a security patch for acroread_ja");
 script_set_attribute(attribute: "description", value: "This update of acroread fixes the following
vulnerabilities: 
...
if ( rpm_check( reference:"acroread_ja-8.1.6-0.1.1", release:"SLED11", cpu:"i586") )
{
