...
'The remote host is missing the DSA-1253 security update');
...
'The Debian project recommends that you upgrade your firefox and iceweasel packages.');
...
deb_check(prefix: 'mozilla-firefox', release: '3.1', reference: '1.0.4-2sarge15');
deb_check(prefix: 'mozilla-firefox-dom-inspector', release: '3.1', reference: '1.0.4-2sarge15');
deb_check(prefix: 'mozilla-firefox-gnome-support', release: '3.1', reference: '1.0.4-2sarge15');
