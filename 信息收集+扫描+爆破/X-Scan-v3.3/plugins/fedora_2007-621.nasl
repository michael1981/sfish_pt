...
#
# This plugin text was extracted from Fedora Security Advisory 2007-621
#
...
script_name(english: "Fedora 6 2007-621: krb5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-621 (krb5)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-2443", "CVE-2007-2798");
...
if ( rpm_check( reference:"krb5-libs-1.5-21.1", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"krb5-devel-1.5-21.1", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"krb5-server-1.5-21.1", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
