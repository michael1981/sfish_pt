...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"27774");

  script_name(english:"ISC DHCP Server supersede_lease() Function DHCPDISCOVER Packet Remote DoS");
...
users." );
 script_set_attribute(attribute:"see_also", value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=380273" );
