...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3868
#
...
script_name(english: "Fedora 10 2009-3868: moin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3868 (moin)");
...
if ( rpm_check( reference:"moin-1.6.4-1.fc10", release:"FC10") )
{
