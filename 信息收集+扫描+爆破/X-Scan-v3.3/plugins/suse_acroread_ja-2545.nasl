...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for acroread_ja (acroread_ja-2545)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch acroread_ja-2545");
 script_set_attribute(attribute: "description", value: "The Adobe Acrobat Reader (Japanese version) has been
...
script_set_attribute(attribute: "solution", value: "Install the security patch acroread_ja-2545");
script_end_attributes();

script_cve_id("CVE-2006-5857", "CVE-2007-0044", "CVE-2007-0045", "CVE-2007-0046", "CVE-2007-0047", "CVE-2007-0048");
script_summary(english: "Check for the acroread_ja-2545 package");
...
if ( rpm_check( reference:"acroread_ja-7.0.9-2.2", release:"SLED10") )
{
