...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"42166");
...
array indices passed to the 'bpf_filter_init()' function via
specially-crafted IOCTL requests." );
 script_set_attribute(attribute:"see_also", value:"http://labs.idefense.com/intelligence/vulnerabilities/display.php?id=625" );
 script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/483581/30/0/threaded" );
