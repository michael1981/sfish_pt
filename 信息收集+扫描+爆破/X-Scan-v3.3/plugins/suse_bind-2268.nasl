...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for bind (bind-2268)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch bind-2268");
script_end_attributes();

script_cve_id("CVE-2006-4339");
script_summary(english: "Check for the bind-2268 package");
