...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1778
#
...
script_name(english: "Fedora 7 2007-1778: bochs");
...
if ( rpm_check( reference:"bochs-2.3-7.fc7", release:"FC7") )
{
