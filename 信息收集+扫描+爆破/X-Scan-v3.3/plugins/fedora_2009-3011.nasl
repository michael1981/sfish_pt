...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3011
#
...
script_name(english: "Fedora 10 2009-3011: argyllcms");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3011 (argyllcms)");
...
Format Library (icclib). An attacker could use this flaw to  potentially execut
e
...
if ( rpm_check( reference:"argyllcms-1.0.3-3.fc10", release:"FC10") )
{
