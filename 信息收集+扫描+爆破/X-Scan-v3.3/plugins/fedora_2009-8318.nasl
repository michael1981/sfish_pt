...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8318
#
...
script_name(english: "Fedora 10 2009-8318: apr-util");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8318 (apr-util)");
...
if ( rpm_check( reference:"apr-util-1.3.9-1.fc10", release:"FC10") )
{
