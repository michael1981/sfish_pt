...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3910
#
...
script_name(english: "Fedora 9 2008-3910: libvorbis");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3910 (libvorbis)");
...
if ( rpm_check( reference:"libvorbis-1.2.0-4.fc9", release:"FC9") )
{
