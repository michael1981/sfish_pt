...
'The remote host is missing the DSA-249 security update');
...
'The Debian project recommends that you upgrade your w3mmee packages.');
...
deb_check(prefix: 'w3mmee', release: '3.0', reference: '0.3.p23.3-1.5');
deb_check(prefix: 'w3mmee-img', release: '3.0', reference: '0.3.p23.3-1.5');
