...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9556
#
...
script_name(english: "Fedora 8 2008-9556: kvm");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9556 (kvm)");
...
This bug was reopened, since it was found out that it is still biting us.
");
 script_set_attribute(attribute: "cvss_vector", value: "CVSS2#AV:L/AC:L/Au:N/C:C/I:C/A:C");
script_set_attribute(attribute: "solution", value: "Get the newest Fedora Updates");
script_end_attributes();

 script_cve_id("CVE-2007-1320", "CVE-2008-4539");
...
if ( rpm_check( reference:"kvm-60-7.fc8", release:"FC8") )
{
