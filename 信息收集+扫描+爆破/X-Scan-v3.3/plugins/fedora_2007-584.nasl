...
#
# This plugin text was extracted from Fedora Security Advisory 2007-584
#
...
script_name(english: "Fedora 5 2007-584: spamassassin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-584 (spamassassin)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-2447", "CVE-2007-0451", "CVE-2007-2873");
...
if ( rpm_check( reference:"spamassassin-3.1.9-1.fc5.1", release:"FC5") )
{
