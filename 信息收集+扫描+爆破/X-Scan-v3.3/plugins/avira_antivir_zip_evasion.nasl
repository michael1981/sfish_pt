...
"The remote host is running an anti-virus application that is affected 
...
circumvent detection by anti-virus software." );
  script_set_attribute(attribute:"see_also", value:"http://forum.avira.com/wbb/index.php?page=Thread&threadID=88472" );
  script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/503013/30/0/threaded" );
  script_set_attribute(attribute:"solution", value:
"Use the Avira update feature to upgrade the scan engine to
7.9.0.148 / 8.2.0.148 or later." );
...
if (s > 0)
{
  ...
  {
    if (s == 1)
      report = "Nessus found the following affected install of Avira Antivirus :" + report;
    else
      report = "Nessus found the following affected installs of Avira Antivirus :"+ report;
