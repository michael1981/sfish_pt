...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for gecko-sdk and mozilla-xulrunner (gecko-sdk-5813)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch gecko-sdk-5813");
...
script_set_attribute(attribute: "solution", value: "Install the security patch gecko-sdk-5813");
...
script_summary(english: "Check for the gecko-sdk-5813 package");
