...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5517
#
...
script_name(english: "Fedora 9 2009-5517: libwmf");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5517 (libwmf)");
...
if ( rpm_check( reference:"libwmf-0.2.8.4-18.1.fc9", release:"FC9") )
{
