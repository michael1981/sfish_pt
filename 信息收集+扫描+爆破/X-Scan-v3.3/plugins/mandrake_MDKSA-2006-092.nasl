...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:092: mpg123");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:092 (mpg123).");
 script_set_attribute(attribute: "description", value: "An unspecified vulnerability in mpg123 0.59r allows user-complicit
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:092");
