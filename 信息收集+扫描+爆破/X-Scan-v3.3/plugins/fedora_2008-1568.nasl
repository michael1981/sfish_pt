...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1568
#
...
script_name(english: "Fedora 8 2008-1568: openldap");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1568 (openldap)");
...
* Fri Feb  8 2008 Jan Safranek <jsafranek redhat com> 2.3.39-2
...
if ( rpm_check( reference:"openldap-2.3.39-3.fc8", release:"FC8") )
{
