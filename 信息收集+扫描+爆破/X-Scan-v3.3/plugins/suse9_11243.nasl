...
if(description)
{
 ...
 script_name(english: "SuSE9 Security Update:  Security update for mailman (11243)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE9 system is missing the security patch 11243");
...
script_set_attribute(attribute: "solution", value: "Install the security patch 11243");
script_end_attributes();

script_cve_id("CVE-2006-2191","CVE-2006-2941","CVE-2006-3636");
script_summary(english: "Check for the security advisory #11243");
...
if ( rpm_check( reference:"mailman-2.1.4-83.27", release:"SUSE9", cpu: "i586") )
{
