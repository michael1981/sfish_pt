...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9367
#
...
script_name(english: "Fedora 9 2008-9367: net-snmp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9367 (net-snmp)");
...
if ( rpm_check( reference:"net-snmp-5.4.1-19.fc9", release:"FC9") )
{
