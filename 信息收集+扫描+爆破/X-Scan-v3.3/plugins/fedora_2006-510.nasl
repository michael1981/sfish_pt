...
#
# This plugin text was extracted from Fedora Security Advisory 2006-510
#
...
script_name(english: "Fedora 5 2006-510: busybox");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-510 (busybox)");
...
if ( rpm_check( reference:"busybox-1.01-3.fc5", release:"FC5") )
{
