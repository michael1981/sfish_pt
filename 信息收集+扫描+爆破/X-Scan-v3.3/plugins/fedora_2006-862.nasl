...
#
# This plugin text was extracted from Fedora Security Advisory 2006-862
#
...
script_name(english: "Fedora 4 2006-862: httpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-862 (httpd)");
 script_set_attribute(attribute: "description", value: "The Apache HTTP Server is a powerful, full-featured, efficient, and
