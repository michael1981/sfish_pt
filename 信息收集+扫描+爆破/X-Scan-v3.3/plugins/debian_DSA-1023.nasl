...
'The remote host is missing the DSA-1023 security update');
...
'The Debian project recommends that you upgrade your kaffeine package.');
...
deb_check(prefix: 'kaffeine', release: '3.1', reference: '0.6-1sarge1');
