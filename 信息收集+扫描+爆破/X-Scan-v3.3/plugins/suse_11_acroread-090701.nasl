...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  acroread (2009-07-01)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing a security patch for acroread");
 script_set_attribute(attribute: "description", value: "This update of acroread fixes the following security
vulnerabilities:
...
if ( rpm_check( reference:"acroread-8.1.6-0.1.1", release:"SLED11", cpu:"i586") )
{
