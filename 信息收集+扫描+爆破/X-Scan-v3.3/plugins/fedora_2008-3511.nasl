...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3511
#
...
script_name(english: "Fedora 7 2008-3511: audacity");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3511 (audacity)");
...
if ( rpm_check( reference:"audacity-1.3.2-21.fc7", release:"FC7") )
{
