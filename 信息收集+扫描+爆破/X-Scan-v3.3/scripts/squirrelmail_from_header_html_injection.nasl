...
# This plugin is redundant with squirrelmail_html_injection_vuln.nasl. The file
# can not be deleted as it is installed in $prefix/plugins/ for many
# people already, and its original ID (14228) has been reused.
exit(0);
...
if (description) {
  ...
  script_cve_id("CAN-2004-0519", "CAN-2004-0520", "CAN-2004-0521");
  ...
  name["english"] = "SquirrelMail XSS and Local escalation";
...
Risk Factor : Medium";
  ...
  script_copyright(english:"This script is Copyright (C) 2004 George A. Theall and Tenable Network Security");
