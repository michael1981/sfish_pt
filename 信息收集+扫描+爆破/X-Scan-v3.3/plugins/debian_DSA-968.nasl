...
'The remote host is missing the DSA-968 security update');
...
'The Debian project recommends that you upgrade your nowebm package.');
...
deb_check(prefix: 'nowebm', release: '3.0', reference: '2.9a-7.4');
deb_check(prefix: 'nowebm', release: '3.1', reference: '2.10c-3.2');
deb_check(prefix: 'noweb', release: '3.1', reference: '2.10c-3.2');
deb_check(prefix: 'noweb', release: '3.0', reference: '2.9a-7.4');
