...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2087
#
...
script_name(english: "Fedora 8 2008-2087: horde");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2087 (horde)");
...
if ( rpm_check( reference:"horde-3.1.6-1.fc8", release:"FC8") )
{
