...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4285
#
...
script_name(english: "Fedora 8 2007-4285: qt4");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4285 (qt4)");
...
if ( rpm_check( reference:"qt4-4.3.3-1.fc8", release:"FC8") )
{
