...
#
# This plugin text was extracted from Fedora Security Advisory 2007-426
#
...
script_name(english: "Fedora 6 2007-426: libX11");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-426 (libX11)");
...
if ( rpm_check( reference:"libX11-1.0.3-7.fc6", release:"FC6") )
{
