...
#  http://www.gentoo.org/security/en/glsa/glsa-200807-02.xml
...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200807-02 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200807-02
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-2654');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200807-02.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'Motion: Execution of arbitrary code');
 exit(0);
}
...
if (qpkg_check(package: "media-video/motion", unaffected: make_list("ge 3.2.10.1"), vulnerable: make_list("lt 3.2.10.1")
