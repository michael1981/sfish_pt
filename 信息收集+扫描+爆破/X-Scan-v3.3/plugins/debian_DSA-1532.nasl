# This script was automatically generated from the dsa-1532
...
'The remote host is missing the DSA-1532 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1532] DSA-1532-1 xulrunner");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1532-1 xulrunner");
 exit(0);
}
