...
'The remote host is missing the DSA-335 security update');
...
'http://www.debian.org/security/2003/dsa-335');
 script_set_attribute(attribute: 'solution', value: 
'Read http://www.debian.org/security/2003/dsa-335
...
deb_check(prefix: 'mantis', release: '3.0', reference: '0.17.1-3');
