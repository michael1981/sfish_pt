...
#
# This plugin text was extracted from Fedora Security Advisory 2007-089
#
...
script_name(english: "Fedora 6 2007-089: squirrelmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-089 (squirrelmail)");
...
if ( rpm_check( reference:"squirrelmail-1.4.8-3.fc6", release:"FC6") )
{
