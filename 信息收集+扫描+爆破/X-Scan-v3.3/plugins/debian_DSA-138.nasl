...
'The remote host is missing the DSA-138 security update');
...
'Read http://www.debian.org/security/2002/dsa-138
...
deb_check(prefix: 'gallery', release: '3.0', reference: '1.2.5-7.woody.0');
