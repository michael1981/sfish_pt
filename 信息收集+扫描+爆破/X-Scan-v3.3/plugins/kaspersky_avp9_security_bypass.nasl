...
if (description)
{
  ...
  script_xref(name:"OSVDB",   value:"56351");
...
"The version of the Kaspersky anti-virus product installed on the
...
disable the computer protection provided by the anti-virus software.");

  script_set_attribute(attribute:"see_also", value:"http://www.kaspersky.com/technews?id=203038755" );
