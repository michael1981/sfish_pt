...
'The remote host is missing the SSA-2006-230-02 security update');
...
script_name(english: "SSA-2006-230-02 php ");
...
extrarep = NULL;
if (slackware_check(osver: "10.2", pkgname: "php", pkgver: "4.4.4", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package php is vulnerable in Slackware 10.2
Upgrade to php-4.4.4-i486-1_slack10.2 or newer.
');
}
if (slackware_check(osver: "10.2", pkgname: "php", pkgver: "5.1.5", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package php is vulnerable in Slackware 10.2
Upgrade to php-5.1.5-i486-1_slack10.2 or newer.
');
}
