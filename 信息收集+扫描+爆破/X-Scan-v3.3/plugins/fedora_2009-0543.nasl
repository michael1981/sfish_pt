...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0543
#
...
script_name(english: "Fedora 9 2009-0543: tqsllib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0543 (tqsllib)");
...
if ( rpm_check( reference:"tqsllib-2.0-5.fc9", release:"FC9") )
{
