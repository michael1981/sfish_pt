...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3460
#
...
script_name(english: "Fedora 7 2008-3460: kronolith");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3460 (kronolith)");
...
if ( rpm_check( reference:"kronolith-2.1.8-1.fc7", release:"FC7") )
{
