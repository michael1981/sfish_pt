...
Risk factor : High";
  ...
  script_dependencie("os_fingerprint.nasl","dcetest.nasl");
  script_require_ports(135);
  script_require_keys ("dcerpc/378e52b0-c0a9-11cf-822d-00aa0051e40f/port");
...
if ( os && "Windows NT" >< os ) exit(0); # NT not affected
...
storedport = get_kb_item("dcerpc/378e52b0-c0a9-11cf-822d-00aa0051e40f/port");
if (!storedport) exit(0);
