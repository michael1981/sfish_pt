...
#
# This plugin text was extracted from Fedora Security Advisory 2006-495
#
...
script_name(english: "Fedora 4 2006-495: yelp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-495 (yelp)");
...
if ( rpm_check( reference:"yelp-2.10.0-1.4.3", release:"FC4") )
{
