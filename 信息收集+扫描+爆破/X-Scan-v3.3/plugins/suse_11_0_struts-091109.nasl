...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  struts (2009-11-09)");
...
if ( rpm_check( reference:"struts-1.2.9-198.4", release:"SUSE11.0", cpu:"noarch") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"struts-javadoc-1.2.9-198.4", release:"SUSE11.0", cpu:"noarch") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"struts-manual-1.2.9-198.4", release:"SUSE11.0", cpu:"noarch") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"struts-webapps-tomcat6-1.2.9-198.4", release:"SUSE11.0", cpu:"noarch") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
