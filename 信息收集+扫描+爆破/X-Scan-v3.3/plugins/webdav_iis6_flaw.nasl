...
if(description)
{
 ...
 script_xref(name: "milw0rm", value: "8704");
...
be browsed, read and/or modified." );
 ...
 script_set_attribute(attribute:"see_also", value: "http://seclists.org/fulldisclosure/2009/May/att-0134/IIS_Advisory_pdf");
 script_set_attribute(attribute:"see_also", value: "http://www.sans.org/reading_room/whitepapers/threats/unicode_vulnerability_how_why_458");
 script_set_attribute(attribute:"see_also", value: "http://isc.sans.org/diary.html?storyid=6397");
 script_set_attribute(attribute:"see_also", value: "http://www.microsoft.com/technet/security/advisory/971492.mspx");
 script_set_attribute(attribute:"see_also", value: "http://unixwiz.net/techtips/ms971492-webdav-vuln.html");
 script_set_attribute(attribute:"solution", value:
"Disable WebDAV if you do not use it, or update your server.
...
'</prop></propfind>\r\n';
      ...
      (r[0] =~ "^HTTP/1\.[01] 207 " && "<a:status>HTTP/1.1 200 OK</a:status>" >< r[2]))
  {
    ...
    else
    {
      ...
      security_hole(port, extra: extra);
    }
  }
}
