...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"53066");
...
on the remote Windows is reportedly affected by 3 stack-based buffer
overflows involving various properties and methods in
...
privileges." );
  script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/985449" );
