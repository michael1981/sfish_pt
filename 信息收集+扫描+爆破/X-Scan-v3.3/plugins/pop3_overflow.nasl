...
if(description)
{
 ...
 script_cve_id("CVE-1999-0822", "CVE-2000-0091", "CVE-2001-0776", "CVE-2001-1046",
               "CVE-2002-0454", "CVE-2002-0799", "CVE-2002-1781");
 script_bugtraq_id(2781, 2811, 4055, 4295, 4789, 790, 830, 942);
 script_xref(name:"OSVDB", value:"776");
 script_xref(name:"OSVDB", value:"1204");
 script_xref(name:"OSVDB", value:"5290");
 script_xref(name:"OSVDB", value:"6992");
 script_xref(name:"OSVDB", value:"12076");
 script_xref(name:"OSVDB", value:"13970");
 script_xref(name:"OSVDB", value:"57175");
 script_xref(name:"OSVDB", value:"59759");
...
If confirmed, this problem might allow an attacker to execute arbitrary
