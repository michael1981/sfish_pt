...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7712
#
...
script_name(english: "Fedora 8 2008-7712: bitlbee");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7712 (bitlbee)");
...
if ( rpm_check( reference:"bitlbee-1.2.2-1.fc8", release:"FC8") )
{
