...
'The remote host is missing the DSA-1507 security update');
...
'The Debian project recommends that you upgrade your turba2 package.');
...
deb_check(prefix: 'turba2', release: '3.1', reference: '2.0.2-1sarge1');
deb_check(prefix: 'turba2', release: '4.0', reference: '2.1.3-1etch1');
