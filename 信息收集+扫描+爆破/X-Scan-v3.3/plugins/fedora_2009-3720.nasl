...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3720
#
...
script_name(english: "Fedora 9 2009-3720: argyllcms");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3720 (argyllcms)");
...
if ( rpm_check( reference:"argyllcms-1.0.3-5.fc9", release:"FC9") )
{
