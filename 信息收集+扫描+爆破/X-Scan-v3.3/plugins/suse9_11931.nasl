...
if(description)
{
 ...
 script_name(english: "SuSE9 Security Update:  Security update for OpenSSH (11931)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE9 system is missing the security patch 11931");
 script_set_attribute(attribute: "description", value: '* This update fixes a bug in ssh\'s cookie handling code.
...
script_set_attribute(attribute: "solution", value: "Install the security patch 11931");
script_end_attributes();

script_cve_id("CVE-2007-4752");
script_summary(english: "Check for the security advisory #11931");
...
if ( rpm_check( reference:"openssh-4.1p1-11.40", release:"SUSE9", cpu: "i586") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"openssh-askpass-4.1p1-11.40", release:"SUSE9", cpu: "i586") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
