...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2970
#
...
script_name(english: "Fedora 10 2009-2970: lcms");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2970 (lcms)");
...
if ( rpm_check( reference:"lcms-1.18-0.1.beta2.fc10", release:"FC10") )
{
