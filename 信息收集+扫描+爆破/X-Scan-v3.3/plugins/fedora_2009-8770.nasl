...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8770
#
...
script_name(english: "Fedora 10 2009-8770: fetchmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8770 (fetchmail)");
...
if ( rpm_check( reference:"fetchmail-6.3.8-9.fc10", release:"FC10") )
{
