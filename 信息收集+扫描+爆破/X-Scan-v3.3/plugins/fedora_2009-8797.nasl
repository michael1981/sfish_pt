...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8797
#
...
script_name(english: "Fedora 10 2009-8797: squirrelmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8797 (squirrelmail)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-2379", "CVE-2009-1581");
...
if ( rpm_check( reference:"squirrelmail-1.4.19-2.fc10", release:"FC10") )
{
