...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libpoppler4 (2009-06-22)");
...
if ( rpm_check( reference:"libpoppler4-0.10.1-1.30.5", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libpoppler4-0.10.1-1.30.5", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
