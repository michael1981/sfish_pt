...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"39995");
...
affected host with SYSTEM level privileges." );
 script_set_attribute(attribute:"see_also", value:"http://labs.idefense.com/intelligence/vulnerabilities/display.php?id=635" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-01/0043.html" );
 script_set_attribute(attribute:"see_also", value:"http://download.novell.com/Download?buildid=5Y6xbs-OKLE~" );
 script_set_attribute(attribute:"solution", value:
"Upgrade to ZENworks ESM Security Client 3.5.0.82 or later." );
