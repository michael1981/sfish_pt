...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4461
#
...
script_name(english: "Fedora 7 2007-4461: e2fsprogs");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4461 (e2fsprogs)");
...
if ( rpm_check( reference:"e2fsprogs-1.40.2-3.fc7", release:"FC7") )
{
