...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  gzip: Security update (gzip-2084)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch gzip-2084");
script_end_attributes();

script_cve_id("CVE-2006-4334", "CVE-2006-4335", "CVE-2006-4336", "CVE-2006-4337");
script_summary(english: "Check for the gzip-2084 package");
