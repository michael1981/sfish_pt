...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:050: unzip");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:050 (unzip).");
 script_set_attribute(attribute: "description", value: "A buffer overflow was foiund in how unzip handles file name arguments.
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:050");
