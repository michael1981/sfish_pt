...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8945
#
...
script_name(english: "Fedora 9 2008-8945: php-Smarty");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8945 (php-Smarty)");
...
if ( rpm_check( reference:"php-Smarty-2.6.20-1.fc9", release:"FC9") )
{
