...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1384
#
...
script_name(english: "Fedora 7 2008-1384: perl-Tk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1384 (perl-Tk)");
...
if ( rpm_check( reference:"perl-Tk-804.028-3.fc7", release:"FC7") )
{
