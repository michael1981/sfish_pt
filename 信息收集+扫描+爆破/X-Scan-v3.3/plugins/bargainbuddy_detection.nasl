...
if(description)
{
 ...
 script_set_attribute(
   attribute:"synopsis",
   value:"The remote host has adware installed on it."
 );
 script_set_attribute(
 ...
 script_set_attribute(
   attribute:"see_also",
   value:"http://www.ca.com/securityadvisor/pest/pest.aspx?id=453068324"
 );
 script_set_attribute(
   attribute:"solution", 
   value:"Remove this software using a spyware or adware removal product."
 );
 script_set_attribute(
