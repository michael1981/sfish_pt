...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for OpenSSL (openssl-4477)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch openssl-4477");
script_end_attributes();

script_cve_id("CVE-2007-5135");
script_summary(english: "Check for the openssl-4477 package");
