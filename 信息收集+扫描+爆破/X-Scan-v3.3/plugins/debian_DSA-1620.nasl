# This script was automatically generated from the dsa-1620
...
'The remote host is missing the DSA-1620 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1620] DSA-1620-1 python2.5");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1620-1 python2.5");
 exit(0);
}
...
deb_check(prefix: 'idle-python2.5', release: '4.0', reference: '2.5-5+etch1');
deb_check(prefix: 'python2.5', release: '4.0', reference: '2.5-5+etch1');
deb_check(prefix: 'python2.5-dbg', release: '4.0', reference: '2.5-5+etch1');
deb_check(prefix: 'python2.5-dev', release: '4.0', reference: '2.5-5+etch1');
deb_check(prefix: 'python2.5-examples', release: '4.0', reference: '2.5-5+etch1');
deb_check(prefix: 'python2.5-minimal', release: '4.0', reference: '2.5-5+etch1');
