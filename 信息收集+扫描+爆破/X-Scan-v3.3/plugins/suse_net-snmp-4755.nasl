...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for net-snmp (net-snmp-4755)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch net-snmp-4755");
script_end_attributes();

script_cve_id("CVE-2007-5846");
script_summary(english: "Check for the net-snmp-4755 package");
