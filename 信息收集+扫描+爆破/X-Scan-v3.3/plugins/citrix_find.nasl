...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"50616");
...
this service to gain further access on the remote host or remote 
network. This protocol has also been shown to be  vulnerable to a 
