...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for xpdf (xpdf-6177)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch xpdf-6177");
...
script_set_attribute(attribute: "solution", value: "Install the security patch xpdf-6177");
...
script_summary(english: "Check for the xpdf-6177 package");
...
if ( rpm_check( reference:"xpdf-tools-3.01-21.16", release:"SLES10") )
{
