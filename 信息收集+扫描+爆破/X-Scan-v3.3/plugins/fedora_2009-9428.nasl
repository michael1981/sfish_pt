...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9428
#
...
script_name(english: "Fedora 10 2009-9428: cyrus-imapd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9428 (cyrus-imapd)");
...
if ( rpm_check( reference:"cyrus-imapd-2.3.14-2.fc10", release:"FC10") )
{
