...
#
# This plugin text was extracted from Fedora Security Advisory 2007-375
#
...
script_name(english: "Fedora 5 2007-375: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-375 (openoffice.org)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-2198", "CVE-2006-2199", "CVE-2006-3117", "CVE-2007-0238", "CVE-2007-0239");
...
if ( rpm_check( reference:"openoffice.org-2.0.2-5.21.2", release:"FC5") )
{
