...
'The remote host is missing the DSA-566 security update');
...
'The Debian project recommends that you upgrade your CUPS package.');
...
deb_check(prefix: 'cupsys', release: '3.0', reference: '1.1.14-5woody7');
deb_check(prefix: 'cupsys-bsd', release: '3.0', reference: '1.1.14-5woody7');
deb_check(prefix: 'cupsys-client', release: '3.0', reference: '1.1.14-5woody7');
deb_check(prefix: 'cupsys-pstoraster', release: '3.0', reference: '1.1.14-5woody7');
deb_check(prefix: 'libcupsys2', release: '3.0', reference: '1.1.14-5woody7');
deb_check(prefix: 'libcupsys2-dev', release: '3.0', reference: '1.1.14-5woody7');
