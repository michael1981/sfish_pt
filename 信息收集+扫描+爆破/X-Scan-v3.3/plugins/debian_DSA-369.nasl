...
'The remote host is missing the DSA-369 security update');
...
'Read http://www.debian.org/security/2003/dsa-369
...
deb_check(prefix: 'zblast-data', release: '3.0', reference: '1.2pre-5woody2');
deb_check(prefix: 'zblast-svgalib', release: '3.0', reference: '1.2pre-5woody2');
deb_check(prefix: 'zblast-x11', release: '3.0', reference: '1.2pre-5woody2');
deb_check(prefix: 'zblast', release: '3.0', reference: '1.2pre-5woody2');
