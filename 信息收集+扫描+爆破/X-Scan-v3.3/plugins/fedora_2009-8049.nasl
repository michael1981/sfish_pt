...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8049
#
...
script_name(english: "Fedora 10 2009-8049: kdelibs");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8049 (kdelibs)");
...
if ( rpm_check( reference:"kdelibs-4.2.4-6.fc10", release:"FC10") )
{
