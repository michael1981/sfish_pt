...
#
# This plugin text was extracted from Fedora Security Advisory 2007-0740
#
...
script_name(english: "Fedora 7 2007-0740: krb5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-0740 (krb5)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-1216", "CVE-2007-2442", "CVE-2007-2443", "CVE-2007-2798");
...
if ( rpm_check( reference:"krb5-1.6.1-2.1.fc7", release:"FC7") )
{
