...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2703
#
...
script_name(english: "Fedora 9 2009-2703: mldonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2703 (mldonkey)");
...
if ( rpm_check( reference:"mldonkey-3.0.0-1.fc9", release:"FC9") )
{
