...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3326
#
...
script_name(english: "Fedora 7 2008-3326: xine-lib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3326 (xine-lib)");
...
if ( rpm_check( reference:"xine-lib-1.1.11.1-1.fc7.2", release:"FC7") )
{
