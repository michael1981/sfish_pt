...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0523
#
...
script_name(english: "Fedora 8 2008-0523: syslog-ng");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0523 (syslog-ng)");
...
if ( rpm_check( reference:"syslog-ng-2.0.7-1.fc8", release:"FC8") )
{
