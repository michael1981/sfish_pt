...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Tomcat 5 (tomcat5-6352)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch tomcat5-6352");
...
script_set_attribute(attribute: "solution", value: "Install the security patch tomcat5-6352");
script_end_attributes();

script_cve_id("CVE-2008-5515", "CVE-2009-0033", "CVE-2009-0580", "CVE-2009-0781", "CVE-2009-0783");
script_summary(english: "Check for the tomcat5-6352 package");
...
if ( rpm_check( reference:"tomcat5-5.0.30-27.40", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"tomcat5-admin-webapps-5.0.30-27.40", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"tomcat5-webapps-5.0.30-27.40", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
