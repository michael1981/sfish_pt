...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8993
#
...
script_name(english: "Fedora 11 2009-8993: xemacs");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8993 (xemacs)");
...
size.    The update also addresses multiple font issues, some of which cause
...
if ( rpm_check( reference:"xemacs-21.5.29-2.fc11", release:"FC11") )
{
