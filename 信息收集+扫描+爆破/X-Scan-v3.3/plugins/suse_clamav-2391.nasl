...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  clamav security update (clamav-2391)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch clamav-2391");
...
script_set_attribute(attribute: "solution", value: "Install the security patch clamav-2391");
script_end_attributes();

script_cve_id("CVE-2006-5874", "CVE-2006-6481", "CVE-2006-5874", "CVE-2006-6406", "CVE-2006-6406");
script_summary(english: "Check for the clamav-2391 package");
...
if ( rpm_check( reference:"clamav-0.88.7-1.1", release:"SUSE10.2") )
{
