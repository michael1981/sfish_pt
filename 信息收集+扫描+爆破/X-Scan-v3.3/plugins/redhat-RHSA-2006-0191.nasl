...
if(description)
{
 ...
 script_name(english: "RHSA-2006-0191:   kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2006-0191");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2006-0191.html");
...
if ( rpm_check( reference:"  kernel-2.4.9-e.68.athlon.rpm               65d2bb250a3647ca0042aeb1963a30b8", release:'RHEL2.1') )
{
...
if ( rpm_check( reference:"  kernel-smp-2.4.9-e.68.athlon.rpm           e26872f9afdf55393554a7753717d58a", release:'RHEL2.1') )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
