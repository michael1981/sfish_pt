...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9243
#
...
script_name(english: "Fedora 10 2009-9243: mapserver");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9243 (mapserver)");
...
if ( rpm_check( reference:"mapserver-5.2.3-1.fc10", release:"FC10") )
{
