...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4847
#
...
script_name(english: "Fedora 8 2008-4847: libpng");
...
if ( rpm_check( reference:"libpng-1.2.29-1.fc8", release:"FC8") )
{
