...
if(description)
{
 ...
 script_name(english: "RHSA-2008-0549: firefox");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2008-0549");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2008-0549.html");
...
if ( rpm_check( reference:"firefox-1.5.0.12-0.19.el4", release:'RHEL4') )
{
