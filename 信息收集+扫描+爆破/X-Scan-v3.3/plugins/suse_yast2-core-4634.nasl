...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  YaST2: This update fixes a local root vulnerability. (yast2-core-4634)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch yast2-core-4634");
script_end_attributes();

script_summary(english: "Check for the yast2-core-4634 package");
