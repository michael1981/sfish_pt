...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8593
#
...
script_name(english: "Fedora 9 2008-8593: postfix");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8593 (postfix)");
...
if ( rpm_check( reference:"postfix-2.5.5-1.fc9", release:"FC9") )
{
