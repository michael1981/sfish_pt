...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7952
#
...
script_name(english: "Fedora 11 2009-7952: znc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7952 (znc)");
...
if ( rpm_check( reference:"znc-0.072-3.fc11", release:"FC11") )
{
