...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4172
#
...
script_name(english: "Fedora 8 2007-4172: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4172 (openoffice.org)");
...
if ( rpm_check( reference:"openoffice.org-2.3.0-6.7.fc8", release:"FC8") )
{
