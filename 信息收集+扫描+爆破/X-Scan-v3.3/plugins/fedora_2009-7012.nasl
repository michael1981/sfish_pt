...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7012
#
...
script_name(english: "Fedora 11 2009-7012: irssi");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7012 (irssi)");
...
if ( rpm_check( reference:"irssi-0.8.13-3.fc11", release:"FC11") )
{
