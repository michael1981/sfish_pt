...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  perl-IO-Socket-SSL (2009-09-01)");
...
if ( rpm_check( reference:"perl-IO-Socket-SSL-1.16-2.9.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"perl-IO-Socket-SSL-1.16-2.9.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
