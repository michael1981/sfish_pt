...
'The remote host is missing the DSA-589 security update');
...
deb_check(prefix: 'libgd-dev', release: '3.0', reference: '1.8.4-17.woody3');
deb_check(prefix: 'libgd-noxpm-dev', release: '3.0', reference: '1.8.4-17.woody3');
deb_check(prefix: 'libgd1', release: '3.0', reference: '1.8.4-17.woody3');
deb_check(prefix: 'libgd1-noxpm', release: '3.0', reference: '1.8.4-17.woody3');
