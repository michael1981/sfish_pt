...
if(description)
{
 ...
 script_set_attribute(
   attribute:"synopsis",
   value:"The remote TFTP server has a denial of service vulnerability."
 );
 script_set_attribute(
   attribute:"description",
   value:
"It is possible to crash the remote TFTP server by sending a small
UDP packet.  A remote attacker could exploit this to crash the
service."
 );
 script_set_attribute(
   attribute:"solution",
