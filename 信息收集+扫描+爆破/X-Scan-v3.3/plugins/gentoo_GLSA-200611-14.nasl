...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200611-14 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200611-14
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-5677');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200611-14.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'TORQUE: Insecure temporary file creation');
 exit(0);
}
...
if (qpkg_check(package: "sys-cluster/torque", unaffected: make_list("ge 2.1.6"), vulnerable: make_list("lt 2.1.6")
