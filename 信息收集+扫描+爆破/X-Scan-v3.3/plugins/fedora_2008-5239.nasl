...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5239
#
...
script_name(english: "Fedora 7 2008-5239: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5239 (openoffice.org)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-0245", "CVE-2007-2834", "CVE-2007-4575", "CVE-2008-0320", "CVE-2008-2152");
...
if ( rpm_check( reference:"openoffice.org-2.3.0-6.9.fc7", release:"FC7") )
{
