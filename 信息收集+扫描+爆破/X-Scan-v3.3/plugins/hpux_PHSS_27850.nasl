...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_27850");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_27850 security update");
 script_set_attribute(attribute: "description", value:
"X OV EMANATE14.2 snmpdm - obsolete mib.");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_27850");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_27850");
...
if ( hpux_patch_installed (patches:"PHSS_27850 PHSS_27858 PHSS_39886 ") )
{
 exit(0);
}
