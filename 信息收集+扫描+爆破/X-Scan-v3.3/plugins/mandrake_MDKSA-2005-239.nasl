...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:239: printer-filters-utils");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:239 (printer-filters-utils).");
 script_set_attribute(attribute: "description", value: "'newbug' discovered a local root vulnerability in the mtink binary,
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:239");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2005-4604");
script_summary(english: "Check for the version of the printer-filters-utils package");
