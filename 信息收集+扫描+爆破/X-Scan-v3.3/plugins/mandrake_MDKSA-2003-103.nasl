...
if(description)
{
 ...
 script_name(english: "MDKSA-2003:103: apache");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2003:103 (apache).");
 script_set_attribute(attribute: "description", value: "A buffer overflow in mod_alias and mod_rewrite was discovered in Apache
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2003:103");
...
if ( rpm_check( reference:"apache2-mod_disk_cache-2.0.47-6.3.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"apache2-mod_file_cache-2.0.47-6.3.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"apache2-mod_mem_cache-2.0.47-6.3.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
