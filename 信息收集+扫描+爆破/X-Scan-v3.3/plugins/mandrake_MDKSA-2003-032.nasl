...
if(description)
{
 ...
 script_name(english: "MDKSA-2003:032: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2003:032 (samba).");
 script_set_attribute(attribute: "description", value: "The SuSE security team, during an audit of the Samba source code, found
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2003:032");
