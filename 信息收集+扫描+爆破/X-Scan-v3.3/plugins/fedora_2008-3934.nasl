...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3934
#
...
script_name(english: "Fedora 8 2008-3934: libvorbis");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3934 (libvorbis)");
...
if ( rpm_check( reference:"libvorbis-1.2.0-2.fc8", release:"FC8") )
{
