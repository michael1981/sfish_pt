...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1973
#
...
script_name(english: "Fedora 7 2008-1973: kvm");
...
if ( rpm_check( reference:"kvm-36-8.fc7", release:"FC7") )
{
