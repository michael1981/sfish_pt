...
if(description)
{
 ...
 script_name(english: "RHSA-2003-334: glibc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2003-334");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2003-334.html");
...
if ( rpm_check( reference:"nptl-devel-2.3.2-95.6", release:'RHEL3') )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
