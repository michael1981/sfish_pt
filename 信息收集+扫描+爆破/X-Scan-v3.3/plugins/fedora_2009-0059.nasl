...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0059
#
...
script_name(english: "Fedora 9 2009-0059: xterm");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0059 (xterm)");
...
if ( rpm_check( reference:"xterm-238-1.fc9", release:"FC9") )
{
