...
if(description)
{
  ...
  script_name(english:"The remote host is infected by a virus");
  script_summary(english:"Checks for the presence of different virii on the remote host");

  script_set_attribute(
    attribute:'synopsis',
    value:'A virus has been detected on the remote host.'
  );

  script_set_attribute(
    attribute:'description',
    value:'This script checks for the presence of different virii on the remote
...
- W32.Fujacks.B'
  ...
  script_set_attribute(
    attribute:'solution',
    value:'See the URLs which will appear in the report.'
  );
