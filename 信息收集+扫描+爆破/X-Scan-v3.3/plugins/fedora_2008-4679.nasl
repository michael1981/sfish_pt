...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4679
#
...
script_name(english: "Fedora 8 2008-4679: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4679 (samba)");
...
if ( rpm_check( reference:"samba-3.0.30-0.fc8", release:"FC8") )
{
