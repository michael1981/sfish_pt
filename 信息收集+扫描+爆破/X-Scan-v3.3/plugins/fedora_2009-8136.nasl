...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8136
#
...
script_name(english: "Fedora 10 2009-8136: OpenEXR");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8136 (OpenEXR)");
...
if ( rpm_check( reference:"OpenEXR-1.6.1-8.fc10", release:"FC10") )
{
