...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9601
#
...
script_name(english: "Fedora 10 2009-9601: planet");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9601 (planet)");
...
if ( rpm_check( reference:"planet-2.0-10.fc10", release:"FC10") )
{
