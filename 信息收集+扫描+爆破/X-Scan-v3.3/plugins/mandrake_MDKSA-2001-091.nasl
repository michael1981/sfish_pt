...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:091: passwd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:091 (passwd).");
 script_set_attribute(attribute: "description", value: "The default pam files for the passwd program did not include support
for md5 passwords, thus any password changes or post-install added
users would not have md5 passwords.
");
 script_set_attribute(attribute: "risk_factor", value: "High");
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:091");
