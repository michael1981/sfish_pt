...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  xine-lib: Fixed various buffer overflow security problems (xine-lib-2308)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch xine-lib-2308");
script_end_attributes();

script_cve_id("CVE-2006-4799", "CVE-2006-4800");
script_summary(english: "Check for the xine-lib-2308 package");
