...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1728
#
...
script_name(english: "Fedora 7 2008-1728: scponly");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1728 (scponly)");
...
if ( rpm_check( reference:"scponly-4.6-10.fc7", release:"FC7") )
{
