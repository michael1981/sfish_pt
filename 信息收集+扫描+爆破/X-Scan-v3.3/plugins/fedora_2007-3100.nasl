...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3100
#
...
script_name(english: "Fedora 7 2007-3100: cups");
...
if ( rpm_check( reference:"cups-1.2.12-7.fc7", release:"FC7") )
{
