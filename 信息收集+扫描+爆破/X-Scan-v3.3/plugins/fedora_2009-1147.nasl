...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1147
#
...
script_name(english: "Fedora 10 2009-1147: glpi");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1147 (glpi)");
...
if ( rpm_check( reference:"glpi-0.71.5-1.fc10", release:"FC10") )
{
