...
'The remote host is missing the DSA-456 security update');
...
deb_check(prefix: 'kernel-doc-2.2.19', release: '3.0', reference: '2.2.19.1-4woody1');
deb_check(prefix: 'kernel-headers-2.2.19', release: '3.0', reference: '20040303');
deb_check(prefix: 'kernel-image-2.2.19-netwinder', release: '3.0', reference: '20040303');
deb_check(prefix: 'kernel-image-2.2.19-riscpc', release: '3.0', reference: '20040303');
deb_check(prefix: 'kernel-patch-2.2.19-arm', release: '3.0', reference: '20040303');
deb_check(prefix: 'kernel-source-2.2.19', release: '3.0', reference: '2.2.19.1-4woody1');
