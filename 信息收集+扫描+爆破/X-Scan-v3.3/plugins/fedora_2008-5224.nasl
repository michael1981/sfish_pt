...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5224
#
...
script_name(english: "Fedora 7 2008-5224: net-snmp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5224 (net-snmp)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-5846", "CVE-2008-0960", "CVE-2008-2292");
...
if ( rpm_check( reference:"net-snmp-5.4-18.fc7", release:"FC7") )
{
