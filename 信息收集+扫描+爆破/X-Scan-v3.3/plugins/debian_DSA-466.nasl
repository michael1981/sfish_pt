...
'The remote host is missing the DSA-466 security update');
...
deb_check(prefix: 'kernel-doc-2.2.10', release: '3.0', reference: '2.2.10-2');
deb_check(prefix: 'kernel-headers-2.2.10-apus', release: '3.0', reference: '2.2.10-13woody1');
deb_check(prefix: 'kernel-image-2.2.10-apus', release: '3.0', reference: '2.2.10-13woody1');
deb_check(prefix: 'kernel-source-2.2.10', release: '3.0', reference: '2.2.10-2');
