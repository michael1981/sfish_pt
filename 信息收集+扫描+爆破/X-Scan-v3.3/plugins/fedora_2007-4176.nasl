...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4176
#
...
script_name(english: "Fedora 8 2007-4176: zabbix");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4176 (zabbix)");
...
if ( rpm_check( reference:"zabbix-1.4.2-4.fc8", release:"FC8") )
{
