...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for gnome-screensave (gnome-screensaver-4284)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch gnome-screensaver-4284");
 script_set_attribute(attribute: "description", value: "Memory corruption made the gnome-screensaver process crash
...
script_set_attribute(attribute: "solution", value: "Install the security patch gnome-screensaver-4284");
script_end_attributes();

script_summary(english: "Check for the gnome-screensaver-4284 package");
