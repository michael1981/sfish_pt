...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8477
#
...
script_name(english: "Fedora 11 2009-8477: puppet");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8477 (puppet)");
...
if ( rpm_check( reference:"puppet-0.24.8-4.fc11", release:"FC11") )
{
