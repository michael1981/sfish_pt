...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"24646");
...
the web server user id." );
 script_set_attribute(attribute:"see_also", value:"http://downloads.securityfocus.com/vulnerabilities/exploits/PHPWebSite_fi_poc" );
