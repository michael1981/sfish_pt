...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2496
#
...
script_name(english: "Fedora 7 2007-2496: wesnoth");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2496 (wesnoth)");
...
Security fix release: A malicious user could send a long chat message with mult
ibyte characters, the server would truncate the message on a fixed length, with
out paying attention to the multibyte characters. This led to invalid utf-8 on
the client and an uncaught exception was thrown.
");
...
if ( rpm_check( reference:"wesnoth-1.2.7-1.fc7", release:"FC7") )
{
