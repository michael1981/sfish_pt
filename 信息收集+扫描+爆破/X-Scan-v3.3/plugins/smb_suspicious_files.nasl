...
if(description)
{
 ...
 script_name(english:"Potentially unwanted software");
 script_summary(english:"Checks for the presence of various DLLs on the remote host");

   script_set_attribute(
    attribute:'synopsis',
    value:'This plugin checks for certain suspicious files.'
  );

  script_set_attribute(
    attribute:'description',
    value:'This script checks for the presence of files and programs which
...
with your organization\'s security policy.'
  ...
  script_copyright(english:"This script is Copyright (C) 2005-2009 David Maciejak and Tenable Network Security, Inc.");
...
EXP=iedcb1f5.dll
NAME=Alexa
URL=http://www.nessus.org/u?824aff44
...
URL=http://www.ca.com/securityadvisor/pest/pest.aspx?id=453075263
