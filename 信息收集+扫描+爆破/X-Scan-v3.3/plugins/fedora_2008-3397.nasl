...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3397
#
...
script_name(english: "Fedora 8 2008-3397: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3397 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.5.1-1.fc8", release:"FC8") )
{
