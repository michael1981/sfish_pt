...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"13138");
...
the affected device, including its encrypted password file." );
 script_set_attribute(attribute:"see_also", value:"http://www.xerox.com/downloads/usa/en/c/CERT_Xerox_Security_XRX05_001.pdf" );
 script_set_attribute(attribute:"see_also", value:"http://www.xerox.com/downloads/usa/en/c/CERT_Xerox_Security_XRX04-10.pdf" );
 script_set_attribute(attribute:"see_also", value:"http://www.xerox.com/downloads/usa/en/c/CERT_Xerox_Security_XRX04-05.pdf" );
 script_set_attribute(attribute:"see_also", value:"http://www.xerox.com/downloads/usa/en/c/CERT_Xerox_Security_XRX04-03.pdf" );
...
if (get_kb_item("www/xerox_workcentre"))
{
  ...
  if (ess && ess =~ "\.P(5|18|19)[^0-9]?") exit(0);
