...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for librpcsecgss (librpcsecgss-4601)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch librpcsecgss-4601");
script_end_attributes();

script_cve_id("CVE-2007-3999");
script_summary(english: "Check for the librpcsecgss-4601 package");
