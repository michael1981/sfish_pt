...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"6247");
  script_xref(name:"OSVDB", value:"47548");
  script_xref(name:"OSVDB", value:"47549");
...
host, subject to the privileges of the web server user id." );
 script_set_attribute(attribute:"see_also", value:"http://jira.dotmarketing.net/browse/DOTCMS-1837" );
