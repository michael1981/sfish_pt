...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Ruby (ruby-5484)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch ruby-5484");
...
script_set_attribute(attribute: "solution", value: "Install the security patch ruby-5484");
script_end_attributes();

 script_cve_id("CVE-2008-1145", "CVE-2008-1891", "CVE-2008-2662", "CVE-2008-2664", "CVE-2008-2725");
script_summary(english: "Check for the ruby-5484 package");
...
if ( rpm_check( reference:"ruby-1.8.4-17.19", release:"SLED10") )
{
