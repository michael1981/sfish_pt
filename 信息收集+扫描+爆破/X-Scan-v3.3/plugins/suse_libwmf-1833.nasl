...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for libwmf (libwmf-1833)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch libwmf-1833");
...
script_set_attribute(attribute: "solution", value: "Install the security patch libwmf-1833");
script_end_attributes();

script_cve_id("CVE-2006-3376");
script_summary(english: "Check for the libwmf-1833 package");
...
if ( rpm_check( reference:"libwmf-0.2.8.2-110.5", release:"SLED10") )
{
