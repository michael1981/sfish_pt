...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7512
#
...
script_name(english: "Fedora 9 2008-7512: xine-lib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7512 (xine-lib)");
...
if ( rpm_check( reference:"xine-lib-1.1.15-1.fc9", release:"FC9") )
{
