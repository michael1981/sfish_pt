...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:027: ipsec-tools");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:027 (ipsec-tools).");
 script_set_attribute(attribute: "description", value: "A very serious security flaw was discovered by Ralf Spenneberg in
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:027");
