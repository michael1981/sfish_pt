...
'The remote host is missing the SSA-2006-178-03 security update');
...
script_name(english: "SSA-2006-178-03 arts ");
...
extrarep = NULL;
if (slackware_check(osver: "10.0", pkgname: "arts", pkgver: "1.2.3", pkgnum:  "2", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package arts is vulnerable in Slackware 10.0
Upgrade to arts-1.2.3-i486-2_slack10.0 or newer.
');
}
if (slackware_check(osver: "10.1", pkgname: "arts", pkgver: "1.3.2", pkgnum:  "2", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package arts is vulnerable in Slackware 10.1
Upgrade to arts-1.3.2-i486-2_slack10.1 or newer.
');
}
if (slackware_check(osver: "10.2", pkgname: "arts", pkgver: "1.4.2", pkgnum:  "2", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package arts is vulnerable in Slackware 10.2
Upgrade to arts-1.4.2-i486-2_slack10.2 or newer.
');
}
