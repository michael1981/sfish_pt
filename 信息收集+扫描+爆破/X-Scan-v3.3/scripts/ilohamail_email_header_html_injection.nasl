...
session cookie and thereby gain access to that user's account by
sending a message with a Date header consisting of :
...
Solution : Upgrade to IlohaMail version 0.8.13 or later.
