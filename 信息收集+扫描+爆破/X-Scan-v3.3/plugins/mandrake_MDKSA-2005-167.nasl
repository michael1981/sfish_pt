...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:167: util-linux");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:167 (util-linux).");
 script_set_attribute(attribute: "description", value: "David Watson disovered that the umount utility, when using the '-r'
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:167");
