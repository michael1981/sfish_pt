...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1711
#
...
script_name(english: "Fedora 7 2008-1711: httpd");
...
if ( rpm_check( reference:"httpd-2.2.8-1.fc7", release:"FC7") )
{
