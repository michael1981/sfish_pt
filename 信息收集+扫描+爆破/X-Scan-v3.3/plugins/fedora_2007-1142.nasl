...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1142
#
...
script_name(english: "Fedora 7 2007-1142: firefox");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-1142 (firefox)");
...
Mozilla Firefox is an open-source web browser, designed for standards complianc
e, performance and portability.
...
if ( rpm_check( reference:"firefox-2.0.0.5-1.fc7", release:"FC7") )
{
