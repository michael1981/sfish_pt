...
if (description) {
  ...
  script_xref(name:"IAVA", value:"2005-T-0012");
  script_xref(name:"OSVDB", value:"16693");
  script_xref(name:"OSVDB", value:"16694");
  script_xref(name:"OSVDB", value:"16695");
  script_xref(name:"OSVDB", value:"16696");
  script_xref(name:"OSVDB", value:"16697");
...
all from remote users." );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/155610" );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/232232" );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/372618" );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/443370" );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/514386" );
