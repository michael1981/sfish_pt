...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:095: gdb");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:095 (gdb).");
 script_set_attribute(attribute: "description", value: "Tavis Ormandy of the Gentoo Linux Security Audit Team discovered two
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:095");
