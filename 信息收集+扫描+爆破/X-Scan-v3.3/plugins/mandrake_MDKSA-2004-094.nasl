...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:094: printer-drivers");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:094 (printer-drivers).");
 script_set_attribute(attribute: "description", value: "The foomatic-rip filter, which is part of foomatic-filters package,
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:094");
...
if ( rpm_check( reference:"foomatic-db-3.0.1-0.20040828.1.1.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"foomatic-db-engine-3.0.1-0.20040828.1.1.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"foomatic-filters-3.0.1-0.20040828.1.1.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"ghostscript-module-X-7.07-19.2.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"foomatic-db-engine-3.0-1.20030908.3.1.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"foomatic-filters-3.0-1.20030908.3.1.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"ghostscript-module-X-7.07-0.12.1.92mdk", release:"MDK9.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
