...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200803-22 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200803-22
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2007-6036');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200803-22.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'LIVE555 Media Server: Denial of Service');
 exit(0);
}
...
if (qpkg_check(package: "media-plugins/live", unaffected: make_list("ge 2008.02.08"), vulnerable: make_list("lt 2008.02.08")
