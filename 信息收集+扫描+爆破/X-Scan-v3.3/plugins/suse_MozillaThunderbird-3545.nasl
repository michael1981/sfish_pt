...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaThunderbird: Security update to version 1.5.0.12 (MozillaThunderbird-3545)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaThunderbird-3545");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaThunderbird-3545");
...
script_summary(english: "Check for the MozillaThunderbird-3545 package");
...
if ( rpm_check( reference:"MozillaThunderbird-1.5.0.12-2.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaThunderbird-translations-1.5.0.12-2.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
