...
#
# This plugin text was extracted from Fedora Security Advisory 2007-0410
#
...
script_name(english: "Fedora 7 2007-0410: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-0410 (openoffice.org)");
...
This update fixes a possible buffer overrun in hand-crafted rtf files that use
the custom /prtdata tag.
");
...
if ( rpm_check( reference:"openoffice.org-2.2.0-14.11", release:"FC7") )
{
