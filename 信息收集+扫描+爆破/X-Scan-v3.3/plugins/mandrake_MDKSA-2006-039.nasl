...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:039: gnutls");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:039 (gnutls).");
 script_set_attribute(attribute: "description", value: "Evgeny Legerov discovered cases of possible out-of-bounds access
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:039");
