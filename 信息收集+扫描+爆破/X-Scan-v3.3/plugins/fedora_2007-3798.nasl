...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3798
#
...
script_name(english: "Fedora 8 2007-3798: blam");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3798 (blam)");
...
if ( rpm_check( reference:"blam-1.8.3-11.fc8", release:"FC8") )
{
