...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2860
#
...
script_name(english: "Fedora 8 2007-2860: zaptel");
...
if ( rpm_check( reference:"zaptel-1.4.6-1.fc8", release:"FC8") )
{
