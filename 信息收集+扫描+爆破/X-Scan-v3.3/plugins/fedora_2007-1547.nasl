...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1547
#
...
script_name(english: "Fedora 7 2007-1547: tetex");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-1547 (tetex)");
...
* Fri Aug 10 2007 Jindrich Novy <jnovy redhat com> 3.0-40.1
...
if ( rpm_check( reference:"tetex-3.0-40.1.fc7", release:"FC7") )
{
