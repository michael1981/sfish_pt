...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:057: cairo");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:057 (cairo).");
 script_set_attribute(attribute: "description", value: "GNOME Evolution allows remote attackers to cause a denial of service
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:057");
