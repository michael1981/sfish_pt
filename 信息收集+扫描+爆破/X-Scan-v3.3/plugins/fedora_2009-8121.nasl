...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8121
#
...
script_name(english: "Fedora 10 2009-8121: xml-security-c");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8121 (xml-security-c)");
...
if ( rpm_check( reference:"xml-security-c-1.5.1-1.fc10", release:"FC10") )
{
