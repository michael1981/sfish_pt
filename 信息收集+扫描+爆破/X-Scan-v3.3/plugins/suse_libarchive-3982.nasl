...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libarchive: security update (libarchive-3982)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch libarchive-3982");
 script_set_attribute(attribute: "description", value: "Specially crafted tar-archives could cause programs based
...
script_set_attribute(attribute: "solution", value: "Install the security patch libarchive-3982");
script_end_attributes();

script_cve_id("CVE-2007-3641", "CVE-2007-3644", "CVE-2007-3645");
script_summary(english: "Check for the libarchive-3982 package");
