...
'The remote host is missing the SSA-2006-207-03 security update');
...
script_name(english: "SSA-2006-207-03 gimp ");
...
extrarep = NULL;
if (slackware_check(osver: "10.2", pkgname: "gimp", pkgver: "2.2.12", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package gimp is vulnerable in Slackware 10.2
Upgrade to gimp-2.2.12-i486-1_slack10.2 or newer.
');
}
