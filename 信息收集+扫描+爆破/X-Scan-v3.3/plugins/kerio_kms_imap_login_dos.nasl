...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"23772");
...
an administrator acknowledges a console message." );
 script_set_attribute(attribute:"see_also", value:"http://lists.grok.org.uk/pipermail/full-disclosure/2006-March/043567.html" );
