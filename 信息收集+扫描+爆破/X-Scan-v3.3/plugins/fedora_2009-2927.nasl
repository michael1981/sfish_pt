...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2927
#
...
script_name(english: "Fedora 9 2009-2927: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2927 (postgresql)");
...
if ( rpm_check( reference:"postgresql-8.3.7-1.fc9", release:"FC9") )
{
