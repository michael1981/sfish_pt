...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaFirefox: Security update to 2.0.0.22 branch state (MozillaFirefox-6194)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-6194");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-6194");
script_end_attributes();

script_cve_id("CVE-2009-0352", "CVE-2009-0353", "CVE-2009-0772", "CVE-2009-0774", "CVE-2009-0776", "CVE-2009-0040", "CVE-2009-1169");
script_summary(english: "Check for the MozillaFirefox-6194 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.21post-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.21post-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
