...
if (description) {
  ...
  script_name(english:"MS03-010: Microsoft Windows RPC Endpoint Manager Malformed Packet DoS (331953)");
...
pointer when it receives a certain malformed request. All MS 
RPC-based services (i.e. a large part of MS Windows 2000+) running on
the target machine are rendered inoperable." );
 script_set_attribute(attribute:"see_also", value:"http://www.microsoft.com/technet/security/bulletin/MS03-010.asp" );
...
script_end_attributes();
  ...
  script_copyright(english:"This script is Copyright (C) 2002-2009  Pavel Kankovsky");
