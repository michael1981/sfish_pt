...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9232
#
...
script_name(english: "Fedora 8 2008-9232: dovecot");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9232 (dovecot)");
...
if ( rpm_check( reference:"dovecot-1.0.15-14.fc8", release:"FC8") )
{
