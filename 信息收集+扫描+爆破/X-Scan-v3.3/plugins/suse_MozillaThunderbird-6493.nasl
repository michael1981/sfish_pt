...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaThunderbird: Security update to version 2.0.0.23 (MozillaThunderbird-6493)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaThunderbird-6493");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaThunderbird-6493");
script_end_attributes();

script_cve_id("CVE-2009-2408");
script_summary(english: "Check for the MozillaThunderbird-6493 package");
...
if ( rpm_check( reference:"MozillaThunderbird-2.0.0.23-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaThunderbird-devel-2.0.0.23-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaThunderbird-translations-2.0.0.23-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
