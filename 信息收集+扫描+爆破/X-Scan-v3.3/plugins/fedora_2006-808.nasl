...
#
# This plugin text was extracted from Fedora Security Advisory 2006-808
#
...
script_name(english: "Fedora 4 2006-808: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-808 (samba)");
...
* Wed Jul 12 2006 Jay Fenlason <fenlason redhat com> 3.0.23-1.fc4
...
if ( rpm_check( reference:"samba-3.0.23-1.fc4", release:"FC4") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"samba-swat-3.0.23-1.fc4", release:"FC4") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
