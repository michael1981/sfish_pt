...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7048
#
...
script_name(english: "Fedora 9 2008-7048: pdns");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7048 (pdns)");
...
if ( rpm_check( reference:"pdns-2.9.21.1-1.fc9", release:"FC9") )
{
