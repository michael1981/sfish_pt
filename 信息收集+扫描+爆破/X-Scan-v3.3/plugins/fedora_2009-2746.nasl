...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2746
#
...
script_name(english: "Fedora 10 2009-2746: ejabberd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2746 (ejabberd)");
...
if ( rpm_check( reference:"ejabberd-2.0.4-1.fc10", release:"FC10") )
{
