...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for IBM Java 1.5.0 (java-1_5_0-ibm-5960)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_5_0-ibm-5960");
 script_set_attribute(attribute: "description", value: "This update brings IBM Java 5 to Service Release 9.

It fixes the following security problems: CVE-2008-5350: A
security vulnerability in the Java Runtime Environment
(JRE) may allow an untrusted applet or application to list
the contents of the home directory of the user running the
...
Runtime Environment (JRE) with unpacking applets and Java
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_5_0-ibm-5960");
...
script_summary(english: "Check for the java-1_5_0-ibm-5960 package");
...
if ( rpm_check( reference:"java-1_5_0-ibm-1.5.0_sr9-2.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-ibm-alsa-1.5.0_sr9-2.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-ibm-devel-1.5.0_sr9-2.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-ibm-fonts-1.5.0_sr9-2.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-ibm-jdbc-1.5.0_sr9-2.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-ibm-plugin-1.5.0_sr9-2.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
