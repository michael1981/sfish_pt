...
'The remote host is missing the DSA-749 security update');
...
'The Debian project recommends that you upgrade your ettercap package.');
...
deb_check(prefix: 'ettercap', release: '3.1', reference: '0.7.1-1sarge1');
deb_check(prefix: 'ettercap-common', release: '3.1', reference: '0.7.1-1sarge1');
deb_check(prefix: 'ettercap-gtk', release: '3.1', reference: '0.7.1-1sarge1');
