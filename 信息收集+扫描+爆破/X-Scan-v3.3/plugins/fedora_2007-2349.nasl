...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2349
#
...
script_name(english: "Fedora 7 2007-2349: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2349 (kernel)");
...
libata pata_sis: DMA fixes (#247768)
...
if ( rpm_check( reference:"kernel-2.6.22.9-91.fc7", prefix:"kernel-", release:"FC7") )
{
