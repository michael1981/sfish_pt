...
'The remote host is missing the DSA-217 security update');
...
'The Debian project recommends that you upgrade your typespeed package.');
...
deb_check(prefix: 'typespeed', release: '2.2', reference: '0.4.0-5.1');
deb_check(prefix: 'typespeed', release: '3.0', reference: '0.4.1-2.1');
