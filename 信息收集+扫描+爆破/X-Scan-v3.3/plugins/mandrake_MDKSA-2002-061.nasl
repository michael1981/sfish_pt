...
if(description)
{
 ...
 script_name(english: "MDKSA-2002:061: glibc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2002:061 (glibc).");
 script_set_attribute(attribute: "description", value: "A heap buffer overflow exists in the XDR decoder in glibc version 2.2.5
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2002:061");
