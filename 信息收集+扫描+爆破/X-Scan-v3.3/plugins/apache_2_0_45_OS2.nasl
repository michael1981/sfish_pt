...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"9713");
 script_version("$Revision: 1.12 $");
 
 script_name(english:"Apache < 2.0.46 on OS/2 filestat.c Device Name Request DoS");
...
older than 2.0.46 on OS/2. There is a vulnerability specific to such
versions running on OS/2 in 'filestat.c' which could allow an attacker
...
"Upgrade to Apache web server version 2.0.46 or newer." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2003-04/0018.html" );
