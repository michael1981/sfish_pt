...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  poppler security update (poppler-3991)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch poppler-3991");
script_end_attributes();

script_cve_id("CVE-2007-3387");
script_summary(english: "Check for the poppler-3991 package");
