...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0413
#
...
script_name(english: "Fedora 10 2009-0413: uw-imap");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0413 (uw-imap)");
...
if ( rpm_check( reference:"uw-imap-2007e-1.fc10", release:"FC10") )
{
