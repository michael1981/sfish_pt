...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6210
#
...
script_name(english: "Fedora 8 2008-6210: sipp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6210 (sipp)");
...
if ( rpm_check( reference:"sipp-3.1-2.fc8", release:"FC8") )
{
