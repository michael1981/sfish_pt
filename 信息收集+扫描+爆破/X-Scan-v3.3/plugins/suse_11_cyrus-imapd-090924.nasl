...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  cyrus-imapd (2009-09-24)");
...
if ( rpm_check( reference:"cyrus-imapd-2.3.11-60.21.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"perl-Cyrus-IMAP-2.3.11-60.21.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"perl-Cyrus-SIEVE-managesieve-2.3.11-60.21.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
