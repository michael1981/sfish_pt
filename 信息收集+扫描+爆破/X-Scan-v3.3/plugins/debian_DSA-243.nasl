...
'The remote host is missing the DSA-243 security update');
...
deb_check(prefix: 'artsbuilder', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'kdemultimedia-dev', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'kmid', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'kmidi', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'kmix', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'kscd', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'libarts-mpeglib', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'mpeglib', release: '3.0', reference: '2.2.2-8.2');
deb_check(prefix: 'noatun', release: '3.0', reference: '2.2.2-8.2');
