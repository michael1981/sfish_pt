...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  ethereal: Securityupdate to fix problems found in version 0.99.6 (ethereal-3885)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch ethereal-3885");
...
script_set_attribute(attribute: "solution", value: "Install the security patch ethereal-3885");
script_end_attributes();

script_cve_id("CVE-2007-3389", "CVE-2007-3390", "CVE-2007-3391", "CVE-2007-3392", "CVE-2007-3393");
script_summary(english: "Check for the ethereal-3885 package");
...
if ( rpm_check( reference:"ethereal-0.10.14-16.16", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"ethereal-devel-0.10.14-16.16", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
