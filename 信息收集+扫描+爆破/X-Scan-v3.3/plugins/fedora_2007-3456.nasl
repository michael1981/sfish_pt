...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3456
#
...
script_name(english: "Fedora 7 2007-3456: tomcat5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3456 (tomcat5)");
...
if ( rpm_check( reference:"tomcat5-5.5.25-1jpp.1.fc7", release:"FC7") )
{
