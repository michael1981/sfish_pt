...
"If you are running FreeBSD 3.X, 4.x, 3.5-STABLE, 4.2-STABLE, 
upgrade your firewall.  If you are not running FreeBSD, 
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2004-2009  Andrey I. Zakharov and John Lampe");
 exit(0);
}
