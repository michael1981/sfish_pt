...
if (description)
{
 ...
 script_xref(name:"OSVDB", value:"5993");
...
"The remote host is running Microsoft IIS with what appears to bea
...
be used to map applications which are processing cookies." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2004-05/0255.html" );
