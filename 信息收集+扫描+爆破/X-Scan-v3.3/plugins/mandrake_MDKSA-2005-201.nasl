...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:201: sudo");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:201 (sudo).");
 script_set_attribute(attribute: "description", value: "Tavis Ormandy discovered that sudo does not perform sufficient
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:201");
