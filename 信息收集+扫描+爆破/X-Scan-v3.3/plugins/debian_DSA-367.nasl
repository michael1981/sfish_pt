...
'The remote host is missing the DSA-367 security update');
...
'Read http://www.debian.org/security/2003/dsa-367
...
deb_check(prefix: 'xtokkaetama', release: '3.0', reference: '1.0b-6woody2');
