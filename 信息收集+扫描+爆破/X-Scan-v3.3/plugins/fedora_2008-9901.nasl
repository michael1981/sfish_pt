...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9901
#
...
script_name(english: "Fedora 10 2008-9901: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9901 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-2.0.0.18-1.fc10", release:"FC10") )
{
