...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  optipng (2009-06-09)");
...
if ( rpm_check( reference:"optipng-0.6.1-10.4.1", release:"SUSE11.1", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"optipng-0.6.1-10.4.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
