...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8324
#
...
script_name(english: "Fedora 11 2009-8324: squid");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8324 (squid)");
...
if ( rpm_check( reference:"squid-3.0.STABLE18-1.fc11", release:"FC11") )
{
