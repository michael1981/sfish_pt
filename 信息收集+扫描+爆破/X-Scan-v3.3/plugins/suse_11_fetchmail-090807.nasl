...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  fetchmail (2009-08-07)");
...
if ( rpm_check( reference:"fetchmail-6.3.8.90-13.16.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"fetchmailconf-6.3.8.90-13.16.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"fetchmail-6.3.8.90-13.16.1", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
