...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3064
#
...
script_name(english: "Fedora 9 2009-3064: netatalk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3064 (netatalk)");
...
if ( rpm_check( reference:"netatalk-2.0.3-21.fc9", release:"FC9") )
{
