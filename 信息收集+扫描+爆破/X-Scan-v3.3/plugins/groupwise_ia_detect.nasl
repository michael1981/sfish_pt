...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis",
    value:"The remote Windows host contains an SMTP server."
  );
  script_set_attribute(
    attribute:"description",
    value:string(
      "Novell GroupWise Internet Agent (GWIA) is installed on the remote\n",
      "host.  GWIA is part of the GroupWise suite, and is used for sending\n",
      "and receiving messages over the Internet."
    )
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.novell.com/products/groupwise/"
  );
  script_set_attribute(
    attribute:"solution",
    value:"n/a"
