...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6737
#
...
script_name(english: "Fedora 9 2008-6737: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6737 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-2.0.0.16-1.fc9", release:"FC9") )
{
