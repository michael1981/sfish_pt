...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for inkscape (inkscape-3061)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch inkscape-3061");
script_end_attributes();

script_cve_id("CVE-2007-1463", "CVE-2007-1464");
script_summary(english: "Check for the inkscape-3061 package");
