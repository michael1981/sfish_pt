# This script was automatically generated from the dsa-1817
...
'The remote host is missing the DSA-1817 security update');
...
'The Debian project recommends that you upgrade your ctorrent packages.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1817] DSA-1817-1 ctorrent");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1817-1 ctorrent");
 exit(0);
}
...
deb_check(prefix: 'ctorrent', release: '5.0', reference: '1.3.4-dnh3.2-1+lenny1');
