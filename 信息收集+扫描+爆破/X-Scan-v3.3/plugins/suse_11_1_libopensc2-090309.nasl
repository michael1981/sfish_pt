...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  libopensc2 (2009-03-09)");
...
if ( rpm_check( reference:"libopensc2-0.11.6-5.2.1", release:"SUSE11.1", cpu:"i586") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libopensc2-0.11.6-5.2.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libopensc2-32bit-0.11.6-5.2.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opensc-0.11.6-5.2.1", release:"SUSE11.1", cpu:"i586") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opensc-0.11.6-5.2.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opensc-32bit-0.11.6-5.2.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opensc-devel-0.11.6-5.2.1", release:"SUSE11.1", cpu:"i586") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opensc-devel-0.11.6-5.2.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
