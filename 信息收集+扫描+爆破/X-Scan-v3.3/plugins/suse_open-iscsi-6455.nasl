...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for open-iscsi (open-iscsi-6455)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch open-iscsi-6455");
...
script_set_attribute(attribute: "solution", value: "Install the security patch open-iscsi-6455");
script_end_attributes();

script_cve_id("CVE-2009-1297");
script_summary(english: "Check for the open-iscsi-6455 package");
...
if ( rpm_check( reference:"open-iscsi-2.0.707-0.47", release:"SLES10") )
{
