...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2231
#
...
script_name(english: "Fedora 10 2009-2231: mediawiki");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2231 (mediawiki)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-5249", "CVE-2008-5688", "CVE-2009-0737");
...
if ( rpm_check( reference:"mediawiki-1.14.0-45.fc10", release:"FC10") )
{
