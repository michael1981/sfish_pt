...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaThunderbird: Security update (MozillaThunderbird-5095)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaThunderbird-5095");
 script_set_attribute(attribute: "description", value: "This update brings Mozilla Thunderbird to security fix
level of version 2.0.0.12
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaThunderbird-5095");
...
script_summary(english: "Check for the MozillaThunderbird-5095 package");
...
if ( rpm_check( reference:"MozillaThunderbird-1.5.0.14-0.3", release:"SUSE10.2") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaThunderbird-translations-1.5.0.14-0.3", release:"SUSE10.2") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
