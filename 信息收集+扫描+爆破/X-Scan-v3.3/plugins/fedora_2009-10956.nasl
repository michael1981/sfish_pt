...
#
# This plugin text was extracted from Fedora Security Advisory 2009-10956
#
...
script_name(english: "Fedora 10 2009-10956: python-4Suite-XML");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-10956 (python-4Suite-XML)");
...
if ( rpm_check( reference:"python-4Suite-XML-1.0.2-8.fc10", release:"FC10") )
{
