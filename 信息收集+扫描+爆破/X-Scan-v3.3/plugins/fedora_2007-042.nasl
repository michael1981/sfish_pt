...
#
# This plugin text was extracted from Fedora Security Advisory 2007-042
#
...
script_name(english: "Fedora 6 2007-042: fetchmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-042 (fetchmail)");
...
if ( rpm_check( reference:"fetchmail-6.3.6-1.fc6", release:"FC6") )
{
