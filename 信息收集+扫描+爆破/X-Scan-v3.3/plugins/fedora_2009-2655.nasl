...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2655
#
...
script_name(english: "Fedora 9 2009-2655: pdfjam");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2655 (pdfjam)");
...
if ( rpm_check( reference:"pdfjam-1.21-1.fc9", release:"FC9") )
{
