...
'The remote host is missing the DSA-142 security update');
...
deb_check(prefix: 'libopenafs-dev', release: '3.0', reference: '1.2.3final2-6');
deb_check(prefix: 'openafs-client', release: '3.0', reference: '1.2.3final2-6');
deb_check(prefix: 'openafs-dbserver', release: '3.0', reference: '1.2.3final2-6');
deb_check(prefix: 'openafs-fileserver', release: '3.0', reference: '1.2.3final2-6');
deb_check(prefix: 'openafs-kpasswd', release: '3.0', reference: '1.2.3final2-6');
deb_check(prefix: 'openafs-modules-source', release: '3.0', reference: '1.2.3final2-6');
