# This script was automatically generated from the dsa-1354
...
'The remote host is missing the DSA-1354 security update');
...
'The Debian project recommends that you upgrade your gpdf packages.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1354] DSA-1354-1 gpdf");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1354-1 gpdf");
 exit(0);
}
...
deb_check(prefix: 'gpdf', release: '3.1', reference: '2.8.2-1.2sarge6');
