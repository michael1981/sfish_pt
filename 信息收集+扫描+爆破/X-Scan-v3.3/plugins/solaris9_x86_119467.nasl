...
if(description)
{
 ...
 script_name(english: "Solaris 5.9 (x86) : 119467-17");
...
e +=  solaris_check_patch(release:"5.9_x86", arch:"i386", patch:"119467-17", obsoleted_by:"", package:"SUNWamutl", version:"6.2,REV=04.04.23.19.50");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
