...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"49189");

  script_name(english:"F-Secure RPM Parsing Integer Overflow (FSC-2008-3)");
  script_summary(english:"Checks version of fm4av.dll");
 
 script_set_attribute(attribute:"synopsis", value:
"The remote host has an application that is affected by integer
overflow vulnerability." );
 script_set_attribute(attribute:"description", value:
"The remote host is running an anti-virus software application from
F-Secure.  The version of F-Secure Anti-Virus installed on the remote
host is affected by a integer overflow vulnerability.  Provided
F-Secure is configured to scan inside compressed archives, it may be
possible for an attacker to execute arbitrary code on the remote
systems via a specially crafted RPM file. 

Note that, in a typical configuration, on-access scanning does not
scan inside compressed archives." );
 script_set_attribute(attribute:"see_also", value:"http://www.f-secure.com/security/fsc-2008-3.shtml" );
...
# nb: Since we are not certain if 'Scan inside compressed files' setting
