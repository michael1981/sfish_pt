...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libsndfile (2009-05-28)");
...
if ( rpm_check( reference:"libsndfile-1.0.17-172.14.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libsndfile-1.0.17-172.14.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
