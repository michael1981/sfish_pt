...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  memcached (2009-08-06)");
...
if ( rpm_check( reference:"memcached-1.2.2-49.2", release:"SUSE11.0", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"memcached-1.2.2-49.2", release:"SUSE11.0", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
