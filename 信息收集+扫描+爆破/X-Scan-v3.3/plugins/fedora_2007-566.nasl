...
#
# This plugin text was extracted from Fedora Security Advisory 2007-566
#
...
script_name(english: "Fedora 5 2007-566: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-566 (postgresql)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-0556", "CVE-2007-2138");
...
if ( rpm_check( reference:"postgresql-8.1.9-1.fc5", release:"FC5") )
{
