...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2883
#
...
script_name(english: "Fedora 9 2009-2883: ghostscript");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2883 (ghostscript)");
...
if ( rpm_check( reference:"ghostscript-8.63-2.fc9", release:"FC9") )
{
