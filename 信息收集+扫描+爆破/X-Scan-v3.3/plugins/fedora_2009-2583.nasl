...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2583
#
...
script_name(english: "Fedora 10 2009-2583: roundup");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2583 (roundup)");
...
if ( rpm_check( reference:"roundup-1.4.6-4.fc10", release:"FC10") )
{
