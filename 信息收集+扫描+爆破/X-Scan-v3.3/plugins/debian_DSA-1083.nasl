...
'The remote host is missing the DSA-1083 security update');
...
'The Debian project recommends that you upgrade your motor package.');
...
deb_check(prefix: 'motor', release: '3.0', reference: '3.2.2-2woody1');
deb_check(prefix: 'motor', release: '3.1', reference: '3.4.0-2sarge1');
deb_check(prefix: 'motor-common', release: '3.1', reference: '3.4.0-2sarge1');
deb_check(prefix: 'motor-fribidi', release: '3.1', reference: '3.4.0-2sarge1');
