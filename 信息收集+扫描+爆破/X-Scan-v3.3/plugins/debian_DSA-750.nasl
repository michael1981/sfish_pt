...
'The remote host is missing the DSA-750 security update');
...
'The Debian project recommends that you upgrade your dhcpcd package.');
...
deb_check(prefix: 'dhcpcd', release: '3.1', reference: '1.3.22pl4-21sarge1');
