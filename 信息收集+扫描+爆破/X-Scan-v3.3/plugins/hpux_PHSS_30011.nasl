...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_30011");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_30011 security update");
 script_set_attribute(attribute: "description", value:
"CDE Base Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_30011");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_30011");
...
if ( hpux_patch_installed (patches:"PHSS_30011 PHSS_30788 PHSS_32110 PHSS_33325 PHSS_35249 PHSS_36394 ") )
{
 exit(0);
}
