...
if(description)
{
 ...
 name["english"] = "Fedora Core 4 2005-928: devhelp";
...
"The remote host is missing the patch for the advisory FEDORA-2005-928 (devhelp).
...
include("rpm.inc");
if ( rpm_check( reference:"devhelp-0.10-1.4.2", release:"FC4") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"devhelp-devel-0.10-1.4.2", release:"FC4") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
