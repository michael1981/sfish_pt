...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_32966");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_32966 security update");
 script_set_attribute(attribute: "description", value:
"Xserver cumulative patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32966");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_32966");
...
if ( hpux_patch_installed (patches:"PHSS_32966 PHSS_32971 PHSS_32976 PHSS_32977 PHSS_34385 PHSS_34389 PHSS_34390 PHSS_34391 PHSS_34392 ") )
{
 exit(0);
}
