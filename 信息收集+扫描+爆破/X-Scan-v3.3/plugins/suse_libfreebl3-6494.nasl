...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  mozilla-nss: Security update to 3.12.3.1 (libfreebl3-6494)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch libfreebl3-6494");
 script_set_attribute(attribute: "description", value: "The Mozilla NSS and dependend libraries were updated to fix
various issues.
...
script_set_attribute(attribute: "solution", value: "Install the security patch libfreebl3-6494");
script_end_attributes();

script_cve_id("CVE-2009-2404", "CVE-2009-2408");
script_summary(english: "Check for the libfreebl3-6494 package");
...
if ( rpm_check( reference:"libfreebl3-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"libfreebl3-32bit-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"libfreebl3-64bit-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nspr-4.7.1-46.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nspr-32bit-4.7.1-46.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nspr-64bit-4.7.1-46.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nspr-devel-4.7.1-46.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nss-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nss-32bit-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nss-64bit-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nss-devel-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-nss-tools-3.12.3.1-1.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
