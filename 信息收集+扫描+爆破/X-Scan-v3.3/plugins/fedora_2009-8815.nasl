...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8815
#
...
script_name(english: "Fedora 11 2009-8815: neon");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8815 (neon)");
...
if ( rpm_check( reference:"neon-0.28.6-1.fc11", release:"FC11") )
{
