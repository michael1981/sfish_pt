...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHCO_33822");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHCO_33822 security update");
 script_set_attribute(attribute: "description", value:
"Software Distributor Cumulative Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//patches_with_warnings/hp-ux_patches/s700_800/11.X/PHCO_33822");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHCO_33822");
...
if ( hpux_patch_installed (patches:"PHCO_33822 PHCO_34295 PHCO_34539 PHCO_35587 PHCO_38226 ") )
{
 exit(0);
}
