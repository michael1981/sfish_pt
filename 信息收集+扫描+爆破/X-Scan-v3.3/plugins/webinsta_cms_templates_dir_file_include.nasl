...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"27948");
...
hosts." );
 script_set_attribute(attribute:"see_also", value:"http://www.milw0rm.com/exploits/2175" );
 script_set_attribute(attribute:"see_also", value:"http://my.opera.com/atomo64/blog/show.dml/443167" );
