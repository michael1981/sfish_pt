...
'The remote host is missing the DSA-1064 security update');
...
deb_check(prefix: 'cscope', release: '3.0', reference: '15.3-1woody3');
deb_check(prefix: 'cscope', release: '3.1', reference: '15.5-1.1sarge1');
