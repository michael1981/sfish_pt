...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2984
#
...
script_name(english: "Fedora 9 2009-2984: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2984 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-3.1.3.1-1.fc9", release:"FC9") )
{
