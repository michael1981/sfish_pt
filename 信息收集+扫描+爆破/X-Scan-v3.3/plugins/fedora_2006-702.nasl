...
#
# This plugin text was extracted from Fedora Security Advisory 2006-702
#
...
script_name(english: "Fedora 5 2006-702: mysql");
...
if ( rpm_check( reference:"mysql-5.0.22-1.FC5.1", release:"FC5") )
{
