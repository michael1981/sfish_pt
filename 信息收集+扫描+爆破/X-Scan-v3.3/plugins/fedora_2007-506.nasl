...
#
# This plugin text was extracted from Fedora Security Advisory 2007-506
#
...
script_name(english: "Fedora 5 2007-506: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-506 (samba)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-3403", "CVE-2007-0452", "CVE-2007-2444", "CVE-2007-2446", "CVE-2007-2447");
...
if ( rpm_check( reference:"samba-3.0.24-5.fc5", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"samba-swat-3.0.24-5.fc5", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
