...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:027: chbg");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:027 (chbg).");
 script_set_attribute(attribute: "description", value: "A vulnerability in chbg was discovered by Danny Lungstrom. A
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:027");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2004-1264");
script_summary(english: "Check for the version of the chbg package");
