...
'The remote host is missing the SSA-2005-269-02 security update');
script_set_attribute(attribute:'description', value: 'New sudo packages are available to fix a security problem which may allow
...
script_summary("SSA-2005-269-02 sudo upgrade fixes a potential vulnerability");
script_name(english: "SSA-2005-269-02 sudo upgrade fixes a potential vulnerability");
