...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2873
#
...
script_name(english: "Fedora 9 2009-2873: drupal-cck");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2873 (drupal-cck)");
...
if ( rpm_check( reference:"drupal-cck-6.x.2.2-1.fc9", release:"FC9") )
{
