...
#
# This plugin text was extracted from Fedora Security Advisory 2007-376
#
...
script_name(english: "Fedora 6 2007-376: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-376 (openoffice.org)");
...
if ( rpm_check( reference:"openoffice.org-2.0.4-5.5.17", release:"FC6") )
{
