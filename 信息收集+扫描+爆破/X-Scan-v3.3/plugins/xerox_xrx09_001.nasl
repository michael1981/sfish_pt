...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"53635");
...
carefully crafted inputs on an affected web page." );
 script_set_attribute(attribute:"see_also", value:"http://www.xerox.com/downloads/usa/en/c/cert_XRX09_001.pdf" );
