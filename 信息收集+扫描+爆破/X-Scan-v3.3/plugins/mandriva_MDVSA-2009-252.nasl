...
if(description)
{
 ...
 script_name(english: "MDVSA-2009:252: perl-IO-Socket-SSL");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDVSA-2009:252 (perl-IO-Socket-SSL).");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDVSA-2009:252");
