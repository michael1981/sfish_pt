...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6899
#
...
script_name(english: "Fedora 11 2009-6899: rt3");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6899 (rt3)");
...
if ( rpm_check( reference:"rt3-3.8.2-8.fc11", release:"FC11") )
{
