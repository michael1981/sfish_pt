...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:077-1: apache");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:077-1 (apache).");
 script_set_attribute(attribute: "description", value: "A problem exists with all Apache servers prior to version 1.3.19. The
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:077-1");
