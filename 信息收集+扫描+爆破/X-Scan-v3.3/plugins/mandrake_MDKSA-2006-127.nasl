...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:127: gimp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:127 (gimp).");
 script_set_attribute(attribute: "description", value: "A buffer overflow in the xcf_load_vector function in app/xcf/xcf-load.c
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:127");
