...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1603
#
...
script_name(english: "Fedora 8 2008-1603: tomcat5");
...
if ( rpm_check( reference:"tomcat5-5.5.26-1jpp.2.fc8", release:"FC8") )
{
