...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4267
#
...
script_name(english: "Fedora 9 2008-4267: Django");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4267 (Django)");
...
if ( rpm_check( reference:"Django-0.96.2-1.fc9", release:"FC9") )
{
