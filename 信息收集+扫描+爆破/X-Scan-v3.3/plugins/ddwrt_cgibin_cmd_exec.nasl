...
if(description)
{
  ...
  script_xref(name:"milw0rm", value:"9209");
  script_xref(name:"OSVDB", value:"55990");
  ...
  script_set_attribute(
    ...
    value:string(
      "The remote web server is vulnerable to a command injection attack that may allow\n",
      "an attacker to execute arbitrary commands on the remote server (usually with root privileges).\n",
...
if (isnull(file)) exit(0, "No web server running");
if (
