...
'The remote host is missing the DSA-1474 security update');
...
'The Debian project recommends that you upgrade your exiv2 packages.');
...
deb_check(prefix: 'exiv2', release: '4.0', reference: '0.10-1.5');
deb_check(prefix: 'libexiv2-0.10', release: '4.0', reference: '0.10-1.5');
deb_check(prefix: 'libexiv2-dev', release: '4.0', reference: '0.10-1.5');
deb_check(prefix: 'libexiv2-doc', release: '4.0', reference: '0.10-1.5');
