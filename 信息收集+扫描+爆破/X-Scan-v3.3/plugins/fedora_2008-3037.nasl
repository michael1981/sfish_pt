...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3037
#
...
script_name(english: "Fedora 7 2008-3037: bzip2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3037 (bzip2)");
...
if ( rpm_check( reference:"bzip2-1.0.4-11.fc7", release:"FC7") )
{
