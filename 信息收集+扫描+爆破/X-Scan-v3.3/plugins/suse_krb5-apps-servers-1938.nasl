...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for krb5-apps-servers and krb5-apps-clients (krb5-apps-servers-1938)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch krb5-apps-servers-1938");
script_end_attributes();

script_cve_id("CVE-2006-3083", "CVE-2006-3084");
script_summary(english: "Check for the krb5-apps-servers-1938 package");
