...
#
# This plugin text was extracted from Fedora Security Advisory 2009-4848
#
...
script_name(english: "Fedora 10 2009-4848: giflib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-4848 (giflib)");
...
if ( rpm_check( reference:"giflib-4.1.6-2.fc10", release:"FC10") )
{
