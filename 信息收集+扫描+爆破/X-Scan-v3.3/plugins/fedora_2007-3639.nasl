...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3639
#
...
script_name(english: "Fedora 8 2007-3639: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3639 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.2.2-1.fc8", release:"FC8") )
{
