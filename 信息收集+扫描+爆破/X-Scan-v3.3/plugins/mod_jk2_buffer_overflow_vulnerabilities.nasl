...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"43189");
...
privileges of the user running the Apache process." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.milw0rm.com/exploits/5330" );
 script_set_attribute(attribute:"see_also", value:"http://today.java.net/pub/n/mod_jk22.0.4" );
