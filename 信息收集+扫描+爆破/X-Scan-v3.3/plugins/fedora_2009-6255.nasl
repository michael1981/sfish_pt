...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6255
#
...
script_name(english: "Fedora 10 2009-6255: pam_krb5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6255 (pam_krb5)");
...
if ( rpm_check( reference:"pam_krb5-2.3.5-1.fc10", release:"FC10") )
{
