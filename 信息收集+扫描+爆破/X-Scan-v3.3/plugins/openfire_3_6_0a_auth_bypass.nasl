...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"49663");
...
other issues." );
 script_set_attribute(attribute:"see_also", value:"http://www.andreas-kurtz.de/advisories/AKADV2008-001-v1.0.txt" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2008-11/0156.html" );
