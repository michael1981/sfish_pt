...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0678
#
...
script_name(english: "Fedora 9 2009-0678: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0678 (drupal)");
...
if ( rpm_check( reference:"drupal-6.9-1.fc9", release:"FC9") )
{
