...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2666
#
...
script_name(english: "Fedora 7 2007-2666: libpng");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2666 (libpng)");
...
if ( rpm_check( reference:"libpng-1.2.22-1.fc7", release:"FC7") )
{
