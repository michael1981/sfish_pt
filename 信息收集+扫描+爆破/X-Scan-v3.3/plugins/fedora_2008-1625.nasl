...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1625
#
...
script_name(english: "Fedora 8 2008-1625: clamav");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1625 (clamav)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-6335", "CVE-2008-0318");
...
if ( rpm_check( reference:"clamav-0.92.1-1.fc8", release:"FC8") )
{
