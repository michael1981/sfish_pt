...
'The remote host is missing the DSA-559 security update');
...
'The Debian project recommends that you upgrade your net-acct package.');
...
deb_check(prefix: 'net-acct', release: '3.0', reference: '0.71-5woody1');
