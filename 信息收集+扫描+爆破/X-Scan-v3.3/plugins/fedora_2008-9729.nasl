...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9729
#
...
script_name(english: "Fedora 8 2008-9729: libxml2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9729 (libxml2)");
...
if ( rpm_check( reference:"libxml2-2.7.2-2.fc8", release:"FC8") )
{
