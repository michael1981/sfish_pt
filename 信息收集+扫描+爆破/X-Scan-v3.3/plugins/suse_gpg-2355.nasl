...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for gpg (gpg-2355)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch gpg-2355");
script_end_attributes();

script_cve_id("CVE-2006-6169", "CVE-2006-6235");
script_summary(english: "Check for the gpg-2355 package");
