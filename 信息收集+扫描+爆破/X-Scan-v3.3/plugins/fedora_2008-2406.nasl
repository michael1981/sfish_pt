...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2406
#
...
script_name(english: "Fedora 7 2008-2406: horde");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2406 (horde)");
...
if ( rpm_check( reference:"horde-3.1.7-1.fc7", release:"FC7") )
{
