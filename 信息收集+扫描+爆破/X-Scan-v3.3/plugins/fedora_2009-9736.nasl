...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9736
#
...
script_name(english: "Fedora 11 2009-9736: drupal-date");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9736 (drupal-date)");
...
if ( rpm_check( reference:"drupal-date-6.x.2.4-0.fc11", release:"FC11") )
{
