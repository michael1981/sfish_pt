...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1986
#
...
script_name(english: "Fedora 8 2008-1986: wyrd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1986 (wyrd)");
...
if ( rpm_check( reference:"wyrd-1.4.3b-1.fc8", release:"FC8") )
{
