...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6676
#
...
script_name(english: "Fedora 8 2008-6676: asterisk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6676 (asterisk)");
...
Update to 1.4.21.2 to fix CVE-2008-3263 / AST-2008-010 and  CVE-2008-3264 /
...
[10]http://downloads.digium.com/pub/security/AST-2008-011.html
");
...
if ( rpm_check( reference:"asterisk-1.4.21.2-1.fc8", release:"FC8") )
{
