...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"53800");
...
"Sun Java System Directory Server is installed on the remote host. 
The installed version is affected by an information disclosure
