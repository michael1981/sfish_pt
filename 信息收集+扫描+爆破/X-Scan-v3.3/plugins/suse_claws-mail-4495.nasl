...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  claws-mail: This update fixes a format string bug. (claws-mail-4495)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch claws-mail-4495");
script_end_attributes();

script_cve_id("CVE-2007-2958");
script_summary(english: "Check for the claws-mail-4495 package");
