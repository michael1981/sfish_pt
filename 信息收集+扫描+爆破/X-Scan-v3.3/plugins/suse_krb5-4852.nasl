...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Kerberos (krb5-4852)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch krb5-4852");
script_end_attributes();

script_cve_id("CVE-2007-5894", "CVE-2007-5902", "CVE-2007-5971", "CVE-2007-5972");
script_summary(english: "Check for the krb5-4852 package");
