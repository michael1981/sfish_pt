...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"32092");
...
"The remote version of IOS contains a flaw which may cause the remote router
to crash when processing specially malformed IP packets.
...
else if ( vuln > 1 ) display("Problem in script $Id: CSCeh52410.nasl,v 1.8 2009/10/26 20:57:20 mikhail Exp $\n");
