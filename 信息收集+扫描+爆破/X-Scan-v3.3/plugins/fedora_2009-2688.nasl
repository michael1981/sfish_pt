...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2688
#
...
script_name(english: "Fedora 9 2009-2688: glib2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2688 (glib2)");
...
if ( rpm_check( reference:"glib2-2.16.6-3.fc9", release:"FC9") )
{
