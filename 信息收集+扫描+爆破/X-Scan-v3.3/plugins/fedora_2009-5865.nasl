...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5865
#
...
script_name(english: "Fedora 11 2009-5865: gupnp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5865 (gupnp)");
...
if ( rpm_check( reference:"gupnp-0.12.8-1.fc11", release:"FC11") )
{
