...
'The remote host is missing the DSA-424 security update');
...
'Read http://www.debian.org/security/2004/dsa-424
...
deb_check(prefix: 'gmc', release: '3.0', reference: '4.5.55-1.2woody2');
deb_check(prefix: 'mc', release: '3.0', reference: '4.5.55-1.2woody2');
deb_check(prefix: 'mc-common', release: '3.0', reference: '4.5.55-1.2woody2');
