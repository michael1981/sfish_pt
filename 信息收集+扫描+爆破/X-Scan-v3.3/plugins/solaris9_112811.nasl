...
"http://sunsolve.sun.com/search/document.do?assetkey=1-21-112811-02-1");
...
e +=  solaris_check_patch(release:"5.9", arch:"sparc", patch:"112811-02", obsoleted_by:"", package:"SUNWolrte", version:"3.7.0,REV=1.2001.10.12");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
