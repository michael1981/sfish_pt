...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"97");
 script_xref(name:"IAVA", value:"1999-a-0007");
...
execution." );
 script_set_attribute(attribute:"see_also", value:"http://www.microsoft.com/technet/security/bulletin/MS99-019.mspx" );
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 1999-2009 Tenable Network Security, Inc. / Modifications by HD Moore <hdmoore@digitaldefense.net>");
