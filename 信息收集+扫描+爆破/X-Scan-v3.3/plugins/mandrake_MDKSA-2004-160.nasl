...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:160: kdelibs");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:160 (kdelibs).");
 script_set_attribute(attribute: "description", value: "A vulnerability in the Konqueror web browser was discovered that would
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:160");
