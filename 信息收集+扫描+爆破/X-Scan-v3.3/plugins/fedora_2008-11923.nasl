...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11923
#
...
script_name(english: "Fedora 9 2008-11923: lighttpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11923 (lighttpd)");
...
if ( rpm_check( reference:"lighttpd-1.4.20-6.fc9", release:"FC9") )
{
