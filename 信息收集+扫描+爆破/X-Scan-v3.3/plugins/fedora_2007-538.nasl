...
#
# This plugin text was extracted from Fedora Security Advisory 2007-538
#
...
script_name(english: "Fedora 6 2007-538: file");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-538 (file)");
...
if ( rpm_check( reference:"file-4.21-1.fc6", release:"FC6") )
{
