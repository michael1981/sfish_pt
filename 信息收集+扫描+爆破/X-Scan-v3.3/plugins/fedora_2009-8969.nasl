...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8969
#
...
script_name(english: "Fedora 10 2009-8969: ctorrent");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8969 (ctorrent)");
...
if ( rpm_check( reference:"ctorrent-1.3.4-7.dnh3.3.2.fc10", release:"FC10") )
{
