# This script was automatically generated from the dsa-1563
...
'The remote host is missing the DSA-1563 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1563] DSA-1563-1 asterisk");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1563-1 asterisk");
 exit(0);
}
