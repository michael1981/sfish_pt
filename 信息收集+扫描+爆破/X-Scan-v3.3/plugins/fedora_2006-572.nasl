...
#
# This plugin text was extracted from Fedora Security Advisory 2006-572
#
...
script_name(english: "Fedora 5 2006-572: kernel");
...
if ( rpm_check( reference:"kernel-2.6.16-1.2122_FC5", prefix:"kernel-", release:"FC5") )
{
