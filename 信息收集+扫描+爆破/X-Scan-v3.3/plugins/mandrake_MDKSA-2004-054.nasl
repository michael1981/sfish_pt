...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:054: mod_ssl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:054 (mod_ssl).");
 script_set_attribute(attribute: "description", value: "A stack-based buffer overflow exists in the ssl_util_uuencode_binary
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:054");
