...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaFirefox: Security update to version 2.0.0.5 (MozillaFirefox-3935)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-3935");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-3935");
...
script_summary(english: "Check for the MozillaFirefox-3935 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.5-1.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.5-1.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
