...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7544
#
...
script_name(english: "Fedora 10 2009-7544: perl-IO-Socket-SSL");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7544 (perl-IO-Socket-SSL)");
...
if ( rpm_check( reference:"perl-IO-Socket-SSL-1.26-1.fc10", release:"FC10") )
{
