...
#
# Ref: http://www.54hack.info/txt/phpwind.doc
...
There is a flaw in older versions of this software in the file 'faq.php'
which may allow an attacker to gain a shell on this host.

Solution: Upgrade to PHPwind 2.0.2 or later.
Risk factor : High";
