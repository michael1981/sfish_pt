...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"20948");
...
the stability of the remote host itself." );
 script_set_attribute(attribute:"see_also", value:"http://www.idefense.com/application/poi/display?id=341&type=vulnerabilities" );
