...
#
# This plugin text was extracted from Fedora Security Advisory 2006-680
#
...
script_name(english: "Fedora 5 2006-680: squirrelmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-680 (squirrelmail)");
...
if ( rpm_check( reference:"squirrelmail-1.4.6-7.fc5", release:"FC5") )
{
