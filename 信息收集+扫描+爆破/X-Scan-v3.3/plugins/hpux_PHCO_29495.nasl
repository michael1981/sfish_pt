...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHCO_29495");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHCO_29495 security update");
 script_set_attribute(attribute: "description", value:
"libc cumulative patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHCO_29495");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHCO_29495");
...
if ( hpux_patch_installed (patches:"PHCO_29495 PHCO_29955 PHCO_30030 PHCO_30530 PHCO_31061 PHCO_31903 PHCO_32761 PHCO_33360 PHCO_33533 PHCO_33711 PHCO_34275 PHCO_35743 PHCO_36184 PHCO_37369 PHCO_38279 ") )
{
 exit(0);
}
