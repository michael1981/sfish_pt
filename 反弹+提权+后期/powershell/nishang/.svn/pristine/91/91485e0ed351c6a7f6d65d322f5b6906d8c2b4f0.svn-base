...
<#
.SYNOPSIS
Nishang payload which gets SQL Server Login Accounts
...
.EXAMPLE
.\Get-SqlSysLogin.ps1 -ComputerName SRV01 -UserName sa -Password sa

.EXAMPLE
"SQL01","SQL02","SQL03" | .\Get-SqlSysLogin.ps1 -UserName sa -Password sa
...
#>
  ...
  Param(
    ...
    [parameter(Position = 2)][string]$Password
    )
