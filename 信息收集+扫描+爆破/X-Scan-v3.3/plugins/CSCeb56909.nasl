...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"13191");
 script_xref(name:"IAVA", value:"2005-t-0002");
...
If IPv6 is enabled, an attacket may exploit this flaw to prevent the
...
else if ( vuln > 1 ) display("Problem in script $Id: CSCeb56909.nasl,v 1.8 2009/10/28 20:47:00 theall Exp $\n");
