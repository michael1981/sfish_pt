...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200804-02 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200804-02
...
script_end_attributes();
 ...
 script_summary(english: 'bzip2: Denial of Service');
 exit(0);
}
...
if (qpkg_check(package: "app-arch/bzip2", unaffected: make_list("ge 1.0.5"), vulnerable: make_list("lt 1.0.5")
