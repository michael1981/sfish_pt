...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"48019");
  script_xref(name:"OSVDB", value:"48020");
...
version is older than 1.0.5 and thus affected by multiple issues :
  ...
  - Due to a weakness in DNS protocol implementation, it may
    ...
    there are currently no known applications that use Bonjour 
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?dfd5604f (Apple Advisory)" );
