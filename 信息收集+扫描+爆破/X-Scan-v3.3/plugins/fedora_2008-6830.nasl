...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6830
#
...
script_name(english: "Fedora 8 2008-6830: trac");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6830 (trac)");
...
if ( rpm_check( reference:"trac-0.10.5-1.fc8", release:"FC8") )
{
