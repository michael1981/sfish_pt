...
'The remote host is missing the DSA-411 security update');
...
'Read http://www.debian.org/security/2004/dsa-411
...
deb_check(prefix: 'mpg321', release: '3.0', reference: '0.2.10.2');
