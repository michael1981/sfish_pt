...
#
# This plugin text was extracted from Fedora Security Advisory 2008-10913
#
...
script_name(english: "Fedora 10 2008-10913: java-1.6.0-openjdk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-10913 (java-1.6.0-openjdk)");
...
if ( rpm_check( reference:"java-1.6.0-openjdk-1.6.0.0-7.b12.fc10", release:"FC10") )
{
