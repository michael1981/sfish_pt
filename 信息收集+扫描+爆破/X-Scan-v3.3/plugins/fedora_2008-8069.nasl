...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8069
#
...
script_name(english: "Fedora 9 2008-8069: ssmtp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8069 (ssmtp)");
...
if ( rpm_check( reference:"ssmtp-2.61-11.6.fc9.1", release:"FC9") )
{
