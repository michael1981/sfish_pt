...
if (description)
{
  ...
  script_name(english:"eDirectory eMBox Utility Unauthorized Access");
  script_summary(english:"Checks version of eDirectory service embox.nlm");
 
  script_set_attribute(
    attribute:"synopsis",
    value:string(
      "The remote host has an application installed that may allow unauthorized\n",
  ...
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade to eDirectory 8.8.2 or rename 'embox.nlm'."
  );
  script_set_attribute(
