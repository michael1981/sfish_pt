...
#
# This plugin text was extracted from Fedora Security Advisory 2007-068
#
...
script_name(english: "Fedora 5 2007-068: mono");
...
if ( rpm_check( reference:"mono-1.1.13.7-3.fc5.1", release:"FC5") )
{
