...
'The remote host is missing the DSA-1041 security update');
...
'The Debian project recommends that you upgrade your abc2ps package.');
...
deb_check(prefix: 'abc2ps', release: '3.0', reference: '1.3.3-2woody1');
deb_check(prefix: 'abc2ps', release: '3.1', reference: '1.3.3-3sarge1');
