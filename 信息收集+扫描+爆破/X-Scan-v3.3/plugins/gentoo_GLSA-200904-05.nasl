...
#  http://www.gentoo.org/security/en/glsa/glsa-200904-05.xml
...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200904-05 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200904-05
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-0021');
script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200902-02.xml');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200904-05.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'ntp: Certificate validation error');
 exit(0);
}
...
if (qpkg_check(package: "net-misc/ntp", unaffected: make_list("ge 4.2.4_p6"), vulnerable: make_list("lt 4.2.4_p6")
