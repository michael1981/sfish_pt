...
if(description)
{
 ...
 script_name(english: "RHSA-2007-0497: iscsi");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2007-0497");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2007-0497.html");
script_set_attribute(attribute: "solution", value: "Get the newest RedHat Updates.");
script_end_attributes();

script_cve_id("CVE-2007-3099", "CVE-2007-3100");
script_summary(english: "Check for the version of the iscsi packages");
