...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3333
#
...
script_name(english: "Fedora 8 2008-3333: dbmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3333 (dbmail)");
...
if ( rpm_check( reference:"dbmail-2.2.9-1.fc8", release:"FC8") )
{
