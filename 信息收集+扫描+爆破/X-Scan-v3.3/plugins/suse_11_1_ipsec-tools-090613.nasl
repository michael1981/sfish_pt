...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  ipsec-tools (2009-06-13)");
...
if ( rpm_check( reference:"ipsec-tools-0.7.1-10.49.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"ipsec-tools-0.7.1-10.49.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
