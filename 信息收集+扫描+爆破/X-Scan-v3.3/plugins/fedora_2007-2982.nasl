...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2982
#
...
script_name(english: "Fedora 8 2007-2982: cups");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2982 (cups)");
...
t of the CUPS scheduler, as well as several PDF handling security issues.
");
...
if ( rpm_check( reference:"cups-1.3.4-2.fc8", release:"FC8") )
{
