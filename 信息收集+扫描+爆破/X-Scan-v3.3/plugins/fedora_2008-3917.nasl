...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3917
#
...
script_name(english: "Fedora 8 2008-3917: rdesktop");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3917 (rdesktop)");
...
if ( rpm_check( reference:"rdesktop-1.6.0-1.fc8", release:"FC8") )
{
