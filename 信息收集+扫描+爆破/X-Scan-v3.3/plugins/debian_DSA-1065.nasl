...
'The remote host is missing the DSA-1065 security update');
...
'The Debian project recommends that you upgrade your hostapd package.');
...
deb_check(prefix: 'hostapd', release: '3.1', reference: '0.3.7-2sarge1');
