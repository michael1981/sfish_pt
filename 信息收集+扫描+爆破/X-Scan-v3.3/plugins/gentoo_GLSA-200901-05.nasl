...
#  http://www.gentoo.org/security/en/glsa/glsa-200901-05.xml
...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200901-05 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200901-05
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-4829');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200901-05.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'Streamripper: Multiple vulnerabilities');
 exit(0);
}
...
if (qpkg_check(package: "media-sound/streamripper", unaffected: make_list("ge 1.64.0"), vulnerable: make_list("lt 1.64.0")
