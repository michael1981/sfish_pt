...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8529
#
...
script_name(english: "Fedora 11 2009-8529: wordpress-mu");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8529 (wordpress-mu)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2009-2334", "CVE-2009-2336");
...
if ( rpm_check( reference:"wordpress-mu-2.8.4a-1.fc11", release:"FC11") )
{
