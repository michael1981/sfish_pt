...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"56247");
...
user's privileges.");
  ...
  script_set_attribute(attribute:"see_also", 
    value:"http://labs.idefense.com/intelligence/vulnerabilities/display.php?id=813" );
  script_set_attribute(attribute:"see_also", 
    value:"http://archives.neohapsis.com/archives/bugtraq/2009-07/0166.html" );
