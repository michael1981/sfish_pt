...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11602
#
...
script_name(english: "Fedora 9 2008-11602: phpPgAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11602 (phpPgAdmin)");
...
if ( rpm_check( reference:"phpPgAdmin-4.2.2-1.fc9", release:"FC9") )
{
