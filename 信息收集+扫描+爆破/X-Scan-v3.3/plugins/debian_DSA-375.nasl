...
'The remote host is missing the DSA-375 security update');
...
'The Debian project recommends that you upgrade your node packages immediately.');
...
deb_check(prefix: 'node', release: '3.0', reference: '0.3.0a-2woody1');
