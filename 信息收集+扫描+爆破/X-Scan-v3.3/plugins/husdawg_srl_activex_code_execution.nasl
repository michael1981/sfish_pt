...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"50119");
  script_xref(name:"OSVDB", value:"50120");
  script_xref(name:"OSVDB", value:"50121");
  script_xref(name:"OSVDB", value:"50122");
...
'sysreqlab2.dll' is affected by this issue." );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/166651" );
