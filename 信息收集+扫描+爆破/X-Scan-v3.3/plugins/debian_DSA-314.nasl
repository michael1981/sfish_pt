...
'The remote host is missing the DSA-314 security update');
...
'Read http://www.debian.org/security/2003/dsa-314
...
deb_check(prefix: 'atftp', release: '3.0', reference: '0.6.0woody1');
deb_check(prefix: 'atftpd', release: '3.0', reference: '0.6.0woody1');
deb_check(prefix: 'atftp', release: '3.0', reference: '0.6.1.1.0woody1');
