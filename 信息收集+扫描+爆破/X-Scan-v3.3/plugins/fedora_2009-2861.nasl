...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2861
#
...
script_name(english: "Fedora 9 2009-2861: weechat");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2861 (weechat)");
...
if ( rpm_check( reference:"weechat-0.2.6.1-1.fc9", release:"FC9") )
{
