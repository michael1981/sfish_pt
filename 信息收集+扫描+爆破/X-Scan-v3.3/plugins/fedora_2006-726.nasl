...
#
# This plugin text was extracted from Fedora Security Advisory 2006-726
#
...
script_name(english: "Fedora 5 2006-726: kdebase");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-726 (kdebase)");
...
* Thu Jun 15 2006 Than Ngo <than redhat com> 6:3.5.3-0.3.fc5
- fix BR
");
...
if ( rpm_check( reference:"kdebase-3.5.3-0.3.fc5", release:"FC5") )
{
