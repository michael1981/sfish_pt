...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4501
#
...
script_name(english: "Fedora 9 2008-4501: cbrpager");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4501 (cbrpager)");
...
if ( rpm_check( reference:"cbrpager-0.9.17-2.fc9", release:"FC9") )
{
