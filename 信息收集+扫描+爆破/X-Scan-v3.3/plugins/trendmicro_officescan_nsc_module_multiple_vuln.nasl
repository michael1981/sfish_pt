...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"53191");
  script_xref(name:"OSVDB", value:"53192");
  script_xref(name:"OSVDB", value:"53193");
...
Micro OfficeScan Client.  The installed version is affected by
