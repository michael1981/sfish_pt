...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1283
#
...
script_name(english: "Fedora 8 2008-1283: kdebase");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1283 (kdebase)");
...
if ( rpm_check( reference:"kdebase-3.5.8-31.fc8", release:"FC8") )
{
