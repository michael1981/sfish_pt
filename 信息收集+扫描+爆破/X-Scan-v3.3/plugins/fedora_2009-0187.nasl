...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0187
#
...
script_name(english: "Fedora 9 2009-0187: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0187 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-2.0.0.19-1.fc9", release:"FC9") )
{
