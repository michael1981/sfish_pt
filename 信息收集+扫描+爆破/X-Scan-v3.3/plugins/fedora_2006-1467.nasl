...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1467
#
...
script_name(english: "Fedora 5 2006-1467: gdm");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1467 (gdm)");
...
if ( rpm_check( reference:"gdm-2.14.11-1.fc5", release:"FC5") )
{
