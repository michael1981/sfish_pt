...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_34098");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_34098 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.50 PA RISC Consolidated Patch 3");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_34098");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_34098");
...
if ( hpux_patch_installed (patches:"PHSS_34098 PHSS_34870 ") )
{
 exit(0);
}
