# This script was automatically generated from the dsa-1723
...
'The remote host is missing the DSA-1723 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1723] DSA-1723-1 phpmyadmin");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1723-1 phpmyadmin");
 exit(0);
}
...
deb_check(prefix: 'phpmyadmin', release: '4.0', reference: '2.9.1.1-10');
