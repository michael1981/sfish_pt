...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0469
#
...
script_name(english: "Fedora 7 2008-0469: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0469 (drupal)");
...
if ( rpm_check( reference:"drupal-5.6-1.fc7", release:"FC7") )
{
