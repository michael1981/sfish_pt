...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9313
#
...
script_name(english: "Fedora 9 2008-9313: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9313 (openoffice.org)");
...
if ( rpm_check( reference:"openoffice.org-2.4.2-18.1.fc9", release:"FC9") )
{
