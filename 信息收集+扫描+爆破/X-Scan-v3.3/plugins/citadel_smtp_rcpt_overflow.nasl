...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"40516");
...
affected service or even execution of arbitrary code." );
 script_set_attribute(attribute:"see_also", value:"http://www.milw0rm.com/exploits/4949" );
 script_set_attribute(attribute:"see_also", value:"http://article.gmane.org/gmane.comp.cms.citadel.devel/2518" );
 script_set_attribute(attribute:"see_also", value:"http://article.gmane.org/gmane.comp.cms.citadel.devel/2569" );
 script_set_attribute(attribute:"see_also", value:"http://article.gmane.org/gmane.comp.cms.citadel.user/3463" );
