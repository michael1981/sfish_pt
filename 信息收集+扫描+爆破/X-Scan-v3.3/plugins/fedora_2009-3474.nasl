...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3474
#
...
script_name(english: "Fedora 10 2009-3474: wordpress-mu");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3474 (wordpress-mu)");
...
if ( rpm_check( reference:"wordpress-mu-2.6.5-2.fc10", release:"FC10") )
{
