...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3253
#
...
script_name(english: "Fedora 8 2007-3253: tomboy");
...
if ( rpm_check( reference:"tomboy-0.8.1-3.fc8", release:"FC8") )
{
