...
if(description)
{
 ...
 script_name(english: "Solaris 5.10 (sparc) : 122073-04");
...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"122073-04", obsoleted_by:"", package:"VRTSnetbp", version:"6.0,REV=2006.11.09.18.12");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
