...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3056
#
...
script_name(english: "Fedora 7 2007-3056: emacs");
...
if ( rpm_check( reference:"emacs-22.1-5.fc7", release:"FC7") )
{
