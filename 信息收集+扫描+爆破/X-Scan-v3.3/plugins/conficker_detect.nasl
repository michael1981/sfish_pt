...
if(description)
{
 ...
 script_name(english:"Conficker Detection - Network check");
...
Update your Antivirus and perform a full scan of the remote operating system.");
 script_set_attribute(attribute:"see_also", value:"http://iv.cs.uni-bonn.de/wg/cs/applications/containing-conficker/");
...
if ( login && password )
 r = NetUseAdd(share:"IPC$", login:login, password:password);
else
