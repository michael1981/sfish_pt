...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  strongswan (2009-03-24)");
...
if ( rpm_check( reference:"strongswan-4.2.1-11.6", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"strongswan-4.2.1-11.6", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"strongswan-doc-4.2.1-11.6", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"strongswan-doc-4.2.1-11.6", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
