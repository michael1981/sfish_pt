...
'The remote host is missing the DSA-102 security update');
...
'The Debian project recommends that you upgrade your at packages.');
...
deb_check(prefix: 'at', release: '2.2', reference: '3.1.8-10.2');
