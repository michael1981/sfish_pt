...
if (description)
{
  ...
  script_name(english:"FuseTalk index.cfm txForumID Variable SQL Injection");
...
to launch SQL injection attacks against the affected application." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2007-06/0227.html" );
