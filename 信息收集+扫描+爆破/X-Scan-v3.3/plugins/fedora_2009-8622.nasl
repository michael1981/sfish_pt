...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8622
#
...
script_name(english: "Fedora 10 2009-8622: gnutls");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8622 (gnutls)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-4989", "CVE-2009-2730");
...
if ( rpm_check( reference:"gnutls-2.4.2-5.fc10", release:"FC10") )
{
