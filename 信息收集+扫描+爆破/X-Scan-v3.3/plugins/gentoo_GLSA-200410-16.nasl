...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200410-16 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200410-16
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2004-0977');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200410-16.xml');
...
if (qpkg_check(package: "dev-db/postgresql", unaffected: make_list("ge 7.4.5-r2", "rge 7.3.7-r2", "rge 7.3.15", "rge 7.3.16", "rge 7.3.18", "rge 7.3.21"), vulnerable: make_list("le 7.4.5-r1")
