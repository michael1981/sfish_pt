...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for freetype2 (freetype2-1918)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch freetype2-1918");
script_end_attributes();

script_cve_id("CVE-2006-3467");
script_summary(english: "Check for the freetype2-1918 package");
