...
if(description)
{
 ...
 name["english"] = "Fedora Core 3 2005-1072: sysreport";
...
"The remote host is missing the patch for the advisory FEDORA-2005-1072 (sysreport).
...
include("rpm.inc");
if ( rpm_check( reference:"sysreport-1.3.13-2", prefix:"sysreport-", release:"FC3") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_exists(rpm:"sysreport-", release:"FC3") )
{
