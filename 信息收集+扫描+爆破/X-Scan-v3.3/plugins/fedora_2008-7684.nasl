...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7684
#
...
script_name(english: "Fedora 8 2008-7684: awstats");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7684 (awstats)");
...
if ( rpm_check( reference:"awstats-6.8-2.fc8", release:"FC8") )
{
