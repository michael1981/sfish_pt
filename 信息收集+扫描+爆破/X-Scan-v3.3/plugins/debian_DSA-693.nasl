...
'The remote host is missing the DSA-693 security update');
...
'The Debian project recommends that you upgrade your luxman package.');
...
deb_check(prefix: 'luxman', release: '3.0', reference: '0.41-17.2');
