...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0572
#
...
script_name(english: "Fedora 8 2008-0572: tog-pegasus");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0572 (tog-pegasus)");
...
* Thu Jan 10 2008 Vitezslav Crhonek <vcrhonek redhat com> - 2.6.1-3
...
if ( rpm_check( reference:"tog-pegasus-2.6.1-3.fc8", release:"FC8") )
{
