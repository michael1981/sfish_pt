...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  festival security update (festival-4377)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch festival-4377");
script_end_attributes();

script_cve_id("CVE-2007-4074");
script_summary(english: "Check for the festival-4377 package");
