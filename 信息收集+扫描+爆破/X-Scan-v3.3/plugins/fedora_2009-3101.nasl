...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3101
#
...
script_name(english: "Fedora 9 2009-3101: seamonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3101 (seamonkey)");
...
if ( rpm_check( reference:"seamonkey-1.1.15-3.fc9", release:"FC9") )
{
