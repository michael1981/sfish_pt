...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9342
#
...
script_name(english: "Fedora 11 2009-9342: libsilc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9342 (libsilc)");
...
if ( rpm_check( reference:"libsilc-1.1.8-7.fc11", release:"FC11") )
{
