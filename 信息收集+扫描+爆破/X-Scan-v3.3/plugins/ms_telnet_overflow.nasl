...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"2043");
 
  script_name(english:"MS02-004: Microsoft Telnet Server Protocol Option Handling Remote Overflow");
...
the telnet service." );
 script_set_attribute(attribute:"see_also", value:"http://www.microsoft.com/technet/security/bulletin/ms02-004.mspx" );
