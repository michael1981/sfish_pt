...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4259
#
...
script_name(english: "Fedora 9 2008-4259: gnutls");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4259 (gnutls)");
...
if ( rpm_check( reference:"gnutls-2.0.4-3.fc9", release:"FC9") )
{
