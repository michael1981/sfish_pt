...
#
# This plugin text was extracted from Fedora Security Advisory 2007-617
#
...
script_name(english: "Fedora 5 2007-617: httpd");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-3747", "CVE-2006-5752", "CVE-2007-1863", "CVE-2007-3304");
...
if ( rpm_check( reference:"httpd-manual-2.2.2-1.3", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"httpd-2.2.2-1.3", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"httpd-devel-2.2.2-1.3", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"mod_ssl-2.2.2-1.3", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
