...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  OpenEXR (2009-08-04)");
...
if ( rpm_check( reference:"OpenEXR-1.6.1-83.17.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"OpenEXR-1.6.1-83.17.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
