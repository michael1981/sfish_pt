...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6519
#
...
script_name(english: "Fedora 9 2008-6519: seamonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6519 (seamonkey)");
...
for Fedora 9.    An integer overflow flaw was found in the way Seamonkey
...
if ( rpm_check( reference:"seamonkey-1.1.11-1.fc9", release:"FC9") )
{
