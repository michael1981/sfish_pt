...
'The remote host is missing the DSA-945 security update');
...
'The Debian project recommends that you upgrade your antiword package.');
...
deb_check(prefix: 'antiword', release: '3.0', reference: '0.32-2woody0');
deb_check(prefix: 'antiword', release: '3.1', reference: '0.35-2sarge1');
