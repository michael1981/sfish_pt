...
#
# This plugin text was extracted from Fedora Security Advisory 2007-0894
#
...
script_name(english: "Fedora 7 2007-0894: wordpress");
...
if ( rpm_check( reference:"wordpress-2.2.1-1.fc7", release:"FC7") )
{
