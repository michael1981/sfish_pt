...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"2717");
...
code on the web server." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2003-10/0262.html" );
...
{
  res = http_send_recv3(method:"GET", item:string(dir, "/new-visitor.inc.php?lvc_include_dir=http://xxxxxxxx"), port:port);
