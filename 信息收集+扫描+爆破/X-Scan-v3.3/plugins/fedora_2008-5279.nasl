...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5279
#
...
script_name(english: "Fedora 8 2008-5279: xorg-x11-server");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5279 (xorg-x11-server)");
...
if ( rpm_check( reference:"xorg-x11-server-1.3.0.0-46.fc8", release:"FC8") )
{
