...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"6047");
  script_xref(name:"milw0rm", value:"6048");
  script_xref(name:"milw0rm", value:"6049");
  script_xref(name:"milw0rm", value:"6050");
  script_xref(name:"milw0rm", value:"6051");
  script_xref(name:"milw0rm", value:"6061");
  script_xref(name:"milw0rm", value:"6062");
  script_xref(name:"milw0rm", value:"6063");
  script_xref(name:"milw0rm", value:"6064");
  script_xref(name:"milw0rm", value:"6065");
  script_xref(name:"milw0rm", value:"6066");
  script_xref(name:"OSVDB", value:"47011");
  script_xref(name:"OSVDB", value:"47019");
  script_xref(name:"OSVDB", value:"47029");
  script_xref(name:"OSVDB", value:"47030");
  script_xref(name:"OSVDB", value:"47031");
  script_xref(name:"OSVDB", value:"47032");
  script_xref(name:"OSVDB", value:"47033");
  script_xref(name:"OSVDB", value:"47034");
  script_xref(name:"OSVDB", value:"57442");
...
and access the admin control panel by simply setting a special cookie." );
 script_set_attribute(attribute:"see_also", value:"http://www.maianscriptworld.co.uk/news.html" );
