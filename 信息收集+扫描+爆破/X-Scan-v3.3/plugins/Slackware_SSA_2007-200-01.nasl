# This script was automatically generated from the SSA-2007-200-01
...
'The remote host is missing the SSA-2007-200-01 security update');
...
script_summary("SSA-2007-200-01 firefox ");
script_name(english: "SSA-2007-200-01 firefox ");
...
extrarep = NULL;
if (slackware_check(osver: "11.0", pkgname: "mozilla-firefox", pkgver: "2.0.0.5", pkgnum:  "1", pkgarch: "i686")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package mozilla-firefox is vulnerable in Slackware 11.0
Upgrade to mozilla-firefox-2.0.0.5-i686-1 or newer.
');
}
if (slackware_check(osver: "12.0", pkgname: "mozilla-firefox", pkgver: "2.0.0.5", pkgnum:  "1", pkgarch: "i686")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
