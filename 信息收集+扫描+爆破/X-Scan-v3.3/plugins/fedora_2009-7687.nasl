...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7687
#
...
script_name(english: "Fedora 11 2009-7687: bugzilla");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7687 (bugzilla)");
...
if ( rpm_check( reference:"bugzilla-3.2.4-1.fc11", release:"FC11") )
{
