...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0796
#
...
script_name(english: "Fedora 7 2008-0796: mantis");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0796 (mantis)");
...
New upstream release, also fixes a minor security issue detailed in: [9]http://
bugs.mantisbt.org/view.php?id=8756
");
...
if ( rpm_check( reference:"mantis-1.1.1-1.fc7", release:"FC7") )
{
