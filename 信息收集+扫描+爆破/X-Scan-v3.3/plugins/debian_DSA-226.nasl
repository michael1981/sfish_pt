...
'The remote host is missing the DSA-226 security update');
...
'The Debian project recommends that you upgrade your xpdf-i package.');
...
deb_check(prefix: 'xpdf-i', release: '2.2', reference: '0.90-8.1');
