...
#
# This plugin text was extracted from Fedora Security Advisory 2009-4883
#
...
script_name(english: "Fedora 9 2009-4883: opensc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-4883 (opensc)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-2235", "CVE-2009-0368");
...
if ( rpm_check( reference:"opensc-0.11.8-1.fc9", release:"FC9") )
{
