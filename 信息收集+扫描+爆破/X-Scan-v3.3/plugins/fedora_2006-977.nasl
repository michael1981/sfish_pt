...
#
# This plugin text was extracted from Fedora Security Advisory 2006-977
#
...
script_name(english: "Fedora 5 2006-977: thunderbird");
...
if ( rpm_check( reference:"thunderbird-1.5.0.7-1.fc5", release:"FC5") )
{
