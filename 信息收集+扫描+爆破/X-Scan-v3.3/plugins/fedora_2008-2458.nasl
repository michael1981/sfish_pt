...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2458
#
...
script_name(english: "Fedora 7 2008-2458: ruby");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2458 (ruby)");
...
if ( rpm_check( reference:"ruby-1.8.6.114-1.fc7", release:"FC7") )
{
