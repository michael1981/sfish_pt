...
'The remote host is missing the DSA-705 security update');
...
'The Debian project recommends that you upgrade your wu-ftpd package.');
...
deb_check(prefix: 'wu-ftpd', release: '3.0', reference: '2.6.2-3woody5');
deb_check(prefix: 'wu-ftpd-academ', release: '3.0', reference: '2.6.2-3woody5');
