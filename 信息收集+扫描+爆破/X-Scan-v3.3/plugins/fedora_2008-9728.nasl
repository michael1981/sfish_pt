...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9728
#
...
script_name(english: "Fedora 9 2008-9728: htop");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9728 (htop)");
...
if ( rpm_check( reference:"htop-0.8.1-2.fc9", release:"FC9") )
{
