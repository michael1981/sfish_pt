...
#  http://www.gentoo.org/security/en/glsa/glsa-200809-08.xml
...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200809-08 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200809-08
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-3699');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200809-08.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'Amarok: Insecure temporary file creation');
 exit(0);
}
...
if (qpkg_check(package: "media-sound/amarok", unaffected: make_list("ge 1.4.10"), vulnerable: make_list("lt 1.4.10")
