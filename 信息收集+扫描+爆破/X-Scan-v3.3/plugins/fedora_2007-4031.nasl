...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4031
#
...
script_name(english: "Fedora 8 2007-4031: poppler");
...
if ( rpm_check( reference:"poppler-0.6.2-1.fc8", release:"FC8") )
{
