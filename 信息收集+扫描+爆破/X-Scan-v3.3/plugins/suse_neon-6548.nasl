...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for neon (neon-6548)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch neon-6548");
...
script_set_attribute(attribute: "solution", value: "Install the security patch neon-6548");
script_end_attributes();

script_cve_id("CVE-2009-2408", "CVE-2009-2473");
script_summary(english: "Check for the neon-6548 package");
...
if ( rpm_check( reference:"neon-0.24.7-20.8.1", release:"SLES10") )
{
