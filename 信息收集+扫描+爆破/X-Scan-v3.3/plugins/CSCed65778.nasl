...
if(description)
{
 ...
 script_xref(name:"IAVA", value:"2005-B-0009");
 script_xref(name:"OSVDB", value:"15302");
 script_xref(name:"OSVDB", value:"15303");
...
else if ( vuln > 1 )  display("Problem in script $Id: CSCed65778.nasl,v 1.8 2009/10/20 21:05:19 mikhail Exp $\n");
