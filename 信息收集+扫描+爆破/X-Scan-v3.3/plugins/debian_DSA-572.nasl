...
'The remote host is missing the DSA-572 security update');
...
'The Debian project recommends that you upgrade your ecartis package.');
...
deb_check(prefix: 'ecartis', release: '3.0', reference: '0.129a+1.0.0-snap20020514-1.3');
deb_check(prefix: 'ecartis-cgi', release: '3.0', reference: '0.129a+1.0.0-snap20020514-1.3');
