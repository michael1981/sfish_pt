...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8575
#
...
script_name(english: "Fedora 9 2008-8575: libxml2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8575 (libxml2)");
...
if ( rpm_check( reference:"libxml2-2.7.1-2.fc9", release:"FC9") )
{
