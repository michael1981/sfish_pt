...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_32960");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_32960 security update");
 script_set_attribute(attribute: "description", value:
"Xserver cumulative patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_32960");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_32960");
...
if ( hpux_patch_installed (patches:"PHSS_32960 PHSS_35253 PHSS_35966 PHSS_36452 PHSS_37971 PHSS_37972 PHSS_39257 ") )
{
 exit(0);
}
