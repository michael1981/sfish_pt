...
if(description)
{
 ...
 script_name(english: "RHSA-2009-0458: gpdf");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2009-0458");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2009-0458.html");
...
if ( rpm_check( reference:"gpdf-2.8.2-7.7.2.el4_7.4", release:'RHEL4') )
{
