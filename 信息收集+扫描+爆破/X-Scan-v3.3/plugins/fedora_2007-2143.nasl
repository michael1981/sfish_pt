...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2143
#
...
script_name(english: "Fedora 7 2007-2143: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2143 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.2.3-0.fc7", release:"FC7") )
{
