...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3003
#
...
script_name(english: "Fedora 9 2009-3003: compiz-fusion");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3003 (compiz-fusion)");
...
if ( rpm_check( reference:"compiz-fusion-0.7.6-6.fc9", release:"FC9") )
{
