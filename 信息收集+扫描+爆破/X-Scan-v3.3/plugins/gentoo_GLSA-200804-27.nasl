...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200804-27 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200804-27
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-1227');
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-1429');
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-1552');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200804-27.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'SILC: Multiple vulnerabilities');
 exit(0);
}
...
if (qpkg_check(package: "net-im/silc-client", unaffected: make_list("ge 1.1.4"), vulnerable: make_list("lt 1.1.4")
)) { security_hole(0); exit(0); }
if (qpkg_check(package: "net-im/silc-server", unaffected: make_list("ge 1.1.2"), vulnerable: make_list("lt 1.1.2")
)) { security_hole(0); exit(0); }
if (qpkg_check(package: "net-im/silc-toolkit", unaffected: make_list("ge 1.1.7"), vulnerable: make_list("lt 1.1.7")
)) { security_hole(0); exit(0); }
