...
if(description)
{
 ...
 script_name(english: "MDKSA-2003:102: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2003:102 (postgresql).");
 script_set_attribute(attribute: "description", value: "Two bugs were discovered that lead to a buffer overflow in PostgreSQL
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2003:102");
