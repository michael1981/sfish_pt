...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for opensc (opensc-5910)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch opensc-5910");
...
script_set_attribute(attribute: "solution", value: "Install the security patch opensc-5910");
script_end_attributes();

script_cve_id("CVE-2008-2235");
script_summary(english: "Check for the opensc-5910 package");
