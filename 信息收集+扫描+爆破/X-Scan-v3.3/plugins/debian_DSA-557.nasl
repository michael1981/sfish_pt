...
'The remote host is missing the DSA-557 security update');
...
'The Debian project recommends that you upgrade your pppoe package.');
...
deb_check(prefix: 'pppoe', release: '3.0', reference: '3.3-1.2');
deb_check(prefix: 'rp-pppoe,', release: '3.0', reference: '3.3-1.2');
