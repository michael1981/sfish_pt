...
if(description)
{
  ...
  script_name(english:"MS02-045: Microsoft Windows SMB Protocol SMB_COM_TRANSACTION Packet Remote Overflow DoS (326830)");
  ...
  script_set_attribute(
    ...
    value:"The remote host is vulnerable to a denial of service attack in
its SMB stack.
...
remotely, without any kind of authentication."
  ...
  script_set_attribute(
    attribute:'see_also',
    value:'http://www.microsoft.com/technet/security/bulletin/ms02-045.mspx'
  );
