...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHNE_38680");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHNE_38680 security update");
 script_set_attribute(attribute: "description", value:
"11.31 cumulative ARPA Transport patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//patches_with_warnings/hp-ux_patches/11.X/PHNE_38680");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHNE_38680");
...
if ( hpux_patch_installed (patches:"PHNE_38680 PHNE_39203 ") )
{
 exit(0);
}
...
if ( hpux_check_patch( app:"Networking.NET-RUN-64", version:"B.11.31") )
{
 security_hole(0);
 exit(0);
}
