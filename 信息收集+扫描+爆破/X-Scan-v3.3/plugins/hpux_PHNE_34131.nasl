...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHNE_34131");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHNE_34131 security update");
 script_set_attribute(attribute: "description", value:
"Cumulative STREAMS Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHNE_34131");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHNE_34131");
...
if ( hpux_patch_installed (patches:"PHNE_34131 PHNE_34777 PHNE_35453 PHNE_36576 ") )
{
 exit(0);
}
