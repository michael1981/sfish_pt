...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:109: wv2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:109 (wv2).");
 script_set_attribute(attribute: "description", value: "A boundary checking error was discovered in the wv2 library, used for
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:109");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2006-2197");
script_summary(english: "Check for the version of the wv2 package");
