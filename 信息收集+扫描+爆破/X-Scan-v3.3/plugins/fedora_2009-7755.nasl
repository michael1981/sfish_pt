...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7755
#
...
script_name(english: "Fedora 11 2009-7755: compat-wxGTK26");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7755 (compat-wxGTK26)");
...
if ( rpm_check( reference:"compat-wxGTK26-2.6.4-10.fc11", release:"FC11") )
{
