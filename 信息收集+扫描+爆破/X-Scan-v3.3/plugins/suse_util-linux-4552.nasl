...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  util-linux security update (util-linux-4552)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch util-linux-4552");
 script_set_attribute(attribute: "description", value: "Insufficient length checks when reading the passphrase for
...
script_set_attribute(attribute: "solution", value: "Install the security patch util-linux-4552");
script_end_attributes();

script_cve_id("CVE-2007-5191");
script_summary(english: "Check for the util-linux-4552 package");
