...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11433
#
...
script_name(english: "Fedora 9 2008-11433: libvirt");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11433 (libvirt)");
...
if ( rpm_check( reference:"libvirt-0.5.1-2.fc9", release:"FC9") )
{
