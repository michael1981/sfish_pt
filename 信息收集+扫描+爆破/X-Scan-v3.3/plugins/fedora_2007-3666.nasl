...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3666
#
...
script_name(english: "Fedora 7 2007-3666: phpMyAdmin");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.2.2-1.fc7", release:"FC7") )
{
