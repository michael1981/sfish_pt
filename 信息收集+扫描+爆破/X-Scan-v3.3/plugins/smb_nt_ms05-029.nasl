...
if(description)
{
 ...
 script_xref(name:"IAVA", value:"2005-t-0020");
 script_xref(name:"OSVDB", value:"17307");

 name["english"] = "MS05-029: Vulnerability in Exchange Server 5.5 Outlook Web Access XSS (895179)";
 script_name(english:name["english"]);

 script_set_attribute(attribute:"synopsis", value:
"The remote Web Server contains a script which is vulnerable to a
...
malicious script.  If this malicious script is run, it would execute
