...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11511
#
...
script_name(english: "Fedora 10 2008-11511: epiphany");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11511 (epiphany)");
...
builds of all applications depending on Gecko libraries, built against new
...
if ( rpm_check( reference:"epiphany-2.24.1-3.fc10", release:"FC10") )
{
