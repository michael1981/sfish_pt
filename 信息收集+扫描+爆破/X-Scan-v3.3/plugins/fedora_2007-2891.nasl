...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2891
#
...
script_name(english: "Fedora 8 2007-2891: xscreensaver");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2891 (xscreensaver)");
...
if ( rpm_check( reference:"xscreensaver-5.03-14.fc8", release:"FC8") )
{
