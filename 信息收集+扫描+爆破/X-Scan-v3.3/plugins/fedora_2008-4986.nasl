...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4986
#
...
script_name(english: "Fedora 9 2008-4986: snort");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4986 (snort)");
...
if ( rpm_check( reference:"snort-2.8.1-3.fc9", release:"FC9") )
{
