...
'The remote host is missing the DSA-799 security update');
...
'The Debian project recommends that you upgrade your webcalendar package immediately.');
...
deb_check(prefix: 'webcalendar', release: '3.1', reference: '0.9.45-4sarge2');
