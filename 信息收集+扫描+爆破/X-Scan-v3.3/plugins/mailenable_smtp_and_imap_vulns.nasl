...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"15308");
...
vulnerabilities:
  ...
  - An SMTP Malformed EHLO Request Denial Of Service Vulnerability
    ...
    to legitimate users." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2005-04/0070.html" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2005-04/0078.html" );
