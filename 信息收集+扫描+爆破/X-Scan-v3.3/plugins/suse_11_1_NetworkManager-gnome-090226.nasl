...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  NetworkManager-gnome (2009-02-26)");
...
script_set_attribute(attribute: "solution", value: "Run yast to install the security patch for NetworkManager-gnome");
...
script_summary(english: "Check for the NetworkManager-gnome package");
...
if ( rpm_check( reference:"NetworkManager-gnome-0.7.0.r1053-11.1.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"NetworkManager-gnome-0.7.0.r1053-11.1.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
