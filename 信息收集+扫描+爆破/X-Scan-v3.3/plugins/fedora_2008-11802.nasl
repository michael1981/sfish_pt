...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11802
#
...
script_name(english: "Fedora 9 2008-11802: mediawiki");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11802 (mediawiki)");
...
if ( rpm_check( reference:"mediawiki-1.13.3-42.fc9", release:"FC9") )
{
