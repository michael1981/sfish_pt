...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2418
#
...
script_name(english: "Fedora 9 2009-2418: bugzilla");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2418 (bugzilla)");
...
if ( rpm_check( reference:"bugzilla-3.2.2-2.fc9", release:"FC9") )
{
