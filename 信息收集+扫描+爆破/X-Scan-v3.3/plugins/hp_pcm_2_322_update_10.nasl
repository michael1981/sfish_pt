...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"53596");
  ...
  script_set_attribute(
    attribute:"synopsis",
    value:string(
      "The remote Windows contains an application that is affected by an\n",
  ...
  script_set_attribute(
    attribute:"see_also", 
    value:"http://cdn.procurve.com/training/Manuals/PCM23_u10-Release-Notes-0309.pdf"
  );
  script_set_attribute(
    attribute:"see_also", 
