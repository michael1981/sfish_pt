...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:233: apache2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:233 (apache2).");
 script_set_attribute(attribute: "description", value: "A memory leak in the worker MPM in Apache 2 could allow remote
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:233");
