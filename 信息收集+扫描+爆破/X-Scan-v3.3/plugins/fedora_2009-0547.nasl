...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0547
#
...
script_name(english: "Fedora 9 2009-0547: ntp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0547 (ntp)");
...
if ( rpm_check( reference:"ntp-4.2.4p6-1.fc9", release:"FC9") )
{
