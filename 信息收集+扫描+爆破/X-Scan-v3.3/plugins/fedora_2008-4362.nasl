...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4362
#
...
script_name(english: "Fedora 9 2008-4362: vsftpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4362 (vsftpd)");
...
if ( rpm_check( reference:"vsftpd-2.0.6-4.fc9", release:"FC9") )
{
