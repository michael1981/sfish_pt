...
#
# This plugin text was extracted from Fedora Security Advisory 2006-490
#
...
script_name(english: "Fedora 5 2006-490: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-490 (thunderbird)");
...
packages containing Thunderbird version 1.5.0.2, which is not
...
if ( rpm_check( reference:"thunderbird-1.5.0.2-1.1.fc5", release:"FC5") )
{
