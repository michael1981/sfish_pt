...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_35434");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_35434 security update");
 script_set_attribute(attribute: "description", value:
"CDE Applications Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_35434");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_35434");
...
if ( hpux_patch_installed (patches:"PHSS_35434 PHSS_36407 ") )
{
 exit(0);
}
