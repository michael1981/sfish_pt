...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"10824");
 script_xref(name:"OSVDB", value:"10827");
...
This vulnerability could be exploited to crash the web server. It might
even be possible to execute arbitrary code on your system.
