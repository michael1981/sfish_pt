...
'The remote host is missing the DSA-565 security update');
...
'The Debian project recommends that you upgrade your sox package.');
...
deb_check(prefix: 'sox', release: '3.0', reference: '12.17.3-4woody2');
deb_check(prefix: 'sox-dev', release: '3.0', reference: '12.17.3-4woody2');
