...
if (description)
{
  ...
  script_cve_id('CVE-2009-0901', 'CVE-2009-2395', 'CVE-2009-2493');
  script_bugtraq_id(35845);

  script_name(english:'Shockwave Player APSB09-11');
  script_summary(english:'Checks version of Shockwave Player');

  script_set_attribute(
    attribute:'synopsis',
    value:string(
      'The remote Windows host contains an Internet Explorer plugin which uses\n',
      'a vulnerable version of the Microsoft Active Template Library (ATL).'
    )
  );
  script_set_attribute(
    ...
    value:string(
      ...
      'that is earlier than 11.5.0.601.  Such versions were compiled against\n',
      'a version of Microsoft\'s Active Template Library (ATL) which contained\n',
      'a vulnerability. If an attacker can trick a user of the affected software\n',
      'into opening such a file, this issue could be leveraged to execute\n',
      'arbitrary code with the privileges of that user.'
    )
  );
  script_set_attribute(
    attribute:'see_also',
