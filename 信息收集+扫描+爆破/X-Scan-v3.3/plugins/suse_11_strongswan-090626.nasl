...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  strongswan (2009-06-26)");
...
if ( rpm_check( reference:"strongswan-4.2.8-1.24.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"strongswan-doc-4.2.8-1.24.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
