...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"13192");

 script_xref(name:"IAVA", value:"2005-B-0003");
...
else if ( vuln > 1 )  display("Problem in script $Id: CSCee67450.nasl,v 1.8 2009/10/28 20:47:00 theall Exp $\n");
