...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1012
#
...
script_name(english: "Fedora 5 2006-1012: mono");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1012 (mono)");
...
if ( rpm_check( reference:"mono-1.1.13.7-2.fc5.1", release:"FC5") )
{
