...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for mutt (mutt-3752)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch mutt-3752");
script_end_attributes();

script_cve_id("CVE-2007-1558");
script_summary(english: "Check for the mutt-3752 package");
