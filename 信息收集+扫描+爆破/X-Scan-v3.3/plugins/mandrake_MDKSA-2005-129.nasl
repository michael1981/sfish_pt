...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:129: apache2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:129 (apache2).");
 script_set_attribute(attribute: "description", value: "Marc Stern reported an off-by-one overflow in the mod_ssl CRL
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:129");
