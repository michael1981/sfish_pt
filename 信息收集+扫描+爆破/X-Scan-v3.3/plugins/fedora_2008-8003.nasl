...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8003
#
...
script_name(english: "Fedora 9 2008-8003: ipa");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8003 (ipa)");
...
if ( rpm_check( reference:"ipa-1.1.0-7.fc9", release:"FC9") )
{
