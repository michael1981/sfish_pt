...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"57493");
  script_xref(name:"OSVDB", value:"57499");
...
vulnerabilities. 
  ...
  - A vulnerability in PureMessage could abruptly terminate 
    ...
    certain TNEF-encoded messages with plain text" );
 script_set_attribute(attribute:"see_also", value:"http://www.sophos.com/support/knowledgebase/article/44385.html" );
