...
'The remote host is missing the DSA-831 security update');
...
'The Debian project recommends that you upgrade your mysql-dfsg packages.');
...
deb_check(prefix: 'libmysqlclient12', release: '3.1', reference: '4.0.24-10sarge1');
deb_check(prefix: 'libmysqlclient12-dev', release: '3.1', reference: '4.0.24-10sarge1');
deb_check(prefix: 'mysql-client', release: '3.1', reference: '4.0.24-10sarge1');
deb_check(prefix: 'mysql-common', release: '3.1', reference: '4.0.24-10sarge1');
deb_check(prefix: 'mysql-server', release: '3.1', reference: '4.0.24-10sarge1');
