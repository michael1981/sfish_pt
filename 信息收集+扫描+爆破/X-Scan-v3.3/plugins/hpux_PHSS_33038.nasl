...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_33038");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_33038 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.01 Patch for Mar-05");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_33038");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_33038");
...
if ( hpux_patch_installed (patches:"PHSS_33038 PHSS_33392 PHSS_33842 PHSS_35579 PHSS_36773 PHSS_38761 ") )
{
 exit(0);
}
