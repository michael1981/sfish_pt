...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0350
#
...
script_name(english: "Fedora 9 2009-0350: bind");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0350 (bind)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-1447", "CVE-2009-0025");
...
if ( rpm_check( reference:"bind-9.5.1-1.P1.fc9", release:"FC9") )
{
