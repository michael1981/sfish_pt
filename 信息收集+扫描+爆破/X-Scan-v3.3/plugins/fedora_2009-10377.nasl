...
#
# This plugin text was extracted from Fedora Security Advisory 2009-10377
#
...
script_name(english: "Fedora 10 2009-10377: python-markdown2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-10377 (python-markdown2)");
...
if ( rpm_check( reference:"python-markdown2-1.0.1.15-1.fc10", release:"FC10") )
{
