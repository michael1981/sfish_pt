...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11220
#
...
script_name(english: "Fedora 8 2008-11220: roundcubemail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11220 (roundcubemail)");
...
if ( rpm_check( reference:"roundcubemail-0.2-4.beta.fc8", release:"FC8") )
{
