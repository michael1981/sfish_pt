...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0897
#
...
script_name(english: "Fedora 9 2009-0897: tor");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0897 (tor)");
...
if ( rpm_check( reference:"tor-0.2.0.33-1.fc9", release:"FC9") )
{
