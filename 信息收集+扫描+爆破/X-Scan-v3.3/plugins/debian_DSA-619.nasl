...
'The remote host is missing the DSA-619 security update');
...
'The Debian project recommends that you upgrade your xpdf package immediately.');
...
deb_check(prefix: 'xpdf', release: '3.0', reference: '1.00-3.3');
deb_check(prefix: 'xpdf-common', release: '3.0', reference: '1.00-3.3');
deb_check(prefix: 'xpdf-reader', release: '3.0', reference: '1.00-3.3');
deb_check(prefix: 'xpdf-utils', release: '3.0', reference: '1.00-3.3');
