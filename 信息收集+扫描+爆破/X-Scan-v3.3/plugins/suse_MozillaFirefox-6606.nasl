...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Mozilla Firefox (MozillaFirefox-6606)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-6606");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-6606");
...
script_summary(english: "Check for the MozillaFirefox-6606 package");
...
if ( rpm_check( reference:"MozillaFirefox-3.5.4-1.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-3.5.4-1.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-xulrunner191-1.9.1.4-2.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-xulrunner191-gnomevfs-1.9.1.4-2.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-xulrunner191-translations-1.9.1.4-2.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
