...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4216
#
...
script_name(english: "Fedora 8 2007-4216: ruby-gnome2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4216 (ruby-gnome2)");
...
if ( rpm_check( reference:"ruby-gnome2-0.16.0-18.fc8", release:"FC8") )
{
