...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"14659");

  script_name(english:"XEROX Document Centre Web Server Unspecified Unauthorised Access");
