# This script was automatically generated from the 847-2 Ubuntu Security Notice
...
script_name(english:"USN847-2 : devscripts vulnerability");
script_set_attribute(attribute:'synopsis', value: 'The remote package "devscripts" is missing a security patch.');
script_set_attribute(attribute:'description', value: 'USN-847-1 fixed vulnerabilities in devscripts. This update provides the
...
- devscripts-2.9.10-0ubuntu0.1 (Ubuntu 6.06)
');
...
found = ubuntu_check(osver: "6.06", pkgname: "devscripts", pkgver: "2.9.10-0ubuntu0.1");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package devscripts-',found,' is vulnerable in Ubuntu 6.06
Upgrade it to devscripts-2.9.10-0ubuntu0.1
');
}
