...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  novell-ipsec-tools (2009-06-16)");
...
if ( rpm_check( reference:"novell-ipsec-tools-0.6.3-183.4", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"novell-ipsec-tools-0.6.3-183.4", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"novell-ipsec-tools-devel-0.6.3-183.4", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"novell-ipsec-tools-devel-0.6.3-183.4", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
