...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  wireshark: Version 0.99.5 fixes four vulnerabilities (wireshark-2638)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch wireshark-2638");
 script_set_attribute(attribute: "description", value: "Wireshark 0.99.5 fixes four vulnerabilities:
...
script_set_attribute(attribute: "solution", value: "Install the security patch wireshark-2638");
script_end_attributes();

script_cve_id("CVE-2007-0459", "CVE-2007-0458", "CVE-2007-0457", "CVE-2007-0456");
script_summary(english: "Check for the wireshark-2638 package");
