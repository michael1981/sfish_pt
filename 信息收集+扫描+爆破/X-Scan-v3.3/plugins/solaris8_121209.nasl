...
if(description)
{
 ...
 script_name(english: "Solaris 5.8 (sparc) : 121209-01");
...
e +=  solaris_check_patch(release:"5.8", arch:"sparc", patch:"121209-01", obsoleted_by:"", package:"SUNWlzag", version:"2.0,REV=rr24");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
