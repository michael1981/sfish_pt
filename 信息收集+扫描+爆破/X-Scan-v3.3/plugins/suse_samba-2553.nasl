...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  samba: Fix logic error in the deferred open code and some other issues. (samba-2553)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch samba-2553");
script_end_attributes();

script_cve_id("CVE-2007-0452");
script_summary(english: "Check for the samba-2553 package");
