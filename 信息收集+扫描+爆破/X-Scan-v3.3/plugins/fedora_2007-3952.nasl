...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3952
#
...
script_name(english: "Fedora 7 2007-3952: ruby-gnome2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3952 (ruby-gnome2)");
...
if ( rpm_check( reference:"ruby-gnome2-0.16.0-17.fc7", release:"FC7") )
{
