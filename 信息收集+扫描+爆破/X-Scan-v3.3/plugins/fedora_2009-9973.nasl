...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9973
#
...
script_name(english: "Fedora 10 2009-9973: BackupPC");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9973 (BackupPC)");
...
* Fri Sep 25 2009 Johan Cwiklinski <johan AT x-tnd DOT be> 3.1.0-6
...
if ( rpm_check( reference:"BackupPC-3.1.0-6.fc10", release:"FC10") )
{
