...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3214
#
...
script_name(english: "Fedora 7 2008-3214: fedora-ds-admin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3214 (fedora-ds-admin)");
...
if ( rpm_check( reference:"fedora-ds-admin-1.1.4-1.fc7", release:"FC7") )
{
