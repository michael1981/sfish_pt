...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"54643");
  script_xref(name:"Secunia", value:"35177");

  script_name(english:"Novell GroupWise WebAccess 'User.lang' Cross-Site Scripting");
  ...
  script_set_attribute(
    ...
    value:string(
      "The remote host is running Novell GroupWise WebAccess and is\n",
