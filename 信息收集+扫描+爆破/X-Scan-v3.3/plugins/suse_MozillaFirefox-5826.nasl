...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for MozillaFirefox (MozillaFirefox-5826)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-5826");
...
This update also changes a previous security fix that
removed functionality required by customers. This issue was
MFSA 2007-34 'Possible file stealing through sftp
protocol', where the fix just disabled sftp:// and smb://
blindly.

Those protocols can now reenabled selectively by changing
the gconf property
/apps/firefox/general/allowed_indirect_gnomevfs_loads to
include smb:,sftp:
");
 script_set_attribute(attribute: "cvss_vector", value: "CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C");
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-5826");
...
script_summary(english: "Check for the MozillaFirefox-5826 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.18-0.5", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.18-0.5", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
