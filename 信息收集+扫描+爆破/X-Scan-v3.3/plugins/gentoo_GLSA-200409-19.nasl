...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200409-19 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200409-19
...
script_set_attribute(attribute: 'see_also', value: 'http://www.pdc.kth.se/heimdal/advisory/2004-09-13/');
script_set_attribute(attribute: 'see_also', value: 'http://www.frasunek.com/lukemftpd.txt');
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CAN-2004-0794');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200409-19.xml');
