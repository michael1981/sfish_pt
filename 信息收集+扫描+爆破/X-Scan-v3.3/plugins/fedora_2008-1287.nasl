...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1287
#
...
script_name(english: "Fedora 8 2008-1287: deluge");
...
if ( rpm_check( reference:"deluge-0.5.8.3-1.fc8", release:"FC8") )
{
