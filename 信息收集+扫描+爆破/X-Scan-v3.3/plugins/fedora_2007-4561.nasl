...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4561
#
...
script_name(english: "Fedora 7 2007-4561: imlib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4561 (imlib)");
...
if ( rpm_check( reference:"imlib-1.9.15-6.fc7", release:"FC7") )
{
