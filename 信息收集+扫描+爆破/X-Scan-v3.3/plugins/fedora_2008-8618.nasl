...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8618
#
...
script_name(english: "Fedora 9 2008-8618: pam_krb5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8618 (pam_krb5)");
...
if ( rpm_check( reference:"pam_krb5-2.3.0-2.fc9", release:"FC9") )
{
