...
#
# This plugin text was extracted from Fedora Security Advisory 2007-609
#
...
script_name(english: "Fedora 6 2007-609: perl-Net-DNS");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-609 (perl-Net-DNS)");
...
This brings FC-6 up to date with the latest changes to
...
if ( rpm_check( reference:"perl-Net-DNS-0.60-1.fc6", release:"FC6") )
{
