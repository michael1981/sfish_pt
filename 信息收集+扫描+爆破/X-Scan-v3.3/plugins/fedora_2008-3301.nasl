...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3301
#
...
script_name(english: "Fedora 8 2008-3301: moin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3301 (moin)");
...
if ( rpm_check( reference:"moin-1.5.9-1.fc8", release:"FC8") )
{
