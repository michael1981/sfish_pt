...
'The remote host is missing the DSA-054 security update');
...
'Read http://www.debian.org/security/2001/dsa-054
...
deb_check(prefix: 'cron', release: '2.2', reference: '3.0pl1-57.3');
