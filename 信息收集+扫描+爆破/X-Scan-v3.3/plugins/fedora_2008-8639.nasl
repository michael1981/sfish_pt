...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8639
#
...
script_name(english: "Fedora 9 2008-8639: mediawiki");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8639 (mediawiki)");
...
if ( rpm_check( reference:"mediawiki-1.13.2-41.fc9", release:"FC9") )
{
