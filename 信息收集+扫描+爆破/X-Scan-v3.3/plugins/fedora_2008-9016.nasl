...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9016
#
...
script_name(english: "Fedora 8 2008-9016: ipsec-tools");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9016 (ipsec-tools)");
...
if ( rpm_check( reference:"ipsec-tools-0.7.1-5.fc8", release:"FC8") )
{
