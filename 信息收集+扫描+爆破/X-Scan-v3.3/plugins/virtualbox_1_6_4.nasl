...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"47424");
...
source virtualization platform, before 1.6.4.  Such versions
reportedly include a kernel driver, 'VBoxDrv.sys', that allows a local
user to open the device '\\.\VBoxDrv' and issue IOCTLs with a
buffering method of 'METHOD_NEITHER' without any validation.  Using
specially crafted input, an unprivileged user can leverage this issue
