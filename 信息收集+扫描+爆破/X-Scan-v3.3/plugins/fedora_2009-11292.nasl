...
#
# This plugin text was extracted from Fedora Security Advisory 2009-11292
#
...
script_name(english: "Fedora 10 2009-11292: wordpress-mu");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-11292 (wordpress-mu)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2009-1030", "CVE-2009-2334");
...
if ( rpm_check( reference:"wordpress-mu-2.8.5.2-1.fc10", release:"FC10") )
{
