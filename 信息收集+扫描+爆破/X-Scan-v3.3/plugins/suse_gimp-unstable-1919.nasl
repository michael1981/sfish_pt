...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  gimp-unstable: Securityfix for XCF overflow problem (gimp-unstable-1919)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch gimp-unstable-1919");
script_end_attributes();

script_cve_id("CVE-2006-3404");
script_summary(english: "Check for the gimp-unstable-1919 package");
