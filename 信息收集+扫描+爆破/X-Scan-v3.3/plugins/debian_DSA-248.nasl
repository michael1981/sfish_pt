...
'The remote host is missing the DSA-248 security update');
...
'The Debian project recommends that you upgrade your hypermail packages.');
...
deb_check(prefix: 'hypermail', release: '2.2', reference: '2.0b25-1.1');
deb_check(prefix: 'hypermail', release: '3.0', reference: '2.1.3-2.0');
