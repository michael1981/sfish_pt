...
"The remote host is missing the patch for the advisory MDKSA-2006:045 (MySQL).");
 script_set_attribute(attribute: "description", value: "Eric Romang discovered a temporary file vulnerability in the
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:045");
