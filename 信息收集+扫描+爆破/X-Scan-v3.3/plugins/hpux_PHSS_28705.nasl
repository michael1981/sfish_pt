...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_28705");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_28705 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM6.2 Intermediate Patch, Feb 2003");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//patches_with_warnings/hp-ux_patches/s700_800/11.X/PHSS_28705");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_28705");
