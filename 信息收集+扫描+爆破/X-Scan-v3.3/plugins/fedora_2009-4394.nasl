...
#
# This plugin text was extracted from Fedora Security Advisory 2009-4394
#
...
script_name(english: "Fedora 11 2009-4394: ipsec-tools");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-4394 (ipsec-tools)");
...
if ( rpm_check( reference:"ipsec-tools-0.7.2-1.fc11", release:"FC11") )
{
