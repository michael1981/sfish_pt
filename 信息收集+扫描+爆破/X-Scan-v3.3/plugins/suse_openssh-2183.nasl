...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  openssh: Security update for security problems solved in OpenSSH 4.4 (openssh-2183)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch openssh-2183");
script_end_attributes();

script_cve_id("CVE-2006-4924", "CVE-2006-4925", "CVE-2006-5051", "CVE-2006-5052");
script_summary(english: "Check for the openssh-2183 package");
