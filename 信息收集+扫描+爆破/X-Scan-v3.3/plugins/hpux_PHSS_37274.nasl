...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_37274");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_37274 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.51 IA-64 Intermediate Patch 18");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//hp-ux_patches/s700_800/11.X/PHSS_37274");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_37274");
...
if ( hpux_patch_installed (patches:"PHSS_37274 ") )
{
 exit(0);
}
