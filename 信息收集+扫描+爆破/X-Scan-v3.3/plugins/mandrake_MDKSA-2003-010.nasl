...
if(description)
{
 ...
 script_name(english: "MDKSA-2003:010: printer-drivers");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2003:010 (printer-drivers).");
 script_set_attribute(attribute: "description", value: "Karol Wiesek and iDefense disovered three vulnerabilities in the
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2003:010");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2003-0034", "CVE-2003-0035", "CVE-2003-0036");
script_summary(english: "Check for the version of the printer-drivers package");
...
if ( rpm_check( reference:"ghostscript-module-SVGALIB-5.50-67.1mdk", release:"MDK8.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"ghostscript-module-SVGALIB-6.51-24.1mdk", release:"MDK8.1", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"ghostscript-module-SVGALIB-6.53-13.2mdk", release:"MDK8.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
