...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Mozilla XULRunner (mozilla-xulrunner190-6616)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch mozilla-xulrunner190-6616");
...
script_set_attribute(attribute: "solution", value: "Install the security patch mozilla-xulrunner190-6616");
...
script_summary(english: "Check for the mozilla-xulrunner190-6616 package");
...
if ( rpm_check( reference:"mozilla-xulrunner190-1.9.0.15-0.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-xulrunner190-gnomevfs-1.9.0.15-0.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-xulrunner190-translations-1.9.0.15-0.4.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
