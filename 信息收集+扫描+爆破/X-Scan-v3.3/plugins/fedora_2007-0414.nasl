...
#
# This plugin text was extracted from Fedora Security Advisory 2007-0414
#
...
script_name(english: "Fedora 7 2007-0414: libexif");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-0414 (libexif)");
...
if ( rpm_check( reference:"libexif-0.6.15-2.fc7", release:"FC7") )
{
