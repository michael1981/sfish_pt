...
"The remote host is missing the patch for the advisory MDKA-2006:030 (imlib2).");
 script_set_attribute(attribute: "description", value: "The tiff loader from imlib2 crashes when processing images on
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKA-2006:030");
