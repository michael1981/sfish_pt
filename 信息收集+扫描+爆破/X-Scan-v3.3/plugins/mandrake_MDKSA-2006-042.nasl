...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:042: libtiff");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:042 (libtiff).");
 script_set_attribute(attribute: "description", value: "Stack-based buffer overflow in libTIFF before 3.7.2 allows remote
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:042");
