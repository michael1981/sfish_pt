...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for IBM Java 1.4.2 (java-1_4_2-ibm-6136)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_4_2-ibm-6136");
 script_set_attribute(attribute: "description", value: "This update brings the IBM Java 1.4.2 JDK and JRE to
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_4_2-ibm-6136");
...
script_summary(english: "Check for the java-1_4_2-ibm-6136 package");
...
if ( rpm_check( reference:"java-1_4_2-ibm-1.4.2_sr13-0.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_4_2-ibm-devel-1.4.2_sr13-0.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_4_2-ibm-jdbc-1.4.2_sr13-0.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_4_2-ibm-plugin-1.4.2_sr13-0.4", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
