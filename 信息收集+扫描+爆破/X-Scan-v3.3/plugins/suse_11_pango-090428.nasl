...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  pango (2009-04-28)");
...
if ( rpm_check( reference:"pango-1.22.1-3.17.3", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"pango-doc-1.22.1-3.17.3", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"pango-1.22.1-3.17.3", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"pango-devel-1.22.1-3.17.3", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
