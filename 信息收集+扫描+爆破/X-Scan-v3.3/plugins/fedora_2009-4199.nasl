...
#
# This plugin text was extracted from Fedora Security Advisory 2009-4199
#
...
script_name(english: "Fedora 10 2009-4199: memcached");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-4199 (memcached)");
...
if ( rpm_check( reference:"memcached-1.2.8-1.fc10", release:"FC10") )
{
