# This script was automatically generated from the dsa-1223
...
'The remote host is missing the DSA-1223 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1223] DSA-1223-1 tar");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1223-1 tar");
 exit(0);
}
...
deb_check(prefix: 'tar', release: '3.1', reference: '1.14-2.3');
