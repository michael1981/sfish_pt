...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9675
#
...
script_name(english: "Fedora 11 2009-9675: xmp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9675 (xmp)");
...
if ( rpm_check( reference:"xmp-2.7.1-1.fc11", release:"FC11") )
{
