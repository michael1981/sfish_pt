...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:229: xmovie");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:229");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2005-4048");
script_summary(english: "Check for the version of the xmovie package");
