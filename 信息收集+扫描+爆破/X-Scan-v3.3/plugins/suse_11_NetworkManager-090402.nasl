...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  NetworkManager (2009-04-02)");
...
if ( rpm_check( reference:"NetworkManager-0.7.0.r4359-15.9.2", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"NetworkManager-glib-0.7.0.r4359-15.9.2", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"NetworkManager-0.7.0.r4359-15.9.2", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"NetworkManager-glib-0.7.0.r4359-15.9.2", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
