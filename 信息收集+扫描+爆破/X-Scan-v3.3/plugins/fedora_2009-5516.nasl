...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5516
#
...
script_name(english: "Fedora 9 2009-5516: php-Smarty");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5516 (php-Smarty)");
...
if ( rpm_check( reference:"php-Smarty-2.6.25-1.fc9", release:"FC9") )
{
