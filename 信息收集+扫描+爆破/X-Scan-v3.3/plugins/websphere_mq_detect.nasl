...
if (description)
{
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-306.ibm.com/software/integration/wmq/index.html"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://en.wikipedia.org/wiki/WebSphere_MQ"
  );
  script_set_attribute(
    attribute:"solution", 
...
# Only check using one channel unless thorough tests are enabled
