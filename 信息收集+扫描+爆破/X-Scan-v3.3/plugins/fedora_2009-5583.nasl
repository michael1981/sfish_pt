...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5583
#
...
script_name(english: "Fedora 11 2009-5583: pidgin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5583 (pidgin)");
...
if ( rpm_check( reference:"pidgin-2.5.6-1.fc11", release:"FC11") )
{
