...
SNMP daemon).'
  ...
  script_set_attribute(
    attribute:'solution',
    value:'Apply the latest SNMP patches from your vendor.'
  );
  ...
  script_set_attribute(
    attribute:'see_also',
    value:'http://archives.neohapsis.com/archives/bugtraq/2002-08/att-0295/00-NOVL-2002-2961546_-_SNMPv1_Trap_and_Request_Handling.txt'
  );
