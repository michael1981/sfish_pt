...
#
# This plugin text was extracted from Fedora Security Advisory 2006-757
#
...
script_name(english: "Fedora 4 2006-757: gnupg");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-757 (gnupg)");
...
if ( rpm_check( reference:"gnupg-1.4.4-1", release:"FC4") )
{
