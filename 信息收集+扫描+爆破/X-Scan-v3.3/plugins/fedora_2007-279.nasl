...
#
# This plugin text was extracted from Fedora Security Advisory 2007-279
#
...
script_name(english: "Fedora 6 2007-279: nss");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-279 (nss)");
...
if ( rpm_check( reference:"nss-3.11.5-0.6.0.fc6", release:"FC6") )
{
