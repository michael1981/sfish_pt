...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  flash-player: Security update (flash-player-3889)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch flash-player-3889");
 script_set_attribute(attribute: "description", value: "The Adobe Flash Player was updated to version 7.0.70.0 on
...
script_set_attribute(attribute: "solution", value: "Install the security patch flash-player-3889");
script_end_attributes();

script_cve_id("CVE-2007-3456", "CVE-2007-3457", "CVE-2007-2022");
script_summary(english: "Check for the flash-player-3889 package");
...
if ( rpm_check( reference:"flash-player-9.0.48.0-1.1", release:"SUSE10.2") )
{
