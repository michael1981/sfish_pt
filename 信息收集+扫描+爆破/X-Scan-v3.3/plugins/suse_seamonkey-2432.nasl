...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  seamonkey: Security update to version 1.0.7 (seamonkey-2432)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch seamonkey-2432");
...
script_summary(english: "Check for the seamonkey-2432 package");
