...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7724
#
...
script_name(english: "Fedora 10 2009-7724: libtiff");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7724 (libtiff)");
...
if ( rpm_check( reference:"libtiff-3.8.2-14.fc10", release:"FC10") )
{
