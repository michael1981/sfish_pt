...
if (description) {
  ...
  script_xref(name:"milw0rm", value:"1585");
  script_xref(name:"milw0rm", value:"6519");
  script_xref(name:"OSVDB", value:"24030");
...
tested for it explicitly." );
 script_set_attribute(attribute:"see_also", value:"http://retrogod.altervista.org/phpical_221_incl_xpl.html" );
