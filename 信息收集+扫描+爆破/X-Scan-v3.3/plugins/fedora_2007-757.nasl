...
#
# This plugin text was extracted from Fedora Security Advisory 2007-757
#
...
script_name(english: "Fedora 6 2007-757: htdig");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-757 (htdig)");
...
if ( rpm_check( reference:"htdig-web-3.2.0b6-9.fc6", release:"FC6") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"htdig-3.2.0b6-9.fc6", release:"FC6") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
