...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:079-2: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:079-2 (kernel).");
 script_set_attribute(attribute: "description", value: "Alexander Viro discovered a vulnerability in the devfs implementation
...
Update:
The previous advisory was missing the md5sums for the lm_utils packages.
The md5sums are now included in the package list.
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:079-2");
