...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9391
#
...
script_name(english: "Fedora 11 2009-9391: kdelibs3");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9391 (kdelibs3)");
...
if ( rpm_check( reference:"kdelibs3-3.5.10-13.fc11.1", release:"FC11") )
{
