...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaFirefox: Security update to version 1.5.0.6 (MozillaFirefox-1981)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-1981");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-1981");
script_end_attributes();

script_cve_id("CVE-2006-3801", "CVE-2006-3677", "CVE-2006-3113", "CVE-2006-3802", "CVE-2006-3803", "CVE-2006-3804", "CVE-2006-3805", "CVE-2006-3806", "CVE-2006-3807", "CVE-2006-3808", "CVE-2006-3809", "CVE-2006-3810", "CVE-2006-3811", "CVE-2006-3812");
script_summary(english: "Check for the MozillaFirefox-1981 package");
...
if ( rpm_check( reference:"MozillaFirefox-1.5.0.6-1.3", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-1.5.0.6-1.3", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
