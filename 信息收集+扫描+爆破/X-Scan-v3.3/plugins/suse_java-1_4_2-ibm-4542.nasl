...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for IBM Java 1.4.2 (java-1_4_2-ibm-4542)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_4_2-ibm-4542");
 script_set_attribute(attribute: "description", value: "The IBM Java JRE/SDK has been brought to release 1.4.2 SR9,
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_4_2-ibm-4542");
script_end_attributes();

 script_cve_id("CVE-2007-2788", "CVE-2007-2789", "CVE-2007-3655", "CVE-2007-3922");
script_summary(english: "Check for the java-1_4_2-ibm-4542 package");
