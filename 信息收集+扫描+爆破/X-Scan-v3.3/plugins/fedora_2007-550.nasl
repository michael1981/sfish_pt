...
#
# This plugin text was extracted from Fedora Security Advisory 2007-550
#
...
script_name(english: "Fedora 6 2007-550: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-550 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-1.5.0.12-1.fc6", release:"FC6") )
{
