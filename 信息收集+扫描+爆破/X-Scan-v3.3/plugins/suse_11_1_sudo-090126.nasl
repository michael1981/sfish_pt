...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  sudo (2009-01-26)");
...
if ( rpm_check( reference:"sudo-1.6.9p17-10.36.1", release:"SUSE11.1", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"sudo-1.6.9p17-10.36.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
