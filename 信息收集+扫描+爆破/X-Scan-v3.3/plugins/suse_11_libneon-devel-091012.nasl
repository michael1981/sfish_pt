...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libneon-devel (2009-10-12)");
...
if ( rpm_check( reference:"libneon27-0.28.3-2.12.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"neon-0.28.3-2.12.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libneon27-0.28.3-2.12.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"neon-0.28.3-2.12.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
