...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"27324");
 script_xref(name:"OSVDB", value:"29143");
 
 name["english"] = "MS06-048: Vulnerabilities in Microsoft Office Could Allow Remote Code Execution (922968)";
 ...
 if ( !isnull(v) ) 
  {
  	 if ( ( v[0] == 9 &&  v[1] == 0 && v[2] == 0 && v[3] < 8948 )  ||
	      ...
	      ( v[0] == 11 && v[1] == 0 && v[2] < 8036 ) ) {
 set_kb_item(name:"SMB/Missing/MS06-048", value:TRUE);
