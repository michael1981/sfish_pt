...
if(description)
{
 ...
 script_name(english:"SMB Share Hosting Copyrighted Material");
...
movies or music files, that are being shared without the owner's
permission. 

If any of these files actually contain copyrighted material, and if
