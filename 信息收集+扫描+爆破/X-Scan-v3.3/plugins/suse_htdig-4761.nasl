...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for htdig (htdig-4761)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch htdig-4761");
script_end_attributes();

script_cve_id("CVE-2007-6110");
script_summary(english: "Check for the htdig-4761 package");
