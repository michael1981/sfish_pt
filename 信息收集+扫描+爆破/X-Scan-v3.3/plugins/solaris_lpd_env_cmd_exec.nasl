...
if(description)
{
  ...
  script_xref(name:"OSVDB", value:"15131");
  ...
  script_set_attribute(
    attribute:'synopsis',
    value:'The remote lpd daemon is vulnernable to abitrary command execution.'
  );
...
command could be executed.'
  ...
  script_set_attribute(
    attribute:'see_also',
    value:'http://archives.neohapsis.com/archives/bugtraq/2001-08/0429.html'
  );
