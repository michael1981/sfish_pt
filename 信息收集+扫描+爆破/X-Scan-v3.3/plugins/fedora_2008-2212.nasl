...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2212
#
...
script_name(english: "Fedora 7 2008-2212: kronolith");
...
if ( rpm_check( reference:"kronolith-2.1.7-1.fc7", release:"FC7") )
{
