...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  ImageMagick: Securityfix for several buffer overflows. (ImageMagick-2006)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch ImageMagick-2006");
...
script_set_attribute(attribute: "solution", value: "Install the security patch ImageMagick-2006");
script_end_attributes();

script_cve_id("CVE-2006-3744", "CVE-2006-3743", "CVE-2006-4144");
script_summary(english: "Check for the ImageMagick-2006 package");
...
if ( rpm_check( reference:"ImageMagick-6.2.5-16.5", release:"SUSE10.1") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"ImageMagick-Magick++-6.2.5-16.5", release:"SUSE10.1") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"ImageMagick-Magick++-devel-6.2.5-16.5", release:"SUSE10.1") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"ImageMagick-devel-6.2.5-16.5", release:"SUSE10.1") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"perl-PerlMagick-6.2.5-16.5", release:"SUSE10.1") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
