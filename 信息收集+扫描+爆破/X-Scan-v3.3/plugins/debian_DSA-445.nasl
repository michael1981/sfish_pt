...
'The remote host is missing the DSA-445 security update');
...
'Read http://www.debian.org/security/2004/dsa-445
...
deb_check(prefix: 'lbreakout2', release: '3.0', reference: '2.2.2-1woody1');
