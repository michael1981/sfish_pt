...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  gpg2: Security update to fix crash on special crafted messages (gpg2-1835)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch gpg2-1835");
...
script_set_attribute(attribute: "solution", value: "Install the security patch gpg2-1835");
script_end_attributes();

script_cve_id("CVE-2006-3082");
script_summary(english: "Check for the gpg2-1835 package");
...
if ( rpm_check( reference:"gpg2-1.9.18-17.5", release:"SUSE10.1") )
{
