...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2122
#
...
script_name(english: "Fedora 10 2009-2122: mldonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2122 (mldonkey)");
...
if ( rpm_check( reference:"mldonkey-2.9.7-3.fc10", release:"FC10") )
{
