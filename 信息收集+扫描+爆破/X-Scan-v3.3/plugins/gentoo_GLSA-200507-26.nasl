...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200507-26 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200507-26
...
script_set_attribute(attribute: 'see_also', value: 'http://www.securityfocus.com/archive/1/406026/30/');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200507-26.xml');
...
if (qpkg_check(package: "net-libs/libgadu", unaffected: make_list("ge 1.7.0_pre20050719"), vulnerable: make_list("lt 1.7.0_pre20050719")
)) { security_hole(0); exit(0); }
