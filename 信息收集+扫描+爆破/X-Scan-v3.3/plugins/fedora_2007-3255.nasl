...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3255
#
...
script_name(english: "Fedora 7 2007-3255: perl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3255 (perl)");
...
if ( rpm_check( reference:"perl-5.8.8-26.fc7", release:"FC7") )
{
