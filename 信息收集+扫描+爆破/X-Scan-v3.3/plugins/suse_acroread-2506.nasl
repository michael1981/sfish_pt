...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  acroread: Securityupgrade to version 7.0.9 (acroread-2506)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch acroread-2506");
...
script_set_attribute(attribute: "solution", value: "Install the security patch acroread-2506");
script_end_attributes();

script_cve_id("CVE-2006-5857", "CVE-2007-0044", "CVE-2007-0045", "CVE-2007-0046", "CVE-2007-0047", "CVE-2007-0048");
script_summary(english: "Check for the acroread-2506 package");
...
if ( rpm_check( reference:"acroread-7.0.9-2.1", release:"SUSE10.2") )
{
