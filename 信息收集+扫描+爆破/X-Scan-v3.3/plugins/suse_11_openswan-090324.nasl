...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  openswan (2009-03-24)");
...
if ( rpm_check( reference:"openswan-2.6.16-1.32.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"openswan-doc-2.6.16-1.32.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
