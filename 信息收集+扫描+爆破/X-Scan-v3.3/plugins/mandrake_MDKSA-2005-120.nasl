...
"The remote host is missing the patch for the advisory MDKSA-2005:120-1 (mozilla-firefox).");
 script_set_attribute(attribute: "description", value: "A number of vulnerabilities were reported and fixed in Firefox 1.0.5
...
Mozilla Suite is also unaffected (MFSA 2005-47; CVE-2005-2262).
...
frames in this manner (MFSA 2005-52; CVE-2005-2266).
...
which created it (MFSA 2005-54; CVE-2005-2268).
...
to execute code with enhanced privileges (MFSA 2005-56; CVE-2005-2270).
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:120-1");
