...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  libpoppler3 (2009-06-11)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing a security patch for libpoppler3");
...
script_set_attribute(attribute: "solution", value: "Run yast to install the security patch for libpoppler3");
...
script_summary(english: "Check for the libpoppler3 package");
...
if ( rpm_check( reference:"libpoppler3-0.8.2-1.4", release:"SUSE11.0", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libpoppler3-0.8.2-1.4", release:"SUSE11.0", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
