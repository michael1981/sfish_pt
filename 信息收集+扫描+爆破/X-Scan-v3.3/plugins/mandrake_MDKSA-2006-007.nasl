...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:007: apache2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:007 (apache2).");
 script_set_attribute(attribute: "description", value: "A flaw was discovered in mod_imap when using the Referer directive with
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:007");
