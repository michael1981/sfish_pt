...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1145
#
...
script_name(english: "Fedora 7 2007-1145: galeon");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-1145 (galeon)");
...
if ( rpm_check( reference:"galeon-2.0.3-10.fc7", release:"FC7") )
{
