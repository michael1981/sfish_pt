...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0653
#
...
script_name(english: "Fedora 10 2009-0653: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0653 (drupal)");
...
SA-CORE-2009-001 ( [9]http://drupal.org/node/358957 )    Remember to log in to
your
...
if ( rpm_check( reference:"drupal-6.9-1.fc10", release:"FC10") )
{
