...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"41377");
...
"The remote Windows host has an anti-virus application that may fail to
scan selected files." );
...
remote host may allow an attacker by bypass anti-virus scanning by
