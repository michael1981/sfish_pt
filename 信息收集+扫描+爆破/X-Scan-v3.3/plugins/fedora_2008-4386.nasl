...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4386
#
...
script_name(english: "Fedora 9 2008-4386: kvm");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4386 (kvm)");
...
* Tue May 27 2008 Glauber Costa <gcosta redhat com> - 65-7.fc9
- Fix the build
");
...
if ( rpm_check( reference:"kvm-65-7.fc9", release:"FC9") )
{
