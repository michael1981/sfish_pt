...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"4343");
...
"The remote TFTP server dies when it receives a too big 
UDP datagram. An attacker may use this flaw to disable 
your server, or even execute arbitrary code on your system." );
 script_set_attribute(attribute:"solution", value:
"Upgrade your software, or disable this service." );
