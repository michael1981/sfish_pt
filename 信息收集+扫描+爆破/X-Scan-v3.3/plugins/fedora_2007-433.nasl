...
#
# This plugin text was extracted from Fedora Security Advisory 2007-433
#
...
script_name(english: "Fedora 5 2007-433: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-433 (kernel)");
...
ATI SB600 SATA workaround
Routing return codes
Libata LBA48 handling
Update libata NCQ blacklist
Libata request sense
SCSI error handler
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-5757", "CVE-2007-0005", "CVE-2007-0006", "CVE-2007-0772", "CVE-2007-1357");
...
if ( rpm_check( reference:"kernel-2.6.20-1.2312.fc5", prefix:"kernel-", release:"FC5") )
{
