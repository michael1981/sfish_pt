...
#
# This plugin text was extracted from Fedora Security Advisory 2007-661
#
...
script_name(english: "Fedora 6 2007-661: openssl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-661 (openssl)");
...
if ( rpm_check( reference:"openssl-0.9.8b-14.fc6", release:"FC6") )
{
