...
if ( rpm_check(reference:"slocate-2.7-13.el4.6", release:"CentOS-4", cpu:"ia64") )
{
 security_note(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check(reference:"slocate-2.7-13.el4.6", release:"CentOS-4", cpu:"i386") )
{
 security_note(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check(reference:"slocate-2.7-13.el4.6", release:"CentOS-4", cpu:"x86_64") )
{
 security_note(port:0, extra:rpm_report_get());
 exit(0);
}
