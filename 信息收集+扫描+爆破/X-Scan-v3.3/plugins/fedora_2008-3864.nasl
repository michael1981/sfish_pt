...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3864
#
...
script_name(english: "Fedora 8 2008-3864: php");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3864 (php)");
...
[9]http://www.php.net/releases/5_2_5.php    [10]http://www.php.net/releases/5_2
_6.php
It was discovered that the PHP escapeshellcmd() function did not properly escap
e
...
Certain sequences of bytes could be passed through these functions without bein
g
...
fnmatch() on untrusted input data. (CVE-2007-4782)    It was discovered that PH
P
...
if ( rpm_check( reference:"php-5.2.6-2.fc8", release:"FC8") )
{
