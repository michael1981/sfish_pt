...
'The remote host is missing the DSA-1450 security update');
...
deb_check(prefix: 'bsdutils', release: '3.1', reference: '2.12p-4sarge2');
deb_check(prefix: 'mount', release: '3.1', reference: '2.12p-4sarge2');
deb_check(prefix: 'util-linux', release: '3.1', reference: '2.12p-4sarge2');
deb_check(prefix: 'util-linux-locales', release: '3.1', reference: '2.12p-4sarge2');
deb_check(prefix: 'bsdutils', release: '4.0', reference: '2.12r-19etch1');
deb_check(prefix: 'mount', release: '4.0', reference: '2.12r-19etch1');
deb_check(prefix: 'util-linux', release: '4.0', reference: '2.12r-19etch1');
deb_check(prefix: 'util-linux-locales', release: '4.0', reference: '2.12r-19etch1');
