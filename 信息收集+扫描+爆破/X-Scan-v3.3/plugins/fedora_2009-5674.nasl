...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5674
#
...
script_name(english: "Fedora 11 2009-5674: ntp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5674 (ntp)");
...
if ( rpm_check( reference:"ntp-4.2.4p7-2.fc11", release:"FC11") )
{
