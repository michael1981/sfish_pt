...
#
# This plugin text was extracted from Fedora Security Advisory 2007-485
#
...
script_name(english: "Fedora 5 2007-485: evolution-data-server");
...
if ( rpm_check( reference:"evolution-data-server-1.6.3-4.fc5", release:"FC5") )
{
