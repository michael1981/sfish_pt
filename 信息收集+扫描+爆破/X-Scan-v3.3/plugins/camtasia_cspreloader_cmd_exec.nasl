...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"40102");

  script_name(english:"Camtasia Studio Pre-generated SWF File csPreloader Variable Unspecified Arbitrary Code Execution");
...
even execution of arbitrary code on a user's system." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/249337" );
 script_set_attribute(attribute:"solution", value:
"Upgrade to Camtasia Studio 5.0 or later as that reportedly resolves
the issue and regenerate SWF content.  Note that upgrading by itself
is not sufficient to resolve this issue." );
