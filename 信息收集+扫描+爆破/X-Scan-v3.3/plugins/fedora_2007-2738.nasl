...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2738
#
...
script_name(english: "Fedora 7 2007-2738: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2738 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.2-1.fc7", release:"FC7") )
{
