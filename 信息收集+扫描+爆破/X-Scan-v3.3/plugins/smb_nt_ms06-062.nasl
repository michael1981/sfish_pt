...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"29430");
 
 name["english"] = "MS06-062: Vulnerabilities in Microsoft Office Could Allow Remote Code Execution (922581)";
 ...
 if ( !isnull(v) ) 
  {
  	 if ( ( v[0] == 9 &&  v[1] == 0 && v[2] == 0 && v[3] < 8950 )  ||
	      ( v[0] == 10 && v[1] == 0 && v[2] < 6817 ) ||
	      ( v[0] == 11 && v[1] == 0 && v[2] < 8107 ) ) {
 set_kb_item(name:"SMB/Missing/MS06-062", value:TRUE);
