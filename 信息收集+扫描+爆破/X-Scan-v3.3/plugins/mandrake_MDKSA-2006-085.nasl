...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:085: xine-ui");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:085 (xine-ui).");
 script_set_attribute(attribute: "description", value: "Multiple format string vulnerabilities in xiTK (xitk/main.c) in xine allow
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:085");
