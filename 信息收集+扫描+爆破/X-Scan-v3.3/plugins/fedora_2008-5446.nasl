...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5446
#
...
script_name(english: "Fedora 9 2008-5446: xemacs-packages-extra");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5446 (xemacs-packages-extra)");
...
if ( rpm_check( reference:"xemacs-packages-extra-20070427-2.fc9", release:"FC9") )
{
