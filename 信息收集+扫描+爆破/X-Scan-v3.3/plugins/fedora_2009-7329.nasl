...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7329
#
...
script_name(english: "Fedora 11 2009-7329: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7329 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-3.2.0.1-1.fc11", release:"FC11") )
{
