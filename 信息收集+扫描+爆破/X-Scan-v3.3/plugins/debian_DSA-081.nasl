...
'The remote host is missing the DSA-081 security update');
...
'The Debian project recommends that you upgrade your w3m packages immediately.');
...
deb_check(prefix: 'w3m-ssl', release: '2.2', reference: '0.1.10+0.1.11pre+kokb23-4');
