...
'The remote host is missing the DSA-194 security update');
...
'The Debian project recommends that you upgrade your masqmail package immediately.');
...
deb_check(prefix: 'masqmail', release: '3.0', reference: '0.1.16-2.1');
