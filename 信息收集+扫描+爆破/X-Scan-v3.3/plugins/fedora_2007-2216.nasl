...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2216
#
...
script_name(english: "Fedora 7 2007-2216: qt");
...
if ( rpm_check( reference:"qt-3.3.8-7.fc7", release:"FC7") )
{
