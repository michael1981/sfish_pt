...
'The remote host is missing the DSA-1061 security update');
...
'The Debian project recommends that you upgrade your popfile package.');
...
deb_check(prefix: 'popfile', release: '3.1', reference: '0.22.2-2sarge1');
