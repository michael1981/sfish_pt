...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  nagios (2009-07-15)");
...
if ( rpm_check( reference:"nagios-3.0.6-1.21.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"nagios-www-3.0.6-1.21.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
