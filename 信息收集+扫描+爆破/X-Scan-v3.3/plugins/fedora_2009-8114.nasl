...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8114
#
...
script_name(english: "Fedora 10 2009-8114: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8114 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.8.2-1.fc10", release:"FC10") )
{
