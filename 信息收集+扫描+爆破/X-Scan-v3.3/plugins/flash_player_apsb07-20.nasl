...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"41483");
  script_xref(name:"OSVDB", value:"41484");
  script_xref(name:"OSVDB", value:"41485");
  script_xref(name:"OSVDB", value:"41486");
  script_xref(name:"OSVDB", value:"41487");
  script_xref(name:"OSVDB", value:"41488");
  script_xref(name:"OSVDB", value:"41489");
  script_xref(name:"OSVDB", value:"51567");

  script_name(english:"Flash Player Multiple Vulnerabilities (APSB07-20)");
