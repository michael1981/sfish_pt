...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1998
#
...
script_name(english: "Fedora 8 2008-1998: ghostscript");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1998 (ghostscript)");
...
(CVE-2008-0411).    This update also restores JPEG2000 support.
");
...
if ( rpm_check( reference:"ghostscript-8.61-8.fc8", release:"FC8") )
{
