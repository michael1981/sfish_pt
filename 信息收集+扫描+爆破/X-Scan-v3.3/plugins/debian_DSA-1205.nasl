...
'The remote host is missing the DSA-1205 security update');
...
deb_check(prefix: 'thttpd', release: '3.1', reference: '2.23beta1-3sarge2');
deb_check(prefix: 'thttpd-util', release: '3.1', reference: '2.23beta1-3sarge2');
