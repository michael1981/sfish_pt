...
'The remote host is missing the DSA-1070 security update');
...
deb_check(prefix: 'kernel-doc-2.4.19', release: '3.0', reference: '2.4.19-4.woody3');
deb_check(prefix: 'kernel-headers-2.4.18-sparc', release: '3.0', reference: '22woody1');
deb_check(prefix: 'kernel-headers-2.4.19', release: '3.0', reference: '2.4.19-0.020911.1.woody5');
deb_check(prefix: 'kernel-headers-2.4.19-sparc', release: '3.0', reference: '26woody1');
deb_check(prefix: 'kernel-image-2.4.18-sun4u', release: '3.0', reference: '22woody1');
deb_check(prefix: 'kernel-image-2.4.18-sun4u-smp', release: '3.0', reference: '22woody1');
deb_check(prefix: 'kernel-image-2.4.19-r4k-ip22', release: '3.0', reference: '2.4.19-0.020911.1.woody5');
deb_check(prefix: 'kernel-image-2.4.19-r5k-ip22', release: '3.0', reference: '2.4.19-0.020911.1.woody5');
deb_check(prefix: 'kernel-image-2.4.19-sun4u', release: '3.0', reference: '26woody1');
deb_check(prefix: 'kernel-image-2.4.19-sun4u-smp', release: '3.0', reference: '26woody1');
deb_check(prefix: 'kernel-patch-2.4.19-mips', release: '3.0', reference: '2.4.19-0.020911.1.woody5');
deb_check(prefix: 'kernel-source-2.4.19', release: '3.0', reference: '2.4.19-4.woody3');
deb_check(prefix: 'mips-tools', release: '3.0', reference: '2.4.19-0.020911.1.woody5');
