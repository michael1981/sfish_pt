...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for IBM Java (java-1_4_2-ibm-3851)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_4_2-ibm-3851");
 script_set_attribute(attribute: "description", value: "The IBM Java JRE/SDK has been brought to release 1.4.2 SR
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_4_2-ibm-3851");
script_end_attributes();

script_cve_id("CVE-2006-6736", "CVE-2006-6737", "CVE-2006-6745", "CVE-2007-0243");
script_summary(english: "Check for the java-1_4_2-ibm-3851 package");
