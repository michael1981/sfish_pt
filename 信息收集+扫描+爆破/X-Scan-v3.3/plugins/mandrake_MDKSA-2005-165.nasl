...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:165: cups");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:165 (cups).");
 script_set_attribute(attribute: "description", value: "A vulnerability in CUPS would treat a Location directive in cupsd.conf
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:165");
