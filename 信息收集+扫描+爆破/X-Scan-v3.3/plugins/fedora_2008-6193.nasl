...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6193
#
...
script_name(english: "Fedora 9 2008-6193: seamonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6193 (seamonkey)");
...
if ( rpm_check( reference:"seamonkey-1.1.10-1.fc9", release:"FC9") )
{
