...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for (MozillaFirefox-5134)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-5134");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-5134");
...
script_summary(english: "Check for the MozillaFirefox-5134 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.13-0.2", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.13-0.2", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-2.0.0.13-0.2", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.13-0.2", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
