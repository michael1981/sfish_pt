...
'The remote host is missing the DSA-460 security update');
...
'Read http://www.debian.org/security/2004/dsa-460
...
deb_check(prefix: 'isag', release: '3.0', reference: '4.0.4-1woody1');
deb_check(prefix: 'sysstat', release: '3.0', reference: '4.0.4-1woody1');
deb_check(prefix: 'sysstat', release: '3.0', reference: '5.0.1-1');
