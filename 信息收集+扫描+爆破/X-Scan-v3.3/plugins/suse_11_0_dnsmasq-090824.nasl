...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  dnsmasq (2009-08-24)");
...
if ( rpm_check( reference:"dnsmasq-2.45-0.3", release:"SUSE11.0", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"dnsmasq-2.45-0.3", release:"SUSE11.0", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
