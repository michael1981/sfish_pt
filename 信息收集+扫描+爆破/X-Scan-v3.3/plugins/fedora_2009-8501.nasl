...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8501
#
...
script_name(english: "Fedora 10 2009-8501: viewvc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8501 (viewvc)");
...
Also includes:     Patch by Patrick Monnerat to make allow_tar work on F-10.
");
...
if ( rpm_check( reference:"viewvc-1.0.9-1.fc10", release:"FC10") )
{
