...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2788
#
...
script_name(english: "Fedora 8 2007-2788: Django");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2788 (Django)");
...
if ( rpm_check( reference:"Django-0.96.1-1.fc8", release:"FC8") )
{
