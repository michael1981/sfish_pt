...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  opera (2008-07-23)");
...
script_set_attribute(attribute: "see_also", value: "https://bugzilla.novell.com/show_bug.cgi?id=411499");
...
if ( rpm_check( reference:"opera-9.51-7.1", release:"SUSE11.0", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opera-9.51-7.1", release:"SUSE11.0", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
