...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200801-05 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200801-05
...
if (qpkg_check(package: "net-proxy/squid", unaffected: make_list("ge 2.6.17"), vulnerable: make_list("lt 2.6.17")
