...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8317
#
...
script_name(english: "Fedora 10 2009-8317: firebird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8317 (firebird)");
...
if ( rpm_check( reference:"firebird-2.1.3.18185.0-2.fc10", release:"FC10") )
{
