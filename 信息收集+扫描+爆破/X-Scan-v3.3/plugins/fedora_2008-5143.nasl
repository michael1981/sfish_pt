...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5143
#
...
script_name(english: "Fedora 9 2008-5143: openoffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5143 (openoffice.org)");
...
Update to upstream version 2.4.1 to fix a range of reported problems and a
security issue CVE-2008-2152:
[9]http://www.openoffice.org/security/cves/CVE-2008-2152.html
");
...
if ( rpm_check( reference:"openoffice.org-2.4.1-17.3.fc9", release:"FC9") )
{
