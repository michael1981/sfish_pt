...
#
# This plugin text was extracted from Fedora Security Advisory 2006-698
#
...
script_name(english: "Fedora 5 2006-698: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-698 (kernel)");
...
if ( rpm_check( reference:"kernel-2.6.16-1.2133_FC5", prefix:"kernel-", release:"FC5") )
{
