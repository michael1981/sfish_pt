...
if(description)
{
 ...
 script_name(english: "MDKSA-2002:041: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2002:041 (kernel).");
 script_set_attribute(attribute: "description", value: "A problem was discovered in the CIPE (VPN tunnel) implementation in the
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2002:041");
...
if ( rpm_check( reference:"kernel-enterprise-2.4.18.8.2mdk-1-3mdk", release:"MDK8.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"kernel-enterprise-2.4.18.8.2mdk-1-3mdk", release:"MDK8.1", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"kernel-enterprise-2.4.18.8.1mdk-1-3mdk", release:"MDK8.2", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
