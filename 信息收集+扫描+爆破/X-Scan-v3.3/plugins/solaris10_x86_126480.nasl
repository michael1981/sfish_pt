...
if(description)
{
 ...
 script_name(english: "Solaris 5.10 (x86) : 126480-17");
...
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"126480-17", obsoleted_by:"", package:"SUNWmessaging-server-64", version:"6.3,REV=2007.02.26");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
