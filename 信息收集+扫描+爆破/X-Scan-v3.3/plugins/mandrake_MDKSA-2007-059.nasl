...
if(description)
{
 ...
 script_name(english: "MDKSA-2007:059: gnupg");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2007:059 (gnupg).");
 script_set_attribute(attribute: "description", value: "GnuPG prior to 1.4.7 and GPGME prior to 1.1.4, when run from the
command
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2007:059");
