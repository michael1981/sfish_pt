...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3709
#
...
script_name(english: "Fedora 10 2009-3709: ghostscript");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3709 (ghostscript)");
...
if ( rpm_check( reference:"ghostscript-8.63-6.fc10", release:"FC10") )
{
