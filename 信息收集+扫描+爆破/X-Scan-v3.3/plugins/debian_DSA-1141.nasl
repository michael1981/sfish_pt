...
'The remote host is missing the DSA-1141 security update');
...
'The Debian project recommends that you upgrade your gnupg2 package.');
...
deb_check(prefix: 'gnupg-agent', release: '3.1', reference: '1.9.15-6sarge2');
deb_check(prefix: 'gnupg2', release: '3.1', reference: '1.9.15-6sarge2');
deb_check(prefix: 'gpgsm', release: '3.1', reference: '1.9.15-6sarge2');
