...
"The remote host is missing the patch for the advisory MDKA-2007:106 (autofs).");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKA-2007:106");
...
if ( rpm_check( reference:"autofs-5.0.2-8.1mdv2008.0", release:"MDK2008.0", yank:"mdv") )
{
