...
'The remote host is missing the DSA-160 security update');
...
'The Debian project recommends that you upgrade your scrollkeeper packages immediately.');
...
deb_check(prefix: 'libscrollkeeper-dev', release: '3.0', reference: '0.3.6-3.1');
deb_check(prefix: 'libscrollkeeper0', release: '3.0', reference: '0.3.6-3.1');
deb_check(prefix: 'scrollkeeper', release: '3.0', reference: '0.3.6-3.1');
