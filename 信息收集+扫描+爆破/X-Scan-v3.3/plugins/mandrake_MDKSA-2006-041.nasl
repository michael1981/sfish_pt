...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:041: bluez-hcidump");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:041 (bluez-hcidump).");
 script_set_attribute(attribute: "description", value: "Buffer overflow in l2cap.c in hcidump allows remote attackers to cause a
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:041");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2006-0670");
script_summary(english: "Check for the version of the bluez-hcidump package");
