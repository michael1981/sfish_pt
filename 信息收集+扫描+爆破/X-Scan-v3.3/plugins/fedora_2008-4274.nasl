...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4274
#
...
script_name(english: "Fedora 7 2008-4274: gnutls");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4274 (gnutls)");
...
if ( rpm_check( reference:"gnutls-1.6.3-3.fc7", release:"FC7") )
{
