...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"26835");

 name["english"] = "MS06-046: Vulnerability in HTML Help Could Allow Remote Code Execution (922616)";
...
if (is_accessible_share())
{
 ...
 {
 set_kb_item(name:"SMB/Missing/MS06-046", value:TRUE);
