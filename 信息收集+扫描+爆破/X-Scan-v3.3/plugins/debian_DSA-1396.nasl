...
'The remote host is missing the DSA-1396 security update');
...
deb_check(prefix: 'firefox', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
deb_check(prefix: 'firefox-dom-inspector', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
deb_check(prefix: 'firefox-gnome-support', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
...
deb_check(prefix: 'iceweasel-dom-inspector', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
deb_check(prefix: 'iceweasel-gnome-support', release: '4.0', reference: '2.0.0.6-0etch1');
deb_check(prefix: 'mozilla-firefox', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
deb_check(prefix: 'mozilla-firefox-dom-inspector', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
deb_check(prefix: 'mozilla-firefox-gnome-support', release: '4.0', reference: '2.0.0.6+2.0.0.8-0etch1');
