...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7541
#
...
script_name(english: "Fedora 9 2008-7541: xastir");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7541 (xastir)");
...
if ( rpm_check( reference:"xastir-1.9.2-9.fc9", release:"FC9") )
{
