...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2678
#
...
script_name(english: "Fedora 7 2008-2678: namazu");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2678 (namazu)");
...
if ( rpm_check( reference:"namazu-2.0.18-1.fc7", release:"FC7") )
{
