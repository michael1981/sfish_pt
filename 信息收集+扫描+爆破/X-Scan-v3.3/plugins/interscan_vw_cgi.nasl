...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"607");
 script_version ("$Revision: 1.18 $");

#Name used in the client window.

name["english"] = "InterScan VirusWall /interscan/cgi-bin/FtpSave.dll Unauthenticated Remote Configuration Manipulation";
...
script_copyright(english:"Copyright (C) INTRANODE - 2001-2009");
