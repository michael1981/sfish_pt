...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"47587");
...
"Upgrade PowerDNS to version 2.9.21.1." );
 script_set_attribute(attribute:"see_also", value:"http://doc.powerdns.com/powerdns-advisory-2008-02.html" );
 script_set_attribute(attribute:"cvss_vector", value: "CVSS2#AV:N/AC:H/Au:N/C:N/I:C/A:C" );
