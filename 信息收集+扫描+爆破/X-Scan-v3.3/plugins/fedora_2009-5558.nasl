...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5558
#
...
script_name(english: "Fedora 10 2009-5558: freetype1");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5558 (freetype1)");
...
if ( rpm_check( reference:"freetype1-1.4-0.8.pre.fc10", release:"FC10") )
{
