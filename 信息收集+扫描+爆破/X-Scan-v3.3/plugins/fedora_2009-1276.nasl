...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1276
#
...
script_name(english: "Fedora 9 2009-1276: nss");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1276 (nss)");
...
if ( rpm_check( reference:"nss-3.12.2.0-2.fc9", release:"FC9") )
{
