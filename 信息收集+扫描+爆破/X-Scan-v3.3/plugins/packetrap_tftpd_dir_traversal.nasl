...
if (description)
{
  ...
  script_bugtraq_id(28078, 28079);
  script_xref(name:"OSVDB", value:"43060");
  script_xref(name:"OSVDB", value:"43061");
...
"PacketTrap pt360 Tool Suite is installed on the remote system.  It is
a single reporting solution that integrates various free network
...
exploitation of the issue may lead to a complete system compromise." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-03/0023.html" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-03/0024.html" );
