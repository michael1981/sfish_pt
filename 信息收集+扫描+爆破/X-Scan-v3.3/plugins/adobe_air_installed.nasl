...
Flash code and provides for Rich Internet Applications (RIAs)." );
 script_set_attribute(attribute:"see_also", value:"http://www.adobe.com/products/air/" );
 script_set_attribute(attribute:"solution", value:
"Ensure that use of Adobe AIR itself and any associated RIAs agrees with your
...
if (!isnull(version) && !isnull(path))
{
  ...
  if (i > max_apps && !thorough_tests)
  {
    app_report = string(
      ...
      "For a complete audit, edit the scan policy, enable 'Thorough Tests',\n",
      "and re-run the scan.\n"
    );
  }
