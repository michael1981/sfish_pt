...
'The remote host is missing the DSA-652 security update');
...
'The Debian project recommends that you upgrade your unarj package.');
...
deb_check(prefix: 'unarj', release: '3.0', reference: '2.43-3woody1');
