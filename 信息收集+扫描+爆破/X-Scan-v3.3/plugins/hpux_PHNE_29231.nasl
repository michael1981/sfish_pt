...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHNE_29231");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHNE_29231 security update");
 script_set_attribute(attribute: "description", value:
"nettl(1M) & nettladm(1M) cumulative patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//hp-ux_patches/s700_800/11.X/PHNE_29231");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHNE_29231");
