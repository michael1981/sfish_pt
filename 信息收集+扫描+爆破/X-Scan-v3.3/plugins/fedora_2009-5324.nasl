...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5324
#
...
script_name(english: "Fedora 11 2009-5324: quagga");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5324 (quagga)");
...
if ( rpm_check( reference:"quagga-0.99.12-1.fc11", release:"FC11") )
{
