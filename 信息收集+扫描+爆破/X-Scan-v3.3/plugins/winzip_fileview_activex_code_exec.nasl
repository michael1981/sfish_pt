...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"30432");
  script_xref(name:"OSVDB", value:"30433");
...
arbitrary code on the host subject to the user's privileges." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2006-11/0247.html" );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/225217" );
