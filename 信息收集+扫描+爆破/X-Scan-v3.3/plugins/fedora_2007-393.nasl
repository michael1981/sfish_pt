...
#
# This plugin text was extracted from Fedora Security Advisory 2007-393
#
...
script_name(english: "Fedora 6 2007-393: evolution");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-393 (evolution)");
...
if ( rpm_check( reference:"evolution-2.8.3-2.fc6", release:"FC6") )
{
