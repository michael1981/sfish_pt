...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1737
#
...
script_name(english: "Fedora 10 2009-1737: fail2ban");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1737 (fail2ban)");
...
if ( rpm_check( reference:"fail2ban-0.8.3-18.fc10", release:"FC10") )
{
