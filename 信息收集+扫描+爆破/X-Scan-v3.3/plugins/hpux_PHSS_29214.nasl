...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_29214");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_29214 security update");
 script_set_attribute(attribute: "description", value:
"(VVOS) CDE Runtime Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_29214");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_29214");
