...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1520
#
...
script_name(english: "Fedora 9 2009-1520: squidGuard");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1520 (squidGuard)");
...
if ( rpm_check( reference:"squidGuard-1.2.1-2.fc9", release:"FC9") )
{
