...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6810
#
...
script_name(english: "Fedora 8 2008-6810: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6810 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.8.1-1.fc8", release:"FC8") )
{
