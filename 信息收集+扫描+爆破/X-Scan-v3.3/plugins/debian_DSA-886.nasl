...
'The remote host is missing the DSA-886 security update');
...
'The Debian project recommends that you upgrade your chmlib packages.');
...
deb_check(prefix: 'chmlib', release: '3.1', reference: '0.35-6sarge1');
deb_check(prefix: 'chmlib-bin', release: '3.1', reference: '0.35-6sarge1');
deb_check(prefix: 'chmlib-dev', release: '3.1', reference: '0.35-6sarge1');
