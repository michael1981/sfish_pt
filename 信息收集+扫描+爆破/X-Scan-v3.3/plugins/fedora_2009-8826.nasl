...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8826
#
...
script_name(english: "Fedora 11 2009-8826: pidgin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8826 (pidgin)");
...
if ( rpm_check( reference:"pidgin-2.6.1-1.fc10", release:"FC11") )
{
