...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  wget (2009-08-12)");
...
if ( rpm_check( reference:"wget-1.11.1-11.2", release:"SUSE11.0", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"wget-1.11.1-11.2", release:"SUSE11.0", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
