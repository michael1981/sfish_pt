...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:163: kdegraphics");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:163 (kdegraphics).");
 script_set_attribute(attribute: "description", value: "iDefense reported a buffer overflow vulnerability, which affects
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:163");
