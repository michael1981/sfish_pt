...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"40701");
  script_xref(name:"Secunia", value:"28662");

  script_name(english:"CandyPress Store admin/utilities_ConfigHelp.asp helpfield Variable SQL Injection");
...
vulnerabilities, although Nessus did not explicitly check for them." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-01/0369.html" );
 script_set_attribute(attribute:"see_also", value:"http://www.candypress.com/CPforum/forum_posts.asp?TID=10630&PN=1" );
