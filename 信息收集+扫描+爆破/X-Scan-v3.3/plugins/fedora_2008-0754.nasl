...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0754
#
...
script_name(english: "Fedora 8 2008-0754: boost");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0754 (boost)");
...
if ( rpm_check( reference:"boost-1.34.1-7.fc8", release:"FC8") )
{
