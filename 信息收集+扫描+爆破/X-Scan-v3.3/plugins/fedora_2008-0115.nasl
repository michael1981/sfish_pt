...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0115
#
...
script_name(english: "Fedora 8 2008-0115: clamav");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0115 (clamav)");
...
if ( rpm_check( reference:"clamav-0.92-6.fc8", release:"FC8") )
{
