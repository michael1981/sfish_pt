...
if(description)
{
 ...
 script_name(english: "SuSE 11.2 Security Update:  update-test-security (2009-05-05)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing a security patch for update-test-security");
