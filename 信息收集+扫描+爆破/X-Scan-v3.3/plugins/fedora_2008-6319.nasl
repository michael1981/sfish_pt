...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6319
#
...
script_name(english: "Fedora 8 2008-6319: newsx");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6319 (newsx)");
...
* Sat Jul 12 2008 Dominik Mierzejewski <rpm greysector net> 1.6-8
...
if ( rpm_check( reference:"newsx-1.6-8.fc8", release:"FC8") )
{
