...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1220
#
...
script_name(english: "Fedora 6 2006-1220: cups");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2004-0888", "CVE-2004-0923", "CVE-2005-0064", "CVE-2005-2097", "CVE-2005-3625", "CVE-2005-3627");
...
if ( rpm_check( reference:"cups-lpd-1.2.7-1.3.fc6", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"cups-1.2.7-1.3.fc6", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"cups-libs-1.2.7-1.3.fc6", release:"FC6") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
