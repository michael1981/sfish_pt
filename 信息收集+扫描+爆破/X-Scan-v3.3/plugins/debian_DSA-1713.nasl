# This script was automatically generated from the dsa-1713
...
'The remote host is missing the DSA-1713 security update');
...
'The Debian project recommends that you upgrade your rt2500 package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:M/Au:N/C:C/I:C/A:C');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1713] DSA-1713-1 rt2500");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1713-1 rt2500");
 exit(0);
}
...
deb_check(prefix: 'rt2500', release: '4.0', reference: '1.1.0+cvs20060620-3+etch1');
deb_check(prefix: 'rt2500-source', release: '4.0', reference: '1.1.0+cvs20060620-3+etch1');
