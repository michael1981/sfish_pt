...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7339
#
...
script_name(english: "Fedora 9 2008-7339: adminutil");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7339 (adminutil)");
...
if ( rpm_check( reference:"adminutil-1.1.7-1.fc9", release:"FC9") )
{
