...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  ntp (2009-05-08)");
...
if ( rpm_check( reference:"ntp-4.2.4p4-44.5", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"ntp-4.2.4p4-44.5", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"ntp-doc-4.2.4p4-44.5", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"ntp-doc-4.2.4p4-44.5", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
