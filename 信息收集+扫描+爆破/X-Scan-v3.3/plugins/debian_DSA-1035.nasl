...
'The remote host is missing the DSA-1035 security update');
...
'http://www.debian.org/security/2006/dsa-1035');
 script_set_attribute(attribute: 'solution', value: 
'The Debian project recommends that you upgrade your fcheck package.');
...
deb_check(prefix: 'fcheck', release: '3.1', reference: '2.7.59-7sarge1');
