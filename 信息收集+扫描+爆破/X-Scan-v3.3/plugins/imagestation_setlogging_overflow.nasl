...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"5086");
  script_xref(name:"OSVDB", value:"41601");
...
host into viewing a specially-crafted HTML document, he may be able to
use this method to execute arbitrary code on the affected system
