...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"3257");
 ...
 script_set_attribute(
   attribute:"synopsis",
   value:"The remote telnet server has a stack buffer overflow vulnerability."
 );
 script_set_attribute(
   ...
   value:string(
     ...
     "in the login procedure.  A remote attacker could exploit this to\n",
