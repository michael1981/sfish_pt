...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:195: squid");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:195 (squid).");
 script_set_attribute(attribute: "description", value: "The rfc1738_do_escape function in ftp.c for Squid 2.5.STABLE11 and
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:195");
