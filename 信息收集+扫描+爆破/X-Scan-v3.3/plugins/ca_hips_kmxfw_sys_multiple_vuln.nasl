...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"47593");
  script_xref(name:"OSVDB", value:"47594");
...
"The 'kmxfw.sys' kernel driver included with CA's Host-Based 
Intrusion Prevention System (HIPS) or a related security
product installed on the remote host is affected by multiple
vulnerabilities. 
