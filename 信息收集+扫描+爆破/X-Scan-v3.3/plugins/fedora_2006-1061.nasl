...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1061
#
...
script_name(english: "Fedora 5 2006-1061: mutt");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1061 (mutt)");
...
* Tue Oct 24 2006 Miroslav Lichvar <mlichvar redhat com> 5:1.4.2.1-7.fc5
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-3242", "CVE-2006-5297");
...
if ( rpm_check( reference:"mutt-1.4.2.1-7.fc5", release:"FC5") )
{
