...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  opera: Security update to version 9.0 (opera-1697)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch opera-1697");
script_end_attributes();

script_cve_id("CVE-2006-3198");
script_summary(english: "Check for the opera-1697 package");
