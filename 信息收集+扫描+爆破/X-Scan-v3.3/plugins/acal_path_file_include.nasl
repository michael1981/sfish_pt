...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"25340");

  script_name(english:"ACal embed/day.php path Variable Remote File Inclusion");
...
hosts." );
 script_set_attribute(attribute:"see_also", value:"http://milw0rm.com/exploits/1763" );
