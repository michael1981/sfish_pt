...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"25937");

  script_name(english:"F-Secure Multiple Products Web Console Pre-authentication Overflow");
...
has been specifically configured to accept connections remotely." );
 script_set_attribute(attribute:"see_also", value:"http://www.f-secure.com/security/fsc-2006-3.shtml" );
