...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2778
#
...
script_name(english: "Fedora 8 2008-2778: Perlbal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2778 (Perlbal)");
...
if ( rpm_check( reference:"Perlbal-1.70-1.fc8", release:"FC8") )
{
