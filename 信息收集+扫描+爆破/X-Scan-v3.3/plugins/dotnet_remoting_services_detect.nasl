...
channel services are supplied as part of Microsoft's .NET Framework -
...
uses SOAP by default." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://en.wikipedia.org/wiki/.NET_Remoting" );
