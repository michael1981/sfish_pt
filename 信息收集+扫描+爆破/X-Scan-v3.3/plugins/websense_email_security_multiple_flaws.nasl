...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"59072");
  script_xref(name:"OSVDB", value:"59073");
  script_xref(name:"OSVDB", value:"59074");
  script_xref(name:"OSVDB", value:"59075");
  script_xref(name:"OSVDB", value:"59076");
...
"Websense Email Security is installed on the remote host.  The
installed version is affected by multiple issues :
  ...
  script_set_attribute(attribute:"see_also", value:"http://kb.websense.com/display/4/kb/article.aspx?aid=4786&n=1&docid=692467&tab=search" );

  script_set_attribute(attribute:"solution", value:
"Apply Hotfix 4 for version 7.1." );
