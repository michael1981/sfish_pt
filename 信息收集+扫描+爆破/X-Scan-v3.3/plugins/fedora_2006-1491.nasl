...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1491
#
...
script_name(english: "Fedora 6 2006-1491: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1491 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-1.5.0.9-2.fc6", release:"FC6") )
{
