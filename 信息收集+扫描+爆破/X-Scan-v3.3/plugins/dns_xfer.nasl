...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"492");

 script_name(english:"DNS Server Zone Tranfer Information Disclosure (AXFR)"); 
...
"2001/01/16");
 ...
 script_copyright(english:"This script is Copyright (C) 2000-2009 j_lampe@bellsouth.net");
 script_family(english: "DNS");

 # should require "Services/dns" but find_service1.nasl does not recognize dns
 # mayby copy copy some code from here to find_service1.nasl???
