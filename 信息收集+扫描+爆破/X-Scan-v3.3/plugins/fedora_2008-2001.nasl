...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2001
#
...
script_name(english: "Fedora 7 2008-2001: qemu");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2001 (qemu)");
...
if ( rpm_check( reference:"qemu-0.9.0-4.fc7", release:"FC7") )
{
