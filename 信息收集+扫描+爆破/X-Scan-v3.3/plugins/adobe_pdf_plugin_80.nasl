...
if (description)
{
  ...
  script_cve_id("CVE-2007-0044", "CVE-2007-0045", "CVE-2007-0046", "CVE-2007-0047", "CVE-2007-0048");
  ...
  script_name(english:"Adobe PDF Plug-In < 8.0 / 7.0.9 / 6.0.6 Multiple Vulnerabilities");
...
link and depending on the browser with which the plugin is used, a
...
host." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/815960" );
