...
if(description)
{
 ...
 script_name(english: "SuSE9 Security Update:  Security update for IBM Java 2 JRE and SDK (12142)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE9 system is missing the security patch 12142");
...
otherwise normally accessible to be accessed or
exploited.
...
script_set_attribute(attribute: "solution", value: "Install the security patch 12142");
...
script_summary(english: "Check for the security advisory #12142");
...
if ( rpm_check( reference:"IBMJava2-JRE-1.4.2-0.112", release:"SUSE9", cpu: "i586") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"IBMJava2-SDK-1.4.2-0.112", release:"SUSE9", cpu: "i586") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
