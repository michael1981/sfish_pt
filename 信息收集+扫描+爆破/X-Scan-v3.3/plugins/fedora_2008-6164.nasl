...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6164
#
...
script_name(english: "Fedora 8 2008-6164: jetty");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6164 (jetty)");
...
if ( rpm_check( reference:"jetty-5.1.14-1jpp.1.fc8", release:"FC8") )
{
