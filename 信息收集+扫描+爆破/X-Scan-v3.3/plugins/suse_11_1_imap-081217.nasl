...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  imap (2008-12-17)");
...
if ( rpm_check( reference:"imap-devel-2006c1_suse-127.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"imap-devel-2006c1_suse-127.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"imap-lib-2006c1_suse-127.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"imap-lib-2006c1_suse-127.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
