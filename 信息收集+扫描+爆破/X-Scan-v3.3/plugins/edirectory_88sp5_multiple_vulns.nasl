...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"55847");
  script_xref(name:"OSVDB", value:"55848");
  script_xref(name:"OSVDB", value:"55849");
  script_xref(name:"Secunia", value:"34160");

  script_name(english:"eDirectory < 8.8 SP5 Multiple Vulnerabilities");
