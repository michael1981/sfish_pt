...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0867
#
...
script_name(english: "Fedora 10 2009-0867: DevIL");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0867 (DevIL)");
...
if ( rpm_check( reference:"DevIL-1.7.5-2.fc10", release:"FC10") )
{
