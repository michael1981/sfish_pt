# This script was automatically generated from the 744-1 Ubuntu Security Notice
...
script_summary(english:"lcms vulnerabilities");
script_name(english:"USN744-1 : lcms vulnerabilities");
...
- python-liblcms 
');
script_set_attribute(attribute:'description', value: 'Chris Evans discovered that LittleCMS did not properly handle certain error
...
- liblcms-utils-1.16-10ubuntu0.2 (Ubuntu 8.10)
- liblcms1-1.16-10ubuntu0.2 (Ubuntu 8.10)
- liblcms1-dev-1.16-10ubuntu0.2 (Ubuntu 8.10)
- python-liblcms-1.16-10ubuntu0.2 (Ubuntu 8.10)
');
...
found = ubuntu_check(osver: "8.10", pkgname: "liblcms-utils", pkgver: "1.16-10ubuntu0.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package liblcms-utils-',found,' is vulnerable in Ubuntu 8.10
Upgrade it to liblcms-utils-1.16-10ubuntu0.2
');
}
found = ubuntu_check(osver: "8.10", pkgname: "liblcms1", pkgver: "1.16-10ubuntu0.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package liblcms1-',found,' is vulnerable in Ubuntu 8.10
Upgrade it to liblcms1-1.16-10ubuntu0.2
');
}
found = ubuntu_check(osver: "8.10", pkgname: "liblcms1-dev", pkgver: "1.16-10ubuntu0.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package liblcms1-dev-',found,' is vulnerable in Ubuntu 8.10
Upgrade it to liblcms1-dev-1.16-10ubuntu0.2
');
}
found = ubuntu_check(osver: "8.10", pkgname: "python-liblcms", pkgver: "1.16-10ubuntu0.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package python-liblcms-',found,' is vulnerable in Ubuntu 8.10
Upgrade it to python-liblcms-1.16-10ubuntu0.2
');
}
