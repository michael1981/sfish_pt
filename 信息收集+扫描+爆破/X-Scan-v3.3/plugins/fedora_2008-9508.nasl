...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9508
#
...
script_name(english: "Fedora 9 2008-9508: moodle");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9508 (moodle)");
...
if ( rpm_check( reference:"moodle-1.9.3-3.fc9", release:"FC9") )
{
