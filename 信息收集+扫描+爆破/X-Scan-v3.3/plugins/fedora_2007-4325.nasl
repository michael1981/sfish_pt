...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4325
#
...
script_name(english: "Fedora 7 2007-4325: eggdrop");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4325 (eggdrop)");
...
if ( rpm_check( reference:"eggdrop-1.6.18-12.fc7", release:"FC7") )
{
