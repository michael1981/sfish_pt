...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2725
#
...
script_name(english: "Fedora 7 2007-2725: liferea");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2725 (liferea)");
...
if ( rpm_check( reference:"liferea-1.2.23-4.fc7", release:"FC7") )
{
