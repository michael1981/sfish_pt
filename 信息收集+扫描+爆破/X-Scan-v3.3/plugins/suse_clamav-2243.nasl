...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for clamav (clamav-2243)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch clamav-2243");
...
script_set_attribute(attribute: "solution", value: "Install the security patch clamav-2243");
script_end_attributes();

script_summary(english: "Check for the clamav-2243 package");
...
if ( rpm_check( reference:"clamav-0.88.6-1.4", release:"SLES10") )
{
