...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7894
#
...
script_name(english: "Fedora 8 2008-7894: wireshark");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7894 (wireshark)");
...
es
addressed in the new upstream version:  [10]http://www.wireshark.org/security/w
npa-
sec-2008-05.html
");
...
if ( rpm_check( reference:"wireshark-1.0.3-1.fc8", release:"FC8") )
{
