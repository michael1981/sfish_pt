...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9254
#
...
script_name(english: "Fedora 10 2009-9254: ikiwiki");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9254 (ikiwiki)");
...
if ( rpm_check( reference:"ikiwiki-2.72-2.fc10", release:"FC10") )
{
