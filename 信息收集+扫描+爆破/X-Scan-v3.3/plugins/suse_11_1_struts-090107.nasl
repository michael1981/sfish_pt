...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  struts (2009-01-07)");
...
if ( rpm_check( reference:"struts-1.2.9-162.163.2", release:"SUSE11.1", cpu:"noarch") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"struts-javadoc-1.2.9-162.163.2", release:"SUSE11.1", cpu:"noarch") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"struts-manual-1.2.9-162.163.2", release:"SUSE11.1", cpu:"noarch") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"struts-webapps-tomcat6-1.2.9-162.163.2", release:"SUSE11.1", cpu:"noarch") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
