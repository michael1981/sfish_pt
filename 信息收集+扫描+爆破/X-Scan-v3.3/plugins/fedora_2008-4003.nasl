...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4003
#
...
script_name(english: "Fedora 9 2008-4003: perl-Imager");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4003 (perl-Imager)");
...
if ( rpm_check( reference:"perl-Imager-0.64-2.fc9", release:"FC9") )
{
