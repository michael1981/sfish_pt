...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"48819");
  script_xref(name:"OSVDB", value:"48820");
  script_xref(name:"OSVDB", value:"48821");
...
It should be noted that code execution will generally result in
a complete compromise of the affected system." );
