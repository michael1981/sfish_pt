...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:044: gftp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:044 (gftp).");
 script_set_attribute(attribute: "description", value: "A format string vulnerability exists in all versions of gftp prior to
version 2.0.8. This vulnerability has been fixed upstream in version
2.0.8.
");
 script_set_attribute(attribute: "risk_factor", value: "High");
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:044");
