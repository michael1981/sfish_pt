...
"The remote host is missing Sun Security Patch number 139620-01");
...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"139620-01", obsoleted_by:"", package:"SUNWdtbas", version:"1.6,REV=10.2004.12.17");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
