...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"18823");

 name["english"] = "MS05-055: Vulnerability in Windows Kernel Could Allow Elevation of Privilege (908523)";
...
if (is_accessible_share())
{
 ...
 {
 set_kb_item(name:"SMB/Missing/MS05-055", value:TRUE);
