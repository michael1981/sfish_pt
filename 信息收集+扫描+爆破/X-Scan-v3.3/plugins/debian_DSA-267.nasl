...
'The remote host is missing the DSA-267 security update');
...
'The Debian project recommends that you upgrade your lpr package immediately.');
...
deb_check(prefix: 'lpr', release: '2.2', reference: '0.48-1.2');
deb_check(prefix: 'lpr', release: '3.0', reference: '2000.05.07-4.3');
deb_check(prefix: 'lpr', release: '2.2', reference: '0.48-1.1');
