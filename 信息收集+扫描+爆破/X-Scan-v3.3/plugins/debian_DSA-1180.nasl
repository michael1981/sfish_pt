...
'The remote host is missing the DSA-1180 security update');
...
'The Debian project recommends that you upgrade your bomberclone package.');
...
deb_check(prefix: 'bomberclone', release: '3.1', reference: '0.11.5-1sarge2');
deb_check(prefix: 'bomberclone-data', release: '3.1', reference: '0.11.5-1sarge2');
