...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3019
#
...
script_name(english: "Fedora 7 2007-3019: net-snmp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3019 (net-snmp)");
...
if ( rpm_check( reference:"net-snmp-5.4-16.fc7", release:"FC7") )
{
