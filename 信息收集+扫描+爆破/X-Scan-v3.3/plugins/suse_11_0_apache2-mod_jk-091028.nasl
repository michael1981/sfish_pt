...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  apache2-mod_jk (2009-10-28)");
...
if ( rpm_check( reference:"apache2-mod_jk-1.2.21-129.2", release:"SUSE11.0", cpu:"i586") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"apache2-mod_jk-1.2.21-129.2", release:"SUSE11.0", cpu:"x86_64") )
{
	security_note(port:0, extra:rpm_report_get() );
	exit(0);
}
