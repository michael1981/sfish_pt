...
'The remote host is missing the DSA-1228 security update');
...
deb_check(prefix: 'elinks', release: '3.1', reference: '0.10.4-7.1');
deb_check(prefix: 'elinks-lite', release: '3.1', reference: '0.10.4-7.1');
deb_check(prefix: 'elinks', release: '4.0', reference: '0.11.1-1.2');
