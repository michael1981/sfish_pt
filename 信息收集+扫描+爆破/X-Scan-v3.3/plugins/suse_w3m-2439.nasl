...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for w3m (w3m-2439)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch w3m-2439");
script_end_attributes();

script_cve_id("CVE-2006-6772");
script_summary(english: "Check for the w3m-2439 package");
