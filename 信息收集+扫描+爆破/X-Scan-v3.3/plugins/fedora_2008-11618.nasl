...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11618
#
...
script_name(english: "Fedora 10 2008-11618: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11618 (kernel)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-2750", "CVE-2008-3525", "CVE-2008-3528", "CVE-2008-3831", "CVE-2008-5079", "CVE-2008-5182", "CVE-2008-5300");
...
if ( rpm_check( reference:"kernel-2.6.27.9-73.fc9", prefix:"kernel-", release:"FC10") )
{
