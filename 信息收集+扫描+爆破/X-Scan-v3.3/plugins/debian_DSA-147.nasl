...
'The remote host is missing the DSA-147 security update');
...
deb_check(prefix: 'mailman', release: '2.2', reference: '1.1-10.1');
deb_check(prefix: 'mailman', release: '3.0', reference: '2.0.11-1woody4');
