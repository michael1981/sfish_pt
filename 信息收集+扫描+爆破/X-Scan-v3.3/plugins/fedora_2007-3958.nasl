...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3958
#
...
script_name(english: "Fedora 8 2007-3958: htdig");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3958 (htdig)");
...
if ( rpm_check( reference:"htdig-3.2.0b6-13.fc8", release:"FC8") )
{
