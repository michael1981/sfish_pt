...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"25261");

  script_name(english:"phpBB Advanced GuestBook addentry.php phpbb_root_path Variable Remote File Inclusion");
...
possibly taken from third-party hosts." );
 script_set_attribute(attribute:"see_also", value:"http://milw0rm.com/exploits/1723" );
