...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  ImageMagick (2009-06-04)");
...
if ( rpm_check( reference:"libMagickCore1-6.4.3.6-7.19.1", release:"SLES11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"ImageMagick-6.4.3.6-7.19.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libMagick++1-6.4.3.6-7.19.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libMagickCore1-6.4.3.6-7.19.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libMagickWand1-6.4.3.6-7.19.1", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
