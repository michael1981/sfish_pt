...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_36123");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_36123 security update");
 script_set_attribute(attribute: "description", value:
"11.31 Xserver cumulative patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/11.X/PHSS_36123");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_36123");
...
if ( hpux_patch_installed (patches:"PHSS_36123 PHSS_37621 PHSS_37973 PHSS_38840 PHSS_39258 PHSS_39706 PHSS_39876 ") )
{
 exit(0);
}
