...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7029
#
...
script_name(english: "Fedora 8 2008-7029: libxslt");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7029 (libxslt)");
...
if ( rpm_check( reference:"libxslt-1.1.24-2.fc8", release:"FC8") )
{
