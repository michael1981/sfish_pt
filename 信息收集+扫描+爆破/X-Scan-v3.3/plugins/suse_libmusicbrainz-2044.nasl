...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libmusicbrainz: This update fixes various buffer overflows (libmusicbrainz-2044)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch libmusicbrainz-2044");
script_end_attributes();

script_cve_id("CVE-2006-4197");
script_summary(english: "Check for the libmusicbrainz-2044 package");
