...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4469
#
...
script_name(english: "Fedora 7 2007-4469: autofs");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4469 (autofs)");
...
if ( rpm_check( reference:"autofs-5.0.1-29", release:"FC7") )
{
