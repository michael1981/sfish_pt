...
'The remote host is missing the DSA-166 security update');
...
'The Debian project recommends that you upgrade your purity packages.');
...
deb_check(prefix: 'purity', release: '2.2', reference: '1-9.1');
deb_check(prefix: 'purity', release: '3.0', reference: '1-14.2');
