...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  tar: Securityupdate to fix symlink traversal (tar-2351)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch tar-2351");
...
script_set_attribute(attribute: "solution", value: "Install the security patch tar-2351");
script_end_attributes();

script_cve_id("CVE-2006-6097");
script_summary(english: "Check for the tar-2351 package");
...
if ( rpm_check( reference:"tar-1.15.1-42.2", release:"SUSE10.2") )
{
