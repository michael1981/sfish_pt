...
#
# This plugin text was extracted from Fedora Security Advisory 2007-605
#
...
script_name(english: "Fedora 5 2007-605: libexif");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-605 (libexif)");
...
if ( rpm_check( reference:"libexif-0.6.12-5", release:"FC5") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"libexif-devel-0.6.12-5", release:"FC5") )
{
 security_warning(port:0, extra:rpm_report_get());
 exit(0);
}
