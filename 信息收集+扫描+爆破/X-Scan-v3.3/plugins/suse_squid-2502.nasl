...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for squid (squid-2502)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch squid-2502");
script_end_attributes();

script_cve_id("CVE-2007-0247", "CVE-2007-0248");
script_summary(english: "Check for the squid-2502 package");
