...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"37463");
  script_xref(name:"OSVDB", value:"37464");
  script_xref(name:"OSVDB", value:"38337");
  script_xref(name:"OSVDB", value:"53372");
...
site script attack against the affected application." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2007-05/0511.html" );
