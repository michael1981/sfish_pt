...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_37183");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_37183 security update");
 script_set_attribute(attribute: "description", value:
"X OV OVO8.X PARISC JavaGUI client A.08.27");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_37183");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_37183");
...
if ( hpux_patch_installed (patches:"PHSS_37183 PHSS_37566 PHSS_38203 PHSS_38854 PHSS_39327 PHSS_39896 ") )
{
 exit(0);
}
