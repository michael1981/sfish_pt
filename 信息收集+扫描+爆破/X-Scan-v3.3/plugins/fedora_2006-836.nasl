...
#
# This plugin text was extracted from Fedora Security Advisory 2006-836
#
...
script_name(english: "Fedora 4 2006-836: sendmail");
...
* Tue Jul 18 2006 Thomas Woerner <twoerner redhat com> 8.13.7-2.fc4.1
...
if ( rpm_check( reference:"sendmail-8.13.7-2.fc4.1", release:"FC4") )
{
