...
'The remote host is missing the DSA-299 security update');
...
'Read http://www.debian.org/security/2003/dsa-299
...
deb_check(prefix: 'leksbot', release: '3.0', reference: '1.2-3.1woody1');
deb_check(prefix: 'leksbot', release: '3.0', reference: '1.2-3.1');
