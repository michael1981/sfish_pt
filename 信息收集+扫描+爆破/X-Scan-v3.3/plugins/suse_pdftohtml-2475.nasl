...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  pdftohtml: This update fixes a vulnerability which occurs while processing a special PDF file. (pdftohtml-2475)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch pdftohtml-2475");
script_end_attributes();

script_cve_id("CVE-2007-0104");
script_summary(english: "Check for the pdftohtml-2475 package");
