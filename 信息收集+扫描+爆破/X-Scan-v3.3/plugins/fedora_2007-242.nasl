...
#
# This plugin text was extracted from Fedora Security Advisory 2007-242
#
...
script_name(english: "Fedora 5 2007-242: spamassassin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-242 (spamassassin)");
...
if ( rpm_check( reference:"spamassassin-3.1.8-1.fc5", release:"FC5") )
{
