...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3184
#
...
script_name(english: "Fedora 8 2007-3184: openvrml");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3184 (openvrml)");
...
if ( rpm_check( reference:"openvrml-0.16.6-8.fc8", release:"FC8") )
{
