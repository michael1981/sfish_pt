...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"48946");
...
This control reportedly has stack buffer overflows in its 'url()',
'toolbar()', and 'enableZoomPastMax()' methods.  If an attacker can
...
on the affected system subject to the user's privileges." );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/848873" );
