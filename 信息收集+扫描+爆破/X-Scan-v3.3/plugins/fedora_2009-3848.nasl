...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3848
#
...
script_name(english: "Fedora 9 2009-3848: maniadrive");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3848 (maniadrive)");
 script_set_attribute(attribute: "description", value: "ManiaDrive is an arcade car game on acrobatic tracks, with a quick and nervous
...
script_summary(english: "Check for the version of the maniadrive package");
...
if ( rpm_check( reference:"maniadrive-1.2-13.fc9", release:"FC9") )
{
