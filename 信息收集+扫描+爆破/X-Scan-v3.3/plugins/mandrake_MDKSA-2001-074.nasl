...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:074: WindowMaker");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:074 (WindowMaker).");
 script_set_attribute(attribute: "description", value: "A buffer overflow exists in the WindowMaker window manager's window
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:074");
