...
'The remote host is missing the DSA-203 security update');
...
'The Debian project recommends that you upgrade your smb2www package immediately.');
...
deb_check(prefix: 'smb2www', release: '2.2', reference: '980804-8.1');
deb_check(prefix: 'smb2www', release: '3.0', reference: '980804-16.1');
