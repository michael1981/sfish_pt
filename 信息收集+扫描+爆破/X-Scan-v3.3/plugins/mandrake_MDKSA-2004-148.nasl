...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:148: iproute2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:148 (iproute2).");
 script_set_attribute(attribute: "description", value: "Herbert Xu discovered that iproute can accept spoofed messages sent
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:148");
