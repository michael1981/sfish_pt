...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3392
#
...
script_name(english: "Fedora 8 2008-3392: perl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3392 (perl)");
...
if ( rpm_check( reference:"perl-5.8.8-39.fc8", release:"FC8") )
{
