...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6647
#
...
script_name(english: "Fedora 9 2008-6647: mantis");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6647 (mantis)");
...
if ( rpm_check( reference:"mantis-1.1.2-1.fc9", release:"FC9") )
{
