...
#
# This plugin text was extracted from Fedora Security Advisory 2007-582
#
...
script_name(english: "Fedora 6 2007-582: spamassassin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-582 (spamassassin)");
...
if ( rpm_check( reference:"spamassassin-3.1.9-1.fc6", release:"FC6") )
{
