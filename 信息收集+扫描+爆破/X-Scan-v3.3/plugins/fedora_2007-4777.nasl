...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4777
#
...
script_name(english: "Fedora 7 2007-4777: gallery2");
...
if ( rpm_check( reference:"gallery2-2.2.4-1.fc7", release:"FC7") )
{
