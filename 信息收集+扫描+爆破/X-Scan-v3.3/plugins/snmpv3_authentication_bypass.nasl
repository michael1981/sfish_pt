...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"5790");
  script_xref(name:"CERT", value:"878044");
  script_xref(name:"OSVDB", value:"46059");
  script_xref(name:"OSVDB", value:"46060");
  script_xref(name:"OSVDB", value:"55248");
  ...
  script_set_attribute(
    attribute:'synopsis',
    value:string(
      'The SNMP server running on this host is affected by an\n',
  ...
  script_set_attribute(
    ...
    value:string(
      'SNMPv3 HMAC verification relies on the client to specify the\n',
      'HMAC length.  This makes it possible for remote attackers to\n',
      'bypass SNMP authentication via repeated attempts with a HMAC\n',
      'length value of 1, which causes only the first byte of the\n',
      'authentication hash to be checked.\n',
      '\n',
  ...
  script_set_attribute(
    attribute:'see_also',
    value:'http://sourceforge.net/forum/forum.php?forum_id=833770'
  );

  script_set_attribute(
    attribute:'see_also',
    value:'http://www.kb.cert.org/vuls/id/878044'
  );

  script_set_attribute(
    attribute:'solution',
    value:string(
      'This vulnerability affects multiple products from multiple\n',
      'vendors.  Check with your vendor for the appropriate solution.'
    )
  );
  script_set_attribute(
