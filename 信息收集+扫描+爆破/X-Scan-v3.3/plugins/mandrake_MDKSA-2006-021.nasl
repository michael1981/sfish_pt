...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:021: mozilla-thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:021 (mozilla-thunderbird).");
 script_set_attribute(attribute: "description", value: "GUI display truncation vulnerability in Mozilla Thunderbird 1.0.2, 1.0.6,
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:021");
