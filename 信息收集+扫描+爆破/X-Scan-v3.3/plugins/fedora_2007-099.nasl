...
#
# This plugin text was extracted from Fedora Security Advisory 2007-099
#
...
script_name(english: "Fedora 5 2007-099: ed");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-099 (ed)");
...
if ( rpm_check( reference:"ed-0.3-0.fc5", release:"FC5") )
{
