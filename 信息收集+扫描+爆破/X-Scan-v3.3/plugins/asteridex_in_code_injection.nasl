...
if (description)
{
  ...
  script_name(english:"AsteriDex callboth.php Multiple Variable CRLF Injection Arbitrary Command Execution");
...
privileges of the user id under which Asterisk runs." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.milw0rm.com/exploits/4151" );
