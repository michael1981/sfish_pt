...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200907-13 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200907-13
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2009-1894');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200907-13.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'PulseAudio: Local privilege escalation');
 exit(0);
}
...
if (qpkg_check(package: "media-sound/pulseaudio", unaffected: make_list("ge 0.9.9-r54"), vulnerable: make_list("lt 0.9.9-r54")
