...
script_set_attribute(attribute:'synopsis', value: 'The remote package "dhcdbd" is missing a security patch.');
script_set_attribute(attribute:'description', value: 'Florian Hackenberger discovered a memory corruption bug in dhcdbd (the
