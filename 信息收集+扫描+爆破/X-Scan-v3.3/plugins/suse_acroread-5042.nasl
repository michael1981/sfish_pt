...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for acroread (acroread-5042)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch acroread-5042");
script_end_attributes();

script_cve_id("CVE-2008-0883");
script_summary(english: "Check for the acroread-5042 package");
