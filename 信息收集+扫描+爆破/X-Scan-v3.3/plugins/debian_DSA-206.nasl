...
'The remote host is missing the DSA-206 security update');
...
'Read http://www.debian.org/security/2002/dsa-206
...
deb_check(prefix: 'tcpdump', release: '3.0', reference: '3.6.2-2.2');
