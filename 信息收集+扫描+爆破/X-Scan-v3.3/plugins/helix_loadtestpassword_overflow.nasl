...
which it runs, which by default on Windows is LOCAL SYSTEM." );
 script_set_attribute(attribute:"see_also", value:"http://gleg.net/helix.txt" );
 script_set_attribute(attribute:"see_also", value:"http://www.securityfocus.com/archive/1/463333/30/0/threaded" );
 script_set_attribute(attribute:"see_also", value:"http://lists.helixcommunity.org/pipermail/server-cvs/2007-January/003783.html" );
