...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"18332");
...
device to reload repeatedly or to execute arbitrary code in the remote IOS." );
 script_set_attribute(attribute:"see_also", value:"http://www.cisco.com/warp/public/707/cisco-sa-20050729-ipv6.shtml" );
...
else if ( vuln > 1 )  display("Problem in script $Id: CSCef68324.nasl,v 1.7 2009/10/28 20:47:00 theall Exp $\n");
