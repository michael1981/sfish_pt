...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  fix possible buffer overflows in check_http and check_snmp (nagios-plugins-4621)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch nagios-plugins-4621");
script_end_attributes();

script_cve_id("CVE-2007-5198", "CVE-2007-5623");
script_summary(english: "Check for the nagios-plugins-4621 package");
