...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3711
#
...
script_name(english: "Fedora 10 2009-3711: udev");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3711 (udev)");
...
if ( rpm_check( reference:"udev-127-5.fc10", release:"FC10") )
{
