...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3390
#
...
script_name(english: "Fedora 7 2007-3390: tetex");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3390 (tetex)");
...
if ( rpm_check( reference:"tetex-3.0-40.3.fc7", release:"FC7") )
{
