...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1535
#
...
script_name(english: "Fedora 8 2008-1535: galeon");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1535 (galeon)");
...
if ( rpm_check( reference:"galeon-2.0.4-1.fc8.2", release:"FC8") )
{
