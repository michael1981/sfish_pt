...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1824
#
...
script_name(english: "Fedora 10 2009-1824: jhead");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1824 (jhead)");
...
if ( rpm_check( reference:"jhead-2.86-1.fc10", release:"FC10") )
{
