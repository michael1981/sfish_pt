...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4590
#
...
script_name(english: "Fedora 8 2007-4590: wireshark");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4590 (wireshark)");
...
if ( rpm_check( reference:"wireshark-0.99.7-2.fc8", release:"FC8") )
{
