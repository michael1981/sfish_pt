...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8286
#
...
script_name(english: "Fedora 8 2008-8286: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8286 (phpMyAdmin)");
...
specified XSS in MSIE using NUL byte vulnerability.    - [auth] Links to versio
n
...
if ( rpm_check( reference:"phpMyAdmin-2.11.9.2-1.fc8", release:"FC8") )
{
