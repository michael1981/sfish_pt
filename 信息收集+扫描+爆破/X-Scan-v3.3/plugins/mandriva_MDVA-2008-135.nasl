...
"The remote host is missing the patch for the advisory MDVA-2008:135 (draksnapshot).");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDVA-2008:135");
...
if ( rpm_check( reference:"draksnapshot-0.19-2.1mdv2008.1", release:"MDK2008.1", yank:"mdv") )
{
