...
#
# This plugin text was extracted from Fedora Security Advisory 2009-10582
#
...
script_name(english: "Fedora 10 2009-10582: ocaml-mysql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-10582 (ocaml-mysql)");
...
if ( rpm_check( reference:"ocaml-mysql-1.0.4-3.fc10.1", release:"FC10") )
{
