...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  java-1_6_0-sun: Security update to 1.6.0 patchlevel 3 (java-1_6_0-sun-4525)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_6_0-sun-4525");
 script_set_attribute(attribute: "description", value: "The Sun JAVA JDK 1.6.0 was upgraded to release 3 to fix
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_6_0-sun-4525");
...
script_summary(english: "Check for the java-1_6_0-sun-4525 package");
...
if ( rpm_check( reference:"java-1_6_0-sun-1.6.0.u3-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-alsa-1.6.0.u3-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-demo-1.6.0.u3-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-devel-1.6.0.u3-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-jdbc-1.6.0.u3-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-plugin-1.6.0.u3-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
