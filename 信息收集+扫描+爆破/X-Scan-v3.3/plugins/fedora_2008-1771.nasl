...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1771
#
...
script_name(english: "Fedora 8 2008-1771: dnssec-tools");
...
if ( rpm_check( reference:"dnssec-tools-1.3.2-1.fc8", release:"FC8") )
{
