...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5342
#
...
script_name(english: "Fedora 8 2008-5342: roundcubemail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5342 (roundcubemail)");
...
if ( rpm_check( reference:"roundcubemail-0.2-0.alpha.fc8", release:"FC8") )
{
