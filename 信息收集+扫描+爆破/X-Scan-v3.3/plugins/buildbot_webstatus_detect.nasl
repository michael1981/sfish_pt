...
foreach dir (dirs)
{
  ...
  # Only check for multiple installs if thorough tests are enabled
  if (!thorough_tests) break;
}

if (isnull(installs))
  exit(1, "Buildbot WebStatus was not detected on the web server on port "+port+".");
