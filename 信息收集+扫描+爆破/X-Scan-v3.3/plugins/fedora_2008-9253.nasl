...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9253
#
...
script_name(english: "Fedora 8 2008-9253: libgadu");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9253 (libgadu)");
...
if ( rpm_check( reference:"libgadu-1.8.2-1.fc8", release:"FC8") )
{
