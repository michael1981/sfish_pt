...
'The remote host is missing the DSA-242 security update');
...
deb_check(prefix: 'kate', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdebase', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdebase-audiolibs', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdebase-dev', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdebase-doc', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdebase-libs', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdewallpapers', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kdm', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'konqueror', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'konsole', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'kscreensaver', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'libkonq-dev', release: '3.0', reference: '2.2.2-14.2');
deb_check(prefix: 'libkonq3', release: '3.0', reference: '2.2.2-14.2');
