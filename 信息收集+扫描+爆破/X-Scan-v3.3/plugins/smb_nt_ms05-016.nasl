...
if(description)
{
 ...
 script_xref(name:"IAVA", value:"2005-A-0009");
 script_xref(name:"OSVDB", value:"15469");

 name["english"] = "MS05-016: Vulnerability in Windows Shell (893086)";
...
if (is_accessible_share())
{
 ...
 {
 set_kb_item(name:"SMB/Missing/MS05-016", value:TRUE);
