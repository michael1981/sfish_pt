...
#
# This plugin text was extracted from Fedora Security Advisory 2006-902
#
...
script_name(english: "Fedora 5 2006-902: firefox");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-902 (firefox)");
...
which contains version 1.5.0.6 of Firefox and is not
...
if ( rpm_check( reference:"firefox-1.5.0.6-2.fc5", release:"FC5") )
{
