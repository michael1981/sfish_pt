...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9170
#
...
script_name(english: "Fedora 8 2008-9170: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9170 (drupal)");
...
Update to 5.12, security fixes:    SA-2008-067 ( [9]http://drupal.org/node/3248
24 )
...
if ( rpm_check( reference:"drupal-5.12-1.fc8", release:"FC8") )
{
