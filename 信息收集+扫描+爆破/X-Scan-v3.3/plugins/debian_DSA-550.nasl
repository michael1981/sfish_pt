...
'The remote host is missing the DSA-550 security update');
...
'http://www.debian.org/security/2004/dsa-550');
 script_set_attribute(attribute: 'solution', value: 
'The Debian project recommends that you upgrade your wv package.');
...
deb_check(prefix: 'wv', release: '3.0', reference: '0.7.1+rvt-2woody3');
