# This script was automatically generated from the dsa-1720
...
'The remote host is missing the DSA-1720 security update');
...
script_end_attributes();
 ...
 script_name(english: "[DSA1720] DSA-1720-1 typo3-src");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1720-1 typo3-src");
 exit(0);
}
...
deb_check(prefix: 'typo3', release: '4.0', reference: '4.0.2+debian-8');
deb_check(prefix: 'typo3-src-4.0', release: '4.0', reference: '4.0.2+debian-8');
deb_check(prefix: 'typo3-src', release: '4.0', reference: '4.0.2+debian-8');
