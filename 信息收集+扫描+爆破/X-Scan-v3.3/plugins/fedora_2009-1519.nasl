...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1519
#
...
script_name(english: "Fedora 9 2009-1519: python-fedora");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1519 (python-fedora)");
...
if ( rpm_check( reference:"python-fedora-0.3.9-1.fc9", release:"FC9") )
{
