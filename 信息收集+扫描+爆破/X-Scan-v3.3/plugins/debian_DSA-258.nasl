...
'The remote host is missing the DSA-258 security update');
...
deb_check(prefix: 'ethereal', release: '3.0', reference: '0.9.4-1woody3');
deb_check(prefix: 'ethereal-common', release: '3.0', reference: '0.9.4-1woody3');
deb_check(prefix: 'ethereal-dev', release: '3.0', reference: '0.9.4-1woody3');
deb_check(prefix: 'tethereal', release: '3.0', reference: '0.9.4-1woody3');
