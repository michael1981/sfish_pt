...
'The remote host is missing the DSA-356 security update');
...
'Read http://www.debian.org/security/2003/dsa-356
...
deb_check(prefix: 'xtokkaetama', release: '3.0', reference: '1.0b-6woody1');
