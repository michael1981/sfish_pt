...
'The remote host is missing the DSA-722 security update');
...
'The Debian project recommends that you upgrade your smail package.');
...
deb_check(prefix: 'smail', release: '3.0', reference: '3.2.0.114-4woody1');
