...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1699
#
...
script_name(english: "Fedora 10 2009-1699: moodle");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1699 (moodle)");
...
if ( rpm_check( reference:"moodle-1.9.4-1.fc10", release:"FC10") )
{
