...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  viewvc (2009-10-20)");
...
if ( rpm_check( reference:"viewvc-1.0.9-0.1.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"viewvc-1.0.9-0.1.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
