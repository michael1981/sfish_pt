...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3599
#
...
script_name(english: "Fedora 10 2009-3599: wireshark");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3599 (wireshark)");
...
if ( rpm_check( reference:"wireshark-1.0.7-1.fc10", release:"FC10") )
{
