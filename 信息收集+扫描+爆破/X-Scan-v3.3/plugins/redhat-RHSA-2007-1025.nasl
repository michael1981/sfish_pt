...
if(description)
{
 ...
 script_name(english: "RHSA-2007-1025: gpdf");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2007-1025");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2007-1025.html");
...
if ( rpm_check( reference:"gpdf-2.8.2-7.7.1", release:'RHEL4') )
{
