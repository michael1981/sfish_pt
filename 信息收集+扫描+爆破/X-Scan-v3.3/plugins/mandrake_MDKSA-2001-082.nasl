...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:082-1: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:082-1 (kernel).");
 script_set_attribute(attribute: "description", value: "Rafal Wojtczuk found a vulnerability in the 2.2.19 and 2.4.11 Linux
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:082-1");
