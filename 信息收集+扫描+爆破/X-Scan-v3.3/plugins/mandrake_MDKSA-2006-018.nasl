...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:018: kernel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:018 (kernel).");
 script_set_attribute(attribute: "description", value: "A number of vulnerabilites have been corrected in the Linux kernel:
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:018");
