...
if(description)
{
 ...
 script_name(english: "Solaris 5.9 (sparc) : 124519-05");
...
e +=  solaris_check_patch(release:"5.9", arch:"sparc", patch:"124519-05", obsoleted_by:"", package:"SUNWsgee", version:"6.0,REV=2004.06.03.16.00");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
