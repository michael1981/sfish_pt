...
'The remote host is missing the DSA-1240 security update');
...
'The Debian project recommends that you upgrade your links2 package.');
...
deb_check(prefix: 'links2', release: '3.1', reference: '2.1pre16-1sarge1');
deb_check(prefix: 'links2', release: '4.0', reference: '2.1pre26-1');
