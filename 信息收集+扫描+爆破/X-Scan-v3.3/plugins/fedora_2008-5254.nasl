...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5254
#
...
script_name(english: "Fedora 9 2008-5254: xorg-x11-server");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5254 (xorg-x11-server)");
...
if ( rpm_check( reference:"xorg-x11-server-1.4.99.902-3.20080612.fc9", release:"FC9") )
{
