...
'The remote host is missing the DSA-264 security update');
...
'The Debian project recommends that you upgrade your lxr package.');
...
deb_check(prefix: 'lxr', release: '3.0', reference: '0.3-3');
