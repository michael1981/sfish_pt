...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7340
#
...
script_name(english: "Fedora 10 2009-7340: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7340 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-3.2.0.1-1.fc10", release:"FC10") )
{
