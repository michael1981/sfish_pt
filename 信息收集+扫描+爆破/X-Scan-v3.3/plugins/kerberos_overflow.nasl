...
if(description)
{
 ...
 script_xref(name:"CERT", value:"CA-2000-06");
 script_xref(name:"OSVDB", value:"1339");
...
An attacker may use this to gain a root shell on this host."
 ...
 script_set_attribute(
  attribute:"see_also", 
  value:"http://archives.neohapsis.com/archives/bugtraq/2000-05/0184.html"
 );
 script_set_attribute(
  attribute:"see_also", 
  value:"http://www.cert.org/advisories/CA-2000-06.html"
 );
 script_set_attribute(
  attribute:"solution", 
  value:
