...
#
# This plugin text was extracted from Fedora Security Advisory 2008-11891
#
...
script_name(english: "Fedora 8 2008-11891: p7zip");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-11891 (p7zip)");
...
if ( rpm_check( reference:"p7zip-4.61-1.fc8", release:"FC8") )
{
