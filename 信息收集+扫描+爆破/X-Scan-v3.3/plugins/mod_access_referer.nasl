...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"13737");
...
vulnerability can possibly be used in denial of service attackers 
against affected systems." );
 script_set_attribute(attribute:"see_also", value:"http://marc.theaimsgroup.com/?l=full-disclosure&m=105053485515811" );
