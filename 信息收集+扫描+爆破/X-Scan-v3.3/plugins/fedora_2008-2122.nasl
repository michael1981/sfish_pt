...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2122
#
...
script_name(english: "Fedora 7 2008-2122: konversation");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2122 (konversation)");
...
removes /usr/share/apps/konversation/scripts/media which can be used to execute
commands via carefully crafted media
");
...
if ( rpm_check( reference:"konversation-1.0.1-4.fc7", release:"FC7") )
{
