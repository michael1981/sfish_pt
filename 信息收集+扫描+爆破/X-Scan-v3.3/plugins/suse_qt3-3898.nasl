...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Qt3 (qt3-3898)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch qt3-3898");
script_end_attributes();

script_cve_id("CVE-2007-3388");
script_summary(english: "Check for the qt3-3898 package");
