...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"37958");

  script_name(english:"Photo Upload Plugin Buffer Overflow Vulnerabilities");
...
allow arbitrary code execution on the affected system.  Successful
...
affected host into visiting a specially-crafted web page." );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/854769" );
