...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9494
#
...
script_name(english: "Fedora 10 2009-9494: yelp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9494 (yelp)");
...
if ( rpm_check( reference:"yelp-2.24.0-13.fc10", release:"FC10") )
{
