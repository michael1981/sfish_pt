...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"48027");
  script_xref(name:"OSVDB", value:"48028");
  script_xref(name:"OSVDB", value:"48029");
  script_xref(name:"OSVDB", value:"48030");
  script_xref(name:"OSVDB", value:"48031");
  script_xref(name:"OSVDB", value:"48032");
...
than 7.5.5.  Such versions contain several vulnerabilities :
  ...
  - A stack buffer overflow exists in the third-party
