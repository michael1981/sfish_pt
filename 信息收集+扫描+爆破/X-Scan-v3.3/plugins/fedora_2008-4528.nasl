...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4528
#
...
script_name(english: "Fedora 8 2008-4528: cbrpager");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4528 (cbrpager)");
...
if ( rpm_check( reference:"cbrpager-0.9.17-2.fc8", release:"FC8") )
{
