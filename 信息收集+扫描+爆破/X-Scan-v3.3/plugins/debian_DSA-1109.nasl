...
'The remote host is missing the DSA-1109 security update');
...
'The Debian project recommends that you upgrade your rssh package.');
...
deb_check(prefix: 'rssh', release: '3.1', reference: '2.2.3-1.sarge.2');
