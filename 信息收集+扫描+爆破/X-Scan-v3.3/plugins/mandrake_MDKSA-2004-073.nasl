...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:073: XFree86");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:073 (XFree86).");
 script_set_attribute(attribute: "description", value: "Steve Rumble discovered XDM in XFree86 opens a chooserFd TCP socket
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:073");
...
if ( rpm_check( reference:"XFree86-cyrillic-fonts-4.3-32.1.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
...
if ( rpm_check( reference:"libxfree86-static-devel-4.3-32.1.100mdk", release:"MDK10.0", yank:"mdk") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
