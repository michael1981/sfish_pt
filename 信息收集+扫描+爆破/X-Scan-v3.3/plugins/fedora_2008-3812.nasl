...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3812
#
...
script_name(english: "Fedora 9 2008-3812: licq");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3812 (licq)");
...
if ( rpm_check( reference:"licq-1.3.5-2.fc9", release:"FC9") )
{
