...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3430
#
...
script_name(english: "Fedora 9 2009-3430: argyllcms");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3430 (argyllcms)");
...
if ( rpm_check( reference:"argyllcms-1.0.3-4.fc9", release:"FC9") )
{
