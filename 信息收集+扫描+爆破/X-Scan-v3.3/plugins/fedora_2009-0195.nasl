...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0195
#
...
script_name(english: "Fedora 8 2009-0195: proftpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0195 (proftpd)");
...
if ( rpm_check( reference:"proftpd-1.3.1-8.fc8", release:"FC8") )
{
