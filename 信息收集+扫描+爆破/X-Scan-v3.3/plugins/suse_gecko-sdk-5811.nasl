...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for gecko-sdk and mozilla-xulrunner (gecko-sdk-5811)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch gecko-sdk-5811");
 script_set_attribute(attribute: "description", value: "This update backports the latest security fixes to the
Mozilla XULRunner engine.
...
script_set_attribute(attribute: "solution", value: "Install the security patch gecko-sdk-5811");
...
script_summary(english: "Check for the gecko-sdk-5811 package");
...
if ( rpm_check( reference:"mozilla-xulrunner-1.8.0.14eol-0.9", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"gecko-sdk-1.8.0.14eol-0.9", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"mozilla-xulrunner-1.8.0.14eol-0.9", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
