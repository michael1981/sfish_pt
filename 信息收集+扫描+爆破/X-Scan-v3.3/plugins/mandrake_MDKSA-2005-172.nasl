...
"The remote host is missing the patch for the advisory MDKSA-2005:172 (openssh).");
 script_set_attribute(attribute: "description", value: "Sshd in OpenSSH before 4.2, when GSSAPIDelegateCredentials is enabled,
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:172");
