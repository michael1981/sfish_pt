...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  compat-openssl097g (2009-11-13)");
...
if ( rpm_check( reference:"compat-openssl097g-0.9.7g-119.7", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"compat-openssl097g-0.9.7g-119.7", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"compat-openssl097g-32bit-0.9.7g-119.7", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
