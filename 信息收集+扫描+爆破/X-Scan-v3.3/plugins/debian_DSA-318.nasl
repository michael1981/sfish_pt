...
'The remote host is missing the DSA-318 security update');
...
'Read http://www.debian.org/security/2003/dsa-318
...
deb_check(prefix: 'lyskom-server', release: '3.0', reference: '2.0.6-1woody1');
