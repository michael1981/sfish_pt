...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"5213");
  script_xref(name:"OSVDB", value:"43063");
...
under Windows is SYSTEM." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2008-03/0036.html" );
