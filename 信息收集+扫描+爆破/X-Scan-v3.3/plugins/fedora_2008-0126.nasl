...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0126
#
...
script_name(english: "Fedora 7 2008-0126: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0126 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.3.2-1.fc7", release:"FC7") )
{
