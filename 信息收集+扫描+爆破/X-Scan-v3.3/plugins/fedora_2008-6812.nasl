...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6812
#
...
script_name(english: "Fedora 8 2008-6812: filezilla");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6812 (filezilla)");
...
if ( rpm_check( reference:"filezilla-3.1.0.1-1.fc8", release:"FC8") )
{
