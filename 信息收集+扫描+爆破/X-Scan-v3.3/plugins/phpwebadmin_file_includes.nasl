...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"7012");
  script_xref(name:"Secunia", value:"32597");
  script_xref(name:"OSVDB", value:"49636");
  script_xref(name:"OSVDB", value:"49637");
...
foreach dir (dirs)
{
  ...
  )
  {
    ...
    foreach exploit (exploits)
    {
      ...
      res = http_send_recv3(port:port, item:url, method:"GET");
      if (res == NULL) exit(0);
