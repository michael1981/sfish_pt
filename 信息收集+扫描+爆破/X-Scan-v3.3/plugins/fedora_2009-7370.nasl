...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7370
#
...
script_name(english: "Fedora 10 2009-7370: pidgin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7370 (pidgin)");
...
if ( rpm_check( reference:"pidgin-2.5.8-1.fc10", release:"FC10") )
{
