...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHNE_35351");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHNE_35351 security update");
 script_set_attribute(attribute: "description", value:
"cumulative ARPA Transport patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_35351");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHNE_35351");
...
if ( hpux_patch_installed (patches:"PHNE_35351 PHNE_36125 PHNE_37671 PHNE_37898 PHNE_38678 ") )
{
 exit(0);
}
