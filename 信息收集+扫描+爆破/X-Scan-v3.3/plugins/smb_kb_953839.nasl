...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"40889");

 name["english"] = "Cumulative Security Update of ActiveX Kill Bits (953839)";
...
script_end_attributes();
 ...
 summary["english"] = "Determines if the newest kill bits are set";
