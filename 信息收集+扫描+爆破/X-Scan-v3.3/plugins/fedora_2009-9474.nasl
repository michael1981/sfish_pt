...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9474
#
...
script_name(english: "Fedora 10 2009-9474: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9474 (postgresql)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-6600", "CVE-2009-0922");
...
if ( rpm_check( reference:"postgresql-8.3.8-1.fc10", release:"FC10") )
{
