...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  opera (2009-11-09)");
...
if ( rpm_check( reference:"opera-10.01-1.1", release:"SUSE11.0", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"opera-10.01-1.1", release:"SUSE11.0", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
