...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3191
#
...
script_name(english: "Fedora 7 2008-3191: speex");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3191 (speex)");
...
if ( rpm_check( reference:"speex-1.2-0.3.beta1", release:"FC7") )
{
