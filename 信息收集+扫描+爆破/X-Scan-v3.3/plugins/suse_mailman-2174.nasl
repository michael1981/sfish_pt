...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for mailman (mailman-2174)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch mailman-2174");
...
script_set_attribute(attribute: "solution", value: "Install the security patch mailman-2174");
script_end_attributes();

script_cve_id("CVE-2006-2191", "CVE-2006-2941", "CVE-2006-3636");
script_summary(english: "Check for the mailman-2174 package");
...
if ( rpm_check( reference:"mailman-2.1.7-15.5", release:"SLES10") )
{
