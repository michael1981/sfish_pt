...
#
# This plugin text was extracted from Fedora Security Advisory 2007-529
#
...
script_name(english: "Fedora 6 2007-529: libpng");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-529 (libpng)");
...
if ( rpm_check( reference:"libpng-1.2.10-9.fc6", release:"FC6") )
{
