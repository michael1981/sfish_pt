...
'The remote host is missing the DSA-295 security update');
...
'The Debian project recommends that you upgrade your pptpd package immediately.');
...
deb_check(prefix: 'pptpd', release: '2.2', reference: '1.0.0-4.2');
deb_check(prefix: 'pptpd', release: '3.0', reference: '1.1.2-1.4');
