...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4871
#
...
script_name(english: "Fedora 9 2008-4871: imlib2");
...
if ( rpm_check( reference:"imlib2-1.4.0-7.fc9", release:"FC9") )
{
