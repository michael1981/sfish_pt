...
'The remote host is missing the DSA-101 security update');
...
'The Debian project recommends that you upgrade your sudo packages immediately.');
...
deb_check(prefix: 'sudo', release: '2.2', reference: '1.6.2p2-2.1');
