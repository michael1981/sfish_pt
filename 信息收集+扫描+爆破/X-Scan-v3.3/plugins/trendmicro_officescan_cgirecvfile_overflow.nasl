...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"48024");
...
result in arbitrary code execution on the remote system." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?f0629899 (v7.3 Build 1367)" );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?4cf6e9b8 (v7.6/v3.6 CSM Build 1195)" );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?181dece3 (v8.0 Build 1361)" );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?e96b6aa1 (v8.0 Service Pack 1, Build 2424)" );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?46ebb3f9 (v8.0 Service Pack 1 Patch 1, Build 3060)" );
