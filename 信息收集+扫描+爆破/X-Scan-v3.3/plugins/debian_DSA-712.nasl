...
'The remote host is missing the DSA-712 security update');
...
'The Debian project recommends that you upgrade your geneweb package.');
...
deb_check(prefix: 'geneweb', release: '3.0', reference: '4.06-2woody1');
deb_check(prefix: 'gwtp', release: '3.0', reference: '4.06-2woody1');
