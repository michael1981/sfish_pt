...
'The remote host is missing the DSA-665 security update');
...
'The Debian project recommends that you upgrade your ncpfs package.');
...
deb_check(prefix: 'ipx', release: '3.0', reference: '2.2.0.18-10woody2');
deb_check(prefix: 'ncpfs', release: '3.0', reference: '2.2.0.18-10woody2');
