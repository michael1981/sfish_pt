...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"54207");
 
 script_name(english:"Linksys WVC54GCA Wireless-G '/img/main.cgi' Information Disclosure Vulnerability");
 script_summary(english:"Determine if the remote network camera is vulnerable to a flaw");

 script_set_attribute(attribute:"synopsis", value: "Authenticated users can elevate their privileges on the remote network camera");
...
other users, including the password of the administrator");
 ...
 script_set_attribute(attribute:"cvss_vector", value:"CVSS2#AV:N/AC:L/Au:S/C:C/I:N/A:N");
 ...
 script_dependencie("network_camera_detect.nasl");
