...
'The remote host is missing the DSA-896 security update');
...
'The Debian project recommends that you upgrade your ftpd-ssl package.');
...
deb_check(prefix: 'ftpd-ssl', release: '3.1', reference: '0.17.18+0.3-3sarge1');
deb_check(prefix: 'linux-ftpd-ssl', release: '3.1', reference: '0.17.18+0.3-3sarge1');
