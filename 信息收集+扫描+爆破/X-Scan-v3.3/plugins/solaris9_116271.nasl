...
if(description)
{
 ...
 script_name(english: "Solaris 5.9 (sparc) : 116271-10");
...
e +=  solaris_check_patch(release:"5.9", arch:"sparc", patch:"116271-10", obsoleted_by:"", package:"VRTSnetbp", version:"5.1,REV=2004.05.11.17.55");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
