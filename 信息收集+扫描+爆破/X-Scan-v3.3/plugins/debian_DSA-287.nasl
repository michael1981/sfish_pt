...
'The remote host is missing the DSA-287 security update');
...
'The Debian project recommends that you upgrade your EPIC package.');
...
deb_check(prefix: 'epic', release: '2.2', reference: '3.004-16.1');
deb_check(prefix: 'epic', release: '3.0', reference: '3.004-17.1');
