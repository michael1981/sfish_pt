...
the '.svn' directory." );
 script_set_attribute(attribute:"see_also", value:"http://www.techcrunch.com/2009/09/23/basic-flaw-reveals-source-code-to-3300-popular-websites/" );
...
script_copyright(english:"This script is Copyright (C) 2008 Westpoint Ltd");
