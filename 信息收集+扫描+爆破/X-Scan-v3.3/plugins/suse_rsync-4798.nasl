...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for rsync (rsync-4798)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch rsync-4798");
...
script_set_attribute(attribute: "solution", value: "Install the security patch rsync-4798");
script_end_attributes();

script_cve_id("CVE-2007-6199", "CVE-2007-6200");
script_summary(english: "Check for the rsync-4798 package");
...
if ( rpm_check( reference:"rsync-2.6.8-36.22", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"rsync-2.6.8-36.22", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
