...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5691
#
...
script_name(english: "Fedora 8 2008-5691: horde");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5691 (horde)");
...
if ( rpm_check( reference:"horde-3.2.1-1.fc8", release:"FC8") )
{
