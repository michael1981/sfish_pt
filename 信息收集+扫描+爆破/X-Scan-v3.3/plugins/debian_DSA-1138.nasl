...
'The remote host is missing the DSA-1138 security update');
...
'The Debian project recommends that you upgrade your cfs package.');
...
deb_check(prefix: 'cfs', release: '3.1', reference: '1.4.1-15sarge1');
