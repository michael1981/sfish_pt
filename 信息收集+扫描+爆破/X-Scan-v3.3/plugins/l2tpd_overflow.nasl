...
if (description)
{
 ...
 script_xref(name:"OSVDB", value:"5061");
 script_xref(name:"OSVDB", value:"5062");
...
hijack L2TP sessions established to this host." );
 script_set_attribute(attribute:"see_also", value:"http://www.debian.org/security/2002/dsa-152" );
