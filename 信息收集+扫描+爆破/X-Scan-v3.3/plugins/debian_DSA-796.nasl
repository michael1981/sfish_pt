...
'The remote host is missing the DSA-796 security update');
...
deb_check(prefix: 'affix', release: '3.1', reference: '2.1.1-3');
deb_check(prefix: 'libaffix-dev', release: '3.1', reference: '2.1.1-3');
deb_check(prefix: 'libaffix2', release: '3.1', reference: '2.1.1-3');
