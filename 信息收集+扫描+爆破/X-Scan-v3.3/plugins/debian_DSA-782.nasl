...
'The remote host is missing the DSA-782 security update');
...
'The Debian project recommends that you upgrade your bluez-utils package.');
...
deb_check(prefix: 'bluez-bcm203x', release: '3.1', reference: '2.15-1.1');
deb_check(prefix: 'bluez-cups', release: '3.1', reference: '2.15-1.1');
deb_check(prefix: 'bluez-pcmcia-support', release: '3.1', reference: '2.15-1.1');
deb_check(prefix: 'bluez-utils', release: '3.1', reference: '2.15-1.1');
