...
script_set_attribute(attribute:'synopsis', value: 'The remote package "apt-listchanges" is missing a security patch.');
script_set_attribute(attribute:'description', value: 'Felipe Sateler discovered that apt-listchanges did not use safe paths when
