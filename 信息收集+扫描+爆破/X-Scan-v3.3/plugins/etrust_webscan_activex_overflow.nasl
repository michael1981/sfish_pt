...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"27785");
  script_xref(name:"OSVDB", value:"27786");
...
attacker to execute arbitrary code or gain privileged access." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2006-08/0126.html" );
