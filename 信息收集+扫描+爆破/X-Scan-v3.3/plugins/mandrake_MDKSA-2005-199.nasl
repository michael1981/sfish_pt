...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:199: netpbm");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:199 (netpbm).");
 script_set_attribute(attribute: "description", value: "Pnmtopng in netpbm 10.2X, when using the -trans option, uses
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:199");
