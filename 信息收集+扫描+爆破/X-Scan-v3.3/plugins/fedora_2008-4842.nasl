...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4842
#
...
script_name(english: "Fedora 8 2008-4842: imlib2");
...
if ( rpm_check( reference:"imlib2-1.4.0-7.fc8", release:"FC8") )
{
