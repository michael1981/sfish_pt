...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3761
#
...
script_name(english: "Fedora 10 2009-3761: prewikka");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3761 (prewikka)");
...
if ( rpm_check( reference:"prewikka-0.9.14-2.fc10", release:"FC10") )
{
