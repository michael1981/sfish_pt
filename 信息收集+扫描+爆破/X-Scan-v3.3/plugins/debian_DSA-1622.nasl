# This script was automatically generated from the dsa-1622
...
'The remote host is missing the DSA-1622 security update');
...
'The Debian project recommends that you upgrade your newsx package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:C');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1622] DSA-1622-1 newsx");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1622-1 newsx");
 exit(0);
}
...
deb_check(prefix: 'newsx', release: '4.0', reference: '1.6-2etch1');
