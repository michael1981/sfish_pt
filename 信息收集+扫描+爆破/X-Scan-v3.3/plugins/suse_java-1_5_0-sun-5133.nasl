...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  java-1_5_0-sun: Security update to 1.5.0 update 15 (java-1_5_0-sun-5133)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_5_0-sun-5133");
 script_set_attribute(attribute: "description", value: "Sun Java was updated to 1.5.0u15 to fix following security
vulnerabilities:
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_5_0-sun-5133");
script_end_attributes();

script_cve_id("CVE-2008-1158", "CVE-2008-1186", "CVE-2008-1186", "CVE-2008-1185", "CVE-2008-1187", "CVE-2008-1189", "CVE-2008-1188", "CVE-2008-1190", "CVE-2008-1191", "CVE-2008-1192", "CVE-2008-1195", "CVE-2008-1196");
script_summary(english: "Check for the java-1_5_0-sun-5133 package");
...
if ( rpm_check( reference:"java-1_5_0-sun-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-alsa-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-demo-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-devel-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-jdbc-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-plugin-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_5_0-sun-src-1.5.0_update15-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
