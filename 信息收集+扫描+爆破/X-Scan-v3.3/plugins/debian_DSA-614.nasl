...
'The remote host is missing the DSA-614 security update');
...
'The Debian project recommends that you upgrade your xzgv package immediately.');
...
deb_check(prefix: 'xzgv', release: '3.0', reference: '0.7-6woody2');
