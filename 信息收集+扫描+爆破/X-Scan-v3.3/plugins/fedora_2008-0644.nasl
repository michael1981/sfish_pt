...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0644
#
...
script_name(english: "Fedora 8 2008-0644: python-paramiko");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0644 (python-paramiko)");
...
if ( rpm_check( reference:"python-paramiko-1.7.1-3.fc8", release:"FC8") )
{
