...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_36902");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_36902 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.51 IA-64 Intermediate Patch 17");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_36902");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_36902");
...
if ( hpux_patch_installed (patches:"PHSS_36902 PHSS_37274 ") )
{
 exit(0);
}
