...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200701-06 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200701-06
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2006-6772');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200701-06.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'w3m: Format string vulnerability');
 exit(0);
}
...
if (qpkg_check(package: "www-client/w3m", unaffected: make_list("ge 0.5.1-r4"), vulnerable: make_list("lt 0.5.1-r4")
