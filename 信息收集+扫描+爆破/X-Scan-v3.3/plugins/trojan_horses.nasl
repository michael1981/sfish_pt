...
"The remote host might be infected by a worm." );
...
system be reinstalled to ensure removal." );
 script_set_attribute(attribute:"risk_factor", value:"Low" );

script_end_attributes();

 
 script_summary(english: "Look for potential trojan horses");
...
m = strcat(m, 'Unless you know for sure what is behind it, you\'d better\n',
 	'check your system\n\n',
