...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_23797");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_23797 security update");
 script_set_attribute(attribute: "description", value:
"CDE Runtime APR2001 Periodic Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_23797");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_23797");
