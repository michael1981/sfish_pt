...
#
# This plugin text was extracted from Fedora Security Advisory 2009-4044
#
...
script_name(english: "Fedora 9 2009-4044: prelude-manager");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-4044 (prelude-manager)");
...
if ( rpm_check( reference:"prelude-manager-0.9.14.2-2.fc9", release:"FC9") )
{
