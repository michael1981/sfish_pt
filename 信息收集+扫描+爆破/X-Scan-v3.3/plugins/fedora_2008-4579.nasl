...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4579
#
...
script_name(english: "Fedora 8 2008-4579: stunnel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4579 (stunnel)");
...
if ( rpm_check( reference:"stunnel-4.24-0.fc8", release:"FC8") )
{
