...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:210: syslinux");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:210 (syslinux).");
 script_set_attribute(attribute: "description", value: "SYSLINUX is a boot loader for the Linux operating system which operates
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:210");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2006-3334", "CVE-2006-5793");
script_summary(english: "Check for the version of the syslinux package");
