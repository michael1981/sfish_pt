...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5412
#
...
script_name(english: "Fedora 10 2009-5412: openssl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5412 (openssl)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2008-5077", "CVE-2009-1377", "CVE-2009-1378", "CVE-2009-1379");
...
if ( rpm_check( reference:"openssl-0.9.8g-14.fc10", release:"FC10") )
{
