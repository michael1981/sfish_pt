...
if (description)
{
  ...
  script_xref(name:"milw0rm", value:"7868");
  script_xref(name:"OSVDB", value:"51590");
  ...
  script_set_attribute(
    attribute:"see_also", 
    value:"http://www.grid2000.com/news.html#activex"
  );
  script_set_attribute(
    attribute:"solution", 
    value:"Upgrade to FlexCell Grid Control 5.8.0 or later."
  );
  script_set_attribute(
