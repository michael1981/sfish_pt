...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"32280");
  script_xref(name:"OSVDB", value:"32281");
...
Note that SiteKiosk by default runs with LOCAL SYSTEM privileges." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/fulldisclosure/2006-12/0225.html" );
