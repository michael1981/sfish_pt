# This script was automatically generated from the dsa-1567
...
'The remote host is missing the DSA-1567 security update');
...
'The Debian project recommends that you upgrade your blender packages.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1567] DSA-1567-1 blender");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1567-1 blender");
 exit(0);
}
...
deb_check(prefix: 'blender', release: '4.0', reference: '2.42a-7.1+etch1');
