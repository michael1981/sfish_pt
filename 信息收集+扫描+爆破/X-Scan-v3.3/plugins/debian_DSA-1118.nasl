...
'The remote host is missing the DSA-1118 security update');
...
CVE-2006-2776
    ...
    code, and <q>moz_bug_r_a4</q> demonstrated that the higher privilege
...
CVE-2006-2785
    ...
    user to right-click on a broken image and choose <q>View Image</q> from
...
deb_check(prefix: 'libnspr-dev', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'libnspr4', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'libnss-dev', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'libnss3', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-browser', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-calendar', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-chatzilla', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-dev', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-dom-inspector', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-js-debugger', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-mailnews', release: '3.1', reference: '1.7.8-1sarge7.1');
deb_check(prefix: 'mozilla-psm', release: '3.1', reference: '1.7.8-1sarge7.1');
