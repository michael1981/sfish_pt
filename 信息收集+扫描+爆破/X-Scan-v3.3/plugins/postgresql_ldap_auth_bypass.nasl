...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"57917");
  ...
  script_set_attribute(
    ...
    value:string(
      ...
      "blank password.  A remote attacker could exploit this to gain access\n",
      "to the database server, possibly as an administrator.\n",
      "\n",
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.postgresql.org/about/news.1135"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade to PostgreSQL 8.2.14 / 8.3.8 or later."
  );
  script_set_attribute(
  ...
  script_require_keys("Services/postgresql", 5432);
