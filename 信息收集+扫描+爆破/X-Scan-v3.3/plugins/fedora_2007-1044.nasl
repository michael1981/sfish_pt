...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1044
#
...
script_name(english: "Fedora 7 2007-1044: gimp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-1044 (gimp)");
...
if ( rpm_check( reference:"gimp-2.2.16-2.fc7", release:"FC7") )
{
