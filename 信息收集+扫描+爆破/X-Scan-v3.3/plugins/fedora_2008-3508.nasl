...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3508
#
...
script_name(english: "Fedora 7 2008-3508: sipp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3508 (sipp)");
...
if ( rpm_check( reference:"sipp-3.1-1.fc7", release:"FC7") )
{
