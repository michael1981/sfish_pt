...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7478
#
...
script_name(english: "Fedora 11 2009-7478: openswan");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7478 (openswan)");
...
if ( rpm_check( reference:"openswan-2.6.21-5.fc11", release:"FC11") )
{
