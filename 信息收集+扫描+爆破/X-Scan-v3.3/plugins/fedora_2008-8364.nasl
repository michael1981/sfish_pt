...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8364
#
...
script_name(english: "Fedora 8 2008-8364: rkhunter");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8364 (rkhunter)");
...
if ( rpm_check( reference:"rkhunter-1.3.2-5.fc8", release:"FC8") )
{
