...
if(description)
{
 ...
 script_name(english: "Solaris 5.4 (x86) : 105717-06");
...
e +=  solaris_check_patch(release:"5.4_x86", arch:"i386", patch:"105717-06", obsoleted_by:"108290-01 ", package:"SUNWdtbas", version:"1.0.2,REV=10.96.04.12");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
