...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9559
#
...
script_name(english: "Fedora 10 2009-9559: dovecot");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9559 (dovecot)");
...
further details:  [9]http://dovecot.org/list/dovecot-
...
if ( rpm_check( reference:"dovecot-1.1.18-2.fc10", release:"FC10") )
{
