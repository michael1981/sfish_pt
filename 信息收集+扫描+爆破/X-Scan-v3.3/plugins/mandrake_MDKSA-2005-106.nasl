...
if(description)
{
 ...
 script_name(english: "MDKSA-2005:106: spamassassin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2005:106 (spamassassin).");
 script_set_attribute(attribute: "description", value: "A Denial of Service bug was discovered in SpamAssassin. An attacker
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2005:106");
