...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4910
#
...
script_name(english: "Fedora 9 2008-4910: libpng");
...
if ( rpm_check( reference:"libpng-1.2.29-1.fc9", release:"FC9") )
{
