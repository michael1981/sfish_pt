...
'The remote host is missing the DSA-681 security update');
...
'The Debian project recommends that you upgrade your synaesthesia package.');
...
deb_check(prefix: 'synaesthesia', release: '3.0', reference: '2.1-2.1woody3');
