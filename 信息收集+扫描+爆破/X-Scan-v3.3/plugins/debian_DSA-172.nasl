...
'The remote host is missing the DSA-172 security update');
...
'The Debian project recommends that you upgrade your tkmail packages.');
...
deb_check(prefix: 'tkmail', release: '2.2', reference: '4.0beta9-4.1');
deb_check(prefix: 'tkmail', release: '3.0', reference: '4.0beta9-8.1');
