...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8582
#
...
script_name(english: "Fedora 11 2009-8582: libxml");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8582 (libxml)");
...
if ( rpm_check( reference:"libxml-1.8.17-24.fc11", release:"FC11") )
{
