# This script was automatically generated from the dsa-1725
...
'The remote host is missing the DSA-1725 security update');
...
'The Debian project recommends that you upgrade your websvn package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:M/Au:S/C:P/I:N/A:N');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1725] DSA-1725-1 websvn");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1725-1 websvn");
 exit(0);
}
...
deb_check(prefix: 'websvn', release: '5.0', reference: '2.0-4+lenny1');
