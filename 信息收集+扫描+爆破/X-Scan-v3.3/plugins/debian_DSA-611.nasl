...
'The remote host is missing the DSA-611 security update');
...
'The Debian project recommends that you upgrade your htget package.');
...
deb_check(prefix: 'htget', release: '3.0', reference: '0.93-1.1woody1');
