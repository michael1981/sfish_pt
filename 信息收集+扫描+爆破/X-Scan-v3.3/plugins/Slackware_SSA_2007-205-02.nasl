# This script was automatically generated from the SSA-2007-205-02
...
'The remote host is missing the SSA-2007-205-02 security update');
...
script_summary("SSA-2007-205-02 seamonkey ");
script_name(english: "SSA-2007-205-02 seamonkey ");
...
extrarep = NULL;
if (slackware_check(osver: "11.0", pkgname: "seamonkey", pkgver: "1.1.3", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package seamonkey is vulnerable in Slackware 11.0
Upgrade to seamonkey-1.1.3-i486-1_slack11.0 or newer.
');
}
if (slackware_check(osver: "12.0", pkgname: "seamonkey", pkgver: "1.1.3", pkgnum:  "1", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package seamonkey is vulnerable in Slackware 12.0
Upgrade to seamonkey-1.1.3-i486-1_slack12.0 or newer.
');
}
