...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4797
#
...
script_name(english: "Fedora 7 2008-4797: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4797 (samba)");
...
if ( rpm_check( reference:"samba-3.0.28a-1.fc7", release:"FC7") )
{
