...
'The remote host is missing the DSA-515 security update');
...
'Read http://www.debian.org/security/2004/dsa-515
...
deb_check(prefix: 'lha', release: '3.0', reference: '1.14i-2woody1');
