...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:118: OpenOffice.org");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:118 (OpenOffice.org).");
 script_set_attribute(attribute: "description", value: "OpenOffice.org 1.1.x up to 1.1.5 and 2.0.x before 2.0.3 allows user-complicit
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:118");
