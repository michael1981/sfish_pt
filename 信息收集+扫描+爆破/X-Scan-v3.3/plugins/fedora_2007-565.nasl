...
#
# This plugin text was extracted from Fedora Security Advisory 2007-565
#
...
script_name(english: "Fedora 6 2007-565: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-565 (postgresql)");
...
if ( rpm_check( reference:"postgresql-8.1.9-1.fc6", release:"FC6") )
{
