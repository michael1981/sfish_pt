...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200804-06 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200804-06
...
script_set_attribute(attribute: 'see_also', value: 'http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2008-0888');

script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200804-06.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'UnZip: User-assisted execution of arbitrary code');
 exit(0);
}
...
if (qpkg_check(package: "app-arch/unzip", unaffected: make_list("ge 5.52-r2"), vulnerable: make_list("lt 5.52-r2")
