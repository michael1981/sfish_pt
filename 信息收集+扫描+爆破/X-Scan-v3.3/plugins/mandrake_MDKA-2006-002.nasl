...
"The remote host is missing the patch for the advisory MDKA-2006:002 (mdkonline).");
 script_set_attribute(attribute: "description", value: "A bug in the mdkupdate cron job (when automatic update mode is enabled)
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKA-2006:002");
