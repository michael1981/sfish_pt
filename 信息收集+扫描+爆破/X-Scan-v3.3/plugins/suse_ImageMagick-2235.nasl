...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  ImageMagick: Securityfix for two security problems. (ImageMagick-2235)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch ImageMagick-2235");
script_end_attributes();

script_cve_id("CVE-2006-5456");
script_summary(english: "Check for the ImageMagick-2235 package");
