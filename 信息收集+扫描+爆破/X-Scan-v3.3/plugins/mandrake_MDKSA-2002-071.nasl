...
if(description)
{
 ...
 script_name(english: "MDKSA-2002:071: kdegraphics");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2002:071 (kdegraphics).");
 script_set_attribute(attribute: "description", value: "A vulnerability exists in KGhostview, part of the kdegraphics package.
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2002:071");
