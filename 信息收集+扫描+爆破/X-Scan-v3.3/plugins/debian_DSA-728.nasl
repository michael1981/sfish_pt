...
'The remote host is missing the DSA-728 security update');
...
'The Debian project recommends that you upgrade your qpopper package.');
...
deb_check(prefix: 'qpopper', release: '3.0', reference: '4.0.4-2.woody.5');
deb_check(prefix: 'qpopper-drac', release: '3.0', reference: '4.0.4-2.woody.5');
deb_check(prefix: 'qpopper', release: '3.1', reference: '4.0.5-4sarge1');
deb_check(prefix: 'qpopper-drac', release: '3.1', reference: '4.0.5-4sarge1');
