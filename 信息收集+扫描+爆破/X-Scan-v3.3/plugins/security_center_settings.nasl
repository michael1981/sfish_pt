...
if (description)
{
  ...
  script_name(english:"Windows Security Center Settings");
  script_summary(english:"Checks Windows Security Center settings");
 
 script_set_attribute(attribute:"synopsis", value:
"It is possible to audit Windows Security Center settings on the 
remote system." );
 script_set_attribute(attribute:"description", value:
"By connecting to the remote host with the supplied credentials, this
plugin enumerates Windows Security Center settings on the remote
host." );
...
if(!isnull(monitor))
{
 report += string("Here's a list of anti-virus / firewall software that may be installed :",
             "\n\n",
             monitor);
}
