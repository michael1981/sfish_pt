...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7370
#
...
script_name(english: "Fedora 9 2008-7370: libtiff");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7370 (libtiff)");
...
if ( rpm_check( reference:"libtiff-3.8.2-11.fc9", release:"FC9") )
{
