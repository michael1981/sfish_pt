...
'The remote host is missing the DSA-624 security update');
...
'The Debian project recommends that you upgrade your zip package.');
...
deb_check(prefix: 'zip', release: '3.0', reference: '2.30-5woody2');
