...
#
# This plugin text was extracted from Fedora Security Advisory 2007-595
#
...
script_name(english: "Fedora 5 2007-595: evolution-data-server");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-595 (evolution-data-server)");
...
if ( rpm_check( reference:"evolution-data-server-1.6.3-5.fc5", release:"FC5") )
{
