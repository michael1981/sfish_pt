...
'The remote host is missing the DSA-440 security update');
...
deb_check(prefix: 'kernel-doc-2.4.17', release: '3.0', reference: '2.4.17-1woody2');
deb_check(prefix: 'kernel-headers-2.4.17-apus', release: '3.0', reference: '2.4.17-4');
deb_check(prefix: 'kernel-image-2.4.17-apus', release: '3.0', reference: '2.4.17-4');
deb_check(prefix: 'kernel-image-apus', release: '3.0', reference: '2.4.17-4');
deb_check(prefix: 'kernel-patch-2.4.17-apus', release: '3.0', reference: '2.4.17-4');
deb_check(prefix: 'kernel-source-2.4.17', release: '3.0', reference: '2.4.17-1woody2');
