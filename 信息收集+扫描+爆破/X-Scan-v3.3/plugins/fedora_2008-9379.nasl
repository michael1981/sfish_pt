...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9379
#
...
script_name(english: "Fedora 9 2008-9379: libpng10");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9379 (libpng10)");
...
if ( rpm_check( reference:"libpng10-1.0.41-1.fc9", release:"FC9") )
{
