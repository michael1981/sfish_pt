...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1017
#
...
script_name(english: "Fedora 8 2008-1017: libtirpc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1017 (libtirpc)");
...
if ( rpm_check( reference:"libtirpc-0.1.7-15.fc8", release:"FC8") )
{
