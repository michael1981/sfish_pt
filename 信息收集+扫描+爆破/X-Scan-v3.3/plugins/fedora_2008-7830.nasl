...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7830
#
...
script_name(english: "Fedora 9 2008-7830: bitlbee");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7830 (bitlbee)");
...
if ( rpm_check( reference:"bitlbee-1.2.3-1.fc9", release:"FC9") )
{
