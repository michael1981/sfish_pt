...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:104: sendmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:104 (sendmail).");
 script_set_attribute(attribute: "description", value: "A vulnerability in the way Sendmail handles multi-part MIME messages
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:104");
