...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:151: php");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:151 (php).");
 script_set_attribute(attribute: "description", value: "A number of vulnerabilities in PHP versions prior to 4.3.10 were
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:151");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2004-1018", "CVE-2004-1019", "CVE-2004-1063", "CVE-2004-1064", "CVE-2004-1065");
