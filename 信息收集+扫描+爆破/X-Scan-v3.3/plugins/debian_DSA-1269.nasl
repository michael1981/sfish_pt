# This script was automatically generated from the dsa-1269
...
'The remote host is missing the DSA-1269 security update');
...
'The Debian project recommends that you upgrade your lookup-el package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:L/AC:L/Au:N/C:P/I:P/A:P');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1269] DSA-1269-1 lookup-el");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1269-1 lookup-el");
 exit(0);
}
...
deb_check(prefix: 'lookup-el', release: '3.1', reference: '1.4-3sarge1');
