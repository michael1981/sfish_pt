...
'The remote host is missing the DSA-370 security update');
...
'Read http://www.debian.org/security/2003/dsa-370
...
deb_check(prefix: 'libpam-pgsql', release: '3.0', reference: '0.5.2-3woody1');
deb_check(prefix: 'pam-pgsql', release: '3.0', reference: '0.5.2-3woody1');
