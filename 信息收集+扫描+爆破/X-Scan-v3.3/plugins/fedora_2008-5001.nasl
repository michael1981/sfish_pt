...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5001
#
...
script_name(english: "Fedora 8 2008-5001: snort");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5001 (snort)");
...
if ( rpm_check( reference:"snort-2.8.1-3.fc8", release:"FC8") )
{
