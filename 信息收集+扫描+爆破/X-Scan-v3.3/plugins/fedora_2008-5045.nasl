...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5045
#
...
script_name(english: "Fedora 7 2008-5045: snort");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5045 (snort)");
...
if ( rpm_check( reference:"snort-2.8.1-3.fc7", release:"FC7") )
{
