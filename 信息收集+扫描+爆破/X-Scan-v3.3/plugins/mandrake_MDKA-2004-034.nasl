...
"The remote host is missing the patch for the advisory MDKA-2004:034 (rpmdrake).");
 script_set_attribute(attribute: "description", value: "When rpmdrake would come across a package name containing the string
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKA-2004:034");
