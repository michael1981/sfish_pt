...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9550
#
...
script_name(english: "Fedora 10 2009-9550: bugzilla");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9550 (bugzilla)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2009-1213", "CVE-2009-3165", "CVE-2009-3166");
...
if ( rpm_check( reference:"bugzilla-3.2.5-1.fc10", release:"FC10") )
{
