...
#
# This plugin text was extracted from Fedora Security Advisory 2007-594
#
...
script_name(english: "Fedora 6 2007-594: evolution-data-server");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-594 (evolution-data-server)");
...
if ( rpm_check( reference:"evolution-data-server-1.8.3-7.fc6", release:"FC6") )
{
