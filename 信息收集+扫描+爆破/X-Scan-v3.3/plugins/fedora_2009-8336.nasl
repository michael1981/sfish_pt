...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8336
#
...
script_name(english: "Fedora 11 2009-8336: apr");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8336 (apr)");
...
if ( rpm_check( reference:"apr-1.3.8-1.fc11", release:"FC11") )
{
