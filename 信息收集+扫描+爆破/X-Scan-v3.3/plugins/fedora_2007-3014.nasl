...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3014
#
...
script_name(english: "Fedora 8 2007-3014: xpdf");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3014 (xpdf)");
...
if ( rpm_check( reference:"xpdf-3.02-4.fc8", release:"FC8") )
{
