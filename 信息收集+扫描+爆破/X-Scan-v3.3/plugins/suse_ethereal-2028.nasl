...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for ethereal (ethereal-2028)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch ethereal-2028");
...
script_set_attribute(attribute: "solution", value: "Install the security patch ethereal-2028");
script_end_attributes();

script_cve_id("CVE-2006-4330", "CVE-2006-4331", "CVE-2006-4332", "CVE-2006-4333");
script_summary(english: "Check for the ethereal-2028 package");
...
if ( rpm_check( reference:"ethereal-0.10.14-16.8", release:"SLES10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"ethereal-0.10.14-16.8", release:"SLED10") )
{
	security_warning(port:0, extra:rpm_report_get());
	exit(0);
}
