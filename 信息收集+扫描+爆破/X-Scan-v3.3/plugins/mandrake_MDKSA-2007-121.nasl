...
if(description)
{
 ...
 script_name(english: "MDKSA-2007:121: freetype2");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2007:121 (freetype2).");
 script_set_attribute(attribute: "description", value: "An integer overflow vulnerability was discovered in the way the
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2007:121");
