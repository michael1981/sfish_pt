...
if(description)
{
  ...
  script_xref(name:"OSVDB", value:"13431");
...
This is typical of IIS installations that are not configured properly." );
 script_set_attribute(attribute:"see_also", value:"http://www.nextgenss.com/papers/iisrconfig.pdf" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2002-03/0038.html" );
...
script_end_attributes();
  ...
  script_copyright(english:"This script is Copyright (C) Sword & Shield Enterprise Security, Inc., 2004-2009");
