...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4136
#
...
script_name(english: "Fedora 7 2007-4136: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4136 (drupal)");
...
if ( rpm_check( reference:"drupal-5.4-1.fc7", release:"FC7") )
{
