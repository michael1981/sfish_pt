...
if (description)
{
 ...
 script_xref(name:"OSVDB", value:"29533");
 script_xref(name:"OSVDB", value:"29534");
 script_xref(name:"OSVDB", value:"29535");
 script_xref(name:"OSVDB", value:"29580");
...
execute code on the remote host." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://supportconnectw.ca.com/public/storage/infodocs/basbr-secnotice.asp" );
