...
#
# This plugin text was extracted from Fedora Security Advisory 2009-10730
#
...
script_name(english: "Fedora 10 2009-10730: texlive");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-10730 (texlive)");
...
if ( rpm_check( reference:"texlive-2007-46.fc10", release:"FC10") )
{
