...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaThunderbird: Security update to fix various problems (MozillaThunderbird-3973)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaThunderbird-3973");
 script_set_attribute(attribute: "description", value: "This update fixes several security problems in Mozilla
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaThunderbird-3973");
...
script_summary(english: "Check for the MozillaThunderbird-3973 package");
