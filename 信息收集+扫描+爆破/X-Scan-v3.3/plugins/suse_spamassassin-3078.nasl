...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for SPAMAssassin (spamassassin-3078)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch spamassassin-3078");
script_end_attributes();

script_cve_id("CVE-2007-0451");
script_summary(english: "Check for the spamassassin-3078 package");
