...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3420
#
...
script_name(english: "Fedora 8 2008-3420: clamav");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3420 (clamav)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-6335", "CVE-2008-0314", "CVE-2008-1100", "CVE-2008-1387", "CVE-2008-1833");
...
if ( rpm_check( reference:"clamav-0.92.1-2.fc8", release:"FC8") )
{
