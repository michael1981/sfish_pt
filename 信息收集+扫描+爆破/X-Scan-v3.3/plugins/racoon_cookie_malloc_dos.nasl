...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"55480");
...
requests with invalid cookie values.  At least one
...
"If you are running racoon VPN, download and install the latest SNAP kit 
from http://www.kame.net/.  If you are running a non-racoon VPN server 
which is crashing due to this check, consult your vendor for a fix." );
