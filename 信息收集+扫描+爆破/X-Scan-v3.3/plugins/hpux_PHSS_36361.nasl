...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_36361");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_36361 security update");
 script_set_attribute(attribute: "description", value:
"11.31 KRB5-Client Version 1.3.5.03 Cumulative patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/11.X/PHSS_36361");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_36361");
...
if ( hpux_patch_installed (patches:"PHSS_36361 PHSS_37666 PHSS_38568 PHSS_39766 ") )
{
 exit(0);
}
