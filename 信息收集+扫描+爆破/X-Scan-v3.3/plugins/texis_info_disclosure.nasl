...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"4314");
 ...
 script_set_attribute(
  ...
  value:string(
   ...
   "sensitive information about the the remote host, such as its internal\n",
   "IP address and the path to various components (eg, cmd.exe)."
  )
 );
 script_set_attribute(
  attribute:"see_also", 
  value:"http://archives.neohapsis.com/archives/bugtraq/2003-03/0216.html"
 );
 script_set_attribute(
  attribute:"see_also", 
  value:"http://archives.neohapsis.com/archives/bugtraq/2003-03/0257.html"
 );
 script_set_attribute(
  attribute:"solution", 
