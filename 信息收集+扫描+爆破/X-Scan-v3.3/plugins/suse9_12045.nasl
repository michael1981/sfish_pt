...
if(description)
{
 ...
 script_name(english: "SuSE9 Security Update:  Security update for libexif (12045)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE9 system is missing the security patch 12045");
...
script_set_attribute(attribute: "solution", value: "Install the security patch 12045");
script_end_attributes();

script_cve_id("CVE-2007-6351","CVE-2007-6352");
script_summary(english: "Check for the security advisory #12045");
...
if ( rpm_check( reference:"libexif-0.5.12-118.12", release:"SUSE9", cpu: "i586") )
{
