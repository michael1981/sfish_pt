...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1880
#
...
script_name(english: "Fedora 7 2008-1880: moin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1880 (moin)");
...
if ( rpm_check( reference:"moin-1.5.8-4.fc7", release:"FC7") )
{
