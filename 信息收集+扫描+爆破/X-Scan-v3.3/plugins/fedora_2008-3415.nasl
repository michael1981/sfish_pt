...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3415
#
...
script_name(english: "Fedora 7 2008-3415: WebKit");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3415 (WebKit)");
...
if ( rpm_check( reference:"WebKit-1.0.0-0.8.svn31787.fc7", release:"FC7") )
{
