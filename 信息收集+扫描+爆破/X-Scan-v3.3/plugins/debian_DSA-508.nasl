...
'The remote host is missing the DSA-508 security update');
...
'Read http://www.debian.org/security/2004/dsa-508
...
deb_check(prefix: 'xpcd', release: '3.0', reference: '2.08-8woody1');
deb_check(prefix: 'xpcd-gimp', release: '3.0', reference: '2.08-8woody1');
deb_check(prefix: 'xpcd-svga', release: '3.0', reference: '2.08-8woody1');
deb_check(prefix: 'xpcd', release: '3.0', reference: '2.08-8woody2');
