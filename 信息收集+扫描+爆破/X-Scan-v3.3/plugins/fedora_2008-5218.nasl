...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5218
#
...
script_name(english: "Fedora 8 2008-5218: net-snmp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5218 (net-snmp)");
...
if ( rpm_check( reference:"net-snmp-5.4.1-7.fc8", release:"FC8") )
{
