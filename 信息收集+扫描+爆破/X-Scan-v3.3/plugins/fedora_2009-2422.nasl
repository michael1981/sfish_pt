...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2422
#
...
script_name(english: "Fedora 10 2009-2422: gnome-web-photo");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2422 (gnome-web-photo)");
...
if ( rpm_check( reference:"gnome-web-photo-0.3-15.fc10", release:"FC10") )
{
