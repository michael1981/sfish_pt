...
'The remote host is missing the DSA-852 security update');
...
'The Debian project recommends that you upgrade your imapproxy package.');
...
deb_check(prefix: 'imapproxy', release: '3.1', reference: '1.2.3-1sarge1');
deb_check(prefix: 'up-imapproxy', release: '3.1', reference: '1.2.3-1sarge1');
