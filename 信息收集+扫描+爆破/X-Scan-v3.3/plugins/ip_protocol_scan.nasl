...
"This plugin detects the protocols understood by the remote IP stack." );
 script_set_attribute(attribute:"see_also", value:"http://www.iana.org/assignments/protocol-numbers" );
...
script_end_attributes();
  ...
  script_summary(english:"Scans IP protocols");
...
if (! COMMAND_LINE && ! thorough_tests) exit(0);	# Too long / possibly unsafe
...
for (j = 0; old_reject_nb != reject_nb || one_more_time; j ++)
{
 ...
 else if (omt_count > 0) one_more_time = 1;
