...
#
# This plugin text was extracted from Fedora Security Advisory 2007-484
#
...
script_name(english: "Fedora 6 2007-484: evolution-data-server");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-484 (evolution-data-server)");
...
if ( rpm_check( reference:"evolution-data-server-1.8.3-6.fc6", release:"FC6") )
{
