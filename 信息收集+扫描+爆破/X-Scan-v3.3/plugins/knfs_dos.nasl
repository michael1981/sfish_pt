...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"2353");
 ...
 script_set_attribute(
  attribute:"synopsis",
  value:"The remote NFS daemon is prone to a denial of service attack."
 );
 script_set_attribute(
...
request with an invalid length field."
 ...
 script_set_attribute(
  attribute:"see_also", 
  value:"http://archives.neohapsis.com/archives/bugtraq/2003-07/0379.html"
 );
 script_set_attribute(
  attribute:"solution", 
  value:
