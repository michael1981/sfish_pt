...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2649
#
...
script_name(english: "Fedora 7 2007-2649: drupal");
...
if ( rpm_check( reference:"drupal-5.3-1.fc7", release:"FC7") )
{
