...
if(description)
{
 ...
 script_xref(name:"IAVA", value:"2005-B-0004");
 script_xref(name:"OSVDB", value:"13609");

 name["english"] = "MS05-015: Vulnerability in the Hyperlink Object Library may allow code execution (888113)";
...
in the Hyperlink Object Library that can be abused to execute
...
if (is_accessible_share())
{
 ...
 {
 set_kb_item(name:"SMB/Missing/MS05-015", value:TRUE);
