...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3875
#
...
script_name(english: "Fedora 8 2008-3875: blender");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3875 (blender)");
...
if ( rpm_check( reference:"blender-2.45-14.fc8", release:"FC8") )
{
