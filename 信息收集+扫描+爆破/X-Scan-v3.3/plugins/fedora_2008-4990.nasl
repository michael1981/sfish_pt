...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4990
#
...
script_name(english: "Fedora 9 2008-4990: evolution");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4990 (evolution)");
...
if ( rpm_check( reference:"evolution-2.22.2-2.fc9", release:"FC9") )
{
