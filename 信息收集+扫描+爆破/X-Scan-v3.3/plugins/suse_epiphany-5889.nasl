...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for Epiphany (epiphany-5889)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch epiphany-5889");
...
script_set_attribute(attribute: "solution", value: "Install the security patch epiphany-5889");
...
script_summary(english: "Check for the epiphany-5889 package");
...
if ( rpm_check( reference:"mozilla-xulrunner-1.8.0.14eol-0.12", release:"SLES10") )
{
