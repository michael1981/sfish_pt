...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3986
#
...
script_name(english: "Fedora 7 2007-3986: wesnoth");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3986 (wesnoth)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2007-3917", "CVE-2007-5742");
...
if ( rpm_check( reference:"wesnoth-1.2.8-2.fc7", release:"FC7") )
{
