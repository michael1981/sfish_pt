...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3500
#
...
script_name(english: "Fedora 10 2009-3500: pam_ssh");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3500 (pam_ssh)");
...
if ( rpm_check( reference:"pam_ssh-1.92-10.fc10", release:"FC10") )
{
