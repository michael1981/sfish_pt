...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9712
#
...
script_name(english: "Fedora 8 2008-9712: roundup");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9712 (roundup)");
...
if ( rpm_check( reference:"roundup-1.4.6-1.fc8", release:"FC8") )
{
