...
'The remote host is missing the DSA-646 security update');
...
deb_check(prefix: 'imagemagick', release: '3.0', reference: '5.4.4.5-1woody5');
deb_check(prefix: 'libmagick5', release: '3.0', reference: '5.4.4.5-1woody5');
deb_check(prefix: 'libmagick5-dev', release: '3.0', reference: '5.4.4.5-1woody5');
deb_check(prefix: 'perlmagick', release: '3.0', reference: '5.4.4.5-1woody5');
