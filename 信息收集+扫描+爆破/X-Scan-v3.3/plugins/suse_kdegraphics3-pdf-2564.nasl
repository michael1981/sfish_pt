...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for kdegraphics3-pdf (kdegraphics3-pdf-2564)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch kdegraphics3-pdf-2564");
script_end_attributes();

script_cve_id("CVE-2007-0104");
script_summary(english: "Check for the kdegraphics3-pdf-2564 package");
