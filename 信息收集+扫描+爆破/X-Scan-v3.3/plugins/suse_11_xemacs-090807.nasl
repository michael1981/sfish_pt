...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  xemacs (2009-08-07)");
...
fixed that enable xeamcs to use the configured fonts.
");
...
if ( rpm_check( reference:"xemacs-21.5.28.20080401-59.23.2", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"xemacs-info-21.5.28.20080401-59.23.2", release:"SLED11", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
