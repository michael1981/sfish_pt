...
if(description)
{
 ...
 name["english"] = "MS08-038: Vulnerability in Windows Explorer Could Allow Remote Code Execution (950582)";
...
script_end_attributes();
 ...
 summary["english"] = "Determines the presence of update 950582";
...
{
 if ( hotfix_is_vulnerable (os:"6.0", sp:0, file:"shell32.dll", version:"6.0.6000.16680", dir:"\system32") ||
      hotfix_is_vulnerable (os:"6.0", sp:0, file:"shell32.dll", version:"6.0.6000.20822", min_version:"6.0.6000.20000", dir:"\system32") ||
      hotfix_is_vulnerable (os:"6.0", sp:1, file:"shell32.dll", version:"6.0.6001.18062", dir:"\system32") ||
      hotfix_is_vulnerable (os:"6.0", sp:1, file:"shell32.dll", version:"6.0.6001.22166", min_version:"6.0.6001.22000", dir:"\system32") )
 {
 set_kb_item(name:"SMB/Missing/MS08-038", value:TRUE);
