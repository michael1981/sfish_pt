...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1499
#
...
script_name(english: "Fedora 5 2006-1499: firefox");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1499 (firefox)");
...
Users of Firefox are advised to upgrade to this package,
which contains Firefox version 1.5.0.9 and corrects these
issues.
");
...
if ( rpm_check( reference:"firefox-1.5.0.9-1.fc5", release:"FC5") )
{
