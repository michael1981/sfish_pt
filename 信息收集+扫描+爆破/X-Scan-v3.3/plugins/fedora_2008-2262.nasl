...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2262
#
...
script_name(english: "Fedora 7 2008-2262: lighttpd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2262 (lighttpd)");
...
* Tue Mar  4 2008 Matthias Saou <[9]http://freshrpms.net/> 1.4.18-3
...
if ( rpm_check( reference:"lighttpd-1.4.18-3.fc7", release:"FC7") )
{
