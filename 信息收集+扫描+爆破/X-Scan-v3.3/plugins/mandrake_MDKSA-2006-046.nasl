...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:046: tar");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:046 (tar).");
 script_set_attribute(attribute: "description", value: "Gnu tar versions 1.14 and above have a buffer overflow vulnerability
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:046");
