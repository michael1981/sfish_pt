...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1199
#
...
script_name(english: "Fedora 5 2006-1199: firefox");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1199 (firefox)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2006-5464", "CVE-2006-5747", "CVE-2006-5748");
...
if ( rpm_check( reference:"firefox-1.5.0.8-1.fc5", release:"FC5") )
{
