...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"42708");
 script_xref(name:"OSVDB", value:"42709");

 name["english"] = "MS08-016: Vulnerabilities in Microsoft Office Could Allow Remote Code Execution (949030)";
 ...
 if ( !isnull(v) ) 
  {
  	 if ( ( v[0] == 9 &&  v[1] == 0 && v[2] == 0 && v[3] < 8968)  ||
	      ( v[0] == 10 && v[1] == 0 && v[2] < 6839 ) ||
	      ( v[0] == 11 && v[1] == 0 && v[2] < 8172) ) {
 set_kb_item(name:"SMB/Missing/MS08-016", value:TRUE);
