...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHNE_36973");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHNE_36973 security update");
 script_set_attribute(attribute: "description", value:
"Bind 9.2.0 components");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHNE_36973");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHNE_36973");
...
if ( hpux_patch_installed (patches:"PHNE_36973 PHNE_37548 PHNE_37865 PHNE_40089 ") )
{
 exit(0);
}
