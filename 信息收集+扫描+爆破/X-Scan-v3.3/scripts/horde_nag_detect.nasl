...
# 
  ...
  desc["english"] = "
This script detects whether the remote host is running Nag and
extracts version numbers and locations of any instances found. 

Nag is a PHP-based multiuser task list manager from the Horde Project. 
See http://www.horde.org/nag/ for more information.";
