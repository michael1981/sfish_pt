...
#
# This plugin text was extracted from Fedora Security Advisory 2006-587
#
...
script_name(english: "Fedora 4 2006-587: ImageMagick");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-587 (ImageMagick)");
...
if ( rpm_check( reference:"ImageMagick-6.2.2.0-3.fc4.2", release:"FC4") )
{
