...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for sendmail (sendmail-2030)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch sendmail-2030");
script_end_attributes();

script_cve_id("CVE-2006-4434");
script_summary(english: "Check for the sendmail-2030 package");
