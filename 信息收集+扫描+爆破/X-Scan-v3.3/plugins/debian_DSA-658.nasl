...
'The remote host is missing the DSA-658 security update');
...
'The Debian project recommends that you upgrade your libdbi-perl package.');
...
deb_check(prefix: 'libdbi-perl', release: '3.0', reference: '1.21-2woody2');
