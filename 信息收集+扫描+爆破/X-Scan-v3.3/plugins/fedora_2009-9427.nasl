...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9427
#
...
script_name(english: "Fedora 10 2009-9427: kdelibs-experimental");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9427 (kdelibs-experimental)");
 script_set_attribute(attribute: "description", value: "KDE libraries with experimental or unstable api/abi.
...
script_summary(english: "Check for the version of the kdelibs-experimental package");
...
if ( rpm_check( reference:"kdelibs-experimental-4.3.1-1.fc10", release:"FC10") )
{
