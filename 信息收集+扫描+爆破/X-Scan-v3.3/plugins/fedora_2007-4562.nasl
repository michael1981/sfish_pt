...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4562
#
...
script_name(english: "Fedora 8 2007-4562: ganglia");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4562 (ganglia)");
...
if ( rpm_check( reference:"ganglia-3.0.6-1.fc8", release:"FC8") )
{
