...
#
# This plugin text was extracted from Fedora Security Advisory 2009-4875
#
...
script_name(english: "Fedora 11 2009-4875: squirrelmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-4875 (squirrelmail)");
...
if ( rpm_check( reference:"squirrelmail-1.4.18-1.fc11", release:"FC11") )
{
