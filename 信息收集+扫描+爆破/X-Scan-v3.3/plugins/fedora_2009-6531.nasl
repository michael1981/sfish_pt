...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6531
#
...
script_name(english: "Fedora 10 2009-6531: libpng");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6531 (libpng)");
...
script_end_attributes();
 ...
 script_cve_id("CVE-2009-0040", "CVE-2009-2042");
...
if ( rpm_check( reference:"libpng-1.2.37-1.fc10", release:"FC10") )
{
