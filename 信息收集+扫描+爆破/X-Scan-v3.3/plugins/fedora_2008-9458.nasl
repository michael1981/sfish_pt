...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9458
#
...
script_name(english: "Fedora 9 2008-9458: cman");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9458 (cman)");
...
if ( rpm_check( reference:"cman-2.03.09-1.fc9", release:"FC9") )
{
