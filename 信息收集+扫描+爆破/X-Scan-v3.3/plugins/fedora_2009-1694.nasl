...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1694
#
...
script_name(english: "Fedora 10 2009-1694: trickle");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1694 (trickle)");
...
if ( rpm_check( reference:"trickle-1.07-7.fc10", release:"FC10") )
{
