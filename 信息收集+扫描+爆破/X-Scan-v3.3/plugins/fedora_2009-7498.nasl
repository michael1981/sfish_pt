...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7498
#
...
script_name(english: "Fedora 11 2009-7498: mumbles");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7498 (mumbles)");
...
if ( rpm_check( reference:"mumbles-0.4-11.fc11", release:"FC11") )
{
