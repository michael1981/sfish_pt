...
#
# This plugin text was extracted from Fedora Security Advisory 2009-9751
#
...
script_name(english: "Fedora 10 2009-9751: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-9751 (drupal)");
...
if ( rpm_check( reference:"drupal-6.14-1.fc10", release:"FC10") )
{
