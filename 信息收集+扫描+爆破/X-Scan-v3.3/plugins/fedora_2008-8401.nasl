...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8401
#
...
script_name(english: "Fedora 8 2008-8401: seamonkey");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8401 (seamonkey)");
...
if ( rpm_check( reference:"seamonkey-1.1.12-1.fc8", release:"FC8") )
{
