...
if(description)
{
 ...
 script_name(english: "MDKSA-2007:017: wget");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2007:017 (wget).");
 script_set_attribute(attribute: "description", value: "The ftp_syst function in ftp-basic.c in Free Software Foundation (FSF)
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2007:017");
