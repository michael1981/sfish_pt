...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8941
#
...
script_name(english: "Fedora 8 2008-8941: jhead");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8941 (jhead)");
...
if ( rpm_check( reference:"jhead-2.84-1.fc8", release:"FC8") )
{
