...
if(description)
{
 ...
 script_name(english: "MDKSA-2004:122: mod_ssl/apache2-mod_ssl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2004:122 (mod_ssl/apache2-mod_ssl).");
 script_set_attribute(attribute: "description", value: "A vulnerability in mod_ssl was discovered by Hartmut Keil. After a
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2004:122");
script_set_attribute(attribute: "solution", value: "Apply the newest security patches from Mandriva.");
script_end_attributes();

script_cve_id("CVE-2004-0885");
script_summary(english: "Check for the version of the mod_ssl/apache2-mod_ssl package");
