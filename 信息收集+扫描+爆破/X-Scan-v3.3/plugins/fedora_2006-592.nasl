...
#
# This plugin text was extracted from Fedora Security Advisory 2006-592
#
...
script_name(english: "Fedora 5 2006-592: libtiff");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-592 (libtiff)");
...
if ( rpm_check( reference:"libtiff-3.7.4-6", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"libtiff-devel-3.7.4-6", release:"FC5") )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
