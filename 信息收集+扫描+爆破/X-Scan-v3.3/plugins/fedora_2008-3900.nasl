...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3900
#
...
script_name(english: "Fedora 9 2008-3900: clamav");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3900 (clamav)");
...
if ( rpm_check( reference:"clamav-0.93-1.fc9", release:"FC9") )
{
