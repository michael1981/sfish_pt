...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4471
#
...
script_name(english: "Fedora 7 2007-4471: mysql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4471 (mysql)");
...
if ( rpm_check( reference:"mysql-5.0.45-6.fc7", release:"FC7") )
{
