...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3667
#
...
script_name(english: "Fedora 8 2007-3667: cacti");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3667 (cacti)");
...
if ( rpm_check( reference:"cacti-0.8.7a-1.fc8", release:"FC8") )
{
