...
#
# This plugin text was extracted from Fedora Security Advisory 2008-8113
#
...
script_name(english: "Fedora 9 2008-8113: tomcat5");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-8113 (tomcat5)");
...
if ( rpm_check( reference:"tomcat5-5.5.27-0jpp.2.fc9", release:"FC9") )
{
