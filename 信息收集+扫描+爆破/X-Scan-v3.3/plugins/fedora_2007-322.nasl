...
#
# This plugin text was extracted from Fedora Security Advisory 2007-322
#
...
script_name(english: "Fedora 6 2007-322: ekiga");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-322 (ekiga)");
...
if ( rpm_check( reference:"ekiga-2.0.5-3.fc6", release:"FC6") )
{
