...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0994
#
...
script_name(english: "Fedora 7 2008-0994: pulseaudio");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0994 (pulseaudio)");
...
if ( rpm_check( reference:"pulseaudio-0.9.6-2.fc7.1", release:"FC7") )
{
