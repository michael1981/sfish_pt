...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2229
#
...
script_name(english: "Fedora 7 2008-2229: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2229 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.5-1.fc7", release:"FC7") )
{
