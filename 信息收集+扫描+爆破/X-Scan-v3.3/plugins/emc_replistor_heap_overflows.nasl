...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"53591");
  script_xref(name:"OSVDB", value:"53592");
...
on the remote system with SYSTEM level privileges." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?1c89e2a9 (6.2 SP5 Release Notes) (login required)" );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?b7a129da (6.3 SP2 Release Notes) (login required)" );
