...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for xsupplicant (xsupplicant-2455)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch xsupplicant-2455");
script_end_attributes();

script_cve_id("CVE-2006-5601");
script_summary(english: "Check for the xsupplicant-2455 package");
