...
script_xref(name:"OSVDB", value:"593");
...
URL encoding of characters in the filename extension." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2001-03/0463.html" );
...
script_copyright(english:"(C) INTRANODE - 2001-2009");
