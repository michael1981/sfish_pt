...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3390
#
...
script_name(english: "Fedora 8 2008-3390: asterisk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3390 (asterisk)");
...
if ( rpm_check( reference:"asterisk-1.4.19.1-1.fc8", release:"FC8") )
{
