...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1525
#
...
script_name(english: "Fedora 10 2009-1525: xine-lib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1525 (xine-lib)");
...
if ( rpm_check( reference:"xine-lib-1.1.16.2-1.fc10", release:"FC10") )
{
