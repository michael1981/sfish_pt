...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:075: sendmail");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:075 (sendmail).");
 script_set_attribute(attribute: "description", value: "An input validation error exists in sendmail that may allow local users
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:075");
