...
#
# This plugin text was extracted from Fedora Security Advisory 2009-0331
#
...
script_name(english: "Fedora 10 2009-0331: openssl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-0331 (openssl)");
...
if ( rpm_check( reference:"openssl-0.9.8g-12.fc10", release:"FC10") )
{
