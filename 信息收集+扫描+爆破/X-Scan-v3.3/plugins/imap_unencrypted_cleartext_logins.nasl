...
is used." );
 script_set_attribute(attribute:"see_also", value:"RFC 2222 for information about SASL." );
 script_set_attribute(attribute:"see_also", value:"RFC 2595 for information about TLS with IMAP." );
