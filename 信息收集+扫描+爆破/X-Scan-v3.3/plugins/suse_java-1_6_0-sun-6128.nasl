...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  java-1_6_0-sun: Security update to JDK 6 update 13. (java-1_6_0-sun-6128)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch java-1_6_0-sun-6128");
...
script_set_attribute(attribute: "solution", value: "Install the security patch java-1_6_0-sun-6128");
...
script_summary(english: "Check for the java-1_6_0-sun-6128 package");
...
if ( rpm_check( reference:"java-1_6_0-sun-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-alsa-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-debuginfo-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-demo-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-devel-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-jdbc-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-plugin-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"java-1_6_0-sun-src-1.6.0.u12-1.4", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
