...
'The remote host is missing the SSA-2006-178-01 security update');
...
script_name(english: "SSA-2006-178-01 kdebase kdm local file reading vulnerability ");
...
extrarep = NULL;
if (slackware_check(osver: "10.0", pkgname: "kdebase", pkgver: "3.2.3", pkgnum:  "4", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package kdebase is vulnerable in Slackware 10.0
Upgrade to kdebase-3.2.3-i486-4_slack10.0 or newer.
');
}
if (slackware_check(osver: "10.1", pkgname: "kdebase", pkgver: "3.3.2", pkgnum:  "3", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package kdebase is vulnerable in Slackware 10.1
Upgrade to kdebase-3.3.2-i486-3_slack10.1 or newer.
');
}
if (slackware_check(osver: "10.2", pkgname: "kdebase", pkgver: "3.4.2", pkgnum:  "3", pkgarch: "i486")) {
w++;
if (report_verbosity > 0) extrarep = strcat(extrarep, '
The package kdebase is vulnerable in Slackware 10.2
Upgrade to kdebase-3.4.2-i486-3_slack10.2 or newer.
');
}
