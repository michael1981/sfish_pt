...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libpng-devel (2009-06-24)");
...
if ( rpm_check( reference:"libpng12-0-1.2.31-5.12.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libpng-devel-1.2.31-5.12.1", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libpng12-0-1.2.31-5.12.1", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
