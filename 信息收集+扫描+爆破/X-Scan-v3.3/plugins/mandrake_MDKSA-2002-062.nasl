...
if(description)
{
 ...
 script_name(english: "MDKSA-2002:062-1: postgresql");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2002:062-1 (postgresql).");
 script_set_attribute(attribute: "description", value: "Vulnerabilities were discovered in the Postgresql relational database
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2002:062-1");
