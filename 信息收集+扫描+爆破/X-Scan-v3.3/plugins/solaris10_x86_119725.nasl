...
if(description)
{
 ...
 name["english"] = "Solaris 10 (i386) : 119725-06";
...
e +=  solaris_check_patch(release:"5.10_x86", arch:"i386", patch:"119725-06", obsoleted_by:"", package:"SUNWljdk", version:"1.0,REV=2004.10.11.06.02");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
