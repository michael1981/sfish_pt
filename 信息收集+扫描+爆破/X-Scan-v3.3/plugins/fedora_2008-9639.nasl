...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9639
#
...
script_name(english: "Fedora 8 2008-9639: optipng");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9639 (optipng)");
...
(Thanks to Vincent Lefevre for the suggestion.)  * Added a programming interfac
e
to the optimization engine, in order to facilitate the development of PNG-
optimizing GUI apps and plugins.  ! Fixed processing when image reduction yield
s
...
optimization in their presence, to preserve their integrity.  + Allowed the use
r
to enforce the optimization of dSIG'ed files.  + Recognized APNG animation file
s
...
if ( rpm_check( reference:"optipng-0.6.2-1.fc8", release:"FC8") )
{
