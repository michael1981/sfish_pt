...
'The remote host is missing the DSA-234 security update');
...
deb_check(prefix: 'kcmlinuz', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'kcron', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'kpackage', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'ksysv', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'kuser', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'kwuftpd', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'lilo-config', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'secpolicy', release: '3.0', reference: '2.2.2-7.2');
deb_check(prefix: 'kdeadmin', release: '3.0', reference: '2.2.2-7.2');
