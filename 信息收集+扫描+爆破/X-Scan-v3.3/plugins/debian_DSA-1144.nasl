...
'The remote host is missing the DSA-1144 security update');
...
'The Debian project recommends that you upgrade your chmlib-bin package.');
...
deb_check(prefix: 'chmlib', release: '3.1', reference: '0.35-6sarge3');
deb_check(prefix: 'chmlib-bin', release: '3.1', reference: '0.35-6sarge3');
deb_check(prefix: 'chmlib-dev', release: '3.1', reference: '0.35-6sarge3');
