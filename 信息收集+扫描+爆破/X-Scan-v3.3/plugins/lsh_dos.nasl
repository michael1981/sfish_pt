...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"14825");
...
(SSH) which is available for Unix-like platforms. This version of LSH
is reported vulnerable to a Denial of Service attack.
