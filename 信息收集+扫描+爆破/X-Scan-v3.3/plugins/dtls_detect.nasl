...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis",
    value:"An encrypted service is listening on the remote host."
  );
  script_set_attribute(
    attribute:"description", 
    value:string(
      "The remote service is encrypted using Datagram Transport Layer\n",
      "Security (DTLS), which provides communications privacy for datagram\n",
      "protocols."
    )
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://tools.ietf.org/html/rfc4347"
  );
  script_set_attribute(
    attribute:"solution",
    value:"n/a"
...
{
  local_var clen, frag_len, frag_ofs, handshake, hello, ver;
