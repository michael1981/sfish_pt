...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5525
#
...
script_name(english: "Fedora 10 2009-5525: php-Smarty");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5525 (php-Smarty)");
...
if ( rpm_check( reference:"php-Smarty-2.6.25-1.fc10", release:"FC10") )
{
