# This script was automatically generated from the dsa-1404
...
'The remote host is missing the DSA-1404 security update');
...
'The Debian project recommends that you upgrade your gallery2 package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:L/Au:N/C:P/I:P/A:N');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1404] DSA-1404-1 gallery2");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1404-1 gallery2");
 exit(0);
}
...
deb_check(prefix: 'gallery2', release: '4.0', reference: '2.1.2-2.0.etch.1');
