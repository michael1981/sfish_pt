...
#
# This plugin text was extracted from Fedora Security Advisory 2006-1396
#
...
script_name(english: "Fedora 6 2006-1396: dovecot");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-1396 (dovecot)");
...
if ( rpm_check( reference:"dovecot-1.0-1.rc15.fc6", release:"FC6") )
{
