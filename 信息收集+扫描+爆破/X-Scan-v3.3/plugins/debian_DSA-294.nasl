...
'The remote host is missing the DSA-294 security update');
...
'The Debian project recommends that you upgrade your gkrellm-newsticker package.');
...
deb_check(prefix: 'gkrellm-newsticker', release: '3.0', reference: '0.3-3.1');
