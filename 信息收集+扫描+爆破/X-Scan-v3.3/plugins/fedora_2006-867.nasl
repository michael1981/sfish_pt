...
#
# This plugin text was extracted from Fedora Security Advisory 2006-867
#
...
script_name(english: "Fedora 4 2006-867: gnupg");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2006-867 (gnupg)");
...
if ( rpm_check( reference:"gnupg-1.4.5-1", release:"FC4") )
{
