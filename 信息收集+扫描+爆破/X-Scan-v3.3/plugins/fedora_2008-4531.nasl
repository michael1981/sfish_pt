...
#
# This plugin text was extracted from Fedora Security Advisory 2008-4531
#
...
script_name(english: "Fedora 9 2008-4531: stunnel");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-4531 (stunnel)");
...
if ( rpm_check( reference:"stunnel-4.24-1.fc9", release:"FC9") )
{
