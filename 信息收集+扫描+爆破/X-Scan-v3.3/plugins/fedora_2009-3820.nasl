...
#
# This plugin text was extracted from Fedora Security Advisory 2009-3820
#
...
script_name(english: "Fedora 10 2009-3820: xpdf");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-3820 (xpdf)");
...
if ( rpm_check( reference:"xpdf-3.02-13.fc10", release:"FC10") )
{
