...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"49283");
...
only checked the affected module's build timestamp." );
 script_set_attribute(attribute:"see_also", value:"http://labs.idefense.com/intelligence/vulnerabilities/display.php?id=751" );
 ...
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?d66cba50" );
