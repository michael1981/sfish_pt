...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2967
#
...
script_name(english: "Fedora 7 2008-2967: gnome-screensaver");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2967 (gnome-screensaver)");
...
if ( rpm_check( reference:"gnome-screensaver-2.18.2-4.fc7", release:"FC7") )
{
