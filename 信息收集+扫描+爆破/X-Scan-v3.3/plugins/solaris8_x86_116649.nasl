...
if(description)
{
 ...
 name["english"] = "Solaris 8 (i386) : 116649-20";
...
e +=  solaris_check_patch(release:"5.8_x86", arch:"i386", patch:"116649-20", obsoleted_by:"OBSOLETE", package:"SUNWwbsvr", version:"6.1,REV=2003.11.21.14.20");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_hole(0);
	else  
