...
'The remote host is missing the DSA-866 security update');
...
deb_check(prefix: 'libnspr-dev', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'libnspr4', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'libnss-dev', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'libnss3', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-browser', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-calendar', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-chatzilla', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-dev', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-dom-inspector', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-js-debugger', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-mailnews', release: '3.1', reference: '1.7.8-1sarge3');
deb_check(prefix: 'mozilla-psm', release: '3.1', reference: '1.7.8-1sarge3');
