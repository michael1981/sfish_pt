...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaThunderbird: Security Update to 2.0.0.19 (MozillaThunderbird-5900)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaThunderbird-5900");
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaThunderbird-5900");
...
script_summary(english: "Check for the MozillaThunderbird-5900 package");
...
if ( rpm_check( reference:"MozillaThunderbird-2.0.0.19-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaThunderbird-translations-2.0.0.19-0.1", release:"SUSE10.3") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
