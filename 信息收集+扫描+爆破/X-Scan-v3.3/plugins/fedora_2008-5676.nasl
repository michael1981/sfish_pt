...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5676
#
...
script_name(english: "Fedora 9 2008-5676: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5676 (phpMyAdmin)");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.7-1.fc9", release:"FC9") )
{
