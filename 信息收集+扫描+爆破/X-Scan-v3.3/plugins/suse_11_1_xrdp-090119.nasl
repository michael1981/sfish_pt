...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  xrdp (2009-01-19)");
...
exploited remotely to execute arbitrary code. Additionally
...
if ( rpm_check( reference:"xrdp-0.4.1-16.6.1", release:"SUSE11.1", cpu:"i586") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"xrdp-0.4.1-16.6.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_hole(port:0, extra:rpm_report_get() );
	exit(0);
}
