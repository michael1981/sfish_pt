...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5500
#
...
script_name(english: "Fedora 9 2009-5500: jetty");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5500 (jetty)");
...
if ( rpm_check( reference:"jetty-5.1.15-3.fc9", release:"FC9") )
{
