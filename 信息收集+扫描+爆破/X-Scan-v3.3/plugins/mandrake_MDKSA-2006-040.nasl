...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:040: kernel");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:040");
