...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2475
#
...
script_name(english: "Fedora 7 2008-2475: dovecot");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2475 (dovecot)");
...
if ( rpm_check( reference:"dovecot-1.0.13-18.fc7", release:"FC7") )
{
