...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6502
#
...
script_name(english: "Fedora 11 2009-6502: rb_libtorrent");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6502 (rb_libtorrent)");
...
if ( rpm_check( reference:"rb_libtorrent-0.14.3-2.fc11", release:"FC11") )
{
