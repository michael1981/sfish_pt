...
#  http://www.gentoo.org/security/en/glsa/glsa-200611-07.xml
...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200611-07 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200611-07
...
script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200611-07.xml');
...
script_end_attributes();
 ...
 script_summary(english: 'GraphicsMagick: PALM and DCM buffer overflows');
 exit(0);
}
...
if (qpkg_check(package: "media-gfx/graphicsmagick", unaffected: make_list("ge 1.1.7-r3"), vulnerable: make_list("lt 1.1.7-r3")
