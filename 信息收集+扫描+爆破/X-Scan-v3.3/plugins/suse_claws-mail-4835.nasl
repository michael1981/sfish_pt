...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  claws-mail security update (claws-mail-4835)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch claws-mail-4835");
script_end_attributes();

script_summary(english: "Check for the claws-mail-4835 package");
