...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200807-07 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200807-07
...
script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200807-07.xml');
...
if (qpkg_check(package: "net-misc/nxnode", unaffected: make_list("ge 3.2.0-r3"), vulnerable: make_list("lt 3.2.0-r3")
)) { security_warning(0); exit(0); }
if (qpkg_check(package: "net-misc/nx", unaffected: make_list("ge 3.2.0-r2"), vulnerable: make_list("lt 3.2.0-r2")
)) { security_warning(0); exit(0); }
