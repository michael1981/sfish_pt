...
[...]');
script_set_attribute(attribute:'description', value: 'Akio Ishida discovered that the SET SESSION AUTHORIZATION command did
...
- postgresql
[...]');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:L/AC:H/Au:N/C:N/I:N/A:C');
