...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6220
#
...
script_name(english: "Fedora 8 2008-6220: WebKit");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6220 (WebKit)");
...
if ( rpm_check( reference:"WebKit-1.0.0-0.10.svn34655.fc8", release:"FC8") )
{
