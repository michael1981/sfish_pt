...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"60242");

  script_name(english:"XOOPS misc.php Query String Cross-Site Scripting");
...
of XOOPS, though Nessus has not checked for those issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"http://www.nessus.org/u?a12c2180"
  );
  script_set_attribute(
    attribute:"see_also",
  ...
  script_set_attribute(
    attribute:"solution",
    value:"Upgrade to XOOPS 2.4.0 or later."
  );
  script_set_attribute(
  ...
  script_set_attribute(
    ...
    value:"2009/10/02"  # when the fix was commited to SVN
  );
  script_set_attribute(
    attribute:"patch_publication_date",
    value:"2009/10/26"  # release date of 2.4.0
  );
  script_set_attribute(
