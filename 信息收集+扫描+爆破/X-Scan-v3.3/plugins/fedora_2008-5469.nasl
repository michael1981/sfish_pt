...
#
# This plugin text was extracted from Fedora Security Advisory 2008-5469
#
...
script_name(english: "Fedora 9 2008-5469: libetpan");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-5469 (libetpan)");
...
if ( rpm_check( reference:"libetpan-0.54-1.fc9", release:"FC9") )
{
