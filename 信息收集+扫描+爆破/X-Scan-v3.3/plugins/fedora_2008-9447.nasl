...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9447
#
...
script_name(english: "Fedora 9 2008-9447: blender");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9447 (blender)");
...
if ( rpm_check( reference:"blender-2.48a-4.fc9", release:"FC9") )
{
