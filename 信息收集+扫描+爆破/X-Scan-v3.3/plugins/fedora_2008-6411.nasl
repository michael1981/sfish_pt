...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6411
#
...
script_name(english: "Fedora 8 2008-6411: drupal");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6411 (drupal)");
...
Update to 5.8, security fixes:    SA-2008-044    Remember to log in to your sit
e
...
if ( rpm_check( reference:"drupal-5.8-1.fc8", release:"FC8") )
{
