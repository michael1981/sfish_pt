...
if(description)
{
 ...
 script_name(english: "MDKSA-2001:045: gnupg");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2001:045 (gnupg).");
 script_set_attribute(attribute: "description", value: "GnuPG version 1.0.5 has been released that fixes a few security
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2001:045");
