...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2554
#
...
script_name(english: "Fedora 8 2008-2554: asterisk");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2554 (asterisk)");
...
[9]http://downloads.digium.com/pub/security/AST-2008-002.pdf   * All users of S
IP
...
[10]http://downloads.digium.com/pub/security/AST-2008-003.pdf   * All users of
SIP
...
if ( rpm_check( reference:"asterisk-1.4.18.1-1.fc8", release:"FC8") )
{
