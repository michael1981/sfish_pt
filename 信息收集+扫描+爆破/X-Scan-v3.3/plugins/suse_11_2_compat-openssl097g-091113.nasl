...
if(description)
{
 ...
 script_name(english: "SuSE 11.2 Security Update:  compat-openssl097g (2009-11-13)");
...
if ( rpm_check( reference:"compat-openssl097g-0.9.7g-149.5.3", release:"SUSE11.2", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"compat-openssl097g-0.9.7g-149.5.3", release:"SUSE11.2", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"compat-openssl097g-32bit-0.9.7g-149.5.3", release:"SUSE11.2", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
