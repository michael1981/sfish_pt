...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for kdelibs3,kdelibs3-devel,CVE-2007-1564 (kdelibs3-3988)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch kdelibs3-3988");
 script_set_attribute(attribute: "description", value: "A bug in konqueror allowed attackers to abuse the FTP
passive mode for portscans (CVE-2007-1564).
");
 script_set_attribute(attribute: "cvss_vector", value: "CVSS2#AV:N/AC:M/Au:N/C:P/I:P/A:P");
script_set_attribute(attribute: "solution", value: "Install the security patch kdelibs3-3988");
script_end_attributes();

script_cve_id("CVE-2007-1564");
script_summary(english: "Check for the kdelibs3-3988 package");
