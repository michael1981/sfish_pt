...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2941
#
...
script_name(english: "Fedora 7 2008-2941: wireshark");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2941 (wireshark)");
...
if ( rpm_check( reference:"wireshark-1.0.0-1.fc7", release:"FC7") )
{
