...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  flash-player security update (flash-player-4855)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch flash-player-4855");
...
script_set_attribute(attribute: "solution", value: "Install the security patch flash-player-4855");
...
script_summary(english: "Check for the flash-player-4855 package");
...
if ( rpm_check( reference:"flash-player-9.0.115.0-0.1", release:"SUSE10.3") )
{
