...
if(description)
{
 ...
 script_name(english: "RHSA-2008-1045: java");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory RHSA-2008-1045");
...
script_set_attribute(attribute: "see_also", value: "http://rhn.redhat.com/errata/RHSA-2008-1045.html");
...
if ( rpm_check( reference:"java-1.6.0-bea-uninstall-1.6.0.03-1jpp.4.el4", release:'RHEL4') )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check( reference:"java-1.6.0-bea-uninstall-1.6.0.03-1jpp.4.el4", release:'RHEL4.7.') )
{
 security_hole(port:0, extra:rpm_report_get());
 exit(0);
}
