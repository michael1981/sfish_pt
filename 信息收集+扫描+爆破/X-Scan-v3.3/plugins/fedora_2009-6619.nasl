...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6619
#
...
script_name(english: "Fedora 9 2009-6619: rb_libtorrent");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6619 (rb_libtorrent)");
...
if ( rpm_check( reference:"rb_libtorrent-0.12.1-2.fc9", release:"FC9") )
{
