...
#
# This plugin text was extracted from Fedora Security Advisory 2008-6502
#
...
script_name(english: "Fedora 9 2008-6502: phpMyAdmin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-6502 (phpMyAdmin)");
...
update/delete issues   - [security] protection against XSS when register_global
s
is on and .htaccess has no effect, thanks to Tim Starling  - [export] Firefox 3
and .sql.gz (corrupted); detect Gecko 1.9, thanks to Juergen Wind  - [security]
XSRF/CSRF by manipulating the db, convcharset and collation_connection
parameters, thanks to YGN Ethical Hacker Group
[9]http://www.phpmyadmin.net/home_page/security.php?issue=PMASA-2008-5
");
...
if ( rpm_check( reference:"phpMyAdmin-2.11.7.1-1.fc9", release:"FC9") )
{
