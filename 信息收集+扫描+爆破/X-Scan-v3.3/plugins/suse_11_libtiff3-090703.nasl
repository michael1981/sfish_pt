...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  libtiff3 (2009-07-03)");
...
if ( rpm_check( reference:"libtiff3-3.8.2-141.7.1", release:"SLES11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"libtiff3-3.8.2-141.7.1", release:"SLED11", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
