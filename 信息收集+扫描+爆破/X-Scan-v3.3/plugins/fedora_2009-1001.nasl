...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1001
#
...
script_name(english: "Fedora 9 2009-1001: vnc");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1001 (vnc)");
...
if ( rpm_check( reference:"vnc-4.1.3-1.fc9", release:"FC9") )
{
