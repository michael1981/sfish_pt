...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"17644");

 script_xref(name:"IAVA", value:"2005-B-0015");
...
else if ( vuln > 1 )  display("Problem in script $Id: CSCee45312.nasl,v 1.5 2009/10/28 20:47:03 theall Exp $\n");
