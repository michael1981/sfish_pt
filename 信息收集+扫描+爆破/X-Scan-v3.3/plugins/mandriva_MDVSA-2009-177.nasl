...
"The remote host is missing the patch for the advisory MDVSA-2009:177 (postgresql).");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDVSA-2009:177");
