...
'The remote host is missing the DSA-1225 security update');
...
deb_check(prefix: 'mozilla-firefox', release: '3.1', reference: '1.0.4-2sarge13');
deb_check(prefix: 'mozilla-firefox-dom-inspector', release: '3.1', reference: '1.0.4-2sarge13');
deb_check(prefix: 'mozilla-firefox-gnome-support', release: '3.1', reference: '1.0.4-2sarge13');
