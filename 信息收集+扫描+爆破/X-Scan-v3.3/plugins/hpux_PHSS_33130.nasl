...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_33130");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_33130 security update");
 script_set_attribute(attribute: "description", value:
"X/Motif Runtime Periodic Patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_33130");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_33130");
...
if ( hpux_patch_installed (patches:"PHSS_33130 PHSS_35711 PHSS_37028 ") )
{
 exit(0);
}
