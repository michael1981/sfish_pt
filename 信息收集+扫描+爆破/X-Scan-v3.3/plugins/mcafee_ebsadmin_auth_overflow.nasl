...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"40220");
...
properly handle over-sized authentication packet sent to its
...
affected service or even to execute arbitrary code on the remote host
with LOCAL SYSTEM privileges." );
 ...
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-01/0095.html" );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/bugtraq/2008-01/0103.html" );
