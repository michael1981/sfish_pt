...
#
# This plugin text was extracted from Fedora Security Advisory 2009-7415
#
...
script_name(english: "Fedora 9 2009-7415: pidgin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-7415 (pidgin)");
...
if ( rpm_check( reference:"pidgin-2.5.8-1.fc9", release:"FC9") )
{
