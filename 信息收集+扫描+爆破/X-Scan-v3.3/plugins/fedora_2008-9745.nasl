...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9745
#
...
script_name(english: "Fedora 9 2008-9745: cobbler");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9745 (cobbler)");
...
if ( rpm_check( reference:"cobbler-1.2.9-1.fc9", release:"FC9") )
{
