...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2815
#
...
script_name(english: "Fedora 7 2008-2815: mod_suphp");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2815 (mod_suphp)");
...
if ( rpm_check( reference:"mod_suphp-0.6.3-1.fc7", release:"FC7") )
{
