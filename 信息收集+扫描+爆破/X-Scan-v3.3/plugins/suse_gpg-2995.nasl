...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  gpg: Fixed mixed signed/unsigned text problem (gpg-2995)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch gpg-2995");
script_end_attributes();

script_cve_id("CVE-2007-1263");
script_summary(english: "Check for the gpg-2995 package");
