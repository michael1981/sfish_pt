...
#
# This plugin text was extracted from Fedora Security Advisory 2007-1700
#
...
script_name(english: "Fedora 7 2007-1700: kdebase");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-1700 (kdebase)");
...
if ( rpm_check( reference:"kdebase-3.5.7-13.fc7", release:"FC7") )
{
