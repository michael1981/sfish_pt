...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7719
#
...
script_name(english: "Fedora 8 2008-7719: amarok");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7719 (amarok)");
...
if ( rpm_check( reference:"amarok-1.4.10-1.fc8", release:"FC8") )
{
