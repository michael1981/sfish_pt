...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"1226");
 
 script_name(english:"MS00-013: Microsoft Windows Media Server Malformed Handshake Sequence DoS (253943)");
...
"See http://www.microsoft.com/technet/security/bulletin/MS00-013.mspx" );
