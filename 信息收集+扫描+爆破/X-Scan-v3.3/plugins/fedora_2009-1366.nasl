...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1366
#
...
script_name(english: "Fedora 9 2009-1366: gpsdrive");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1366 (gpsdrive)");
...
if ( rpm_check( reference:"gpsdrive-2.09-7.fc9", release:"FC9") )
{
