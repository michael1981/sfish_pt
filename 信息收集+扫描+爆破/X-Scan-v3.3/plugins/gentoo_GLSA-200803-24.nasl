...
if (description)
{
 ...
 script_set_attribute(attribute:'synopsis', value: 'The remote host is missing the GLSA-200803-24 security update.');
 script_set_attribute(attribute:'description', value: 'The remote host is affected by the vulnerability described in GLSA-200803-24
...
script_set_attribute(attribute: 'see_also', value: 'http://www.gentoo.org/security/en/glsa/glsa-200803-24.xml');
...
if (qpkg_check(package: "dev-libs/libpcre", unaffected: make_list("ge 7.6-r1"), vulnerable: make_list("lt 7.6-r1")
)) { security_hole(0); exit(0); }
if (qpkg_check(package: "dev-libs/glib", unaffected: make_list("ge 2.14.6", "lt 2.14.0"), vulnerable: make_list("lt 2.14.6")
)) { security_hole(0); exit(0); }
