...
'The remote host is missing the DSA-630 security update');
...
'The Debian project recommends that you upgrade your lintian package.');
...
deb_check(prefix: 'lintian', release: '3.0', reference: '1.20.17.1');
