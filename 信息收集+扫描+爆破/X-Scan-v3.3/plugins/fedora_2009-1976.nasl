...
#
# This plugin text was extracted from Fedora Security Advisory 2009-1976
#
...
script_name(english: "Fedora 10 2009-1976: libpng10");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-1976 (libpng10)");
...
if ( rpm_check( reference:"libpng10-1.0.43-1.fc10", release:"FC10") )
{
