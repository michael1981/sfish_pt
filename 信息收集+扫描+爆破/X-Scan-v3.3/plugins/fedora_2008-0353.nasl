...
#
# This plugin text was extracted from Fedora Security Advisory 2008-0353
#
...
script_name(english: "Fedora 8 2008-0353: mantis");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-0353 (mantis)");
...
if ( rpm_check( reference:"mantis-1.1.0-1.fc8", release:"FC8") )
{
