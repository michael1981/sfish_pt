...
"http://sunsolve.sun.com/search/document.do?assetkey=1-21-141014-01-1");
...
e +=  solaris_check_patch(release:"5.10", arch:"sparc", patch:"141014-01", obsoleted_by:"138647-01 ", package:"SUNWesu", version:"11.10.0,REV=2005.01.21.15.53");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
