...
'The remote host is missing the DSA-738 security update');
...
'The Debian project recommends that you upgrade your razor package.');
...
deb_check(prefix: 'razor', release: '3.1', reference: '2.670-1sarge2');
