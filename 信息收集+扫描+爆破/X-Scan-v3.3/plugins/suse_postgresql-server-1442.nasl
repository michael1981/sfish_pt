...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  postgresql security update (postgresql-server-1442)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch postgresql-server-1442");
script_end_attributes();

script_cve_id("CVE-2006-2313", "CVE-2006-2314");
script_summary(english: "Check for the postgresql-server-1442 package");
