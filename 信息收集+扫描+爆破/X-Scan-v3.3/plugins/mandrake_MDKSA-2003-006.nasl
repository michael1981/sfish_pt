...
if(description)
{
 ...
 script_name(english: "MDKSA-2003:006: openldap");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2003:006 (openldap).");
 script_set_attribute(attribute: "description", value: "A review was completed by the SuSE Security Team on the OpenLDAP
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2003:006");
