...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for OpenSSL (openssl-2141)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch openssl-2141");
script_end_attributes();

script_cve_id("CVE-2006-2937", "CVE-2006-2940", "CVE-2006-3738", "CVE-2006-4343");
script_summary(english: "Check for the openssl-2141 package");
