...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHNE_28538");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHNE_28538 security update");
 script_set_attribute(attribute: "description", value:
"cumulative ARPA Transport patch");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//patches_with_warnings/hp-ux_patches/s700_800/11.X/PHNE_28538");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHNE_28538");
...
if ( hpux_patch_installed (patches:"PHNE_28538 PHNE_29473 PHNE_32041 PHNE_33395 PHNE_35729 ") )
{
 exit(0);
}
