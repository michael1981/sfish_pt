...
if(description)
{
 ...
 script_name(english: "Solaris 5.9 (sparc) : 123870-05");
...
e +=  solaris_check_patch(release:"5.9", arch:"sparc", patch:"123870-05", obsoleted_by:"", package:"SUNWsrspx", version:"001.002.006");
if ( e < 0 ) { 
	if ( NASL_LEVEL < 3000 ) 
	   security_warning(0);
	else  
