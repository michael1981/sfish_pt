...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3218
#
...
script_name(english: "Fedora 8 2007-3218: perl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3218 (perl)");
...
if ( rpm_check( reference:"perl-5.8.8-31.fc8", release:"FC8") )
{
