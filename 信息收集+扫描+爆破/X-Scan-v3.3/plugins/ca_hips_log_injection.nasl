...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"37998");
...
security context of the affected service." );
 script_set_attribute(attribute:"see_also", value:"http://supportconnectw.ca.com/public/cahips/infodocs/cahips-secnotice.asp" );
