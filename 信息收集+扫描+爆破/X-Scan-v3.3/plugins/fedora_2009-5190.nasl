...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5190
#
...
script_name(english: "Fedora 9 2009-5190: nsd");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5190 (nsd)");
...
if ( rpm_check( reference:"nsd-3.2.2-1.fc9", release:"FC9") )
{
