...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5572
#
...
script_name(english: "Fedora 10 2009-5572: eggdrop");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5572 (eggdrop)");
...
if ( rpm_check( reference:"eggdrop-1.6.19-4.fc10", release:"FC10") )
{
