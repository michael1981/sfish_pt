...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2784
#
...
script_name(english: "Fedora 10 2009-2784: evolution-data-server");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2784 (evolution-data-server)");
...
if ( rpm_check( reference:"evolution-data-server-2.24.5-4.fc10", release:"FC10") )
{
