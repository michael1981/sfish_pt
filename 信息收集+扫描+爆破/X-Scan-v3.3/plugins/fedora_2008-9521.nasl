...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9521
#
...
script_name(english: "Fedora 8 2008-9521: grip");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9521 (grip)");
...
if ( rpm_check( reference:"grip-3.2.0-24.fc8", release:"FC8") )
{
