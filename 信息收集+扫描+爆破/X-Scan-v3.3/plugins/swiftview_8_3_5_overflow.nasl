...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"42836");
  script_xref(name:"OSVDB", value:"42837");
...
plug-in currently installed is affected by a stack buffer overflow. 
...
user's privileges." );
 script_set_attribute(attribute:"see_also", value:"http://www.kb.cert.org/vuls/id/639169" );
 script_set_attribute(attribute:"see_also", value:"http://www.swiftview.com/tech/security/bulletins/SBSV-07-10-02.htm" );
 script_set_attribute(attribute:"solution", value:
"Upgrade to SwiftView Viewer version 8.3.5 or later." );
