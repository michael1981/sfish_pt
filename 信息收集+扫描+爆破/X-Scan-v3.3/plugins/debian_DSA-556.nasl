...
'The remote host is missing the DSA-556 security update');
...
'The Debian project recommends that you upgrade your netkit-telnet package.');
...
deb_check(prefix: 'telnet', release: '3.0', reference: '0.17-18woody2');
deb_check(prefix: 'telnetd', release: '3.0', reference: '0.17-18woody2');
deb_check(prefix: 'netkit-telnet', release: '3.0', reference: '0.17-18woody2');
