...
of the remote SilverStream database by sending a special request." );
 script_set_attribute(attribute:"see_also", value:"http://archives.neohapsis.com/archives/sf/pentest/2000-11/0147.html" );
...
script_end_attributes();
 ...
 script_copyright(english:"This script is Copyright (C) 2002-2009 Tor Houghton");
