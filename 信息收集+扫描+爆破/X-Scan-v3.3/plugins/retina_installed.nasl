...
if (description)
{
  ...
  script_set_attribute(
    attribute:"synopsis",
    value:"A network scanner is installed on the remote Windows host."
  );
  script_set_attribute(
    attribute:"description",
    value:"Retina Network Security Scanner is installed on the remote host."
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  NetUseDel();
  exit(1, "Unable to open HKEY_LOCAL_MACHINE key.");
}
