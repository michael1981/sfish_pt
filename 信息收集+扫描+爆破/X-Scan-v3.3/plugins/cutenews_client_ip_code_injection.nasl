...
that code by requesting 'data/flood.db.php'." );
 script_set_attribute(attribute:"see_also", value:"http://retrogod.altervista.org/cutenews140.html" );
  ...
  if (!safe_checks()) {
    ...
    if (!isnull(id)) {
      ...
      u = strcat(
          ...
          "ucat=1&",
          "script=", SCRIPT_NAME);
      r = http_send_recv3(method: "POST ",  item: u, version: 11, data: postdata, port: port,
