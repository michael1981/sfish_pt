...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  MozillaFirefox: Security update to version 2.0.0.4 (MozillaFirefox-3547)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-3547");
...
the browser chrome UI such as the location bar.
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-3547");
script_end_attributes();

script_cve_id("CVE-2007-2871", "CVE-2007-2870", "CVE-2007-1362", "CVE-2007-2869", "CVE-2007-2867", "CVE-2007-2868", "CVE-2007-1562");
script_summary(english: "Check for the MozillaFirefox-3547 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.4-1.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.4-1.2", release:"SUSE10.1") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
