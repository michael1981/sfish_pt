...
#
# This plugin text was extracted from Fedora Security Advisory 2007-2807
#
...
script_name(english: "Fedora 8 2007-2807: hugin");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-2807 (hugin)");
...
if ( rpm_check( reference:"hugin-0.6.1-11.fc8", release:"FC8") )
{
