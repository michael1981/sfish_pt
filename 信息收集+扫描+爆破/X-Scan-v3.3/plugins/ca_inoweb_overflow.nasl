...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"34585");
...
overflow involving its Console Server component.  By means of
specially-crafted login credentials, a remote attacker can overflow a
