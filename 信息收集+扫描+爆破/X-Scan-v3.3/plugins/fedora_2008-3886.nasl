...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3886
#
...
script_name(english: "Fedora 9 2008-3886: rdesktop");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3886 (rdesktop)");
...
if ( rpm_check( reference:"rdesktop-1.6.0-1.fc9", release:"FC9") )
{
