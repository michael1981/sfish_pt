...
Protocol' and 'AppleShare'." );
 script_set_attribute(attribute:"see_also", value:"http://www.nessus.org/u?7cadff1c" );
 script_set_attribute(attribute:"see_also", value:"http://en.wikipedia.org/wiki/Apple_Filing_Protocol" );
...
{
	local_var afpversioncount_offset, machinetype, machinetype_offset, versions;
