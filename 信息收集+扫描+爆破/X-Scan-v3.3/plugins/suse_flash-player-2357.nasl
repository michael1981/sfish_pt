...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for flash-player (flash-player-2357)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch flash-player-2357");
script_end_attributes();

script_cve_id("CVE-2006-5330");
script_summary(english: "Check for the flash-player-2357 package");
