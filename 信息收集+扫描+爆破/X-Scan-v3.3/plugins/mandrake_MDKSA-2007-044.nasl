...
if(description)
{
 ...
 script_name(english: "MDKSA-2007:044: ekiga");
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2007:044");
