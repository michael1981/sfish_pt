...
if(description)
{
 ...
 script_name(english: "SuSE 11.1 Security Update:  sblim-sfcb (2009-02-05)");
...
if ( rpm_check( reference:"sblim-sfcb-1.3.2-9.12.1", release:"SUSE11.1", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"sblim-sfcb-1.3.2-9.12.1", release:"SUSE11.1", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
