...
if(description)
{
 ...
 script_name(english: "MDKSA-2006:120: samba");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory MDKSA-2006:120 (samba).");
 script_set_attribute(attribute: "description", value: "A vulnerability in samba 3.0.x was discovered where an attacker could
...
script_set_attribute(attribute: "see_also", value: "http://wwwnew.mandriva.com/security/advisories?name=MDKSA-2006:120");
