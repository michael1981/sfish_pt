...
#
# This plugin text was extracted from Fedora Security Advisory 2009-6033
#
...
script_name(english: "Fedora 11 2009-6033: perl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-6033 (perl)");
...
if ( rpm_check( reference:"perl-5.10.0-69.fc11", release:"FC11") )
{
