...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2292
#
...
script_name(english: "Fedora 8 2008-2292: evolution");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2292 (evolution)");
...
if ( rpm_check( reference:"evolution-2.12.3-3.fc8", release:"FC8") )
{
