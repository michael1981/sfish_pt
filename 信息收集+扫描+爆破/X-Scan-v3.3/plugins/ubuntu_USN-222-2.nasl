# This script was automatically generated from the 222-2 Ubuntu Security Notice
...
script_name(english:"USN222-2 : perl vulnerability");
...
- perl-suid 
');
script_set_attribute(attribute:'description', value: 'USN-222-1 fixed a vulnerability in the Perl interpreter. It was
...
found = ubuntu_check(osver: "5.10", pkgname: "libcgi-fast-perl", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package libcgi-fast-perl-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to libcgi-fast-perl-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "libperl-dev", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package libperl-dev-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to libperl-dev-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "libperl5.8", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package libperl5.8-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to libperl5.8-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "perl", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package perl-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to perl-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "perl-base", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package perl-base-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to perl-base-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "perl-debug", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package perl-debug-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to perl-debug-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "perl-doc", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package perl-doc-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to perl-doc-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "perl-modules", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package perl-modules-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to perl-modules-5.8.7-5ubuntu1.2
');
}
found = ubuntu_check(osver: "5.10", pkgname: "perl-suid", pkgver: "5.8.7-5ubuntu1.2");
if (! isnull(found)) {
w++;
extrarep = strcat(extrarep, '
The package perl-suid-',found,' is vulnerable in Ubuntu 5.10
Upgrade it to perl-suid-5.8.7-5ubuntu1.2
');
}
