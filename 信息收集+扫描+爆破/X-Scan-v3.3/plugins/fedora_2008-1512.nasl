...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1512
#
...
script_name(english: "Fedora 7 2008-1512: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1512 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.3.3-0.fc7", release:"FC7") )
{
