...
if (description) {
  ...
  script_xref(name:"OSVDB", value:"14130");
  script_xref(name:"OSVDB", value:"14131");
  script_xref(name:"OSVDB", value:"14132");
...
if (!isnull(matches)) {
  ...
  # Otherwise, try to exploit it.
    ...
    r = http_send_recv3(method: "POST ",  item: dir + url, version: 11, port: port,
