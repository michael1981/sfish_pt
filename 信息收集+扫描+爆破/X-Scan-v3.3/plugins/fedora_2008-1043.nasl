...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1043
#
...
script_name(english: "Fedora 8 2008-1043: xine-lib");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1043 (xine-lib)");
...
if ( rpm_check( reference:"xine-lib-1.1.10-1.fc8", release:"FC8") )
{
