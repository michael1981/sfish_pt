...
#
# This plugin text was extracted from Fedora Security Advisory 2008-7862
#
...
script_name(english: "Fedora 9 2008-7862: httrack");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-7862 (httrack)");
...
if ( rpm_check( reference:"httrack-3.42.93-1.fc9", release:"FC9") )
{
