...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Security update for MozillaFirefox (MozillaFirefox-5644)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch MozillaFirefox-5644");
 script_set_attribute(attribute: "description", value: "This update brings MozillaFirefox to version 2.0.0.17 to
...
script_set_attribute(attribute: "solution", value: "Install the security patch MozillaFirefox-5644");
...
script_summary(english: "Check for the MozillaFirefox-5644 package");
...
if ( rpm_check( reference:"MozillaFirefox-2.0.0.17-0.3", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.17-0.3", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-2.0.0.17-0.2.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.17-0.2.1", release:"SLES10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-2.0.0.17-0.2.1", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
if ( rpm_check( reference:"MozillaFirefox-translations-2.0.0.17-0.2.1", release:"SLED10") )
{
	security_hole(port:0, extra:rpm_report_get());
	exit(0);
}
