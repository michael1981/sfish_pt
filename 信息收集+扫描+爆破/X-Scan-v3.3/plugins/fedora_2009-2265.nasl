...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2265
#
...
script_name(english: "Fedora 9 2009-2265: curl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2265 (curl)");
...
if ( rpm_check( reference:"curl-7.19.4-1.fc9", release:"FC9") )
{
