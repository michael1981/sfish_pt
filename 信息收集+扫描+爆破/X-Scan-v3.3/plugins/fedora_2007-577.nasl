...
#
# This plugin text was extracted from Fedora Security Advisory 2007-577
#
...
script_name(english: "Fedora 6 2007-577: mod_perl");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-577 (mod_perl)");
...
if ( rpm_check( reference:"mod_perl-2.0.2-6.2.fc6", release:"FC6") )
{
