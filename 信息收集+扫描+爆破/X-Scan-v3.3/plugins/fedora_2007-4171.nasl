...
#
# This plugin text was extracted from Fedora Security Advisory 2007-4171
#
...
script_name(english: "Fedora 8 2007-4171: hsqldb");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-4171 (hsqldb)");
...
if ( rpm_check( reference:"hsqldb-1.8.0.8-1jpp.5.fc8", release:"FC8") )
{
