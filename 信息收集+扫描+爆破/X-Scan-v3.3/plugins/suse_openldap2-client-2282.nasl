...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  OpenLDAP security update (openldap2-client-2282)");
...
script_set_attribute(attribute: "solution", value: "Install the security patch openldap2-client-2282");
script_end_attributes();

script_cve_id("CVE-2006-5779");
script_summary(english: "Check for the openldap2-client-2282 package");
