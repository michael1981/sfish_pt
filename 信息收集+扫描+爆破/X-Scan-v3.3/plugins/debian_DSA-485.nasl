...
'The remote host is missing the DSA-485 security update');
...
'Read http://www.debian.org/security/2004/dsa-485
...
deb_check(prefix: 'ssmtp', release: '3.0', reference: '2.50.6.1');
