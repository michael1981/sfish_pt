...
#
# This plugin text was extracted from Fedora Security Advisory 2006-697
#
...
script_name(english: "Fedora 4 2006-697: kernel");
...
if ( rpm_check( reference:"kernel-2.6.16-1.2115_FC4", prefix:"kernel-", release:"FC4") )
{
