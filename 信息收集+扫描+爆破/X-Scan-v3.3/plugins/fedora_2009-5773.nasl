...
#
# This plugin text was extracted from Fedora Security Advisory 2009-5773
#
...
script_name(english: "Fedora 10 2009-5773: ocsinventory");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-5773 (ocsinventory)");
...
if ( rpm_check( reference:"ocsinventory-1.02.1-1.fc10", release:"FC10") )
{
