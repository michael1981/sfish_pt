...
if(description)
{
 ...
 script_name(english: "SuSE 11.0 Security Update:  pam_mount (2009-01-14)");
...
if ( rpm_check( reference:"pam_mount-0.35-15.8", release:"SUSE11.0", cpu:"i586") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"pam_mount-0.35-15.8", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
if ( rpm_check( reference:"pam_mount-32bit-0.35-15.8", release:"SUSE11.0", cpu:"x86_64") )
{
	security_warning(port:0, extra:rpm_report_get() );
	exit(0);
}
