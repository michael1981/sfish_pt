...
#
# This plugin text was extracted from Fedora Security Advisory 2007-197
#
...
script_name(english: "Fedora 6 2007-197: postgresql");
...
if ( rpm_check( reference:"postgresql-8.1.7-1.fc6", release:"FC6") )
{
