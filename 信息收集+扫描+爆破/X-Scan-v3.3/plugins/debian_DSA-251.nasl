...
'The remote host is missing the DSA-251 security update');
...
'The Debian project recommends that you upgrade your w3m and w3m-ssl packages.');
...
deb_check(prefix: 'w3m', release: '3.0', reference: '0.3-2.4');
deb_check(prefix: 'w3m-img', release: '3.0', reference: '0.3-2.4');
deb_check(prefix: 'w3m-ssl', release: '3.0', reference: '0.3-2.4');
deb_check(prefix: 'w3m,', release: '3.0', reference: '0.3-2.4');
