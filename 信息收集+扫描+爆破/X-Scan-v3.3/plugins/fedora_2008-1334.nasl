...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1334
#
...
script_name(english: "Fedora 8 2008-1334: mailman");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1334 (mailman)");
...
if ( rpm_check( reference:"mailman-2.1.9-8.2.fc8", release:"FC8") )
{
