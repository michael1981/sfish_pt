...
#
# This plugin text was extracted from Fedora Security Advisory 2007-391
#
...
script_name(english: "Fedora 6 2007-391: file");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-391 (file)");
...
if ( rpm_check( reference:"file-4.19-2.fc6", release:"FC6") )
{
