...
'The remote host is missing the DSA-1102 security update');
...
'The Debian project recommends that you upgrade your pinball package.');
...
deb_check(prefix: 'pinball', release: '3.1', reference: '0.3.1-3sarge1');
deb_check(prefix: 'pinball-data', release: '3.1', reference: '0.3.1-3sarge1');
deb_check(prefix: 'pinball-dev', release: '3.1', reference: '0.3.1-3sarge1');
