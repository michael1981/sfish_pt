...
#
# This plugin text was extracted from Fedora Security Advisory 2009-2686
#
...
script_name(english: "Fedora 10 2009-2686: mod_security");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-2686 (mod_security)");
...
if ( rpm_check( reference:"mod_security-2.5.9-1.fc10", release:"FC10") )
{
