...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  Opera 9.26 security update. (opera-5028)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch opera-5028");
 script_set_attribute(attribute: "description", value: "This is a version update for Opera to version 9.26 to fix :
...
script_set_attribute(attribute: "solution", value: "Install the security patch opera-5028");
script_end_attributes();

script_summary(english: "Check for the opera-5028 package");
