...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3683
#
...
script_name(english: "Fedora 7 2007-3683: cacti");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3683 (cacti)");
...
if ( rpm_check( reference:"cacti-0.8.7a-1.fc7", release:"FC7") )
{
