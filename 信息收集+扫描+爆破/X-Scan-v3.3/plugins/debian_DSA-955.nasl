...
'The remote host is missing the DSA-955 security update');
...
'The Debian project recommends that you upgrade your mailman package immediately.');
...
deb_check(prefix: 'mailman', release: '3.1', reference: '2.1.5-8sarge1');
