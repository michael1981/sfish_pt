...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"59632");
  script_xref(name:"OSVDB", value:"59633");
  script_xref(name:"OSVDB", value:"59634");
...
following vulnerabilities :
  ...
  - A remote stack buffer overflow in the client acceptor
    daemon (CAD) scheduler could lead to the execution of
    arbitrary code. (CVE-2009-3853)

  - A remote stack buffer overflow in the traditional
    scheduler could lead to the execution of arbitrary
    code. (CVE-2009-3854)

  - There is an unspecified unauthorized access vulnerability
    in the Unix, Linux, and OS/400 API clients when specifying
    the MAILPROG option.  This vulnerability reportedly allows
    a remote attacker to modify arbitrary files on the remote
    host. (CVE-2009-2855)"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"http://www-01.ibm.com/support/docview.wss?uid=swg21405562"
  );
  script_set_attribute(
    attribute:"solution",
    value:
...
port = get_http_port(default:1581);
