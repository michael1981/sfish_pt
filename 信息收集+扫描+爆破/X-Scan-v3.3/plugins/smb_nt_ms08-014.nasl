...
if(description)
{
 ...
 script_cve_id("CVE-2008-0111", "CVE-2008-0112", "CVE-2008-0114", "CVE-2008-0115", "CVE-2008-0116", "CVE-2008-0117", "CVE-2008-0081");
 script_bugtraq_id(27305, 28094, 28095, 28166, 28167, 28168, 28170);
 script_xref(name:"OSVDB", value:"40344");
 script_xref(name:"OSVDB", value:"42722");
 script_xref(name:"OSVDB", value:"42723");
 script_xref(name:"OSVDB", value:"42724");
 script_xref(name:"OSVDB", value:"42725");
 script_xref(name:"OSVDB", value:"42730");
 script_xref(name:"OSVDB", value:"42731");
 script_xref(name:"OSVDB", value:"42732");

 name["english"] = "MS08-014: Vulnerabilities in Microsoft Excel Could Allow Remote Code Execution (949029)";
...
if ( v ) 
{
 ...
 set_kb_item(name:"SMB/Missing/MS08-014", value:TRUE);
