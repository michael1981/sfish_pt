...
#
# This plugin text was extracted from Fedora Security Advisory 2008-10962
#
...
script_name(english: "Fedora 9 2008-10962: awstats");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-10962 (awstats)");
...
if ( rpm_check( reference:"awstats-6.8-3.fc9", release:"FC9") )
{
