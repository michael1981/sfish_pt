...
#
# This plugin text was extracted from Fedora Security Advisory 2008-9807
#
...
script_name(english: "Fedora 8 2008-9807: thunderbird");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-9807 (thunderbird)");
...
if ( rpm_check( reference:"thunderbird-2.0.0.18-1.fc8", release:"FC8") )
{
