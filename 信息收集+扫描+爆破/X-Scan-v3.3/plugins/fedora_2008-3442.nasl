...
#
# This plugin text was extracted from Fedora Security Advisory 2008-3442
#
...
script_name(english: "Fedora 8 2008-3442: bugzilla");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-3442 (bugzilla)");
...
if ( rpm_check( reference:"bugzilla-3.0.4-1.fc8", release:"FC8") )
{
