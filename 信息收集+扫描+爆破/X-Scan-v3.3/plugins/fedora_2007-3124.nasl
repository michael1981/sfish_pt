...
#
# This plugin text was extracted from Fedora Security Advisory 2007-3124
#
...
script_name(english: "Fedora 7 2007-3124: openldap");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2007-3124 (openldap)");
...
if ( rpm_check( reference:"openldap-2.3.34-4.fc7", release:"FC7") )
{
