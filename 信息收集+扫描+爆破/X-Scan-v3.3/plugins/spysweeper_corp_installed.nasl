...
if(description)
{
 ...
 script_summary(english:"Checks that SpySweeper is installed and then makes sure the latest Vdefs are loaded.");
  ...
  script_set_attribute(
    attribute:'synopsis',
    value:'The remote host has enterprise class anti-spyware installed.'
  );

  script_set_attribute(
    attribute:'description',
    value:'This plugin checks that the remote host has Webroot Spy Sweeper
...
Vdefs are loaded.'
  ...
  script_set_attribute(
    attribute:'solution',
    value:'Make sure Spy Sweeper Ent is installed, running and using the
latest VDEFS.'
  );

  script_set_attribute(
    attribute:'see_also',
    value:'http://www.webroot.com/business/products/spysweeperenterprise/'
  );
