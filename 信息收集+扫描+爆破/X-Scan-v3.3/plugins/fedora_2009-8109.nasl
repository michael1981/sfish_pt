...
#
# This plugin text was extracted from Fedora Security Advisory 2009-8109
#
...
script_name(english: "Fedora 11 2009-8109: wordpress");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2009-8109 (wordpress)");
...
if ( rpm_check( reference:"wordpress-2.8.2-1.fc11", release:"FC11") )
{
