...
if (description)
{
  ...
  script_xref(name:"OSVDB", value:"40960");

  script_name(english:"boastMachine mail.php id Variable SQL Injection");
...
if (thorough_tests) dirs = list_uniq(make_list("/boastmachine", "/bmachine", "/blob", cgi_dirs()));
