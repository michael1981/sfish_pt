...
if(description)
{
 ...
 script_xref(name:"OSVDB", value:"4469");
 script_xref(name:"OSVDB", value:"13397");
 script_xref(name:"RHSA", value:"RHSA-2003:137-02");
...
calls the function trans2open(). An attacker may exploit this flaw 
to gain a root shell on this host.

In addition, it is reported that this version of Samba
is vulnerable to additional overflows, although Nessus 
