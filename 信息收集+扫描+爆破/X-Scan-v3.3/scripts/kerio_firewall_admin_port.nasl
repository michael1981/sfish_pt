...
if(description)
{
 ...
 name["english"] = "Kerio Personal Firewall < 4.1.3";

 script_name(english:name["english"]);

 desc["english"] = "
The remote host appears to be running a version of
Kerio Personal Firewall which is older than 4.1.3
...
Risk factor : Medium";
 ...
 summary["english"] = "Determines if Kerio Personal Firewall is vulnerable to brute-force attacks and DoS";
...
if (kpf_isWeakAdminProtocol(port)) security_hole(port);
