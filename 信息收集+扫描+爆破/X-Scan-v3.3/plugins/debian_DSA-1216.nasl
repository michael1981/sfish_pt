...
'The remote host is missing the DSA-1216 security update');
...
'The Debian project recommends that you upgrade your flexbackup package.');
...
deb_check(prefix: 'flexbackup', release: '3.1', reference: '1.2.1-2sarge1');
deb_check(prefix: 'flexbackup', release: '4.0', reference: '1.2.1-3');
