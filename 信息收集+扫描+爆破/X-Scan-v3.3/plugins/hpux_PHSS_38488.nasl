...
if(description)
{
 ...
 script_name(english: "HP-UX Security patch : PHSS_38488");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing HP-UX PHSS_38488 security update");
 script_set_attribute(attribute: "description", value:
"X OV NNM7.53 PA-RISC Intermediate Patch 20");
 script_set_attribute(attribute: "solution", value: "ftp://ftp.itrc.hp.com//superseded_patches/hp-ux_patches/s700_800/11.X/PHSS_38488");
 script_set_attribute(attribute: "risk_factor", value: "High");
 script_end_attributes();

 script_summary(english: "Checks for patch PHSS_38488");
...
if ( hpux_patch_installed (patches:"PHSS_38488 PHSS_38782 PHSS_39245 PHSS_39639 PHSS_39944 ") )
{
 exit(0);
}
