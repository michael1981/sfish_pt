...
#
# This plugin text was extracted from Fedora Security Advisory 2006-717
#
...
script_name(english: "Fedora 5 2006-717: thunderbird");
...
if ( rpm_check( reference:"thunderbird-1.5.0.4-1.1.fc5", release:"FC5") )
{
