...
if ( rpm_check(reference:"slocate-2.7-3.RHEL3.6", release:"CentOS-3", cpu:"ia64") )
{
 security_note(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check(reference:"slocate-2.7-3.RHEL3.6", release:"CentOS-3", cpu:"i386") )
{
 security_note(port:0, extra:rpm_report_get());
 exit(0);
}
if ( rpm_check(reference:"slocate-2.7-3.RHEL3.6", release:"CentOS-3", cpu:"x86_64") )
{
 security_note(port:0, extra:rpm_report_get());
 exit(0);
}
