...
if(description)
{
 ...
 script_name(english: "SuSE Security Update:  wv: Securityfix for two integer overflow problems (wv-2279)");
 script_set_attribute(attribute: "synopsis", value: 
"The remote SuSE system is missing the security patch wv-2279");
...
script_set_attribute(attribute: "solution", value: "Install the security patch wv-2279");
script_end_attributes();

script_cve_id("CVE-2006-4513");
script_summary(english: "Check for the wv-2279 package");
...
if ( rpm_check( reference:"wv-1.0.3-20.5", release:"SUSE10.1") )
{
