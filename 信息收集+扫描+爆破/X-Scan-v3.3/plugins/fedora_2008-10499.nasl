...
#
# This plugin text was extracted from Fedora Security Advisory 2008-10499
#
...
script_name(english: "Fedora 8 2008-10499: openvpn");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-10499 (openvpn)");
...
if ( rpm_check( reference:"openvpn-2.1-0.29.rc15.fc8", release:"FC8") )
{
