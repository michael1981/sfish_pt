...
'The remote host is missing the DSA-223 security update');
...
deb_check(prefix: 'geneweb', release: '3.0', reference: '4.06-2');
deb_check(prefix: 'gwtp', release: '3.0', reference: '4.06-2');
