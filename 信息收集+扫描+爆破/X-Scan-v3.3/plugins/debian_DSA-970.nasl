...
'The remote host is missing the DSA-970 security update');
...
'The Debian project recommends that you upgrade your kronolith and kronolith2 packages.');
...
deb_check(prefix: 'kronolith', release: '3.1', reference: '1.1.4-2sarge1');
