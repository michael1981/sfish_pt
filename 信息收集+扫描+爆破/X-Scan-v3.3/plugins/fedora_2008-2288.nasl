...
#
# This plugin text was extracted from Fedora Security Advisory 2008-2288
#
...
script_name(english: "Fedora 8 2008-2288: mediawiki");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-2288 (mediawiki)");
...
if ( rpm_check( reference:"mediawiki-1.10.4-38.fc8", release:"FC8") )
{
