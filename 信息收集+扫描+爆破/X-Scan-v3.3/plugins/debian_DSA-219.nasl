...
'The remote host is missing the DSA-219 security update');
...
'The Debian project recommends that you upgrade your dhcpcd package (on the client
machine).');
...
deb_check(prefix: 'dhcpcd', release: '2.2', reference: '1.3.17pl2-8.1');
