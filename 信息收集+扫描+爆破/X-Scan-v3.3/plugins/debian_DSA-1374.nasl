# This script was automatically generated from the dsa-1374
...
if (description) {
 ...
 script_cve_id("CVE-2007-3189", "CVE-2007-3190", "CVE-2007-3191");

 script_set_attribute(attribute:'synopsis', value: 
'The remote host is missing the DSA-1374 security update');
...
'The Debian project recommends that you upgrade your jffnms package.');
script_set_attribute(attribute: 'cvss_vector', value: 'CVSS2#AV:N/AC:L/Au:N/C:C/I:C/A:N');
script_end_attributes();

 script_copyright(english: "This script is (C) 2009 Tenable Network Security, Inc.");
 script_name(english: "[DSA1374] DSA-1374-1 jffnms");
 script_category(ACT_GATHER_INFO);
 script_family(english: "Debian Local Security Checks");
 script_dependencies("ssh_get_info.nasl");
 script_require_keys("Host/Debian/dpkg-l");
 script_summary(english: "DSA-1374-1 jffnms");
 exit(0);
}
...
deb_check(prefix: 'jffnms', release: '4.0', reference: '0.8.3dfsg.1-2.1etch1');
