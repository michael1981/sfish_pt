...
#
# This plugin text was extracted from Fedora Security Advisory 2008-1231
#
...
script_name(english: "Fedora 7 2008-1231: SDL_image");
 script_set_attribute(attribute: "synopsis", value: 
"The remote host is missing the patch for the advisory FEDORA-2008-1231 (SDL_image)");
...
if ( rpm_check( reference:"SDL_image-1.2.5-7.fc7", release:"FC7") )
{
