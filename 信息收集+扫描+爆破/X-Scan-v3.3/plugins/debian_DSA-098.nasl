...
'The remote host is missing the DSA-098 security update');
...
'Read http://www.debian.org/security/2002/dsa-098
...
deb_check(prefix: 'libgtop-daemon', release: '2.2', reference: '1.0.6-1.1');
deb_check(prefix: 'libgtop-dev', release: '2.2', reference: '1.0.6-1.1');
deb_check(prefix: 'libgtop1', release: '2.2', reference: '1.0.6-1.1');
